...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="Indian express"; }
...
if ($iphone || $android || $palmpre || $ipod || $berry == true) 
{
	...
	$retrivesource="Indian express Mobile";

}
else { 			$device = "Desktop";	$retrivesource="Indian express desktop";}
...
// Calling the plugin
   ...
   $(document).ready(function() {
            ...
            $("#subimg").click(function(event){	
				...
				if(name2.length >0 && phone2.length>=8)
				{
				  $.post("applypersonal-loans-continue-mob.php",
					{
						Name2: $("#Name2").val(),
						Phone2: $("#Phone2").val(),
						source2: $("#source2").val(),
...
<tr align="left">
  ...
  <tr>
    <td height="20" colspan="2" align="center" class="form_text">&nbsp;</td>
		...
		<div id="leavenumber" <?php echo $shClassMobile; ?>>
		 <form name="personal_form" action="applypersonal-loans-continue-mobful.php" method="POST" onSubmit="return chkploan(document.personal_form);">
         <input type="hidden" name="source2" id="source2" value="<? echo $retrivesource; ?>"> 
		 <input type="hidden" name="requestid_Mob" id="requestid_Mob">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td height="35" colspan="2" align="center" class="form_text"><img src="d4limages/aplp_submit_btn-new.jpg" style="width:173px; height:40px; border:none;" id= "subimg" onclick="return chkploan(document.personal_form);" /></td>
  </tr>
  <tr>
  <td colspan="2" width="100%" style="display:none;" id="openthisdiv">
  
  <table width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td height="35" colspan="2" style="color: #0072bc;" class="form_text"> Fill details & receive 100% free assistance
      <div id="loanVal2"  class="alert_msg"></div></td>
    </tr>
  <tr>
    <td height="30" align="left" class="form_text">Occupation</td>
<td height="30"align="left" class="form_text"><input type="radio" name="Employment_Status2" id="Employment_Status2" value="1">
     Salaried <input name="Employment_Status2" id="Employment_Status2" type="radio" value="0"> Self-Employed</td>
  </tr>
  <tr>
    <td height="30" align="left" class="form_text">City</td>
    <td height="30"align="center" class="form_text" style="font-size:10px; text-align:left;"><label for="select"></label>
      <select  name="City2" class="select" id="City2"  tabindex="5" onChange=" addPersonalDetails(); validateDiv('cityVal');" ><option value="Select Your City">Select your City</option><option value="Ahmedabad">Ahmedabad</option><option value="Aurangabad">Aurangabad</option><option value="Bangalore">Bangalore</option><option value="Baroda">Baroda</option><option value="Bhiwadi">Bhiwadi</option><option value="Bhopal">Bhopal</option><option value="Bhubneshwar">Bhubneshwar</option><option value="Chandigarh">Chandigarh</option><option value="Chennai">Chennai</option><option value="Cochin">Cochin</option><option value="Coimbatore">Coimbatore</option><option value="Cuttack">Cuttack</option><option value="Dehradun">Dehradun</option><option value="Delhi">Delhi</option><option value="Faridabad">Faridabad</option><option value="Gaziabad">Gaziabad</option><option value="Gurgaon">Gurgaon</option><option value="Guwahati">Guwahati</option><option value="Hosur">Hosur</option><option value="Hyderabad">Hyderabad</option><option value="Indore">Indore</option><option value="Jabalpur">Jabalpur</option><option value="Jaipur">Jaipur</option><option value="Jamshedpur">Jamshedpur</option><option value="Kanpur">Kanpur</option><option value="Kochi">Kochi</option><option value="Kolkata">Kolkata</option><option value="Lucknow">Lucknow</option><option value="Ludhiana">Ludhiana</option><option value="Madurai">Madurai</option><option value="Mangalore">Mangalore</option><option value="Mysore">Mysore</option><option value="Mumbai">Mumbai</option><option value="Nagpur">Nagpur</option><option value="Nasik">Nasik</option><option value="Navi Mumbai">Navi Mumbai</option><option value="Noida">Noida</option><option value="Patna">Patna</option><option value="Pune">Pune</option><option value="Ranchi">Ranchi</option><option value="Raipur">Raipur</option><option value="Rewari">Rewari</option><option value="Sahibabad">Sahibabad</option><option value="Surat">Surat</option><option value="Thane">Thane</option><option value="Thiruvananthapuram">Thiruvananthapuram</option><option value="Trivandrum">Trivandrum</option><option value="Trichy">Trichy</option><option value="Vadodara">Vadodara</option><option value="Vishakapatanam">Vishakapatanam</option><option value="Vizag">Vizag</option><option value="Others">Others</option></select></td>
  </tr>
  <tr>
    <td height="30" align="left" class="form_text">Annual Income</td>
    <td height="30"align="center" class="form_text" style="font-size:10px; text-align:left;"><label for="textfield"></label>
      <input type="text" name="Net_Salary2" id="Net_Salary2" class="input"></td>
  </tr>
  ...
  <tr>
    <td height="35" colspan="2" align="center" class="form_text"><input type="image" name="Submit2" src="d4limages/aplp_getquote_btn-new.jpg" style="width:173px; height:40px; border:none;" /></td>
  </tr></table>
  <div style="clear:both;"></div>
  </td>
  </tr>
 ...
 <div style="clear:both;"></div>
  ...
  <div class="why_text_box-right-new"> 
    ...
    <p><strong style="font-size:33px;">Personal Loan</strong> at <strong style="font-size:33px;">Lowest Rate</strong><br>
      or a <strong style="font-size:33px;">Watch Free</strong></p>
  </div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr>
       <td class="text_head-bullet" style="color:#CC0000;"><ul>
         ...
         <li>Lowest Rate starting as low as <strong>11.99% </strong></li>
         <li>Processing Fee offers starts <strong>999</strong></li>
         <li><strong>3 </strong>Nil Prepayment offers</li>
...
<tr>
<td width="328" valign="middle" bgcolor="#FFFFFF" style="color:#333; font-family:'Raleway'; font-size:12px;">Part Prepayment <strong style="font-weight:normal; font-size:10px;">(3rd&nbsp;Month)</strong></td>
...
<tr>
<td width="328" valign="middle" bgcolor="#FFFFFF" style="color:#333; font-family:'Raleway'; font-size:12px;">Withdrawal <strong style="font-weight:normal; font-size:10px;">(3rd&nbsp;month)</strong></td>
