...
Pincode,Net_Salary,Loan_Any,PL_EMI_Amt,Loan_Amount,Card_Limit,Allocation_Date FROM Req_Feedback_Bidder1,Req_Loan_Personal WHERE (Req_Feedback_Bidder1.AllRequestID=Req_Loan_Personal.RequestID and Req_Feedback_Bidder1.BidderID in (2721,2722,2723,2809,2830,2937,3376) and Req_Feedback_Bidder1.Reply_Type=1 and Req_Feedback_Bidder1.Allocation_Date Between '".($min_date)."' and '".($max_date)."') ";
	...
	while($row_result=mysql_fetch_array($search_result))
	{
		...
		$qry1="insert into temp (session_id, name, dob, email, mobile_number, emp_status, c_name, city, city_other, pincode, cc_holder, net_salary, loan_any, emi_paid,is_processed, loan_amount, card_vintage, card_limit, doe) values ('".$session_id."', '".$row_result["Name"]."', '".$row_result["DOB"]."', '".$row_result["Email"]."', '".$row_result["Mobile_Number"]."', '".$emp_status."','".$row_result["Company_Name"]."', '".$row_result["City"]."', '".$row_result["City_Other"]."','".$row_result["Pincode"]."','".$cc_holder."','".$row_result["Net_Salary"]."','".$row_result["Loan_Any"]."','".$emi_paid."','".$row_result["PL_EMI_Amt"]."','".$row_result["Loan_Amount"]."','".$card_vintage."','".$row_result["Card_Limit"]."','".$row_result["Allocation_Date"]."')";
...
//$newToday ="280112";
	...
	$newfileatt = "/home/deal4loans/public_html/pldwnld/citi".$newToday."2725.xls";
...
if($recordcount>0)
	...
	$to = "yatish@prosales.in"; 
	//$to = "ranjana5chauhan@gmail.com"; 
	
       $from = "Deal4loans <no-reply@deal4loans.com>"; 
        $subject = "Citibank Personal Loan Leads @ deal4loans.com".$newToday; 
          
	   $fileatt = "/home/deal4loans/public_html/pldwnld/citi".$newToday."2725.xls";
        $fileatttype = "application/xls"; 
        $fileattname = "citi".$newToday."2725.xls";
