...
$crap = " ".$Name." ".$Email." ".$Company_Name." ".$City_Other;
		...
		if($crapValue=='Put')
		{
			...
			$getdetails="select RequestID From Req_Loan_Against_Property  Where (Mobile_Number='".$Phone."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."' and Phone not in (9971396361,9871245467,9811215138,9891118553,9555060388,9311773341) ) order by RequestID DESC";
			//echo $getdetails."<br>";
			//exit();
...
<table width="100%"  border="0" align="center" cellpadding="2" cellspacing="3" >
     ...
     <td>
	  ...
	  <form name="lap_verify" action="apply-loan-against-property-thanks_100616.php" method="post">
     ...
     <div class="apply-hl-form" style="background:#0e79b9;"> 
...
<div class="apply-hl-input-wapper" style="margin-top:15px; margin-bottom:10px;">
  ...
  <div class="apply-hl-input-wapper" style="margin-top:15px;">
       <table width="98%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           <td class="formhlwpbody-text" style="color:#FFF;">Age:</td>
         </tr>
         </table>
     </div>
...
<div class="apply-hl-input-wapper" style="margin-top:15px; margin-bottom:10px;">
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="formhlwpbody-text"><select onchange="validateDiv(\'AgeVal\');" class="emi_input" name="Age" id="Age"><option value="">Select Age</option><?php for($a=18;$a<=65;$a++) {?><option value="<?php echo $a;?>"><?php echo $a;?></option><?php }?></select><div id="AgeVal"></div></td>
    </tr>
    </table>
</div>
<div style="clear:both;"></div>
  <div class="apply-hl-input-wapper" style="margin-top:15px;">
       <table width="98%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           <td class="formhlwpbody-text" style="color:#FFF;">Company Name:</td>
         </tr>
         </table>
     </div>
...
<div class="apply-hl-input-wapper" style="margin-top:15px; margin-bottom:10px;">
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="formhlwpbody-text"><input name="Company_Name" id="Company_Name" type="text"  class="emi_input" onkeydown="validateDiv(\'companyNameVal\');" tabindex="12" autocomplete="off" /><div id="companyNameVal"></div></td>
    </tr>
    </table>
</div>
  ...
  <div class="apply-hl-input-wapper" style="margin-top:15px;">
       <table width="98%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           <td class="formhlwpbody-text" style="color:#FFF;">
...
<div class="apply-hl-input-wapper" style="margin-top:15px; margin-bottom:10px;">
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="formhlwpbody-text"><input name="Property_Value" id="Property_Value" maxlength="8" onkeypress="intOnly(this);"   type="text" class="emi_input" onkeydown="validateDiv(\'propertyVal\');" tabindex="13" autocomplete="off" /> <div id="propertyVal"></div></td>
    </tr>
    </table>
</div>
  ...
  <div class="apply-hl-input-wapper" style="margin-top:15px;">
       <table width="98%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           <td class="formhlwpbody-text" style="color:#FFF;">Property Type:</td>
         </tr>
         </table>
     </div>
...
<div class="apply-hl-input-wapper" style="margin-top:15px; margin-bottom:10px;">
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="formhlwpbody-text"><select name="Property_Type" id="Property_Type" class="emi_input" onchange="validateDiv('propertyTypeVal');" tabindex="12" /><option value="">Property Type</option><option value="1">Residential</option> <option value="2">Commercial</option> </select><div id="propertyTypeVal"></div></td>
    </tr>
    </table>
</div>
...
<div class="apply-hl-input-wapper" style="margin-bottom:20px;">
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="formhlwpbody-text">  <input type="image" src="http://www.deal4loans.com/images/wp-loan-get-quote.png" height="44" width="117" value=""/></td>
    </tr>
    </table>
</div>
