...
{   
    ...
    echo $qry = "SELECT * FROM Bidders_List WHERE (Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and BankID !='66' ) order by `bankwise_priority` ASC";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $City = trim($row[$fc]["City"]);
		...
		{
			echo "fffffffffff".$strProduct."<br>";
			if(trim($strProduct)=="wishfin_quote_loan")
			{
			$query = str_ireplace("Req_Loan_Personal", "wishfin_quote_loan", $query);
			 $qry2 = $query." and (City in ".$propercity." or City_Other in ".$propercity." ) and ".$strProduct.".RequestID ='".$RequestID."'";
			}
			else
			{
