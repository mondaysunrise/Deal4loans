...
<tr>
  ...
  <?php
  $getData = "select * from rm_detail_fullerton where 1=1";
  ...
  <table width="950" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" >
   ...
   <tr>
     ...
     <td width="88" align="center" bgcolor="#FFFFFF" class="style2">Mobile</td>
      <td width="141" align="center" bgcolor="#FFFFFF" class="style2">Email </td>
   ...
   <tr>
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3" ><? echo $row["rm_name"]; ?></td>
	 <td align="center" bgcolor="#DFF6FF" class="style3"><? 
	 	$getCitySql = "select City from Bidders where BidderID='".$row["rm_city"]."'";
			//echo $getCitySql."<br>";
	 ...
	 echo $row["rm_city"];
//	 echo $getCity; ?></td>	
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["rm_contact"]; ?></td>
     	   <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["rm_email"]; ?></td>
	 	 <td align="center" bgcolor="#DFF6FF" class="style3"><a href="update_fullerton_rm.php?id=<? echo $row["id"]; ?>">Edit</a></td>
