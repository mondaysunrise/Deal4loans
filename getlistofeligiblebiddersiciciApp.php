...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
 ...
 $CheckDateSql = "select sum(BookLeadCount) as SumDay from Bidders_Book_Keeping where BidderID = ".$FBidderID." and BookDate = ".$TodayDay." and BookProduct='".$mvarType."'  and  BookMonth = ".$TodayMonth." and  BookYear= ".$TodayYear." ";
	...
	list($recordcount2,$row_result_W)=MainselectfuncNew($CheckWeekSql,$array = array());
	$w=0;
	...
	list($recordcount3,$row_result_M)=MainselectfuncNew($CheckMonthSql,$array = array());
	$m=0;
	...
	list($recordcount4,$row_result_LT)=MainselectfuncNew($CheckLifeTimeSql,$array = array());
	$lt=0;
