...
{
	echo $strProduct." - ".$strRequestID." - ".$strCity." - ".$strritebidder."<br><br>";
$ProductType=1;
$LeadID = $strRequestID;
$BiddersValue = explode(",",$strritebidder);

//code for leadallocation
for($l=0;$l<count($BiddersValue);$l++)
	{
			if($ProductType==1)
			{
$InsertFeedBackSqlPL = "Insert into Req_Feedback_Bidder_PL (AllRequestID,BidderID,Reply_Type,Allocation_Date) Values ('$LeadID', '$BiddersValue[$l]','$ProductType', Now())";
	...
	entryBookKeeping($arrbidder[$l], $ProductType);
	//end of book keeping
...
if(strlen($strcitywise)>0)
	...
	$getValidBiddersForSms="Select * from Req_Compaign Where Sms_Flag=1 and Reply_Type=".$ProductType." and BidderID='".$BiddersValue[$l]."'and City_Wise like '%".$strCity."%'";
...
$GetBidderID = $strritebidder;
//code to send mail

updateBidderCountinProduct($ProductType, count($BiddersValue), $LeadID);
...
function entryBookKeeping($Biddersid, $ProductType)
{ 
            $toInsert = ExecQuery("select Restrict_Bidder from Bidders_List where  BidderID ='".$Biddersid."' and Reply_Type ='".$ProductType."'");
            ...
            {   
                ...
                $BookKeepingSql = "select * from Bidders_Book_Keeping where BidderID=".$Biddersid." and BookProduct=".$ProductType." and BookDate=".$BK_Day." and BookMonth=".$BK_Month." and BookYear=".$BK_Year."";
                ...
                $BookYear = @mysql_result($BookKeepingQuery,0,'BookYear');//added
                 ...
                 if($BookLeadCountExisting>=1)
                 {
                    ...
                    $UpdateBKSql = "update Bidders_Book_Keeping set BookLeadCount=".$IncrementLeadCount.", BookEntryTime = Now()  where BidderID = ".$Biddersid." and BookDate = ".$BK_Day." and BookMonth=".$BK_Month." and BookYear =".$BK_Year." and BookProduct =".$ProductType."";
                 ...
                 else
                 {
                    //Insert
                    $InitialCount = 1;
                    $InsertBKSql = "INSERT INTO Bidders_Book_Keeping ( BidderID , BookProduct , BookDate , BookWeek , BookMonth , BookYear , BookLeadCount, BookEntryTime ) VALUES (".$Biddersid.", ".$ProductType.", ".$BK_Day.",".$BK_Week.", ".$BK_Month.", ".$BK_Year.", ".$InitialCount.",Now())";
...
<td bgcolor='#494949' style='color:#FFFFFF; font-family:Verdana,Arial,Helvetica,sans-serif; font-size:11px; font-weight:bold; padding:2px; text-align:center;'>&nbsp;</td></tr>";
	...
	if($defrow['BidderID']=="2720" || $defrow['BidderID']=="2718" || $defrow['BidderID']=="2719" || $defrow['BidderID']=="2721" || $defrow['BidderID']=="2722" || $defrow['BidderID']=="2730" || $defrow['BidderID']=="2830" || $defrow['BidderID']=="2843" || $defrow['BidderID']=="2846" || $defrow['BidderID']=="2937" || $defrow['BidderID']=="2962" || $defrow['BidderID']=="2958" || $defrow['BidderID']=="2984" || $defrow['BidderID']=="2995" || $defrow['BidderID']=="3061" || $defrow['BidderID']=="3082" || $defrow['BidderID']=="3133" || $defrow['BidderID']=="3132" || $defrow['BidderID']=="3196" || $defrow['BidderID']=="3198" || $defrow['BidderID']=="3199" || $defrow['BidderID']=="3299" || $defrow['BidderID']=="3359" || $defrow['BidderID']=="3381" || $defrow['BidderID']=="3383" || $defrow['BidderID']=="3407" || $defrow['BidderID']=="3576" || $defrow['BidderID']=="3451" || $defrow['BidderID']=="3581" || $defrow['BidderID']=="3532" || $defrow['BidderID']=="3533" || $defrow['BidderID']=="3579" || $defrow['BidderID']=="3658" || $defrow['BidderID']=="3722" || $strbidderid=="3754" || $strbidderid=="3753" || $strbidderid=="3758" || $strbidderid=="3759" || $strbidderid=="3724" || $strbidderid=="3726" || $strbidderid=="3725" || $strbidderid=="3787" || $strbidderid=="3788" || $strbidderid=="3868")
				{
$Message .= "<tr>
...
//	echo "mvarCity : ".$mvarCity."<BR>";
	...
	$strSQL = "SELECT Bank_Name,Banker_Contact,BidderID,Bankers_Name  FROM Bidder_Contact_To_Customers WHERE (BidderID in (".$strbidderid.") AND Reply_Type=".$strProduct." AND Sms_Flag=1)";
...
//		echo $SMSMessage.$SMSMessageBidders."<BR>";
		...
		{
			getleadbysms($SMSMessage.$SMSMessageBidders, $Phone);   
		}
	...
	if(strlen(trim($sms_4barclays))>0)
	{
		...
		if(strlen(trim($Phone)) > 0)
		{
			getleadbysms($sms_4barclays, $Phone);   
		}
	...
	if(strlen(trim($sms_4barclaysBid))>0)
	{
		...
		{
			getleadbysms($sms_4barclaysBid, $bdPhone);   
