<?php
include "includes/header_appt.php";
?>
<div id="payment_container-dash_page">
  <?php include "includes/left1.php";?>
  <div class="content_right" style="background:#6FC; height:550px;">
    ...
    <table width="633" cellspacing="0" cellpadding="0" border="0" style="border:solid 1px #ccc; margin-bottom:10px;" class="table-prolist">
      <thead>
      <form id="form1" method="post" action="edit_appt_continue.php">
        <tr>
       ...
       <?php
	    $w = 1;
        $Query = "SELECT * FROM Bidders WHERE leadidentifier='plalloclms'";
    ...
    <td><?php echo $rowsCon->BidderID;?></td>             
    <td><?php echo $rowsCon->Email;?></td>
          <td><?php echo $rowsCon->PWD;?></td>
          <td><?php echo $rowsCon->Associated_Bank;?></td>
        </tr>
        <?php $w++;}?>
