...
<div id="payment_container-dash_page">
  ...
  <div class="content_right">
	...
	<table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
	  <form name="frmsearch" action="hllmsdashboard.php" method="post" onSubmit="return chkform();">
...
if($search=="y")
{
	...
	while($BidsRow = $obj->fun_db_fetch_rs_object($result))
	{
		...
		$sqllifecyclebid="Select Bidder_Name From Bidders Where (BidderID='".$bididcaller."' and leadidentifier='hlallocatelms')";
