...
<div id="payment_container-dash_page">
  ...
  <div class="content_right">
    <h1>List of Bidders in Diallercallerccpredictive LMS</h1>
    <br />
    <?php 
	if($_REQUEST['msg']!="")
			{
    ...
    <table width="633" cellspacing="0" cellpadding="0" border="0" style="border:solid 1px #ccc; margin-bottom:10px;" class="table-prolist">
      <thead>
      <form id="form1" method="post" action="edit_diallercallerccpredictive_continue.php">
        <tr>
       ...
       <?php
	    $w = 1;
        $Query = "SELECT `BidderID`, `Email`, `PWD`, `Bidder_Name`, `Associated_Bank`, `Profile`, `leadidentifier`, `Status` FROM Bidders WHERE leadidentifier='diallercallerccpredictive'";
