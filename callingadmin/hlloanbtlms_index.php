...
$qryCheck = "SELECT * FROM Bidders where (leadidentifier in ('hlbtlms'))";
...
if (restore) selObj.selectedIndex=0;
    ...
    <table width="98%" border="0">
        ...
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="hlloanbtlms_index.php" method="get" onSubmit="return chkform();">
	...
	{		
		...
		if($BidderIDstatic!="")
		{
			...
			$qry="SELECT *,hlcallinglms_allocation.BidderID AS allocatedBidid FROM ".$feedback_tble.",".TABLE_REQ_LOAN_HOME." LEFT OUTER JOIN Req_Feedback_HL ON Req_Feedback_HL.AllRequestID=".TABLE_REQ_LOAN_HOME.".RequestID AND Req_Feedback_HL.BidderID in (".$hlbidderidstr.") WHERE ".$feedback_tble.".AllRequestID=".TABLE_REQ_LOAN_HOME.".RequestID and ".$feedback_tble.".BidderID in (".$hlbidderidstr.") and ((".$feedback_tble.".DOE Between '".($min_date)."' and '".($max_date)."') or (Req_Feedback_HL.Followup_Date Between '".($min_date)."' and '".($max_date)."')) ";
