...
<div class="content_right" style="background:#6FC; ">
    <h1>Consolidated view of HL LMS(Exclusive Leads)</h1>
...
//GET Manager Bidder Id's
$getManagerBidderSql = "SELECT * FROM Bidders WHERE leadidentifier IN ('hlallocatelms') AND Selection_Category = 2";
$getManagerBidderResult = $obj->fun_db_query($getManagerBidderSql);
while($getManagerBidderRow = $obj->fun_db_fetch_rs_object($getManagerBidderResult))
{
 	$hlmanagerbidderid[] = $getManagerBidderRow->BidderID;
}
$finalHlManagerBidderID = array();
$finalHlManagerBidderID = array_merge($hlallbidderid, $hlmanagerbidderid);
$hlallbidderidstr=implode(",",$finalHlManagerBidderID);
        ...
        <tr>
			<td align="center" width="100%">
				...
				<table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
					<form name="frmsearch" action="hlloanlms_index_exclusive.php" method="get" onSubmit="return chkform();">
					...
					<tr>
						<td width="12%" align="center"  valign="middle" class="bidderclass">Search with Reference No</td>
