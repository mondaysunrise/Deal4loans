...
///////Get common bidder NAme//////////////////////////
    ...
    if (strlen($hlname) > 0 && strlen($hlmobile) > 0) {
		...
		$resultdt = $obj->fun_db_query($getdetails);
		...
		else
		{
			...
			$result = $obj->fun_db_query($updatelead);
		}
	}
}
?>
        ...
        <p align="center"><b>Home loan Lead Details </b></p>
			...
			<td style="border:1px solid black;" colspan="4" bgcolor="#DAEAF9" align="center" class="fontstyle" ><b>Employment Details</b></td></tr>
                ...
                <tr>
					...
					<option value="HLInternalReference">Internal Reference</option></select></td>
                </tr>
                <tr>
                    ...
                    <td>
						<select size="1" name="reference_from" >
							...
							<option value="Vaibhav Srivastava">Vaibhav Srivastava</option>
							<option value="HL LMS Calling 1">HL LMS Calling 1</option>
							<option value="HL LMS Calling 2">HL LMS Calling 2</option>
