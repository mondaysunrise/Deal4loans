...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	//echo $IP; die;
	$Uname = 'adminpl@deal4loans.com';
	$Password = 'adminpl@123';
	
	//if(($IP=="122.176.100.27" || $IP=="122.176.100.28" || $IP=="122.176.122.134" || $IP=="122.161.196.68" || $IP=="61.246.3.127" || $IP=="122.160.30.168" || $IP=="180.188.224.34" || $IP=="122.161.193.191" || $IP=="122.160.74.241" || $IP=="122.160.74.235" || $IP=="182.73.4.60" || $IP=="182.71.109.218" || $IP=="122.176.54.210" || $IP=="182.69.242.115" || $IP=="122.177.172.243" || $IP=="::1" || ($getIPNum>0)))
	//		{
	...
	if($adminUname!=$Uname)
		{
			redirectURL(SITE_URL."plagents.php?msg=".urlencode("Please enter correct username!"));
		}
	if($adminPass!=$Password)
		{
			redirectURL(SITE_URL."plagents.php?msg=".urlencode("Your password does not match with our record. Please enter correct password!"));
		}
		
	if($adminUname and $adminPass){
			$_SESSION['Email'] = $_POST['Email'];
			$_SESSION['PWD'] = $_POST['PWD'];
			redirectURL(SITE_URL."pldashboard.php");
			}
	else{
			redirectURL(SITE_URL."plagents.php?msg=".urlencode("Invalid username or password!"));
		}
	
	//die;
//}else{
//	redirectURL(SITE_URL."plagents.php?msg=".urlencode("Not permission for you!"));
//	}
}
?>
<?php include "includes/header_plagents.php"; ?>
