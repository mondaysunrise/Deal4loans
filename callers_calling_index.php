...
if(isset($_REQUEST['bidsession']))
	...
	$inhouseCut = '';
	$inhouseCut_Call = '';
		 if($_SESSION['BidderID']==6467 || $_SESSION['BidderID']==6359 || $_SESSION['BidderID']==6358 ||  $_SESSION['BidderID']==6484 || $_SESSION['BidderID']==6483 || $_SESSION['BidderID']==6361 || $_SESSION['BidderID']==6482 || $_SESSION['BidderID']==6514 || $_SESSION['BidderID']==6482 || $_SESSION['BidderID']==6465 || $_SESSION['BidderID']==6800 || $_SESSION['BidderID']==6803 || $_SESSION['BidderID']==6823 || $_SESSION['BidderID']==6929 || $_SESSION['BidderID']==6977 || $_SESSION['BidderID']==6943 || $_SESSION['BidderID']==6944 || $_SESSION['BidderID']==6988 || $_SESSION['BidderID']==7049 || $_SESSION['CallStatus']==1)
		 {
		 $inhouseCut_Call = 1;
		 }
//	if( $_SESSION['BidderID']==6484 || $_SESSION['BidderID']==6483 || $_SESSION['BidderID']==6361 || $_SESSION['BidderID']==6482 || $_SESSION['BidderID']==6514 || $_SESSION['BidderID']==6482 || $_SESSION['BidderID']==6465  || $_SESSION['BidderID']==6802  || $_SESSION['BidderID']==6803 || $_SESSION['BidderID']==6799 || $_SESSION['BidderID']==6800 || $_SESSION['BidderID']==7006 || $_SESSION['BidderID']==7007 || $_SESSION['BidderID']==6359 || $_SESSION['BidderID']==6977 || $_SESSION['BidderID']==7024 || $_SESSION['BidderID']==7049 || $_SESSION['BidderID']==6410 || $_SESSION['BidderID']==7079 || $_SESSION['BidderID']==7080 || $_SESSION['BidderID']==7081)// Cut for Inhouse to enable to view the mobile number on salary click
	if( $_SESSION['BidderID']==6359)
	{
		$inhouseCut = 1;	
	}
	$inhouseCut = 0;//Disable viewing numbers
?>
<html>
<head>
...
{
	var gifName = form;
	document.frmsearch.action="callers_calling_index.php?search=y"+gifName;
...
<? if (((!isset($val) && $viewtexttype==1) || ($val=="Req_Loan_Personal")) || ((!isset($val) && $viewtexttype==2) || ($val=="".$val."")))
  ...
  <tr>
	...
	<? } ?>
	    <tr><td>
		<form name="frmsearch" action="callers_calling_index.php?search=y" method="post" onSubmit="return chkform();">
...
<input type="hidden" name="productVal" id="productVal" value="<? echo $productVal; ?>">
 ...
 <?php if($_SESSION["Associated_Bank"]=="RBL Bank")
		{
        ?>
...
<?  if($_SESSION["Associated_Bank"]=="ICICI Bank")
		{ ?>
		...
		if($num_rows > 0)
		{
			...
			//		echo "<br>Check<br>";
				...
				$BankID_Agent= d4l_mysql_result($query1,0,'BankID');
                    ...
                    $plcity_other= d4l_mysql_result($queryReqPL1,0,'City_Other');
                    if($plcity=='Others'){
...
<?php } ?>
	...
	?><span id="clkNum<?php echo $i; ?>" onClick="return getNumberValue(<?php echo $i; ?>,<?php echo $row["RequestID"]; ?>,<?php echo $getParameterVal; ?>)" style="cursor:hand;"><?php echo $row["City"]; ?></span><?php } else { ?><?php echo $row["City"]; ?><?php } ?></td>
	 ...
	 if($inhouseCut==1)
	 {
	?><span id="clkNum<?php echo $i; ?>" onClick="return getNumberValue(<?php echo $i; ?>,<?php echo $row["RequestID"]; ?>,<?php echo $getParameterVal; ?>)" style="cursor:hand;"><? echo $row["Net_Salary"]; ?></span><?php } else { ?><? echo $row["Net_Salary"]; ?><?php } ?></td>
	  ...
	  <?php
	  	$spocStatus = '';
			...
			$docStatus = d4l_mysql_result($getApptDetailsQry,0,'docStatus');
			$spocStatus = d4l_mysql_result($getApptDetailsQry,0,'spocStatus');
			if($docStatus>0 || strlen($spocStatus)>0 )
			{
				$iupdated_date = d4l_mysql_result($getApptDetailsQry,0,'updated_date');
	...
	echo getJumpMenu("callers_calling_index.php",$row["RequestID"],"1",$row["Feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val,$row["BidderID"]); } ?>
		</td>
<td align="center" bgcolor="#DFF6FF" class="bodyarial11"><table width="100%"><tr><td><textarea  name="comment_section_<? echo $i;?>" id="comment_section_<? echo $i;?>" cols="15" rows="2"><? //echo $row["Comments"]; ?></textarea></td><td><a onClick="insertData(<? echo $i;?>);" style="cursor:pointer; color:blue;" class="style3">Save</a></td></tr>
	...
	<input name="followup_date_<? echo $i;?>" type="text" id="followup_date_<? echo $i;?>" size="10" value="<? echo $row["Followup_Date"];?>">&nbsp;<a href="javascript:NewCal('followup_date_<? echo $i;?>','yyyymmdd',true,24)"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td></tr>
          ...
          <?php
			...
			{
				$show_Comments = d4l_mysql_result($query_Comments,0,'Comments');
			}
			else 
			{
