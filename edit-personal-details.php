...
<td  width="178" valign="top"><strong> DOB: </strong></td>
  ...
  <? }
   ...
   <tr>
        ...
        <?php }?>
  <?php if($_SESSION['leadidentifier'] == "CallerAccountICICI" || $_SESSION['leadidentifier'] =="CallerAccountOICICI" || $_SESSION['leadidentifier']=="CallerAccountTata" || $_SESSION['leadidentifier']=="CallerAccountBTata" || $_SESSION['leadidentifier']=="CallerAccountHTata"  || $_SESSION['leadidentifier']=="CallerAccountMICICI" || $_SESSION['leadidentifier']=="CallerAccountCICICI" || $_SESSION['leadidentifier']=="CallerAccountMTata" || $_SESSION['leadidentifier']=="CallerAccountCTata"  || $_SESSION['leadidentifier']=="CallerAccountPTata" || $_SESSION['leadidentifier']=="CallerAccountPICICI" || $_SESSION['leadidentifier']=="CallerAccountABFL" || $_SESSION['leadidentifier']=="CallerAccountAPKTata" || $_SESSION['leadidentifier']=="PL_ICICI_BCDHKMP" || $_SESSION['leadidentifier']=="tatacapitalBcalling" || $_SESSION['leadidentifier']=="CallerAccountICICIBangalore" || $_SESSION['leadidentifier']=="tatacapitalcalling" || $_SESSION['leadidentifier']=="INDUSINDSALAccount" || $_SESSION['leadidentifier']=="TATACAPITALSALAccount" || $_SESSION['leadidentifier']=="ICICIBANKREC") { ?>
<tr><td colspan="4">
