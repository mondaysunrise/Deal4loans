...
<tr><td colspan="4"><form action="/pllms_bidders_calculation.php" name="plbidcalc" method="POST" target="_blank"><input type="hidden" name="plcustid" id="plcustid" value="<? echo $post; ?>">
<input type="hidden" name="Name" id="Name" value="<? echo $Name; ?>">
<input type="hidden" name="monthsalary" id="monthsalary" value="<? echo round($monthsalary); ?>">
<input type="hidden" name="PL_EMI_Amt" id="PL_EMI_Amt" value="<? echo $PL_EMI_Amt; ?>">
<input type="hidden" name="Company_Name" id="Company_Name" value="<? echo $Company_Name; ?>">
<input type="hidden" name="getDOB" id="getDOB" value="<? echo $getDOB; ?>">
<input type="hidden" name="Company_Type" id="Company_Type" value="<? echo $Company_Type; ?>">
<input type="hidden" name="Primary_Acc" id="Primary_Acc" value="<? echo $Primary_Acc; ?>">
<input type="hidden" name="Loan_Amount" id="Loan_Amount" value="<? echo $Loan_Amount; ?>">
<input type="hidden" name="pleligiblestr" id="pleligiblestr" value="<? echo implode(",",$finalBidderName); ?>">
<input type="submit" name="submit" value="check calculation" style="background-color:#990000; color:#FFFFFF; font-size:14px;">
</form>
</td></tr>
</table>--></td></tr>
<tr><td>
...
<table style='border:1px dotted #9C9A9C;' cellspacing="2" cellpadding="5" width="80%" height="80%" align="center" border="0" >
<tr>
   ...
   for($i=0;$i<count($FinalBidder);$i++)
	  ...
	  if((($FinalBidder[$i]==2490 || $FinalBidder[$i]==4018 || $FinalBidder[$i]==2496 || $FinalBidder[$i]==4019 || $FinalBidder[$i]==2497 || $FinalBidder[$i]==4020 || $FinalBidder[$i]==2498 || $FinalBidder[$i]==2499 || $FinalBidder[$i]==4342 || $FinalBidder[$i]==2500 || $FinalBidder[$i]==2813 || $FinalBidder[$i]==2887 || $FinalBidder[$i]==3894 || $FinalBidder[$i]==4302 || $FinalBidder[$i]==4309 || $FinalBidder[$i]==4529 || $FinalBidder[$i]==4528 || $FinalBidder[$i]==4663 || $FinalBidder[$i]==4914 || $FinalBidder[$i]==4915))  && ($ingvyasyacategory=="" && $Primary_Acc!="IngVysya" && $Company_Type!=4 && $Company_Type!=5))
	   {			  
		...
		elseif(($FinalBidder[$i]==4083 || $FinalBidder[$i]==4084 || $FinalBidder[$i]==4085 || $FinalBidder[$i]==4086 || $FinalBidder[$i]==4087 || $FinalBidder[$i]==4088 || $FinalBidder[$i]==4089 || $FinalBidder[$i]==4090 || $FinalBidder[$i]==4091 || $FinalBidder[$i]==4092 || $FinalBidder[$i]==5168) && ((($Indusind=='') && $Net_Salary<360000) || ($PL_EMI_Paid<=9 && $Existing_Loan>1)))
				{
...
elseif(($FinalBidder[$i]==4872 || $FinalBidder[$i]==3868 || $FinalBidder[$i]==3061 || $FinalBidder[$i]==4353 ||  $FinalBidder[$i]==4701 ||  $FinalBidder[$i]==2984 || $FinalBidder[$i]==4815 || $FinalBidder[$i]==3532 ||  $FinalBidder[$i]==3533 ||  $FinalBidder[$i]==3595 || $FinalBidder[$i]==4671 || $FinalBidder[$i]==4807 || $FinalBidder[$i]==3132 || $FinalBidder[$i]==4461 || $FinalBidder[$i]==2917 || $FinalBidder[$i]==4798 || $FinalBidder[$i]==4388 || $FinalBidder[$i]==5322) && (((strncmp("ICICI", $Primary_Acc,5))!=0 && $icici_bankcmp=="" && $Net_Salary<360000) || ((strncmp("ICICI", $Primary_Acc,5))!=0 && strlen($icici_bankcmp)>2 && $Net_Salary<300000) || ((strncmp("ICICI", $Primary_Acc,5))==0 && $Net_Salary<360000 && strlen($icici_bankcmp)>2) || ((strncmp("ICICI", $Primary_Acc,5))==0 && $Net_Salary<360000 && $icici_bankcmp=="")))
				{
				}
...
<? 
$btbiddersarry=array_unique($btbiddersarry);
...
<? } ?>
<!--bidders section-->
<tr><td colspan="4" height="20" align="center"><a href="pllms_bidders_calculation.php?plcustid=<? echo $post; ?>" style="background-color:#990000; color:#FFFFFF; font-size:14px;" target="_blank"> Check Calculation</a></td></tr>
