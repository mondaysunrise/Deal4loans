...
//echo $IP;
if($IP=="122.176.100.27" || $IP=="122.176.100.28" || $IP=="122.176.122.134" || $IP=="122.161.196.68" || $IP=="61.246.3.127" || $IP=="122.160.30.168"  || $IP=="122.161.193.191" || $IP=="122.160.74.241" || $IP=="122.160.74.235" || $IP=="172.20.122.14" || $IP=="180.151.74.83" || $IP=="115.249.245.30" || $IP=="182.71.109.218" || $IP=="122.160.74.235" || $IP=="185.93.231.12" || $IP=="192.88.134.12")
{
}
else {
...
{
	var gifName = form;
	document.frmsearch.action="plallocation_appointment.php?search=y"+gifName;
...
<tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#45B2D8">
			<tr><td style="padding-top:5px;  padding-right:10px; font-size:13px; text-align:right;">&nbsp;&nbsp;<a  href="callinglms/plallocation_index.php" style="color:#FFFFFF;"><b>Calling</b></a> | <a href="/callers_calling_login.php" style="color:#FFFFFF;"><b>login</b></a></td></tr>
...
<? if (((!isset($val) && $viewtexttype==1) || ($val=="Req_Loan_Personal")) || ((!isset($val) && $viewtexttype==2) || ($val=="".$val."")))
  ...
  <tr>
	...
	<? } ?>
	    <tr><td>
		<form name="frmsearch" action="plallocation_appointment.php?search=y" method="post" onSubmit="return chkform();">
