...
<?  if((strlen(strpos($_SERVER['REQUEST_URI'], "Contents_Calculators")) > 0) || (strlen(strpos($_SERVER['REQUEST_URI'], "loan-amortization-calculator")) > 0) )
	 {?>
...
<table cellspacing="0" cellpadding="0" border="0">
		<tr>
              <td height="40" align="center"   valign="middle"  bgcolor="#FFFFFF" class="steps-text" style="color:#333333;" ><b>Personal Loan Rate of Interest</b><br />
<div align="center">( Last edited on : <? echo $currentdate; ?> )</div></td>
    </tr>
            <tr>
              <td valign="top"  bgcolor="#FFFFFF" class="steps-text" ><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#d5cfb1">
                <tr>
...
<? }?>
            ...
            <tr>
              <td height="40" align="center"  valign="middle"  bgcolor="#FFFFFF" class="steps-text" style="color: #333333;" ><b>Home Loan Rate of Interest</b><br />
              <div align="center">( Last edited on : <? echo $currentdate; ?> )</div></td>
            </tr>
            <tr>
              <td  valign="top"  bgcolor="#FFFFFF" class="steps-text" ><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#d5cfb1">
                <tr>
                  ...
                  <td width="75" align="center" valign="middle" bgcolor="#494949" class="tblwt_txt" style="font-size:10px;">Rate <br />
      of Interest</td>
                  <td width="47" align="center" valign="middle" bgcolor="#494949" class="tblwt_txt" style="font-size:10px;">Prepayment<br>
      charges</td>
                  <td width="50" align="center" valign="middle" bgcolor="#494949" class="tblwt_txt" style="font-size:10px;">Apply Here </td>
                </tr>
				<? $gethlrates="Select ndtv_rates,bank_name,bank_url,processing_fee From home_loan_interest_rate_chart where (tenure=1 and hlrateid in (115,3,8,5))";
...
for($j=0;$j<$hlrowcount;$j++)
	...
	<? }?>
                ...
                <tr>
                  ...
                  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt" style="font-size:10px;"> 8.9%-<br>
      9.25% </td>
                  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt" style="font-size:10px;">2%</td>
                  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt" style="font-size:10px;"><a href="http://www.deal4loans.com/home-loan-apply.php" target="_blank" style="color:#335599;">APPLY</a></td>
                </tr>
                <tr>
                  <td height="25" align="center" valign="middle" bgcolor="#FFFFFF" style="font-size:10px;"><a href="icici-hfc-home-loan.php" style="color:#335599;">ICICI<br>
      Bank </a></td>
                  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt" style="font-size:10px;">8.25%-<br>
      9.25%</td>
                  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt" style="font-size:10px;">2%</td>
                  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt" style="font-size:10px;"><a href="http://www.deal4loans.com/home-loan-apply.php" target="_blank" style="color:#335599;">APPLY</a></td>
                </tr>
