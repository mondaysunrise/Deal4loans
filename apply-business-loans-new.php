...
<title>Business Loans - Compare Lowest Rates</title>
<meta name="keywords" content="business loan,business loans,business loans india,low interest business loan"/>
<meta name="description" content="Compare business loans from Sbi,Hdfc,Citibank,Standard Chartered bank and get lowest EMI & Rates."/>
...
function addElement()
{
		...
		if(ni.innerHTML=="")
		{
			...
			if(document.businessloan_form.CC_Holder.value="on")
			{
...
function othrcity()
{
var ni = document.getElementById('myDivOthrcity');
		if(document.businessloan_form.City.value=="Others")
		{
	ni.innerHTML='<table cellpadding="0" cellspacing="0" width="100%"><tr align="left">				  <Td height="26" class="bldtxt" width="43%">Other City </Td>				  <Td><input name="City_Other" id="City_Other" type="text"  style="width:140px; "  /></Td>				  </tr></table>';
		}
		else
		{
			ni.innerHTML='';
...
{
?>
if(document.businessloan_form.Email.value!="Email Id")
{
	if (!validmail(document.businessloan_form.Email.value))
	{
		//alert("Please enter your valid email address!");
		document.businessloan_form.Email.focus();
		return false;
	}
...
else if((Form.City.value=='Others'))
	{
	if((Form.City_Other.value=='')||!isNaN(Form.City_Other.value)||(Form.City_Other.value=="Other City"))
{
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="161" height="169" align="left" valign="top"><img src="new-images/pl/hdr1-new.gif" width="161" height="169" /></td>
            <td width="158" height="169" align="left" valign="top"><img src="new-images/pl/hdr2-new.gif" width="158" height="169" /></td>
          ...
          <tr>
            <td height="167" align="left" valign="top"><img src="new-images/pl/bl_1hdr.jpg" width="161" height="167" /></td>
            <td height="167" align="left" valign="top"><img src="new-images/pl/bl_2hdr.jpg" width="158" height="167" /></td>
          ...
          <tr>
            <td colspan="4"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><table width="550" border="0" cellspacing="0" cellpadding="0" style="border:2px solid #def3f8; ">
                  <tr>
                    <td style="padding-left:15px; "><table width="98%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Over 36 lakh customers have taken quote at Deal4loans.com</div></td>
                      </tr>
                                          <tr>
                        <td width="30" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Business Loan Quotes are free for customers. It's a totally free service for customers</div></td>
                      </tr>
                      <tr>
                        <td width="30" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Deal4loans.com has tie ups with all Business loan Banks in India.</div></td>
                      </tr>
					  <tr>
                        <td width="30" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">0% Prepayment charges offer on business loan.</div></td>
                      </tr>
			  ...
			  <!--<tr>
                <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>                    <td width="100" height="30"><b>Loan Partners : </b></td><td></td>	</tr>
					<tr>
                    <td colspan="2"><table width="80%"  border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
						  <td width="14%"><div align="center"><img src="new-images/pl/plicici_lgo.jpg" width="87" height="21" /></div></td>
                          <td width="14%"><div align="center"><img src="new-images/pl/plhdfc.jpg" width="81" height="21" /></div></td>
						 
						  <td width="17%"><div align="center"><img src="new-images/pl/plbajj_flgo.jpg" width="94" height="21" /></div></td>
                          <td width="12%"><div align="center"><img src="new-images/pl/plfultrn_n1.jpg" width="84" height="21" /></div></td>
                                </tr>
                    </table></td>                  </tr>
                </table>                  </td>              </tr> -->
              <tr>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="new-images/pl/frm-hdng-new.gif" width="289" height="88" /></td>
              </tr>
              <tr>
                <td valign="top" style="border-left:1px solid #c2c2c2; border-right:1px solid #c2c2c2;">
				<form name="businessloan_form"  action="insert_personal_loan_value_step1.php" method="POST" onSubmit="return chkbusinessloan(document.businessloan_form);">
<input type="hidden" name="Type_Loan" value="Req_Loan_business">
<input type="hidden" name="creative" value="<? echo $_REQUEST['creative'] ?>">
<input type="hidden" name="section" value="<? echo $_REQUEST['section'] ?>">
<input type="hidden" name="source" value="new Businessloan"> 
...
<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif;" color="#FF0000"><strong><?php if(isset($_GET['msg'])) echo "Kindly give Valid Details"; ?></strong></font></div><table width="95%"  border="0" align="right" cellpadding="0" cellspacing="0">
				...
				<tr align="left">
				<Td width="43%" class="bldtxt">Full Name </Td>
 				<Td width="57%"><input name="Name" type="text" id="Name" style=" width:140px;" onchange="insertData();"/></Td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
				  ...
				  <Td>+91 
	  <input name="Phone" id="Phone" type="text"  style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"  maxlength="10"  /></Td>
				  </tr>
				   <tr>
		  <td colspan="2"><div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:11px;"></div></td>
				...
				<tr align="left">
				  ...
				  <Td><input name="Email" id="Email" type="text" style="width:140px; "  onblur="onBlurDefault(this,'Email Id');"  onChange="insertData();"/></Td>
				  </tr>
				<tr align="left">
				  <Td height="26" class="bldtxt">City</Td>
				  <Td><select style="width:142px; height:18px;  "  name="City" id="City" onchange="othrcity();"  >
        <?=plgetCityList($City)?>
      </select>	  </Td>
				  </tr>
				<tr align="left">
				  <Td colspan="2" id="myDivOthrcity"></Td>
				  </tr>
				
				
			
				<tr align="left">
				  <Td height="26" class="bldtxt">Annual I.T.R </Td>
				  <Td><input name="IncomeAmount" id="IncomeAmount" type="text"  style="width:140px; " onFocus="this.select();"  onChange="intOnly(this);"  onKeyUp="intOnly(this);PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome');" onKeyPress="intOnly(this); PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome');" onBlur="PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome'); "/>				  </Td>
				  </tr>
				  <tr>
	...
	<span id='wordIncome' style='font-size:11px;font-weight:bold;color:666699;font-Family:Verdana;text-transform: capitalize;   margin-left:10px; margin-bottom:5px;'></span></td>
				  	...
				  	<tr align="left">
				  <Td height="26" class="bldtxt">Annual Turnover </Td>
				  <Td><select name="Annual_Turnover" id="Annual_Turnover" style="width:138px; ">
				 <option value=''>Please Select</option>	<option value='1' > 0 - 40 Lacs</option>	<option value='4' > 40 Lacs - 1 Cr</option>		<option value='2' > 1Cr - 3Crs </option>	<option value='3' >3Crs & above</option>
				  </select></Td>
				  </tr>
				<tr align="left">
				  ...
				  <tr>
				  <td colspan="2" align="left">  <span id='formatedlA' style='font-size:11px; font-weight:bold;color:666699;font-Family:Verdana; '></span></td>
				  </tr>
				<tr align="left">
...
No</Td>
				...
				<tr align="left">
				  <Td colspan="2" ><div  id="myDiv"></div></Td>
					...
					<tr align="left">
				  <Td  Height="45" colspan="2" style="font-size:9px;"><input type="checkbox"  name="accept" style="border:none;" checked  > I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a>.</Td>
				  </tr>
				 					<tr align="center">
             ...
             <tr><td style="font-size:17px; font-family:Arial, Helvetica, sans-serif; " class="bldtxt" height="26">Best Business loan Banks
</td></tr>
 <tr><td style="color:#7e5a09; font-size:13px; font-weight:bold;line-height:24px; ">
Sbi(state Bank),Hdfc Bank,Ing Vysya, Bajaj Finserv, Fullerton India</td></tr>
            </table></td>
  ...
  <Tr>
  <td><?php include 'footer_landingpage.php'; ?>
</td>
  </Tr>
</table>
