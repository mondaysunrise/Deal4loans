<?
	...
	while($cntr<count($row_result))
        {
		if($row_result[$cntr][$cntr]["Employment_Status"]==0) { $emp_status="Self Employed"; } else { $emp_status="Salaried"; }
...
$insert = Maininsertfunc ($table, $dataInsert);
	...
	$qry="select name, dob, email, mobile_number, std_code, landline, std_code_o, landline_o, emp_status, c_name, city, city_other, net_salary, descr, vehicle_owned, cc_holder, Feedback, pancard, no_of_banks, doe from temp where session_id='".$session_id."'";
