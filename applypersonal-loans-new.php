...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="GOOG_D4L_applypersonal-loans-new"; }
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="call_us_box">Call us Now @ <strong style="color:#ee7232;">1800 3000 1500</strong><span style="font-size:13px;"> Toll Free</span></div>
</div>
</div>
...
<tr align="left">
 ...
 <div class="row_a">Call us Now @ <strong style="color:#ee7232;">1800 3000 1500</strong><span style="font-size:13px;"> Toll Free</span></div>
  <div style="clear:both;"></div>
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr>
       <td class="body_apl_text" style="color:#CC0000"><ul>
         ...
         <li><span style="font-size:17px; font-weight:bold;">4 </span>Banks Rate as low as <span style="font-size:17px; font-weight:bold;">13.99%</span> .</li>
