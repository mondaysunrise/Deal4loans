...
echo $getCarSql = "select hdfc_car_model,hdfc_car_name from hdfc_car_list_category where hdfc_car_manufacturer='".$getCar."' group by hdfc_car_model order by hdfc_car_model asc";
...
{
?><body class="<?php //echo $model; ?>" style="width:800px; overflow-y:hidden; overflow-x:hidden; border-radius:8px 8px 8px 8px; " >
<?php
}
 else
 {
 ?>
 <body class="<?php //echo $model; ?>" style="width:800px; border-radius:8px 8px 8px 8px; overflow-y:hidden; overflow-x:hidden;  ">
 <?php
 }
 ?>
