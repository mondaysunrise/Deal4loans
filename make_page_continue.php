...
$getPageSql = "select * from city_pages where City='".$City."' and Product='Persoanl Loan'";
...
{
	$sql = "INSERT INTO city_pages (Product ,City , State, Title ,MetaKeyword ,MetaDescription ,PageDescription ,HeaderDEscription ,Dated ,Status) VALUES ('Personal Loan',  '".$City."', '".$State."',  '".$Title."',  '".$keyword."',  '".$metadesc."',  '".$mainDesc."', '".$header."', Now(), '1')";
	$query = ExecQuery($sql);
	//echo "<br>".$sql;
	$report = "Inserted";
	$creadetPage = '<a href="http://www.deal4loans.com/personal-loan/'.$City.'" target="_blank">Created Page</a>';
...
<a href="make_page_index.php">Make Other Page</a>
</td></tr></table>
</body>
</html>