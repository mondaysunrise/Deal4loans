...
<title>Home loan interest rates | Instant Home loan rates for all Banks</title>
...
<meta name="keywords" content="Instant Home loan Interest rates, Compare Home Loan interest rates, Compare Home Loan Eligibility in Mumbai Hyderabad Pune kolkata Delhi Noida Bangalore">
...
<tr><td align="center"><table width="1004" border="0" cellspacing="0" cellpadding="0">
  <tr>
      ...
      <tr>
          ...
          <tr>
            <td colspan="4"><table width="99%"  border="0"   cellpadding="0" cellspacing="0">
              <tr>
			   ...
			   <tr>
                <td height="25"  style=" padding-left:10px; " ><div style="color:#5e5e5e; font-size:13px; font-weight:bold;line-height:24px;  ">Home loan interest rates | Home Loan Rates</div></td>
              </tr>
              <tr>
                  ...
                  <tr>
                    <td ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="623"><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Instant Home loan rates for major Banks.</div></td>
                      </tr>

                     <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Get quote on how much loan you can get at what Rate.</div></td>
                      </tr>
					   <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Compare Interest rates from Top Banks
</div></td>
                      </tr>
                      <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Choose best and cheapest Interest rate banks.</div></td>
                      </tr>
                      <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  "> All Interest rates quote are free for customers. It's a totally free service for customers.</div></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
              ...
              <tr>
                <td width="674" class="bldtxt" style="font-size:17px; font-family:Arial, Helvetica, sans-serif;"><?php include "tophlbanks.php"; ?></td>
              </tr>
              <tr>
                <td width="674" class="bldtxt" style="font-size:17px; font-family:Arial, Helvetica, sans-serif;">&nbsp;</td>
              </tr>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="http://www.deal4loans.com/new-images/hl/hintratefrm-hdng121.jpg" width="289" height="88" /></td>
              </tr>
              <tr>
                <td valign="top" align="center" style="border-left:2px solid #454545; border-right:2px solid #454545;  border-top:2px solid #454545; padding-top:13px;">
				<form name="home_loan" action="home-loan-apply-continue.php" onSubmit="return submitform(document.home_loan);" method="post">
                 <input type="hidden" name="referrer" value="<? echo $_REQUEST['referrer'] ?>">
                                    ...
                                    <input type="hidden" name="source" value="GHL_IntRte">
                                    <input type="hidden" name="last_id" value="<? echo $last_id; ?>">
                                    <input type="hidden" name="PostURL" value="<?php echo $_SERVER['REQUEST_URI']; ?>"> 
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr><td  colspan="2">  <div id="hideHeader"  style=" color:#0c6ad4; font-size:11px; text-transform:capitalize; padding-left:5px; margin-top:-3px;">
  <strong style="color:#c99926;">Bank A</strong> - Rates as low as 8.50%<span style="color:#FF0000; font-weight:bold;">*</span> <br> <strong style="color:#c99926;">Bank B</strong>- Fixed rate for 10 years.<span style="color:#FF0000; font-weight:bold;">*</span><br> <strong style="color:#c99926;">Bank C</strong>- Last 12 month Emi waived off<span style="color:#FF0000; font-weight:bold;">*</span><br />Check Your Free Customized Offers From 10 Other Banks.</div></td></tr>
