...
{
	var gifName = form;
	document.frmsearch.action="banner-comp-cclmsview.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="banner-comp-cclmsview.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="0"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><?$current_date=date('Y-m-d');  $cmpdate="2013-02-01"; ?> 
 ...
 <? 
	if(isset($comp_source) || strlen($_SESSION["Comp_Source"])>0 )
		{
				$qry2="SELECT RequestID from  Req_Credit_Card WHERE ((Req_Credit_Card.Updated_Date Between '".$min_date."' and '".$max_date."') and source='".$comp_source."' and City in ('Ahmedabad','Kolkata','Jaipur','Chandigarh','Lucknow','Jalandhar','Cochin','Nagpur ','Delhi','Noida','Gurgaon','Mumbai','Thane','Bangalore','Chennai','Hyderabad','Pune','Surat','Coimbatore','Gaziabad') and Net_Salary >=360000 and (Req_Credit_Card.DOB!='' and DATE_SUB(CURDATE(),INTERVAL 23 YEAR) >= Req_Credit_Card.DOB))";
