...
echo "<h2><b><font color='#0F74D4' face='Century Gothic'>Answered Queries from Loan Guru </font></b></h2>";
...
echo "<table border=0 align=center width=90%><tr><td align=center>";
			...
			{
				$PreviousPage = "<a href='show-query.php?track=".$ArrayTrackID[$GetPageNo-2]."&pageno=".$PreviousPageNo."'>Prev</a>";
			...
			{
				$NextPage = "<a href='show-query.php?track=".$ArrayTrackID[$GetPageNo]."&pageno=".$NextPageNo."'>Next</a>";
				echo "<b>".$NextPage."</b>";
			}
