...
function addElementLoan()
{
		...
		if(ni.innerHTML=="")
		{
				...
				ni.innerHTML = '<table border="0"><tr> <td align="left" class="frmtxt" width="200" height="20" ><b>Any type of loan(s) running? </b></td> <td colspan="3" class="frmtxt" width="300" ><table border="0">	 <tr><td class="frmtxt" width="60" height="20" ><input type="checkbox" id="Loan_Any" name="Loan_Any[]" class="noBrdr" value="hl">Home</td><td class="frmtxt"  width="60" height="20"><input type="checkbox" class="noBrdr" id="Loan_Any" name="Loan_Any[]" value="pl">Personal</td><tr><td  width="60" height="20" class="frmtxt"><input type="checkbox" id="Loan_Any" name="Loan_Any[]" class="noBrdr" id="Loan_Any" value="cl" >Car</td><td class="frmtxt" ><input type="checkbox" name="Loan_Any[]" id="Loan_Any" class="noBrdr" value="lap">Property</td></tr><tr><td class="frmtxt" ><input type="checkbox" name="Loan_Any[]" id="Loan_Any" class="noBrdr" value="other">Other</td></tr> </table></td></tr><tr><td width="400" height="5" colspan="4">&nbsp;	 </td> </tr> <tr>    <td align="left"  width="200" height="20" class="frmtxt"><b>How many EMI paid?  </b></td>   <td colspan="3" align="left" width="300" height="18" ><select name="EMI_Paid"  style="float: left"> <option value="0">Please select</option><option value="1">Less than 6 months</option> <option value="2">6 to 9 months</option> <option value="3">9 to 12 months</option> <option value="4">more than 12 months</option </select>  </td>	</tr></table>';
...
function removeElementLoan()
{
		...
		if(ni.innerHTML!="")
		{
				...
				//alert(document.personalloan_form.CC_Holder.value);
				ni.innerHTML = '';
...
function addIdentified()
{
		...
		if(ni.innerHTML=="")
		{
			...
			if(document.loan_form.Property_Identified.value="on")
			{
				...
				ni.innerHTML = '<table border="0" width="100%"><tr> <td height="30" class="frmtxt"><b>Property Location</b> 	</td><td  class="frmtxt" width="196" align="center"><select size="1" align="center"  name="Property_Loc" >	<?=getCityList1($Property_Loc)?></select></td></tr>	</table>';
			}
 ...
 function addElement()
{
		...
		if(ni.innerHTML=="")
		{
				...
				ni.innerHTML = '<table border="0" width="100%"><tr><td align="left" class="frmtxt" width="180" height="20"><b>Reconfirm Mobile No.</b></td>	<td class="frmtxt" colspan="3" align="left" width="350" height="20" ><input size="18" type="text" onChange="intOnly(this);" maxlength="10" onKeyUp="intOnly(this);" onKeyPress="intOnly(this)"; name="RePhone" ></td></tr></table>';
...
<div id="container">
  <div id="txt">	
    ...
    <form name="personalloan_form" method="post" action="apply-personal-loan-thank.php?flag=1" onSubmit="return submitform2(document.personalloan_form);">
    <? }
  else {?><form name="personalloan_form" method="post" action="apply-personal-loan-thank.php" onSubmit="return submitform2(document.personalloan_form);">
      <? }?>
	  ...
	  <tr>
	 <td colspan="2" class="frmtxt" ><input   style="border:none;" type="checkbox"  name="confirm" onClick="addElement();" value="hello" id="validate" >
	...
	<tr><td colspan="2" class="frmtxt" id="myDiv" ></td></tr>-->
		...
		<tr>
                <td height="35" class="frmtxt"><b>Company Type</b></td>
          <td class="frmtxt"><select name="Company_Type" id="Company_Type" style="width: 150px;">
          ...
          <td class="frmtxt"><input size="25"  name="Credit_Limit" onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="this.select();" >          </td>
        </tr>
              <? }
						 ?>
              <tr>
		...
		<tr>
                <td class="frmtxt"><b>Consolidated EMI (Per Month)</b></td>
          <td class="frmtxt"><input type="text" name="PL_EMI_Amt" id="PL_EMI_Amt" >
        ...
        Please share which of the following documents that you have or can arrange , so that we can let you know what more documents are required by each bank.This will help you to choose your Personal Loan Provider better.    </td>
              ...
              <tr>
                <td height="30" colspan="2"  align="left" class="frmtxt"><b>Which of the following Documents you Have?</b></td>
        <tr>
          <tr>
...
?>
  ...
  <tr>
          <td class="aplfrm"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><input type="hidden" value="<? echo $Type_Loan; ?>" name="type3" /></td>
            </tr>
            <tr>
              <td class="frmtxt"><b>Activation Code</b></td>
              <td class="frmtxt"><input type="text" name="Reference_Code12" size="25" maxlength="4"  onfocus="return Decoration('Please enter 4 digit code you have received on your mobile,to activate your card request and to get the bidder contacts.')" style="float: left" onblur="return Decoration1(' ')" />
                  <div id="layer" style="position:absolute; font-size:10px; width:250px; font-weight:none; left:571px; top: 706px;" ></div></td>
            </tr>
            <tr>
              <td colspan="2" class="frmtxt" ><input   style="border:none;" type="checkbox"  name="confirm2" onclick="addElement();" value="hello" id="confirm" />
                <b>if you havent received activation code sms. </b></td>
            </tr>
            <tr>
              <td colspan="2" class="frmtxt" id="myDiv" ></td>
            </tr>
            <?if($CC_Holder==1) { ?>
            <tr>
              <td class="frmtxt" ><b>I have an active credit card from ? </b></td>
              <td  class="frmtxt" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="22" class="frmtxt" ><input type="checkbox" id="From_Product" name="From_Product[]"  style="border:none;" value="Abn Ambro" />
                      ABN AMRO</td>
                    <td height="22" class="frmtxt"><input type="checkbox"  style="border:none;" id="From_Product" name="From_Product[]" value="Amex" />
                      Amex</td>
                  </tr>
                <tr>
                    <td height="22" class="frmtxt"><input type="checkbox" name="From_Product[]"  style="border:none;" id="From_Product" value="Canara Bank" />
                      Canara Bank</td>
                  <td height="22" class="frmtxt"><input type="checkbox" name="From_Product[]" id="From_Product"  style="border:none;" value="Citi Bank" />
                    Citi Bank</td>
                </tr>
                  <tr>
                    <td height="22" class="frmtxt"><input type="checkbox" name="From_Product[]"  style="border:none;" id="From_Product" value="Deutsche bank" />
                      Deutsche Bank</td>
                    <td height="22" class="frmtxt"><input type="checkbox"  id="From_Product" name="From_Product[]" value="HDFC"  style="border:none;" />
                      HDFC</td>
                  </tr>
                  <tr>
                    <td height="22" class="frmtxt"><input type="checkbox"  style="border:none;" value="HSBC" name="From_Product[]" id="From_Product" />
                      HSBC</td>
                    <td height="22" class="frmtxt"><input type="checkbox" id="From_Product" name="From_Product[]"  style="border:none;" value="ICICI" />
                      ICICI</td>
                  </tr>
                  <tr>
                    <td height="22" colspan="2" class="frmtxt"><input type="checkbox" name="From_Product[]" value="Standard Chartered" id="From_Product"  style="border:none;" />
                      Standard Chartered</td>
                  </tr>
                  <tr>
                    <td height="22" class="frmtxt"><input type="checkbox" name="From_Product[]" value="Barclays" id="From_Product"  style="border:none;" />
                      Barclays</td>
                    <td height="22" class="frmtxt"><input type="checkbox" id="From_Product" name="From_Product[]"  style="border:none;" value="SBi" />
                      SBI</td>
                  </tr>
                  <tr>
                    <td height="22" colspan="2" class="frmtxt"><input type="checkbox" name="From_Product[]" value="Others" id="From_Product"  style="border:none;" />
                      Others</td>
                  </tr>
              </table></td>
            </tr>
            <tr>
              <td class="frmtxt"><b>Credit Card Limit?</b></td>
              <td  align="left"  colspan="3" width="240" height="25"><select size="1" style="width:135px;"  name="Credit_Limit">
                  <option value="0">Please select</option>
            ...
            <tr>
              <td class="frmtxt"><b>Residence No.</b></td>
              <td class="frmtxt" align="left"><input type="text"  name="Std_Code" id="Std_Code" size="5" onchange="intOnly(this);"  onkeyup="intOnly(this);" onkeypress="intOnly(this);" value="std" onblur="onBlurDefault(this,'std');" />
                  <input size="18" type="text"  name="Landline" id="Landline" onchange="intOnly(this);"  onkeyup="intOnly(this);" onkeypress="intOnly(this)"; /></td>
            </tr>
            <tr>
              <td class="frmtxt"><b>Residence Address</b></td>
              <td width="240" class="frmtxt"><textarea name="Residence_Address" id="Residence_Address" cols="22" rows="2"></textarea></td>
            </tr>
            <tr>
              <td class="frmtxt"><b>Pincode</b></td>
              <td width="240" class="frmtxt"><input type="text" name="Pincode" id="Pincode" size="25" maxlength="6" /></td>
            </tr>
            <tr>
              <td class="frmtxt"><b>Office No.</b></td>
              <td  class="frmtxt" align="left"><input type="text"  name="Std_Code_O" id="Std_Code_O" size="5" onchange="intOnly(this);"  onkeyup="intOnly(this);" onkeypress="intOnly(this);" value="std" onblur="onBlurDefault(this,'std');" />
                  <input size="18" type="text" name="Landline_O" id="Landline_O" onchange="intOnly(this);"  onkeyup="intOnly(this);" onkeypress="intOnly(this);" /></td>
            </tr>
            <tr>
              <td class="frmtxt"><b>Office Address</b></td>
              <td width="240" class="frmtxt"><textarea name="Office_Address" id="Office_Address" cols="22" rows="2"></textarea></td>
            </tr>
            <? if($Pancard=="Yes")
	{?>
            <tr>
              <td class="frmtxt"><b>Pancard No.</b></td>
              <td width="240" class="frmtxt"><input type="text" size="25" name="Pancard_no" id="Pancard_no" maxlength="10" /></td>
            </tr>
            <? }?>
            <tr>
...
<tr>
  ...
  <tr>        
        ...
        <td class="aplfrm"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
 <input type="hidden" value="<? echo $Type_Loan; ?>" name="type">
            <!--<tr>
       <td class="frmtxt">Activation Code</td>
       <td class="frmtxt"><input type="text" name="Reference_Code1" size="10" maxlength="4"  onFocus="return Decoration('Please enter 4 digit code you have received on your mobile,to activate your loan request and to get the bidder contacts.')" style="float: left" onBlur="return Decoration1(' ')"><div id="plantype" style="position:absolute;font-size:10px;width:250;font-weight:none; " ></div></td>
     </tr>
...
<tr><td colspan="2" class="frmtxt" id="myDiv" ></td></tr>-->
            <tr>
              <td height="30" class="frmtxt"><b>Company Name</b></td>
		    <td class="frmtxt"><input size="20" name="Company_Name"></td>
		    </tr>
            <tr>
              <td height="30" class="frmtxt"><b>Property Identified</font></b></td>
		    <td class="frmtxt"><input type="radio"  name="Property_Identified"  id="Property_Identified" style="border:none;"  value="1" onClick="addIdentified();">Yes
		      <input size="10" type="radio" style="border:none;" name="Property_Identified" id="Property_Identified"onClick="removeIdentified();" value="0" >No		      </td>
            </tr>
            <tr><td   colspan="2" id="myDiv1"></td></tr>
            <tr><td   colspan="2" id="myDiv2"></td></tr>
                   
            <tr>
              <td height="35" class="frmtxt"><b>Estimated market value<br /> 
            ...
            <tr>
              <td height="35" class="frmtxt"><b>When you are planning<br /> 
                to take loan?</b></td>
  ...
  <tr>
    <td class="aplfrm"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr><td><input type="hidden" value="BusinessLoan" name="type"></td></tr>
                <tr>
                  <td width="40%" class="frmtxt"><strong>Activation Code?                    </strong></td>
            ...
            <tr>
                <td colspan="2" align="left"  class="frmtxt"  ><strong>
                  <input   style="border:none;" type="checkbox"  name="confirm" onClick="addElement();" value="hello" id="validate" >
                    if you havent received activation code sms                </strong></td>
		    </tr>

            <tr><td colspan="2" id="myDiv" ></td></tr>
             <tr>
               <td height="30" class="frmtxt"><strong>Name of Co/Business</strong></td>
               <td width="70%" class="frmtxt"><input type="text" id="Company_Name"  name="Company_Name" onFocus="this.select();" size="20"  ></td>
     </tr>
            <tr>
              <td height="30" class="frmtxt"><strong>Type of Company ?</strong></td>
       <td>
         <select size="1"  name="Constitution" >
           ...
           <option value="Others">Others</option>
            ...
            <tr>
              <td height="30" class="frmtxt"><strong>Office Status</strong></td>
         <td class="frmtxt"><input type="radio" value="1" name="Office_Status" style="border:none;" checked>Owned
           <input type="radio" value="2" name="Office_Status" style="border:none;">Rented</td>
            ...
            <tr>
              <td height="30" class="frmtxt"><strong>Residential Status</strong></td>
         <td class="frmtxt"><input type="radio" value="1" name="Residential_Status" style="border:none;" checked>Owned
           <input type="radio" value="2" name="Residential_Status" style="border:none;">Rented</td>
             ...
             <tr>
               <td height="30" class="frmtxt" ><strong>Are you a Credit card holder?</strong></td> 
               <td  class="frmtxt" ><input type="radio"  name="CCbusiness"  style="border:none;"  value="1"  onclick="addElementCC();" >Yes
                       
            <input type="radio" style="border:none;" name="CCbusiness" value="0" onClick="removeElementCC();">No</td></tr>
            <tr><td colspan="2" id="myDivCC"></td>
            </tr>
                   
                   
                   
                <tr>
                  <td height="30"  class="frmtxt"><strong>Any Loan running?</strong></td>
