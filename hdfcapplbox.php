...
//echo $model;
?>
<div class="<?php echo $model; ?>_menu_top_text_box" style="color:#FFFFFF; padding-top:70px; padding-bottom:5px;" ><?php 
...
{
?><body class="<?php //echo $model; ?>" style="width:800px; height:550px; overflow-y:hidden; overflow-x:hidden; border-radius:8px 8px 8px 8px; background-color:#000;" >
<?php
}
 else
 {
 ?>
 <body class="<?php //echo $model; ?>" style="width:800px; height:550px; border-radius:8px 8px 8px 8px; overflow-y:hidden; overflow-x:hidden;  background-color:#000;">
 <?php
 }
 ?>
...
<table width="723" border="0" style="height:550px;"  >
...
list($getNumRows,$getLowestQuery)=MainselectfuncNew($getLowestSql,$array = array());
