<?php
	...
	function formHandler(){
		...
		$result = ExecQuery("select * from  B_Property where Email='$Email' and PWD='$PWD' and Is_Verified>1");
		...
		if($num_rows > 0){
			...
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."property_bidders_index.php");
			exit;
