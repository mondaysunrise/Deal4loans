...
$getPageSql = "select * from city_pages where City='".$City."' and Product='Education'";
...
{
	$sql = "INSERT INTO city_pages (Product ,City ,State, Title ,MetaKeyword ,MetaDescription ,PageDescription ,HeaderDEscription ,Dated ,Status) VALUES ('Education',  '".$City."', '".$State."', '".$Title."',  '".$keyword."',  '".$metadesc."',  '".$mainDesc."', '".$header."', Now(), '1')";
	$query = ExecQuery($sql);
	//echo "<br>".$sql;
	$report = "Inserted";
	$creadetPage = '<a href="http://www.deal4loans.com/education-loan/'.$City.'" target="_blank">Created Page</a>';
...
<a href="makeeduloan_index.php">Make Other Page</a>
</td></tr></table>
</body>
</html>