...
$checkSql = "select AllRequestID from Req_Feedback_Bidder_LAP1 where (AllRequestID='".$RequestID."' and (DATE_SUB( NOW() , INTERVAL '00:15' HOUR_MINUTE ) >= Allocation_Date) and BidderID='".$Nobanks."')";
...
else
{
	...
	//	echo "Select AllRequestID from Req_Feedback_Bidder_LAP1 where (Consent=0 and AllRequestID='".$RequestID."' and BidderID='".$Nobanks."')"; 
		// echo "<br>";
		$qry_rmbid = "Select AllRequestID from Req_Feedback_Bidder_LAP1 where (Consent=0 and AllRequestID='".$RequestID."' and BidderID='".$Nobanks."')";
		...
		else
		{
			...
			Mainupdatefunc ('Req_Feedback_Bidder_LAP1', $dataUpdate, $wherecondition);
			//echo $upconsent."<br>";
			//echo "<br>";
			//change bookkeeping
			$BK_Year = date('Y');
...
<title>Thank you Loan Against Property</title>
...
<div class="text12" style="margin:auto;  height:11px; margin-top:70px; color:#0a8bd9;"><u><a href="index.php" class="text12" style="color:#0080d6;" >Home</a></u> > <a href="loan-against-property.php"  class="text12" style="color:#0080d6;"><u>Loan Against Property</u></a> </div>
