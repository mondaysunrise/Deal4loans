...
{
	var gifName = form;
	document.frmsearch.action="sbihl_callingview.php?search=y"+gifName;
...
<? if (((!isset($val) && $viewtexttype==1) || ($val=="Req_Loan_Personal")) || ((!isset($val) && $viewtexttype==2) || ($val=="Req_Loan_Home")))
  ...
  <tr>
	...
	<? } ?>
	    <tr><td>
		<form name="frmsearch" action="sbihl_callingview.php?search=y" method="post" onSubmit="return chkform();">
...
<input type="hidden" name="BidderIDstatic" id="BidderIDstatic" value="<? echo $BidderIDstatic;?>">
  ...
  <tr>
    ...
    <td width="81%"><input name="max_date" class="input-lead" type="text" id="max_date" size="15" value="<? echo $_REQUEST['max_date']; ?>"></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="47%" class="style1">ASM Wise</td>
    <td width="53%"><? 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="27%" class="style1">Feedback</td>
    <td width="73%"><select name="cmbfeedback" id="cmbfeedback" class="input-lead">
		...
		<option value="Arranging Documents" <? if($varCmbFeedback == "Arranging Documents") { echo "selected"; } ?>>Arranging Documents</option>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="47%" class="style1">City wise</td>
    <td width="53%"><select name="citywise" class="input-lead" id="citywise"><option value="">All</option>
	 <? 	$arrBidderID="";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="20%" class="style1">Caller</td>
				<td width="45%">
   ...
   <td align="center" bgcolor="#DFF6FF" class="style3"><? echo "HL".$row["Feedback_ID"]."S".$BidderIDstatic; ?></td>
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Net_Salary"]; ?></td>
	  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Loan_Amount"]; ?></td>
       <td align="center" bgcolor="#DFF6FF" class="style3"><? 		
	echo getJumpMenu("sbihl_callingview.php",$row["RequestID"],"1",$row["Feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val,$row["BidderID"]) ?>
		</td>
...
?>
	<select name="type" id="type" onChange="MM_jumpMenu('parent',this,0)" class="style3" style="width:110px;">
		...
		<option value="<? echo $strURL.'&Feedback=Property Not Identified'?>" <? if($varFeedback == "Property Not Identified") { echo "selected"; } ?>>Property Not Identified</option>
		...
		<option value="<? echo $strURL.'&Feedback=Arranging Documents'?>" <? if($varFeedback == "Arranging Documents") { echo "selected"; } ?>>Arranging Documents</option>
		<option value="<? echo $strURL.'&Feedback=Document Picked'?>" <? if($varFeedback == "Document Picked") { echo "selected"; } ?>>Document Picked</option>
