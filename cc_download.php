...
$insert = Maininsertfunc ($table, $dataInsert);
	...
	$qry="select name, dob, email, mobile_number, std_code, landline, std_code_o, landline_o, emp_status, c_name, city, city_other, net_salary, descr, vehicle_owned, cc_holder, Feedback, pancard, no_of_banks, pincode, card_vintage, doe from temp where session_id='".$session_id."'";
