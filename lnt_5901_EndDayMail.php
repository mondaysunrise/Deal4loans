...
function retrivedatafortata()
{
	...
	$max_date=$Today." 23:59:59";
		...
		$citifinquery="SELECT Name,DOB,Email, Mobile_Number,Std_Code, Landline,Company_Name,City, City_Other,Pincode, Net_Salary, Loan_Any, Loan_Amount, IP_Address,Add_Comment,Allocation_Date, Employment_Status FROM Req_Feedback_Bidder_HL,Req_Loan_Home WHERE (Req_Feedback_Bidder_HL.AllRequestID=Req_Loan_Home.RequestID and Req_Feedback_Bidder_HL.BidderID in (5893,5894,5895,5896,5897,5898,5899,5900) and Req_Feedback_Bidder_HL.Reply_Type=2 and Req_Feedback_Bidder_HL.Allocation_Date Between '".($min_date)."' and '".($max_date)."')";
	...
	$newfileatt = "/home/deal4loans/public_html/hldwnld/lnt5901".$newToday.".xls";
	...
	function sendexcelfileattachment($session_id,$cityname)
	{
		...
		$to = "sales@Lthousingfinance.com,r.raju@teamhgs.com"; 
		$from = "Deal4loans <no-reply@deal4loans.com>"; 
		$subject = "L & T Home Loan Leads @ deal4loans.com ".$newToday; 
		$fileatt = "/home/deal4loans/public_html/hldwnld/lnt5901".$newToday.".xls";
		$fileatttype = "application/xls"; 
		$fileattname = "lnt5901".$newToday.".xls";
		...
		$headers .= "Cc: RitikaAswani@ltfinance.com,rajiv.prasad@deal4loans.com,Shweta.sharma@deal4loans.com"."\n";		   
