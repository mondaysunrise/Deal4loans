...
{
	var gifName = form;
	document.frmsearch.action="banner-comp-lmsclawdigital.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="banner-comp-lmsclawdigital.php?search=y" method="post" onSubmit="return chkform();">
