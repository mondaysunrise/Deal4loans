...
function addPersonalDetails()
{
	...
	ni1.innerHTML = '<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="left" class="formbodytext" width="50%">Net Annual Income</td><td class="formbodytext" width="50%" valign="top">Total EMI per Month</td></tr><tr><td colspan="2" height="7"></td></tr><tr><td class="formbodytext" valign="top"><input type="text" name="Net_Salary" id="Net_Salary" class="input-bx" onKeyUp="intOnly(this); getDiToWordsIncome(\'Net_Salary\',\'formatedIncome\',\'wordIncome\');" onKeyPress="intOnly(this);"  onblur="getDiToWordsIncome(\'Net_Salary\',\'formatedIncome\',\'wordIncome\');"  tabindex="8" onKeyDown="validateDiv(\'netSalaryVal\');"  autocomplete="off" /><div id="netSalaryVal" class="alert_msg"></div> <span id=\'formatedIncome\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;\'></span> <span id=\'wordIncome\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;text-transform: capitalize;\'></span></td><td class="formbodytext" valign="top"><input type="text" name="total_emi" id="total_emi" class="input-bx" onKeyUp="intOnly(this); getDiToWordsIncome(\'total_emi\',\'formatedemi\',\'wordemi\');" onKeyPress="intOnly(this);"  onblur="getDiToWordsIncome(\'total_emi\',\'formatedemi\',\'wordemi\');" tabindex="9"  autocomplete="off" /> <span id=\'formatedemi\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;\'></span> <span id=\'wordemi\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;text-transform: capitalize;\'></span></td></tr><tr><td colspan="2" class="formbodytext" height="7"></td></tr><tr><td align="left" class="formbodytext" valign="top">Total EMI for Personal Loan</td><td class="formbodytext">Your relation with ICICI Bank </td></tr><tr><td colspan="2" height="7"></td></tr><tr><td class="formbodytext" valign="top"><input type="text" name="other_emi" id="other_emi" class="input-bx" onKeyUp="intOnly(this); getDiToWordsIncome(\'other_emi\',\'formatedother_emi\',\'wordother_emi\');" onKeyPress="intOnly(this);"  onblur="getDiToWordsIncome(\'other_emi\',\'formatedother_emi\',\'wordother_emi\');" tabindex="10"  autocomplete="off" /><span id=\'formatedother_emi\' style=\'font-size:11px; font-weight:normal; color:#0000;font-Family:Verdana;\'></span> <span id=\'wordother_emi\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;text-transform: capitalize;\'></span></td><td class="formbodytext" valign="top"><select name="relationship" id="relationship" class="select-bx" tabindex="11"><option value="">Select</option><option value="SALARY_ACCOUNT">Salaried Account</option><option value="SAVINGS_ACCOUNT" selected="selected">Savings Account</option><option value="CREDIT_CARD">Credit Card</option><option value="CURRENT_ACCOUNT">Current Account</option><option value="HOME_LOAN">Home Loan</option><option value="PERSONAL_LOAN">Personal Loan</option><option value="CAR_LOAN">Car Loan</option><option value="TWO_WHLR_LOAN">Two Wheeler Loan</option><option value="TERM_DEPOSIT">Term Deposit</option><option value="LOAN_AGAINST_SECURITIES">Loan Against Securities</option><option value="DEMAT">Demat</option><option value="OTHER">No Existing Relationship</option></select><div id="relVal" class="alert_msg"></div></td></tr><tr><td colspan="2" class="formbodytext" style="font-size:11px;">&nbsp;</td></tr><tr><td colspan="2" class="formbodytext"><input name="accept" type="checkbox"  tabindex="12" />  I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  class="text" style=" color:#000; text-decoration:none; font-size:11px;">Privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  class="text" style="color:#000; font-size:11px; text-decoration:none;">Terms and Conditions</a>.<div id="acceptVal" class="alert_msg"></div></td></tr><tr><td colspan="2" class="formbodytext" style="font-size:11px;">&nbsp;</td></tr><tr><td colspan="2" align="center" class="formbodytext"><input type="submit" style="border: 0px none ; background: url(images/submit-app.png); width: 135px; height: 40px; margin-bottom: 0px;" value=""  tabindex="13"/></td></tr></table>';
...
<div id="wrapper">
   <div id="container">
 <section role="main">
<form id="myform" onSubmit="return chkpersonalloan();" action="icici-app-second-page.php" method="post" name="loan_form">
<div class="box1">
...
<div style=" text-align:left !important;">Professional Details</div>
     ...
     <div class="form-wrapper-app">
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr>
           <td colspan="2" class="formbodytext" height="7"></td>
         </tr>
         <tr>
...
<?=plgetCityList($City)?>
           ...
           <td class="formbodytext"> <input name="day" id="day" type="text" class="input-dd-app" value="dd" onBlur="onBlurDefault(this,'dd');" onFocus="onFocusBlank(this,'dd');" maxlength="2" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onKeyDown="validateDiv('dobVal');" tabindex=3 autocomplete="off" />&nbsp;        <input name="month" id="month" type="text" class="input-dd-app" value="mm" onBlur="onBlurDefault(this,'mm');" onFocus="onFocusBlank(this,'mm');" maxlength="2" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onKeyDown="validateDiv('dobVal');" tabindex="4" autocomplete="off" />&nbsp;	<input name="year" id="year" type="text" class="input-yy-app" value="yyyy" onBlur="onBlurDefault(this,'yyyy');" onFocus="onFocusBlank(this,'yyyy');" maxlength="4" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onKeyDown="validateDiv('dobVal');" tabindex="5" autocomplete="off" /><div id="dobVal" class="alert_msg"></div></td>
         </tr>
         <tr>
           <td colspan="2" class="formbodytext" height="7"></td>
         </tr>
         ...
         <tr>
           ...
           <td class="formbodytext">
            <input name="Company_Name" id="Company_Name" type="text" class="input-bx" onBlur="onBlurDefault(this,'Type slowly to autofill');" onKeyUp="ajax_showOptions(this,'getCountriesByLetters',event, 'http://www.deal4loans.com/ajax-list-plicici.php')" onFocus="addPersonalDetails(); onFocusBlank(this,'Type slowly to autofill');" onKeyDown="validateDiv('companyNameVal');" value="Type slowly to autofill" tabindex="7" autocomplete="off" />
