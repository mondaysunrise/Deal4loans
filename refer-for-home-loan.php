...
<div class="group">      
    ...
    <input type="text" name="alternate_number" id="alternate_number" maxlength="10" onkeyup="intOnly(this);" onkeypress="intOnly(this)"; onchange="intOnly(this);" /><div id="alternateNVal"></div>
