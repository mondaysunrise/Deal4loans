...
<table width="650"  border="0" align="center" cellpadding="0" cellspacing="0">
	 <tr>
        <td height="75" valign="middle" background="new-images/apl-bigtp.gif" style="background-repeat:no-repeat;"><h1 >Apply Personal Loan</h1></td>
 </tr>
     <tr>
     <td class="aplfrm"><table width="96%" border="0" align="right" cellpadding="4" cellspacing="0"  id="frm">
          <tr>
...
<input type="hidden" name="PostURL" value="<?php echo $_SERVER['REQUEST_URI']; ?>"></td>
          ...
          <tr>
            <td class="formtext"><input name="Full_Name" type="text" <? if(isset($loan_type)) { ?>value="<? echo $name; ?>" <? }else {?>value="Name"<? }?> id="Full_Name" style="width:157px;" onBlur="onBlurDefault(this,'Name');"  onFocus="onFocusBlank(this,'Name');" onChange="insertData();"/></td>
             ...
             <td class="formtext">+91 <input type="text" value="Mobile No." name="Phone" id="Phone" style="width:132px;"  maxlength="10" onChange="intOnly(this);insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="insertData();"  ></td>
            </tr>
          <? if(!isset($_SESSION['UserType'])) {?>
          <tr>
        ...
        <td  valign="top">
          <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0">
            <tr>
              ...
              <? echo $myrow["pl_bank_name"];?></td>
            </tr>
            <tr>
              <td height="40" align="center" class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow["pl_bank_roi"];?></b></td>
	        </tr>
            <tr>
              <td height="50" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow["pl_bank_processing_fee"];?></b></td>
	        </tr>
            <tr>
              <td height="40" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow["pl_bank_loan_amt"];?></b></td>
	        </tr>
            <tr>
              <td height="40" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow["pl_bank_prepayment"];?></b> </td>
	        </tr>
            <tr>
              <td height="40" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow["pl_bank_disbursal_time"];?></b> </td>
	        </tr>
            <tr>
              <td align="left" height="350" class="txt-hd" valign="top" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><? echo $myrow["pl_bank_documents"];?> </td></tr>
        </table></td>
           <? 
			   $i=$i+1;
			   }
