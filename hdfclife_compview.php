...
{
	var gifName = form;
	document.frmsearch.action="hdfclife_compview.php?search=y"+gifName;
...
function chkform()
{
	...
	<? } 
		...
		if(document.frmsearch.min_date.value<"2011-05-31")
	{
		alert("Sorry!!!! Your minimum date is 2011-05-21.Please Select.");
		document.frmsearch.min_date.value="";
		document.frmsearch.min_date.focus();
		return false;
	}
...
<tr>
 ...
 <form name="frmsearch" action="hdfclife_compview.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="0"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><?$current_date=date('Y-m-d');?> 
	   <input name="min_date" type="text" id="min_date" size="15" <? if($min_date=="") { ?>value="2012-04-25"<? } else { ?>value="<? echo $min_date; ?>" <? }?>></td>
	   <td>
 ...
 <? 
		$search_qry="SELECT * from hdfclife_compleads WHERE (hdfclife_compleads.hdfclife_dated Between '".($min_date)."' and '".($max_date)."' ) ";	
		//$search_qry=$search_qry.$FeedbackClause;
		$search_qry=$search_qry." group by hdfclife_compleads.	hdfclife_mobile_number";
		$search_qry=$search_qry." order by hdfclife_compleads.hdfclife_dated DESC";

		$qry="SELECT * from hdfclife_compleads WHERE (hdfclife_compleads.hdfclife_dated  Between '".($min_date)."' and '".($max_date)."' ) ";
		//$qry=$qry.$FeedbackClause;
		$qry=$qry."group by hdfclife_compleads.	hdfclife_mobile_number";
 ...
 ?>
   ...
   <tr>
     ...
     <td width="88" align="center" bgcolor="#FFFFFF" class="style2">Mobile</td>
		 ...
		 <td width="75" align="center" bgcolor="#FFFFFF" class="style2">Income</td>
	...
	<?
		...
		//$qry=$qry.$FeedbackClause;
		$qry=$qry."group by hdfclife_compleads.	hdfclife_mobile_number";
		$qry=$qry." order by hdfclife_compleads.hdfclife_dated DESC";
   ...
   <tr>
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3" ><? echo $row["hdfclife_name"]; ?></td>
	   <td align="center" bgcolor="#DFF6FF" class="style3" ><? echo $row["hdfclife_email"]; ?></td>
	  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["hdfclife_city"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["hdfclife_mobile_number"]; ?></td>
    <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["hdfclife_dob"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["hdfclife_income"]; ?></td>
...
<table width="500" border="0" cellspacing="1" cellpadding="4">
 <form name="frmdownload" action="hdfclife_download.php" method="post">
   <tr>
     <td align="center">
