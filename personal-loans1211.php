...
<meta name="description" content="Personal loan: Get details on Latest Trends, Basic to compare best personal loans, benefits, Documents, Eligibility Criteria by Various Banks and Cibil Score Importance. ">
<style type="text/css">
...
<script language="javascript" type="text/javascript"> 
    /*  function disableselect(e) {             
      ...
      if (window.sidebar) { 
          document.onmousemove = disableselect                    // for mozilla   
	      document.onmouseover = disableselect                    // for mozilla           
		  document.onmouseout = disableselect                    // for mozilla           
...
<div><span style="width:100%; height:auto; margin-top:2px; padding-top:2px; text-align:justify;">
    <h3 class="text" style="color:#4c4c4c; size:18px; ">What is a Personal loan?<br />
      <span class="text11" style="color:#4c4c4c; ">Personal Loan is an unsecured loan for personal use which doesn’t require any security or collateral and can be availed for any purpose, be it a wedding expenditure, a holiday or purchasing consumer durables, the loans is very handy &amp; caters to all your needs. The amount of loans can be ranged from Rs. 50,000 – Rs. 20 lakh &amp; the tenure for repaying the loan varies from 1 to 5 years.<br /><br />
      <img src="gButt.php?text=9971396361" width="84" height="24">
      
       <img src="gButt.php?text=9250956947"  width="84" height="24">
       
       <br /><label>9971396361</label>
<br />
    <br />
...
<p class="text11 style1"><a href="http://www.deal4loans.com/hdfc-personal-loan-eligibility.php"><strong>HDFC Bank Personal loan</strong></a>:<br />
  ...
  Interest  Rates: 13.49% to 17.50% | Prepayment charges: NIL (For Loan amount >10 lacs & 12 EMI paid), else 5%  | Processing Fees: 0.5% for special companies else 1.50% - 2.25% | Loan disbursement time: 3-4 Days  | Total Loan disbursed Per Month- 200crs<br />
  <strong><br />
  ...
  Interest  Rates: 13.50% to 17.00% | Prepayment charges: 5% | Processing Fees: 2%  | Loan  disbursement time: 3-4 Days | Total Loan Disbursed per month – 35 Crs<br />
  <br />
   <a href="http://www.deal4loans.com/personal-loan-ingvysya-bank.php"><strong>Ing Vysya Personal Loan</strong></a>: <br />
  Interest Rates: 13.50% to 17.25% | Prepayment charges:Nil (till <strong>30th April'14</strong>)| Processing Fees: Flat Processing Fees – 999/- offer for Special companies & Salary Above 75k or Upto 2%   | Loan disbursement time: 1-4 days  | Total loan disbursed per month- 40 Crs<br /><br />
