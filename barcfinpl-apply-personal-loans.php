...
<title>Barclays Finance Personal Loan</title>
...
else if((Form.year.value < "1950") || (Form.year.value >"1992"))
{
      ...
      <tr>
          ...
          <tr>
            <td colspan="4"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
			   <tr>
				 ...
				 <tr>
                <td height="25" class="bldtxt" style="font-size:13px; font-family:Verdana, Arial, Helvetica, sans-serif; " >Barclays Personal Loan Features.
</td>
              </tr>
              <tr>
                <td><table width="550" border="0" cellspacing="0" cellpadding="0" >
                  <tr>
                    <td align="left"><table   border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="22" height="22" align="left" valign="middle">1)</td>
                        <td>Only Bank to offer tenure Personal Loan upto 7 years.</td>
                      </tr>
                      <tr>
                        <td width="22" height="22" align="left" valign="middle">2)</td>
                        <td>Instant quote and Emi Eligibility.</td>
                      </tr>
                      <tr>
                        <td width="22" height="22" align="left" valign="middle">3)</td>
                        <td>Maximum Loan Eligibility.</td>
                      </tr>
			   ...
			   <tr>
                <td height="25" class="bldtxt" style="font-size:13px; font-family:Verdana, Arial, Helvetica, sans-serif; " >&nbsp;
</td>
              </tr>
              <tr>
                <td height="25" class="bldtxt" style="font-size:13px; font-family:Verdana, Arial, Helvetica, sans-serif; " >Why Deal4loans.com
				</td>
              </tr>
              <tr>
                <td><table width="550" border="0" cellspacing="0" cellpadding="0" >
                  <tr>
                    <td align="left"><table   border="0" cellspacing="0" cellpadding="0">
					 <tr>
                        ...
                        <td>Compare Barclays finance quote with Hdfc,Citi,Standard Chartered,Fullerton & Sbi</td>
                      </tr>
                      <tr>
                        <td width="22" height="22" align="left" valign="middle"><img src="new-images/pl/orng-arrow.gif" width="12" height="12" /></td>
                      ...
                      <tr>
                        <td width="22" height="22" align="left" valign="middle"><img src="new-images/pl/orng-arrow.gif" width="12" height="12" /></td>
                        <td>Deal4loans.com service is totally free for customers.</td>
                      </tr>
                      <tr>
                        <td width="22" height="22" align="left" valign="middle"><img src="new-images/pl/orng-arrow.gif" width="12" height="12" /></td>
                        <td>Your contact details will not be shared with any Bank unless you give us consent after knowing your emi and Eligibility.</td>
                      </tr>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="new-images/pl/barcfinfrm-hdng.gif" width="289" height="88" /></td>
              </tr>
              <tr>
...
<input type="hidden" name="source" value="PB9FL"> 
