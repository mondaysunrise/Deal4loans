...
$followup_date="";
$ccdetails = "select Employment_Status,Card_Vintage,CC_Holder,Dated,DOB,Name,Email,Company_Name,City,City_Other,Mobile_Number,Net_Salary,Loan_Amount,Pincode,IP_Address,Add_Comment,Residence_Address,Total_Experience,Pancard, Cibilscore, Cibilok from Req_Loan_Personal Where (RequestID=".$requestid.")";
//echo $ccdetails."<br>";
