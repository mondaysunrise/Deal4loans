...
<div style="float:left; clear:right; width:243px; height:94px;"><a href="index.php"><img src="images/logo.gif" width="243" height="90" border="0" /></a></div>
<div style="float:left; clear:right; width:714px; height:94px; margin-top:13px; text-align:left;">
<div style="float:right;  width:680px; height:37px; ">
 <table border="0" align="center" cellpadding="0" cellspacing="3">
 <tr><td align="left"><? include "count_home.php";  ?></td><td width="20">&nbsp;&nbsp;&nbsp;</td><td align="right"><script type="text/javascript" src="https://apis.google.com/js/plusone.js"></script><g:plusone></g:plusone>
 </td></tr></table>
 </div>

<div style="float:right; clear:right; width:720px; height:42px; background-image:url(images/nav_bg.gif ); background-repeat:no-repeat;  margin-right:-30px; <?php if(strlen(strpos($_SERVER['HTTP_USER_AGENT'], "MSIE 6.0")) > 0) { echo 'padding-top:12px'; } else {	echo 'padding-top:12px; margin-top:14px;'; } ?>">

<ul class="menu" id="menu"  >
<li style="text-align:center; width:116px; ">
...
<li  style="text-align:center; width:95px;  "><a href="home-loans.php" class="btn" style="margin-left:-5px;">Home Loan </a>   
...
<li  style="text-align:center; width:85px; ">
...
<li style="text-align:center; width:105px;  ">
...
<li style="text-align:left;">  <a href="Contents_Loan_Against_Property_Faqs.php" rel="nofollow" class="btn">Loan Against Property FAQs</a>  </li>
 ...
 {?>
 <li style="text-align:center; width:117px; ">
<a href="gold-loan.php" class="btn"  style="margin-left:-5px;">Gold Loan</a>
<ul style="margin-left:-139px;" >
<li style="text-align:left;"><a href="apply-gold-loans.php" rel="nofollow" class="btn">Apply Gold Loan</a></li>
</ul>
</li>
 <?php 
 }
...
<script type="text/javascript">
 ...
 <?  if((strlen(strpos($_SERVER['SCRIPT_NAME'], "index")) > 0))
		  { } else
		  { ?>
