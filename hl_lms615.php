...
?>
 ...
 <form name="frmsearch" action="hl_lms615.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
...
//echo $qry;
  ...
  <td class="bodyarial11"><?php echo $dated;?></td>
    <td class="bodyarial11">	
	  <?php
	 echo getJumpMenu("hl_lms615.php",$row["RequestID"],"1",$row["Feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val) ?></td>
	<?php
...
{
	var gifName = form;
	document.frmsearch.action="hl_lms615.php?search=y"+gifName;
