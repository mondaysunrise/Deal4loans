...
$qry="SELECT * FROM ".TABLE_REQ_LOAN_PERSONAL." LEFT OUTER JOIN Req_Feedback_PL ON Req_Feedback_PL.AllRequestID=".TABLE_REQ_LOAN_PERSONAL.".RequestID AND Req_Feedback_PL.BidderID in (5706,5705,5749) WHERE (".TABLE_REQ_LOAN_PERSONAL.".Employment_Status=1 and ".TABLE_REQ_LOAN_PERSONAL.".Net_Salary<=300000 and (".TABLE_REQ_LOAN_PERSONAL.".City in ('Ahmedabad','Bangalore','Baroda','Vadodara','Bhopal','Bhubneshwar','Chandigarh','Panchkula','Mohali','Chennai','Coimbatore','Cuttack','Delhi','Gurgaon','Faridabad','Hyderabad','Indore','Jaipur','Jalandhar','Jodhpur','Kolkata','Lucknow','Ludhiana','Pune','Surat','Udaipur','Vijaywada','Vijayawada','Vishakapatnam','Vizag','Anand','Madurai','Ambala') or ".TABLE_REQ_LOAN_PERSONAL.".City_Other in ('Ahmedabad','Bangalore','Baroda','Vadodara','Bhopal','Bhubneshwar','Chandigarh','Panchkula','Mohali','Chennai','Coimbatore','Cuttack','Delhi','Gurgaon','Faridabad','Hyderabad','Indore','Jaipur','Jalandhar','Jodhpur','Kolkata','Lucknow','Ludhiana','Pune','Surat','Udaipur','Vijaywada','Vijayawada','Vishakapatnam','Vizag','Anand','Madurai','Ambala')) and ( ".TABLE_REQ_LOAN_PERSONAL.".Updated_Date Between '".($min_date)."' and '".($max_date)."' or Req_Feedback_PL.Followup_Date Between '".($min_date)."' and '".($max_date)."') and (".TABLE_REQ_LOAN_PERSONAL.".DOB!='' and DATE_SUB(CURDATE(),INTERVAL 21 YEAR) >= ".TABLE_REQ_LOAN_PERSONAL.".DOB) and ".TABLE_REQ_LOAN_PERSONAL.".Card_Vintage>=1 and (MOD(Req_Loan_Personal.RequestID,".NoOFLMS.")=".$pllms."))";
