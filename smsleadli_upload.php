...
echo  $getdetails="select RequestID From ".$tblname." Where ( Mobile_Number not in (9811215138) and Mobile_Number='".$data[2]."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
