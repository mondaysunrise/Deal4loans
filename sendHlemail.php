...
//echo $email."<br>".$name."<br>".$type;
	...
	if($type=="hlmailer")
	{
	//$query="update Req_Loan_Home set Hl_mailer=1 where RequestID=".$_REQUEST['Request'];
	$DataArray = array("Hl_mailer"=>1);
	$wherecondition ="RequestID=".$_REQUEST['Request'];
	Mainupdatefunc ('Req_Loan_Home', $DataArray, $wherecondition);
	}
	else
	{
//	$query="update Req_Loan_Home set Email_Sent=1 where RequestID=".$_REQUEST['Request'];
	$DataArray = array("Email_Sent"=>1);
	$wherecondition ="RequestID=".$_REQUEST['Request'];
	Mainupdatefunc ('Req_Loan_Home', $DataArray, $wherecondition);
	}
	//echo $query."<br>";
