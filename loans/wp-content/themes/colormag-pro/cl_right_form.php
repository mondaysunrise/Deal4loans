	...
	<td  align="left" valign="top" width="279">
		...
		<tr>
			<td align="left" valign="top" colspan="2" style=" color:#FFF; font-size:15px;  text-align:center; height:30; ">
				<strong>Compare Car loan</strong>			</td>
		</tr>
        <tr>
...
<input name="Name" id="Name" type="text" style="width:150px; height:20px;" onKeyDown="validateDiv('nameVal');" tabindex="1" />
<div id="nameVal"></div>    
</td>
</tr>
<tr>
...
<td width="161" class="text" style="  color:#FFF; font-size:11px;  ">
   <div class="text" style=" float:left; clear:right; padding-right:6px;">
        <input name="day" id="day" type="text" style="width:42px; height:20px;" value="dd" onblur="onBlurDefault(this,'dd');" onfocus="onFocusBlank(this,'dd');" maxlength="2" onkeyup="intOnly(this);" onkeypress="intOnly(this);" onkeydown="validateDiv('dobVal');" tabindex="7" />
        </div>
      <div class="text" style=" float:left; clear:right; padding-right:6px;">
		<input name="month" id="month" type="text" style="width:42px; height:20px;" value="mm" onblur="onBlurDefault(this,'mm');" onfocus="onFocusBlank(this,'mm');" maxlength="2" onkeyup="intOnly(this);" onkeypress="intOnly(this);" onkeydown="validateDiv('dobVal');" tabindex="8" />
      </div>
      <div class="text" style=" float:left; clear:right;">
	<input name="year" id="year" type="text" style="width:52px; height:20px;" value="yyyy" onblur="onBlurDefault(this,'yyyy');" onfocus="onFocusBlank(this,'yyyy');" maxlength="4" onkeyup="intOnly(this);" onkeypress="intOnly(this);" onkeydown="validateDiv('dobVal');" tabindex="9" />
      </div>
         <div id="dobVal"></div>
</td>
</tr>
...
Other City</td>
<td width="161" class="text" style="  color:#FFF; font-size:11px;  ">
    <input name="City_Other" id="City_Other" type="text" style="width:150px; height:20px;" disabled onKeyUp="searchSuggest();" onkeydown="validateDiv('othercityVal');"  tabindex="5" />
...
<td width="161" class="text" style="color:#FFF; font-size:11px;  ">
  <div style=" float:left; width:15px; height:auto; clear:right; margin-left:0px; margin-top:5px; ">
                  <input type="radio" value="1" name="Car_Booked" id="Car_Booked" style="border:none;">
                    </div>
                    ...
                    <div style=" float:left; width:15px; height:auto; clear:right; margin-left:13px; margin-top:5px; ">
                     <input type="radio" value="2" name="Car_Booked" id="Car_Booked" style="border:none;">
                    </div>
