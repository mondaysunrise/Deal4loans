...
$(function() {
	...
	var mai= Math.round(ai/12);
		    $( "#dialog-modal" ).dialog({			title:"You Have Indicated Your Annual Income Is 'Rs. " + ai + "' which is 'Rs." + mai + "' per month. If correct Continue or Edit Annual Income to get Right Quote",            height: 0,            modal: true
        });
		}
		});
    });
...
<div class="plc_form_box">
<div class="plc_title_box"> <h2 style=" color:#FFF; font-size:20px; text-transform:none; padding:4px;"> 
    <?php
    ...
    <div style=" color:#FFF; width:100%; font-size:11px; text-transform:capitalize; padding-left:5px;"><strong>Bank A</strong> - 13.99 % for select companies<span style="color:#FF0000; font-weight:bold;">*</span> &nbsp;&nbsp;&nbsp;&nbsp; <strong>Bank B</strong>- 0% prepayment Charges<span style="color:#FF0000; font-weight:bold;">*</span><br /> <strong>Bank C</strong>- Discount on processing fee<span style="color:#FF0000; font-weight:bold;">*</span><br />Check your free customized offer now from 5 others. <?php echo $view_form; ?></div>
    <div style="clear:both;"></div>
    
<div class="plc_input_box">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="39%"><span class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;">Full Name</span></td>
      <td width="61%" height="25"><input type="text" name="Name" id="Name" class="plc_input" maxlength="30"  onchange="insertData();" tabindex="1" /></td>
    </tr>
    <tr>
      <td><span class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;">DOB</span></td>
      <td height="25"><input name="day" type="text" id="day"  value="DD" class="plc_dd" onblur="onBlurDefault(this,'dd');" onfocus="onFocusBlank(this,'dd');" maxlength="2" onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="2"/>
                         <input  name="month" type="text" id="month" class="plc_dd" value="MM" onblur="onBlurDefault(this,'mm');" onfocus="onFocusBlank(this,'mm');" maxlength="2" onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="3"/>
                         <input name="year" class="plc_yy" type="text" id="year" value="YYYY" onblur="onBlurDefault(this,'yyyy');" onfocus="onFocusBlank(this,'yyyy');" maxlength="4" onkeyup="intOnly(this);" onkeypress="intOnly(this);" onchange="insertData();" tabindex="4"/></td>
    </tr>
    <tr>
      <td height="25"><span class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;">Mobile</span></td>
      <td height="25" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;" >
      <table cellpadding="0" cellspacing="0" width="90%">
				<tr><td>+91</td><td><input type="text"  class="plc_mobo" name="Phone" id="Phone" maxlength="10"   onkeyup="intOnly(this);" onkeypress="intOnly(this);" onchange="intOnly(this);insertData();"  tabindex="5"/></td>
				</tr></table>
      </td>
    </tr>
    <tr>
      <td height="25"><span class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;">Email ID</span></td>
      <td height="25" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;" ><input type="text" name="Email_id" id="Email_id" class="plc_input" onchange="insertData();" tabindex="6" /></td>
    </tr>
  </table>
</div>
<div class="plc_input_box"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr valign="middle">
    <td width="37%" height="25" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;">City</td>
    <td width="63%" height="25" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><select name="City" class="plc_select" onchange="othercity1(); addhdfclife(document.personalloan_form);">
  ...
  <tr valign="middle">
    ...
    <td height="28" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><input type="text" name="City_Other" id="City_Other" disabled="disabled"  value="Other City" onfocus="onFocusBlank(this,'Other City');" class="plc_input" onkeyup="searchSuggest();" tabindex="8" />
  ...
  <tr valign="middle">
    ...
    <td class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><select   name="Employment_Status"  id="Employment_Status" class="plc_select" tabindex="11" onchange="change_empstst();">
  ...
  <tr valign="middle">
    <td height="28" colspan="2" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><div id="chnge_empstst">
      <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"  width="37%" >Company Name</td>
          <td width="63%"><input name="Company_Name" id="Company_Name" type="text" tabindex="10" class="plc_input"  onblur="onBlurDefault(this,'Type slowly to autofill');" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event)" onfocus="onFocusBlank(this,'Type slowly to autofill');"  value="Type slowly to autofill"  autocomplete="off" /></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<div class="plc_input_box"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="35%" height="25" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;">Pincode</td>
    <td width="65%" height="25" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><input type="text" name="Pincode" onfocus="this.select();" style="width:148px;" maxlength="6" onkeypress="intOnly(this);" onkeyup="intOnly(this);"   tabindex="9" /></td>
  </tr>
  <tr>
    <td height="25" class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;">Annual Income</td>
    <td class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><input type="text" name="IncomeAmount" id="IncomeAmount" style="width:148px;" onkeyup="intOnly(this); getDigitToWords('IncomeAmount','formatedIncome','wordIncome');" onkeypress="intOnly(this);"  onblur="getDigitToWords('IncomeAmount','formatedIncome','wordIncome');"  onchange="ShowHide('incomeShow','Net_Salary');" tabindex="12" /></td>
  </tr>
  <tr>
    <td colspan="2"><div id="dialog-modal" > </div></td>
  </tr>
  <tr>
  ...
  <div id="cc_pl_div" style="visibility:hidden;">
    <tr>
      ...
      <td class="text" style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><table cellpadding="0" cellspacing="0" width="90%">
        <tr>
          <td style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><input type="radio" name="CC_Holder" id="CC_Holder" style="border:none;" tabindex="14"  value="1" onclick="addElement();" />
            Yes</td>
          <td style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;"><input type="radio" name="CC_Holder" id="CC_Holder" style="border:none;" tabindex="15" value="0" onclick="removeElement();" />
            No</td>
        </tr>
...
<div style="clear:both;"></div>
<div class="plc_terms_box"  style="color:#FFF; font-size:11px; text-transform:none;"><input type="checkbox"  name="accept" style="border:none;"  > I authorize Deal4loans.com &amp; its partnering banks to contact me to explain the product &amp; I Agree to&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  class="text" style=" color:#88a943; font-size:11px; text-decoration:underline;">privacy policy</a> and&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow" class="text" style=" color:#88a943; font-size:11px; text-decoration:underline;">Terms and Conditions</a>.</div>
<div class="plc_btn_box"><input type="submit" style="border: 0px none ;  background-image: url(/images/get1.gif); width: 114px; height: 52px; margin-bottom: 0px;" value=""/></div>
<div style="clear:both;"></div>
<div style="margin-top:5px; width:100%; color:#FFF; padding-bottom:5px; "><span style="color:#FF0000; font-weight:bold;">*</span> All loans and offers on sole discretion of banks.</div>
</div>
</div></form>
</div>
<div style="clear:both;"></div>
