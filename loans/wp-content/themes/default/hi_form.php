...
.frmbldtxt{	
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"   >
			<tr>
				<td valign="bottom" >
					...
					<input type="hidden" name="source" id="source" value="SEO_D4L_<?php echo $first_part; ?>">
						<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="brdr5">
							<tr>
								<td style=" padding:12px;">
									<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr>
										<td height="30"  bgcolor="#FFFFFF" class="frmbldtxt" align="center"><h1 style="margin:0px; padding:0px;"> Apply For <?php echo $first_part; ?> </h1></td>
									</tr>
								</table>
								</td>
							</tr>
  ...
  <option value="Ahmedabad">Ahmedabad</option>
						...
						I have read the <a href="http://www.bimadeals.com/Privacy.php" target="_blank">Privacy Policy</a> and agree to the <a href="http://www.bimadeals.com/Privacy.php" target="_blank">Terms
     And Condition</a>.</td>
