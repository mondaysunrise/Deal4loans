...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="brdr5" >
  ...
  <tr>
    <td height="20"  bgcolor="#FFFFFF" class="frmbldtxt" ><h1 style="color:#443133; font-size:17px;  margin:0 0 10px; padding:15px 0 3px; text-align:center; font-family:Arial, Helvetica, sans-serif;">Apply For Personal Loan</h1></td>
  </tr>
</table></td>
 </tr>
     <tr>
...
<input type="hidden" name="source" value="SEO_D4L_PL Cities"> 
...
<option value="Please Select">Please Select</option>
  <option value="Ahmedabad">Ahmedabad</option>
                   ...
                   <tr valign="middle">
                     ...
                     <td height="28" class="frmbldtxt"><input type="text" name="City_Other" id="City_Other" disabled  value="Other City" onfocus="this.select();" style="width:148px;"  tabindex="8" /><div id="CityOLayer"></div></td>
                   </tr>
                   <tr valign="middle">
