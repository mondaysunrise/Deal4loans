...
<?
	$Cfcount=0;
?>
<link href="css/styles-home-loan-23-07-2015.css" type="text/css" rel="stylesheet"  />
<link rel="stylesheet" href="css-range-slider/rangeslider-23-07-2015.css">
...
<div class="form-ui-main-wrapper">
  ...
  <form name="loan_form" method="post" action="apply-home-loanscontinue1.php" onSubmit="return chkform();">
      ...
      <div class="margin-left-one">Loan Amount</div>
      <div class="form-clear" style="height:25px;"></div>
      <!--- Range Slider start--->
      
      <div id="js-example-change-value" style="margin-left:1%;">
      ...
      <div id="validation-box" style="display:none;"><div id="RangeFormatedIncome" style="display: none;"></div>
      <div id="RangeWordIncome" style="display: none;"></div></div>
      
      <!-- Range Slider End-->
      <div class="form-clear"></div>
      <div class="nagative-margin-new">
        <div class="form-input-wrapper">
<div class="icon-box"><img src="test-newui/images-newui/occupation-frm-icon.png" width="30" height="30"  alt="Occupation" /></div> <div class="inputwrapperhl"><select name="Employment_Status" onchange="validateDiv('empStatusVal');" class="form-select" >
...
<div class="icon-box"> <img src="test-newui/images-newui/rupee-symbol-form.png" width="30" height="30" alt="Annual income" /></div>
<div class="inputwrapperhl">       
...
<div class="icon-box"> <img src="test-newui/images-newui/loaction-icon.png" alt="location icon" width="20" height="30"/>  </div>
<div class="inputwrapperhl">
...
<option value="">Select City</option>
        ...
        <div style="display:none;" id="PersonalDetails">
          ...
          <div class="form-input-wrapper">
<div class="icon-box">  <img src="test-newui/images-newui/name-icon.png" width="30" height="30" alt="Name" /></div>
       <div class="inputwrapperhl">     
<input type="text" class="form-input" value="Full Name"  name="Name" id="Name" onblur="if (this.value == '') {this.value = 'Full Name';}" onfocus="if (this.value == 'Full Name') {this.value = '';}" onkeydown="validateDiv('nameVal');" autocomplete="off"  /></div>
            <div id="nameVal"></div>
            <div class="form-clear"></div>
          </div>
          <div class="form-input-wrapper form-box-left-margin">
<div class="icon-box"> <img src="test-newui/images-newui/mail-id-icon.png" width="30" height="30" alt="Email-id" /></div>
<div class="inputwrapperhl">  <input  type="text" class="form-input"  value="E-mail Id" name="Email" id="Email" onblur="if (this.value == '') {this.value = 'E-mail Id';}" onfocus="if (this.value == 'E-mail Id') {this.value = '';}"  onkeydown="validateDiv('emailVal');" autocomplete="off" /></div>
            <div id="emailVal"></div>
            <div class="form-clear"></div>
          </div>
          <div class="form-input-wrapper form-box-left-margin">
 <div class="icon-box"> <img src="test-newui/images-newui/age-icon.png" width="30" height="30" alt="Age" /></div>
           <div class="inputwrapperhl">
          ...
          <div class="form-clear"></div>
          <div class="form-input-wrapper">
           <div class="icon-box"><img src="test-newui/images-newui/mobile-icon.png" width="30" height="30" alt="Contact Number" /></div>
 <div class="inputwrapperhl">                       <input type="text" class="form-input"  value="Mobile No." name="Phone" id="Phone" maxlength="10" onkeyup="intOnly(this);" onkeypress="intOnly(this)"; onchange="intOnly(this);" onkeydown="validateDiv('phoneVal');" onblur="if (this.value == '') {this.value = 'Mobile No.';}" onfocus="if (this.value == 'Mobile No.') {this.value = '';}" /></div>
            <div id="phoneVal"></div>
            <div class="form-clear"></div>
          </div>
<div class="form-input-wrapper form-box-left-margin">
<div class="icon-box"><img src="test-newui/images-newui/property-value.png" width="30" height="30" alt="Property Value" /></div>
  <div class="inputwrapperhl">          
<input type="text" class="form-input" value="Property Value"  name="property_value"  id="property_value" maxlength="10" onkeyup="intOnly(this);" onkeypress="intOnly(this);" onblur="if (this.value == '') {this.value = 'Property Value';}" onfocus="if (this.value == 'Property Value') {this.value = '';}" onkeydown="validateDiv('propertyValueVal');" /></div>
            <div id="propertyValueVal"></div>
            <div class="form-clear"></div>
          </div>
          <div class="form-input-wrapper form-box-left-margin">
<div class="icon-box"><img src="test-newui/images-newui/running-emi.png" width="30" height="30" alt="Running EMI"  /></div>
<div class="inputwrapperhl">                        <input type="text" class="form-input" value="Monthly EMI for all running loans" name="obligations" id="obligations" onkeyup="intOnly(this);" onkeypress="intOnly(this);" onblur="if (this.value == '') {this.value = 'Monthly EMI for all running loans';}"
 onfocus="if (this.value == 'Monthly EMI for all running loans') {this.value = '';}" /></div>
          </div>
          <div class="form-clear"></div>
          <div class="form-input-wrapper">
...
<div class="form-clear"></div>
<div class="bottom-margin-new bottom-ulli">
<input type="checkbox" name="accept" id="checkboxG2" value="1" class="css-checkbox" checked="checked" onclick="validateDiv('TermConditionVal');" />
        ...
        <div id="commonfloorlogo"></div>
           <div style="clear:both !important;"></div>
        <div class="form-white-text form-special-top bottom-ulli">
        <ul>
        <li>54 lakh customers serviced to get  best Loan deals with deal4loans. Deal4loans views Published @ yourstory .com<li>As RBI cuts rate, should you go for fixed home loan Deal4loans views Published @ Economic Times online         
        </ul>
        </div>
        <div class="form-clear"></div>
    <div></div>
