...
$age=$currentyear-$year;
	...
	$getpldetails=("select City_Other,City,Company_Name,Name,Net_Salary,DOB, Mobile_Number From Req_Loan_Personal Where (RequestID='".$leadid."')");
...
<table width="1008" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td width="1008" align="center" valign="middle" style="background:url(images/logos/bg1.gif) repeat;"><table width="980" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="980" height="470" align="center" style="font-family:verdana; font-size:14px; color:#0099FF; " valign="top">
        <table cellpadding="2" cellspacing="2" border="0" >
		<tr><td colspan="2">&nbsp;</td></tr>
		
        <tr><td align="center" style="padding-top:3px;">
             <img src="images/progress-bar.gif" width="220" height="19" /><br />
          Search in Progress<br /><br />
...
var pauseit=1
var marqueecontent='<nobr><img src="new-images/thumb/hdfc-logo.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/hdb-logo.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/fullrton.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/axis.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/bajaj-finserv1.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/stndc.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/hdfc-logo.jpg" /></nobr>'
...
document.write('</td></table>')
	   ...
	   <tr><td colspan="2" >&nbsp;</td></tr>
          <!--<tr><td colspan="2" align="center"><img src="/new-images/pl/bajaj336X280.gif" /></td></tr>-->
          </table>
</td>
      </tr>
