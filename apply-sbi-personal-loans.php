...
.txt ul li{background:url(images/cl/arrow.gif) no-repeat 0 4px;list-style-type:none;color:#292323;padding:0 0 4px 15px}
...
form{display:inline}
input,select{border:1px solid #878787;margin:0;padding:0}</style>
</style>
      ...
      <tr>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="http://www.deal4loans.com/new-images/pl/frm-hdng.gif" width="289" height="88" /></td>
              </tr>
              <tr>
...
<input type="hidden" name="source" value="sbipl"> 
	  ...
	  <input name="Phone" id="Phone" type="text"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?>style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();" maxlength="10"  /></Td>
        ...
        <?=plgetCityList($City)?>
				...
				<tr align="left">
				  ...
				  <Td><input name="City_Other" id="City_Other" type="text" value="Other City" style="width:140px; " onblur="onBlurDefault(this,'Other City');"  onfocus="onFocusBlank(this,'Other City');" disabled  onKeyUp="searchSuggest();" />
