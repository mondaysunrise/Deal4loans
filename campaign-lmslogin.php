<?php
	...
	{
			if($Email=="campaign@d4l.com" && $PWD=="campaign1")
			{ //$PWD=="interactive"
				$_SESSION["Comp_Source"] = "campaign";
				$_SESSION["UserType"] = "bidder";
				$_SESSION['UName'] = "campaign";
			}
		else 
		{
				global $Msg;
			$Msg =  "** You are not Authorized. Please try again **";
	   		 ...
	   		 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."campaign-lmsview.php");
			exit;
