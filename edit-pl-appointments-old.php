...
//echo "hello".$Final_Bid."<br>";
	...
	//	$echoQuery .= $final_allocation."<br>";
		...
		//insert 
		$insertSql = "INSERT INTO zexternal_appointment_docs (caller_id, RequestID, Reply_Type, appt_date, dated, updated_date, viewstatus, AgentFeedback,Feedback_ID,BidderID, BankID, Address) VALUES ('".$Bidder_Id."', '".$post."', '1', '".$tomorrowDate."', Now(),Now(), '1', '1', '".$recordLastInserted."', '".$Final_Bidder."', '".$BankID_Agent."', '".$residence_address."')";
		ExecQuery($insertSql);
