...
function addPersonalDetails()
{
	...
	ni1.innerHTML = ' <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="left" class="formbodytext" width="37%">Net Annual Income</td><td class="formbodytext" width="63%" valign="top"><input type="text" name="Net_Salary" id="Net_Salary" class="input-bx" onKeyUp="intOnly(this); getDiToWordsIncome(\'Net_Salary\',\'formatedIncome\',\'wordIncome\');" onKeyPress="intOnly(this);"  onblur="getDiToWordsIncome(\'Net_Salary\',\'formatedIncome\',\'wordIncome\');"  tabindex="6" onKeyDown="validateDiv(\'netSalaryVal\');"  autocomplete="off" /><div id="netSalaryVal" class="alert_msg"></div> <span id=\'formatedIncome\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;\'></span> <span id=\'wordIncome\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;text-transform: capitalize;\'></span></td></tr><tr>  <td colspan="2" height="15"></td></tr><tr>  <td width="37%" valign="top" class="formbodytext">Total EMI per Month</td>  <td width="63%" valign="top" class="formbodytext"><input type="text" name="total_emi" id="total_emi" class="input-bx" onKeyUp="intOnly(this); getDiToWordsIncome(\'total_emi\',\'formatedemi\',\'wordemi\');" onKeyPress="intOnly(this);"  onblur="getDiToWordsIncome(\'total_emi\',\'formatedemi\',\'wordemi\');" tabindex="7"  autocomplete="off" /> <span id=\'formatedemi\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;\'></span> <span id=\'wordemi\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;text-transform: capitalize;\'></span></td></tr><tr>  <td colspan="2" class="formbodytext" height="15"></td></tr><tr><td width="37%" align="left" valign="top" class="formbodytext">EMIs paid only for Personal Loans</td><td width="63%" class="formbodytext"><input type="text" name="other_emi" id="other_emi" class="input-bx" onKeyUp="intOnly(this); getDiToWordsIncome(\'other_emi\',\'formatedother_emi\',\'wordother_emi\');" onKeyPress="intOnly(this);"  onblur="getDiToWordsIncome(\'other_emi\',\'formatedother_emi\',\'wordother_emi\');" tabindex="8"  autocomplete="off" /><span id=\'formatedother_emi\' style=\'font-size:11px; font-weight:normal; color:#0000;font-Family:Verdana;\'></span> <span id=\'wordother_emi\' style=\'font-size:11px;font-weight:normal; color:#0000;font-Family:Verdana;text-transform: capitalize;\'></span></td></tr><tr><td colspan="2" height="15"></td></tr><tr>    <td width="37%" valign="top" class="formbodytext">Your relation with ICICI Bank </td><td width="63%" valign="top" class="formbodytext"><select name="relationship" id="relationship" class="select-bx" tabindex="9" onChange="addPDetails();"><option value="">Select</option><option value="SALARY_ACCOUNT">Salaried Account</option><option value="SAVINGS_ACCOUNT" >Savings Account</option><option value="CREDIT_CARD">Credit Card</option><option value="CURRENT_ACCOUNT">Current Account</option><option value="HOME_LOAN">Home Loan</option><option value="PERSONAL_LOAN">Personal Loan</option><option value="CAR_LOAN">Car Loan</option><option value="TWO_WHLR_LOAN">Two Wheeler Loan</option><option value="TERM_DEPOSIT">Term Deposit</option><option value="LOAN_AGAINST_SECURITIES">Loan Against Securities</option><option value="DEMAT">Demat</option><option value="OTHER">No Existing Relationship</option></select><div id="relVal" class="alert_msg"></div></td></tr><tr><td colspan="2" class="formbodytext" height="15"></td></tr><tr>  <td align="left" class="formbodytext" width="37%"><tr><td colspan="2" class="formbodytext" style="font-size:12px;">&nbsp;</td></tr><tr><td colspan="2" align="center" class="formbodytext" id="pDetails"><img src="images/submit-app.png" width="135" height="40" border="0" ></td></tr></table>';
}
...
<form id="myform" onSubmit="return chkpersonalloan('document.loan_form');" action="icici_application-continue.php" method="post" name="loan_form">
...
<div class="form-wrapper-app">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr>
           ...
           <td align="left" class="formbodytext"><select name="City" id="City" class="select-bx" onChange="validateDiv('cityVal');" tabindex="2">
             <?=plgetCityList($City)?>
         ...
         <tr>
           ...
           <td class="formbodytext" height="10"><select name="age" id="age" class="select-bx" onChange="validateDiv('ageVal');" tabindex="2">
         ...
         <tr>
           ...
           <td class="formbodytext"><input name="Company_Name" id="Company_Name" type="text" class="input-bx" onBlur="onBlurDefault(this,'Type slowly to autofill'); " onKeyUp="ajax_showOptions(this,'getCountriesByLetters',event, 'https://www.deal4loans.com/ajax-list-plicici.php')" onFocus="addPersonalDetails();  onFocusBlank(this,'Type slowly to autofill');" onKeyDown="validateDiv('companyNameVal');" value="Type slowly to autofill" tabindex="7" autocomplete="off"  style="color:#999999;" />
