...
<?php
 if((strlen(strpos($_SERVER['REQUEST_URI'], "car-loan-emi-calculator.php")) > 0)) 
{
	echo '<input type="hidden" name="source" value="Car loan emi calc" />';
}
else
{
	echo '<input type="hidden" name="source" value="Quick Apply New CL" />';
}
?>
<input type="hidden" name="Type_Loan" value="Req_Loan_Car" />
