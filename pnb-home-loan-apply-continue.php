...
function InsertTataAig($RequestID, $ProductName)
	...
	//	echo "select Dated, City, City_Other from ".$ProductName." where RequestID = $RequestID";
		...
		$table = $Type_Loan;		
			...
			{
		$InsertwUsersSql = array("Email"=>$Email, "FName"=>$Name, "Phone"=>$Phone, "Join_Date"=>$Dated, "IsPublic"=>$IsPublic);
		$table1 = 'wUsers';
		$UserID = Maininsertfunc ($table1, $InsertwUsersSql);	

		$InsertProductSql = array("UserID"=>$UserID, "Name"=>$Name, "Email"=>$Email, "City"=>$City, "City_Other"=>$City_Other, "Mobile_Number"=>$Phone, "Net_Salary"=>$Net_Salary, "Loan_Amount"=>$Loan_Amount, "Dated"=>$Dated, "source"=>$source, "Referrer"=>$Referrer, "Creative"=>$Creative, "Section"=>$Section, "IP_Address"=>$IP, "Reference_Code"=>$Reference_Code, "Updated_Date"=>$Dated, "Accidental_Insurance"=>$Accidental_Insurance);
		$table = $Type_Loan;	
			
			}
			$ProductValue = Maininsertfunc ($table, $InsertProductSql);
      ...
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<td height="25"  style=" padding-left:10px; " ><div style="color:#5e5e5e; font-size:13px; font-weight:bold;line-height:24px;  ">Features & Benefits of PNB Housing Home Loan</div></td>
              </tr>
              <tr>
...
IDBI Home Finance</div>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="new-images/hl/pnbfrm-hdng.gif" width="289" height="88" /></td>
              </tr>
              <tr>
