    ...
    <td style="padding:5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="padding:5px 0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" valign="top" background="images/hl_rgt-tp-bg.gif" style="background-repeat:no-repeat; width:272px; height:44px; background-position:top;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top" style="padding-bottom:5px;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="35" align="center" class="heading">Just 3 easy steps!</td>
                      </tr>
                      <tr>
                ...
                <tr>
                  <td align="center" valign="top"   ><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td align="center" valign="top" style="background-color:#EFE6CB; border:3px solid #FFFFFF; "><table width="96%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="center" class="heading" style="text-align:center; padding-top:4px; font-size:15px; font-weight:bold;">Sponsored By <br>
                              <img src="images/hl_lic_ban.jpg" width="239" height="61" alt=""></td>
                        </tr>
                        <tr>
                        <td height="25" align="center" class="heading" style="padding-top:5px; font-size:15px; font-weight:bold;">www.deal4loans.com</td>
                        </tr>
						  <tr>
                      ...
                      <tr>
                        <td height="22" align="right" valign="middle" ><a href="http://www.deal4loans.com" target="_blank" class="subheading" style="font-size:12px; text-decoration:underline; font-weight:bold;">www.deal4loans.com</a></td>
                      </tr>
            ...
            <td width="303" align="left" valign="top"><table width="100%" height="270" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="600" align="center" valign="middle" background="images/hl_form_bg.gif" style="background-repeat:no-repeat; width:303px; height:44px; background-position:top;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td align="center" style="background-color:#EFE6CB; border:3px solid #FFFFFF; border-top:none; "><form name="home_loan" action="apply-home-loan-continue.php" onSubmit="return submitform(document.home_loan);" method="post">
					  
                          <table width="93%" border="0" align="right" cellpadding="0" cellspacing="0">
                            
                            <tr>
                              <td height="10" colspan="2" align="center"  ><img src="http://www.deal4loans.com/images/spacer.gif" width="220" height="10" border="0" align="center "></td>
                              </tr>
                            <tr>
                              <td width="166" height="30" align="left" valign="middle" class="formtext">First Name<font color="#FF0000">*</font></td>
                            ...
                            <tr>
                              <td width="166" height="30" align="left" valign="middle" class="formtext">Mobile<font color="#FF0000">*</font></td>
                            ...
                            <tr>
                              <td height="30" align="left" valign="middle" class="formtext">Email</td>
                            ...
                            <tr>
                              <td height="30" align="left" valign="middle" class="formtext">City<font color="#FF0000">*</font></td>
                              <td class="formtext"><select size="1" align="left" style="width:140"  name="City" id="City" onChange="othercity1(this); insertData(); " />
                              
                                  <?=getCityList1($City)?>                              </td>
                            </tr>
                            <tr>
                              <td height="30" align="left" valign="middle" class="formtext">Other City </td>
                            ...
                            <tr>
                              <td width="166" height="30" align="left" valign="middle" class="formtext">Net Salary<font color="#FF0000">*</font></td>
                            ...
                            <tr>
                              <td height="30" align="left" valign="middle" class="formtext">Loan Amount </td>
                            ...
                            <tr>
                              <td height="30" align="left" valign="middle" class="formtext"><font color="#FF0000">*</font>Mandatory</td>
                            ...
                            <tr>
                              <td height="55"  colspan="2" align="center" valign="middle" ><input value="Get Quotes" name="submit" type="submit" class="hlbtn" /></td>
                            </tr>
                          </table>
                      </form></td>
                    </tr>
...
<td valign="top" style=" background-color:#EFE6CB; border:3px solid #FFFFFF;"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="33" align="left" valign="top" class="heading"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="56%" valign="bottom"  class="heading">Helpful tips <span class="subheading" style=" font-style:normal;">to Get the Best Home Loan Deal</span></td>
    <td width="44%" class="subheading"></td>
  </tr>
</table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="right" valign="top"  style="padding :8px 0px;"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="47%" class="subheading" style="line-height:16px;">
...
&raquo; Penalties. </td>
            <td width="53%" align="right" valign="bottom"><a href="http://www.deal4loans.com/Contents_Home_Loan_Mustread.php" target="_blank" class="subheading" style="font-size:12px; text-decoration:underline; font-weight:bold;">Know more....</a></td>
          </tr>
        </table>          </td>
      </tr>
  ...
  <tr>
        <td align="center" valign="top"  style="padding-bottom:5px;"><img src="images/lic-bgban.gif" width="588" height="90" alt=""></td>
      </tr>
</table>
