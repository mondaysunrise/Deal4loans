...
<br /><br />
    <form name="form123" action="Send_Perform_REQuest.php" method="post">
  ...
  <!--  <input name="submit" id="submit" type="submit" value="Pay Now" style="border-style:outset;border-color:#0066A2;height:50px;width:130px;font: bold 15px arial,sans-serif;"  /> -->
   <input type="submit" name="submit" id="submit"  value="Pay Now" style="border-style:outset;border-color:#0066A2;height:50px;width:130px;font: bold 15px arial,sans-serif;"  />
    </form>
</td></tr></table>
</td></tr>
</table></td></tr>
