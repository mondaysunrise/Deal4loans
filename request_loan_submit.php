<?php
	...
	else
	{
		...
		//$sql = "INSERT INTO wUsers (Email,FName,PWD,Phone,DOB,Join_Date,IsPublic) VALUES ('$mailid','$name','$pwd','$mobile','$dob', '$doe','$detail')";
...
$insert = Maininsertfunc ($table, $dataInsert);
		...
		{
			//$sql = "INSERT INTO Req_Loan_Personal (UserID, Name, Email, Employment_Status, Company_Name, City, Net_Salary, Loan_Amount, Dated, Mobile_Number,IsPublic) VALUES ('$newid', '$name', '$mailid', '$salaried', '$comp_name', '$city', '$income', '$loan_amount', '$today', '$mobile','$detail')";
			//$result = ExecQuery($sql);
...
$insert = Maininsertfunc ($table, $dataInsert);
		...
		if($product=="car_loan")
		{
			//$sql = "INSERT INTO Req_Loan_Car (UserID, Name, Email, Employment_Status, Company_Name, City, Net_Salary, Loan_Amount, Dated, Mobile_Number,IsPublic) VALUES ('$newid', '$name', '$mailid', '$salaried', '$comp_name', '$city', '$income', '$loan_amount', '$today', '$mobile','$detail')";
			//$result = ExecQuery($sql); 
			$dataInsert = array("UserID"=>$newid, "Name"=>$name, "Email"=>$mailid, "Employment_Status"=>$salaried, "Company_Name"=>$comp_name, "City"=>$city, "Net_Salary"=>$income, "Loan_Amount"=>$loan_amount, "Dated"=>$today, "Mobile_Number"=>$mobile, "Std_Code"=>$std, "Landline"=>$landline, "IsPublic"=>$detail);
$table = 'Req_Loan_Car';
$insert = Maininsertfunc ($table, $dataInsert);
		...
		{
			//$sql = "INSERT INTO Req_Credit_Card (UserID, Name, Email, Employment_Status, Company_Name, City, Net_Salary, Loan_Amount, Dated, Mobile_Number,IsPublic) VALUES ('$newid', '$name', '$mailid', '$salaried', '$comp_name', '$city', '$income', '$loan_amount', '$today', '$mobile','$detail')";
			//$result = ExecQuery($sql); 
		$dataInsert = array("UserID"=>$newid, "Name"=>$name, "Email"=>$mailid, "Employment_Status"=>$salaried, "Company_Name"=>$comp_name, "City"=>$city, "Net_Salary"=>$income, "Loan_Amount"=>$loan_amount, "Dated"=>$today, "Mobile_Number"=>$mobile, "Std_Code"=>$std, "Landline"=>$landline, "IsPublic"=>$detail);
...
$insert = Maininsertfunc ($table, $dataInsert);
		...
		{
			//$sql = "INSERT INTO Req_Loan_Against_Property (UserID, Name, Email, Employment_Status, Company_Name, City, Net_Salary, Loan_Amount, Dated, Mobile_Number,IsPublic) VALUES ('$newid', '$name', '$mailid', '$salaried', '$comp_name', '$city', '$income', '$loan_amount', '$today', '$mobile','$detail')";
			//$result = ExecQuery($sql); 
...
$insert = Maininsertfunc ($table, $dataInsert);
		...
		{
			//$sql = "INSERT INTO Req_Loan_Home (UserID, Name, Email, Employment_Status, Company_Name, City, Net_Salary, Loan_Amount, Dated, Mobile_Number,IsPublic) VALUES ('$newid', '$name', '$mailid', '$salaried', '$comp_name', '$city', '$income', '$loan_amount', '$today', '$mobile','$detail')";
			//$result = ExecQuery($sql);
