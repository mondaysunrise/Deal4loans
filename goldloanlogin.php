	   ...
	   //$last_inserted_value = mysql_insert_id();
		...
		$_SESSION['last_inserted_value'] = $last_inserted_value;
 		  ...
 		  ExecQuery($sqlTrackBidder);
			...
			else if($_SESSION['BidderID']==6716)
			{
				header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."application-for-gold-loan.php");
				exit;
			}
...
<body style="margin:0px; padding:0px; background-color:#45B2D8;">
 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse: collapse" valign="top">
  ...
  <tr>
    <td height="52" align="center"  ><h1 style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#052733; line-height:18px; font-weight:bold;">Gold Loan Login Panel</h1></td>
  </tr>
  <tr>
