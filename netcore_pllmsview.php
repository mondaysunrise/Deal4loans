...
{
	var gifName = form;
	document.frmsearch.action="netcore_pllmsview.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="netcore_pllmsview.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="0"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><?  if($_SESSION["Comp_Source"]=="netcorepl") {$cmpdate="2013-01-01"; }?> 
 ...
 <? 
	if($comp_source=="netcorepl")
		{
			$qry2="SELECT komli_uniqueid,Feedback,komli_date from komli_plcompaign LEFT OUTER JOIN Req_Feedback_PL ON Req_Feedback_PL.AllRequestID= komli_plcompaign.komli_uniqueid AND Req_Feedback_PL.BidderID in (846,847,854,9,10,63,67) WHERE ((komli_date Between '".$min_date."' and '".$max_date."') and  komli_city in ('Chennai','Bangalore','Hyderabad','Mumbai','Navi Mumbai','Thane','Delhi','Kolkata','Ahmedabad','Pune','Vizag','Vishakapatanam','Surat','Indore','Cochin','Chandigarh','Jaipur','Baroda','Coimbatore','Noida','Gurgaon','Faridabad','Gaziabad') and komli_netsalary  >=360000 and  vendor_name='".$comp_source."' and validated=1 and Req_Feedback_PL.Feedback in ('Wrong Number','Not Eligible','Not Contactable','Ringing','Not Applied','Not Interested','Duplicate'))";
...
<td width="141" align="center" bgcolor="#FFFFFF" class="style2">Feedback</td>
  ...
  <?  
	 $qry="SELECT komli_uniqueid,Feedback,komli_date from komli_plcompaign LEFT OUTER JOIN Req_Feedback_PL ON Req_Feedback_PL.AllRequestID= komli_plcompaign.komli_uniqueid AND Req_Feedback_PL.BidderID in (846,847,854,9,10,63,67) WHERE ((komli_date Between '".$min_date."' and '".$max_date."') and  komli_city in ('Chennai','Bangalore','Hyderabad','Mumbai','Navi Mumbai','Thane','Delhi','Kolkata','Ahmedabad','Pune','Vizag','Vishakapatanam','Surat','Indore','Cochin','Chandigarh','Jaipur','Baroda','Coimbatore','Noida','Gurgaon','Faridabad','Gaziabad') and komli_netsalary  >=360000 and  vendor_name='".$comp_source."' and validated=1 and Req_Feedback_PL.Feedback in ('Wrong Number','Not Eligible','Not Contactable','Ringing','Not Applied','Not Interested','Duplicate'))";
