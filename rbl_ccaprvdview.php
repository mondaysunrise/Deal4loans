...
{
	var gifName = form;
	document.frmsearch.action="rbl_ccaprvdview.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="rbl_ccaprvdview.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr>
   <td colspan="3" align="center"><table border="0" cellpadding="0" cellspacing="0" width="95%">     
     ...
     <td width="9%"  valign="middle" class="bidderclass"></td>
	  <td width="26%"  valign="middle" class="bidderclass">
</td>
...
<? 
	...
	$search_qry="SELECT * FROM Req_Feedback_Bidder_CC,`".$val."`  WHERE Req_Feedback_Bidder_CC.AllRequestID=`".$val."`.RequestID and Req_Feedback_Bidder_CC.BidderID in (4905) and Req_Feedback_Bidder_CC.Reply_Type=".$pro_code." and (Req_Feedback_Bidder_CC.Allocation_Date Between '".($min_date)."' and '".($max_date)."' ) ";
	...
	$qry="SELECT RequestID FROM Req_Feedback_Bidder_CC,`".$val."` WHERE Req_Feedback_Bidder_CC.AllRequestID=`".$val."`.RequestID and Req_Feedback_Bidder_CC.BidderID in (4905) and Req_Feedback_Bidder_CC.Reply_Type=".$pro_code."  and (Req_Feedback_Bidder_CC.Allocation_Date Between '".($min_date)."' and '".($max_date)."') ";
...
<?
  ...
  $qry="SELECT ".$getfields." FROM Req_Feedback_Bidder_CC,`".$val."` WHERE Req_Feedback_Bidder_CC.AllRequestID=`".$val."`.RequestID and Req_Feedback_Bidder_CC.BidderID in (4905) and Req_Feedback_Bidder_CC.Reply_Type=".$pro_code."  and (Req_Feedback_Bidder_CC.Allocation_Date Between '".($min_date)."' and '".($max_date)."') ";
		$qry=$qry.$FeedbackClause;		
		$qry=$qry."group by ".$val.".Mobile_Number";
...
$cardsarrunq="";
	$cardsarrunq = array_unique($cardsarr);
	  ...
	  for($r=0;$r<count($cardsarrunq);$r++)
			{
	  if((strncmp ("RBL", $cardsarrunq[$r],3))==0)
			{
				echo $cardsarrunq[$r]; 
			}
			}
...
<? 
 ...
 <form name="frmdownload" action="rbl_ccapprvd_download.php" method="post">
   <tr>
     <td align="center">
