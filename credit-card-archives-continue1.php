...
<!--                  <div id="dvbannerContainer"><?php //include 'header_cc.php';?></div>
 --> </div>
  ...
  <div id="dvContentPanel" style="padding:8px 0px;">
    ...
    <form  name="CC_offers_mailer" action="check-cc.php" method="POST" ONsubmit="return ccofferform(document.CC_offers_mailer);"><table width="725" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <td align="center" valign="middle" class="bldtxt"><table width="600" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#d3ecf8">
              <tr>
                <td width="273" height="22" bgcolor="#f6fcff" class="bldtxt">Name</td>
                    <td width="316" bgcolor="#f6fcff"><input type="text" name="last_id" style="width:225px; border:none;" maxlength="30" value="<?php echo $last_id;?>" readonly />
	...
	?>
                                <tr>
                                  <td><table width="300" border="0" align="left" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td height="22" class="bldtxt"  valign="middle" align="left" ><img src="images/plus2.gif" alt="" name="imgfaq3" width="12"  height="12" id="imgfaq3" style="cursor:pointer;" onClick="showdetailsFaq(<? echo $i;?>,12)"> <span  onclick="showdetailsFaq(<? echo $i;?>,12)" style="cursor:pointer; font-weight:bold; color:#07468C;" ><? echo $myrow[$i]["bank_name"];?></span>
...
while($cntr<count($row))
        {
			?>
                                                <tr>
                                                  <td width="25" align="left" valign="top"><input type="checkbox" value="<? echo $row[$cntr]["ccndc_offerid"];?>_<? echo $row[$cntr]["bank_name"];?>" name="category_cc[]" style="border:none; cursor:pointer;" onClick="showdetailsFaq(<? echo $r;?>,800)" id="imgfaq4"/>
	...
	?>
                                <tr>
                                  <td><table width="300" border="0" align="right" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td height="22" class="bldtxt" valign="middle" align="left" ><img src="images/plus2.gif" alt="" onClick="showdetailsFaqDc(<? echo $i;?>,12)" id="imgfaq3"  height="12" width="12" style="cursor:pointer;"> <span  onclick="showdetailsFaqDc(<? echo $i;?>,12)" style="cursor:pointer; font-weight:bold;" ><? echo $myrow[$i]["bank_name"];?></span>
...
while($cntr<count($row))
        {
			...
			?>
                                                <tr>
                                                  <td  width="25" align="left" valign="top"><input type="checkbox" value="<? echo $row[$cntr]["ccndc_offerid"];?>_<? echo $row[$cntr]["bank_name"];?>" name="category_dc[]" style="border:none; cursor:pointer;" onClick="showdetailsFaqDc(<? echo $r;?>,800)" id="imgfaqdc4"/>                                                         </td>
                                                  <td class="nrmltxt" align="left"><span  onclick="showdetailsFaqDc(<? echo $r;?>,800)" style="cursor:pointer;" ><? echo $row[$cntr]["card_name"];?></span>
                                                      <div style="display:none;" id="divfaqdc<? echo $r;?>">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                          <tr>
                                                            <td  width="25" align="left" valign="top"><input type="checkbox" value="dinning_offers" name="category_dc_<?php	echo $row[$cntr]["ccndc_offerid"]; ?>[]" style="border:none"/></td>
                                                            <td class="nrmltxt" align="left">Dinning Offers</td>
                                                          </tr>
                                                          <tr>
                                                            <td  width="25" align="left" valign="top"><input type="checkbox" value="travel_offers" name="category_dc_<?php echo $row[$cntr]["ccndc_offerid"]; ?>[]" style="border:none"/></td>
                                                            <td class="nrmltxt" align="left">Travel Offer</td>
                                                          </tr>
                                                          <tr>
                                                            <td  width="25" align="left" valign="top"><input type="checkbox" value="shopping_offers" name="category_dc_<?php	echo $row[$cntr]["ccndc_offerid"]; ?>[]" style="border:none"/></td>
                                                            <td class="nrmltxt" align="left">Shopping Offer</td>
                                                          </tr>
                                                          <tr>
                                                            <td  width="25" align="left" valign="top"><input type="checkbox" value="entertainment_offers" name="category_dc_<?php echo $row[$cntr]["ccndc_offerid"]; ?>[]" style="border:none"/></td>
                                                            <td class="nrmltxt" align="left">Entertainment Offer</td>
                                                          </tr>
                                                          <tr>
                                                            <td  width="25" align="left" valign="top"><input type="checkbox" value="petrol_offers" name="category_dc_<?php echo $row[$cntr]["ccndc_offerid"]; ?>[]" style="border:none"/></td>
                                                            <td class="nrmltxt" align="left">Petrol Offer</td>
                                                          </tr>
                                                          <tr>
                                                            <td  width="25" align="left" valign="top"><input type="checkbox" value="reward_points_offers" name="category_dc_<?php	echo $row[$cntr]["ccndc_offerid"]; ?>[]" style="border:none"/></td>
                                                            <td class="nrmltxt">Reward Points Offers</td>
                                                          </tr>
                                                          <tr>
                                                            <td width="25" align="left" valign="top"><input type="checkbox" value="other_offers" name="category_dc_<?php echo $row[$cntr]["ccndc_offerid"]; ?>[]" style="border:none"/></td>
                                                            <td class="nrmltxt" align="left">Other Offers</td>
                                                          </tr>
                                                        </table>
                                                      </div></td>
