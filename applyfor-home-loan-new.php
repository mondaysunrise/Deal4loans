...
if(strlen($_REQUEST["source"])>0)	{		$srce=$_REQUEST["source"];	}	else	{		$srce="GOOG_D4L_newhomeloan2";	}
?>
<!DOCTYPE html>
<html >
<head>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td height="28" align="center" bgcolor="#e5eef3" class="table_text_b" style="border-right:thin solid #FFF;">9.85%</td>
          <td height="28" align="center" bgcolor="#e5eef3" class="table_text_b" style="border-right:thin solid #FFF;">Rs. 23,00,000</td>
          <td height="28" align="center" bgcolor="#e5eef3" class="table_text_b" style="border-right:thin solid #FFF;">Rs. 21,967</td>
        ...
        <tr>
          ...
          <td height="28" align="center" bgcolor="#FFFFFF" class="table_text_b" style="border-right:thin solid #FFF;">9.90%</td>
          <td height="28" align="center" bgcolor="#FFFFFF" class="table_text_b" style="border-right:thin solid #FFF;">Rs. 25,00,000</td>
          <td height="28" align="center" bgcolor="#FFFFFF" class="table_text_b" style="border-right:thin solid #FFF;">Rs. 23,960</td>
...
Salary Slip</span></td>
        ...
        <tr class="table_text_b">
          ...
          <td height="28" align="center" bgcolor="#e5eef3" class="table_text_b" style="border-right:thin solid #FFF;">Rs. 25,004</td>
...
Salary Slip</span></td>
        ...
        <tr class="table_text_b">
          ...
          <td height="28" align="center" bgcolor="#FFFFFF" class="table_text_b" style="border-right:thin solid #FFF;">10.10%</td>
          <td height="28" align="center" bgcolor="#FFFFFF" class="table_text_b" style="border-right:thin solid #FFF;">Rs. 27,00,000</td>
          <td height="28" align="center" bgcolor="#FFFFFF" class="table_text_b" style="border-right:thin solid #FFF;">Rs. 26,235</td>
          <td height="28" align="center" bgcolor="#FFFFFF" class="table_text" style="border-right:thin solid #FFF;"><span class="table_text_b" style="border-right:thin solid #FFF; font-size:9px;">Bank Stat,<br />
Salary Slip</span></td>
        </tr>
      </table></td>
  ...
  <div class="row_a margin_top"><span class="list_text_head">List of top Home Loans Banks in India</span><br />
   ...
   <span style="color:#aa2a5d;"> Axis Bank,</span> <span style="color:#1c689a;">Bajaj Finserv,</span> <span style="color:#820606;">PNB Home Finance.</span></div>   
   ...
   <li><strong>Fixed rate offers for <span style="font-size:15px;">10-20 years</span> start <span style="font-size:15px;">@10.10%</span>.</strong></li>
   <li>Over <strong style="color:#F60; font-size:24px;">5<span style="font-size:24px; color:#F60;">3</span><span style="font-size:28px; color: #06F;">47</span><span style="color: #900;">963</span></strong> customers have taken quote at <strong style="color:#187abe; font-size:15px;">Deal4loans.com</strong></li>
   </ul>
   <span style="text-align:right; font-size:12px; font-weight:normal;">*All loans repayment period are over 6 months. No short term loans</span>
   </div>
...
$sql = "SELECT Company_Name, Net_Salary, City,City_Other FROM Req_Loan_Home WHERE (Net_Salary >400000 AND Employment_Status =1 AND Allocated =1 and Property_Identified=1 and LENGTH(Company_Name)>10) ORDER BY RequestID DESC  LIMIT 0 , 6";
	...
	list($count,$ArrRow)=MainselectfuncNew($sql,$array = array());
