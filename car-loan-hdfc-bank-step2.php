...
function getCityField($field_name,$class_name,$selectedValue='')
{
	...
	list($numselectCity,$selectCityQuery)=MainselectfuncNew($selectCitySql,$array = array());
	$selected ='';
	for($numCity=0;$numCity<$numselectCity;$numCity++)
	{
		$name_state = $selectCityQuery[$numCity]['name'];
...
<script type="text/javascript" src="https://www.deal4loans.com/ajax-dynamic-https.js"></script>
  <link rel="stylesheet" href="CoverPop.css">
  <link rel="stylesheet" href="css/hdfcstyles.css">
...
function addResiField1()
{
		...
		ni3.innerHTML = '<table width="525" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td colspan="5" class="hdtext-formsub" height="45">Professional Details</td></tr>      <tr><td width="15">&nbsp;</td><td width="4">&nbsp;</td><td width="85" class="hdtext-car-formsub" >Profession</td><td width="158"><select name="Employment_Status" id="Employment_Status" class="hdtext-select-car" tabindex="14" ><option value="">Profession</option><option value="1"  >Salaried</option><option value="2" >Self Employed</option></select></td><td width="263"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="15">&nbsp;</td><td width="4">&nbsp;</td><td width="95" class="hdtext-car-formsub">Company Name</td><td width="149"><input type="text" name="Company_Name" id="Company_Name" style="color:#888;" class="hdtext-input-car"  value="Type slowly for autofill" onBlur="inputBlur(this); onBlurDefault(this,\'Type slowly for autofill\'); "  onfocus="inputFocus(this); onFocusBlank(this,\'Type slowly for autofill\');" onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event, \'https://www.deal4loans.com/hdfcajax-cmplist-cl.php\')" autocomplete="off" tabindex="15"/></td></tr></table></td></tr><tr><td colspan="5" height="10"></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td class="hdtext-car-formsub">PAN Card no.<span style="color:#FF0000;">*</span> </td><td><input type="text" name="Pancard" id="Pancard" class="hdtext-input-car" maxlength="10" tabindex="16" /></td><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="15">&nbsp;</td><td width="4">&nbsp;</td><td width="95" class="hdtext-car-formsub">HDFC Cust ID or A/C no<span style="color:#FF0000;">*</span></td><td width="149" class="hdtext-car-formsub"><input type="radio" name="select_acc" id="select_acc" value="custid" onclick="checkAccField();" tabindex="17"  checked /> Customer ID<br /><input type="radio" name="select_acc" id="select_acc" value="accno" onclick="checkAccField1();" tabindex="18" /> Account Number</td></tr></table></td></tr><tr><td colspan="5" height="5"></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td class="hdtext-car-formsub">Tenure</td><td> <select name="Tenure" id="Tenure" class="hdtext-select-car" tabindex="19" ><option value="">Select</option><option value="1" >12 Months</option><option value="2" >24 Months</option><option value="3" >36 Months</option><option value="4" >48 Months</option><option value="5" >60 Months</option><option value="6" >72 Months</option><option value="7" >84 Months</option></select></td><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="15">&nbsp;</td><td width="4">&nbsp;</td><td width="95" class="hdtext-car-formsub" id="checkcustIDLabel">HDFC Cust ID</td><td width="149"  id="checkcustIDName"><input type="text" name="customer_id" id="customer_id" class="hdtext-input-car" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" maxlength="8" tabindex="20" onfocus="addResiField2();"  /></td></tr></table></td></tr><tr><td colspan="5" height="5"></td></tr></table>';
}
...
//	alert("sasda");
	var ni3 = document.getElementById('addMoreFields2');
		ni3.innerHTML = '<table width="530" border="0" cellspacing="0" cellpadding="0"><tr><td height="45" colspan="2" class="hdtext-formsub">Correspondance Address<span style="color:#FF0000;">*</span></td></tr><tr><td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="3%" >&nbsp;</td><td width="2%" >&nbsp;</td><td width="15%" valign="middle" class="hdtext-car-formsub" >Address</td><td width="80%" valign="middle" class="hdtext-car-formsub" ><input type="radio" name="chk_address" id="chk_address" value="Office" checked="checked" tabindex="28" />Office<input type="radio" name="chk_address" id="chk_address" tabindex="29" value="Residence" />Residence <input type="radio" name="chk_address" tabindex="30" id="chk_address" value="Office cum Residence" />Office cum Residence</td></tr></table></td></tr><tr><td colspan="2" height="10"></td></tr><tr><td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="3%" >&nbsp;</td><td width="2%" >&nbsp;</td><td width="15%" class="hdtext-car-formsub" >Address</td><td width="80%" ><span class="hdtext-car-formsub"><input type="text" name="off_add_line1" id="off_add_line1" class="hdtext-address-car"   autocomplete="off" tabindex="31"/></span></td></tr></table></td></tr><tr><td colspan="2" height="10"></td></tr><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="6%" >&nbsp;</td><td width="3%" >&nbsp;</td><td width="32%" class="hdtext-car-formsub" >City</td><td width="59%" ><select name="off_City" id="off_City" class="hdtext-select-car" tabindex="32" onchange="addOtherCity();  "><?=plgetCityList($_SESSION["off_City"])?></select></td></tr></table></td><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="7%" >&nbsp;</td><td width="1%" >&nbsp;</td><td width="31%" class="hdtext-car-formsub" >State</td><td width="58%" ><?php echo getCityField("off_State","hdtext-select-car",$_SESSION["off_State"]); ?></td></tr></table></td></tr><tr><td colspan="2" height="10"></td></tr><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="7%" >&nbsp;</td><td width="1%" >&nbsp;</td><td width="31%" class="hdtext-car-formsub" >PIN Code </td><td width="58%" ><input type="text" name="pincode" id="pincode" class="hdtext-input-car" onFocus="addResiField3();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" autocomplete="off" maxlength="6" tabindex="33"/></td></tr></table></td><td>&nbsp;</td></tr></table>';
	return true;
}	
...
<div id="CoverPop-cover" class="splash">
    <div id="CoverPop-content" class="splash-center">
        <form class="signup signup-splash" method="post" accept-charset="utf-8">
          <p class="hdtext-car-formsub">I/We certify that the details I will submitted on the site is accurate and not in contravention of my existing employer/channel/business
I/We certify that the information being furnished is true and accurate. I / We agree and acknowledge that only direct telephone numbers (not board / general telephone numbers of offices / corporates / employers) will be accepted for registration of "Do Not Call". I / We am / are aware that post registration, I / We may receive a call from the Bank to verify the correctness of the request for registration.
I/We understand that the online eligibility and offer shown is tentative and is subject to change based on verifications by HDFC Bank Credit Processes. 
I/We understand that the interest rates and processing fees are subject to change without prior notice. 
</p>
            <input type="submit" value="I Agree" class="submit-button CoverPop-close-go">
        </form>
    </div>
</div>
<?php $_COOKIE['_CoverPop']='';?>
...
<input type="hidden" name="Source" id="Source" value="car-loan-hdfc">
          ...
          <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="12%"><table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td><select name="name_abbr" class="hdtext-mrs-car" id="name_abbr" tabindex="1">
  ...
  <tr>
    <td><input type="text" name="FName" id="FName" style="color:#888; border:none;" class="hdtext-mrs-inputb-car" onblur="inputBlur(this); onBlurDefault(this,'firstname');" onfocus="inputFocus(this); onFocusBlank(this,'firstname');" value="<?php if(strlen($_SESSION['FName'])>0) { echo $_SESSION['FName']; } else {?>firstname<?php } ?>" tabindex="2" /></td>
    <td><input type="text" name="MName" id="MName" style="color:#888; border:none;" class="hdtext-mrs-input-car" onfocus="inputFocus(this); onFocusBlank(this,'middlename');" onblur="inputBlur(this); " value="<?php if(strlen($_SESSION['MName'])>0) { echo $_SESSION['MName']; } else {?>middlename<?php } ?>" tabindex="3"  /></td>
    <td><input type="text" name="LName" id="LName" style="color:#888; border:none;" class="hdtext-mrs-inputb-car" onblur="inputBlur(this); onBlurDefault(this,'lastname');" onfocus="inputFocus(this); onFocusBlank(this,'lastname');" value="<?php if(strlen($_SESSION['LName'])>0) { echo $_SESSION['LName']; } else {?>lastname<?php } ?>" tabindex="4" /></td>
  </tr>
</table></div></td>
            </tr>
          </table>          
        ...
        <tr>
          ...
          <td width="158" class="hdtext-car-formsub"><input type="text" style="color:#888;" name="Phone" id="Phone" class="hdtext-input-car" maxlength="10" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" tabindex="5" onChange="intOnly(this); insertstat_code();" onBlur="inputBlur(this); onBlurDefault(this,'Mobile');"  onFocus="inputFocus(this); onFocusBlank(this,'Mobile');" autocomplete="off" value="<?php if(strlen($_SESSION['Phone'])>0) echo $_SESSION['Phone']; else echo "Mobile"; ?>" />
            </td> 
          <td width="263"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="152">
<input type="text" name="Email" id="Email" class="hdtext-input-car" style="color:#888;" onBlur="inputBlur(this); onBlurDefault(this,'Email');"  onFocus="inputFocus(this); onFocusBlank(this,'Email');" tabindex="6" onChange="insertstat_code();" autocomplete="off" value="<?php if(strlen($_SESSION['Email'])>0) echo $_SESSION['Email']; else echo "Email"; ?>" />
</td>
            </tr>
          </table></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="Net_Salary" id="Net_Salary" class="hdtext-input-car" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" autocomplete="off" tabindex="7" onFocus="addResi();" value="<?php echo $_SESSION['Net_Salary'];?>"  /></td>
          <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="15">&nbsp;</td>
              <td width="4">&nbsp;</td>
              <td width="93" class="hdtext-car-formsub">Loan Amount</td>
              <td width="151"><input type="text" name="Loan_Amount" id="Loan_Amount" class="hdtext-input-car" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" tabindex="8"  value="<?php echo $_SESSION['Loan_Amount'];?>" /></td>
            </tr>
          </table></td>
        </tr>
        <tr>
...
<input name="mm" id="mm" type="text" maxlength="2" style="color:#888;" class="hdtext-dd-inputb-car" onChange="intOnly(this);" onKeyUp="intOnly(this); swtchToNextTab_mm();" onKeyPress="intOnly(this);" onBlur="inputBlur(this); onBlurDefault(this,'MM');" onFocus="inputFocus(this); onFocusBlank(this,'MM');" tabindex="10" value="<?php if(strlen($_SESSION['mm'])>0) { echo $_SESSION['mm']; } else {?>MM<?php } ?>"/> <input name="yyyy" id="yyyy" type="text" maxlength="4" style="color:#888;" class="hdtext-yy-inputb-car" onChange="intOnly(this);" onKeyUp="intOnly(this); swtchToNextTab_yyyy();" onKeyPress="intOnly(this);" onBlur="inputBlur(this); onBlurDefault(this,'YYYY');" onFocus="inputFocus(this); onFocusBlank(this,'YYYY');" tabindex="11" value="<?php if(strlen($_SESSION['yyyy'])>0) { echo $_SESSION['yyyy']; } else {?>YYYY<?php } ?>"/>
          ...
          <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="151" class="hdtext-car-formsub"><input type="radio" name="Gender" id="Gender" value="Male" checked tabindex="12" /> Male 
            <input type="radio" name="Gender" id="Gender" value="Female" tabindex="13" /> Female</td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td ><strong>
            <select name="Education" class="hdtext-select-car" tabindex="14">
...
<option value="School" <?php if($_SESSION['Education']=="School") echo "selected"; ?>>School</option>
          ...
          <td ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="138"><input type="text" name="no_dependents" id="no_dependents" onfocus="addResiField1();" class="hdtext-dependents-inputb-car" maxlength="3" tabindex="15" autocomplete="off"  value="<?php echo $_SESSION['no_dependents'];?>" /></td>
            </tr>
          </table></td>
        </tr>
      <tr>
