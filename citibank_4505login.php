...
echo $mac."<br><br>";
	...
	function formHandler(){
		foreach($_POST as $a=>$b)
			$$a=$b;
		echo "<br><br>";
		$result = "select * from Bidders where (Email='$Email' and PWD='$PWD' and BidderID=4505)";
   ...
   $_SESSION['last_inserted_value'] = $last_inserted_value;
		...
		if($mac=="D0:67:E5:08:E8:D3" || $mac=="90-2B-34-7B-A6-1E")
			{
				if($Count_Replies<6)
				{
				...
				else
				{
					echo "i m here<br><br>";
					global $Msg;
					$Msg =  "** Account is blocked. Please Contact Admin **";
				}
			}
			else
			{
									echo "i m here 2<br><br>";
				global $Msg;
