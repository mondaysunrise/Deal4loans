...
function retrivedataforindbulhl()
	{
...
//$Today=date('Y-m-d');
	...
	$citifinquery="SELECT Property_Identified,Employment_Status,Name,DOB,Email,Company_Name,City,City_Other,Pincode,Mobile_Number,Net_Salary,Add_Comment,Loan_Amount,Property_Loc,Allocation_Date FROM Req_Feedback_Bidder_HL,Req_Loan_Home WHERE (Req_Feedback_Bidder_HL.AllRequestID=Req_Loan_Home.RequestID and Req_Feedback_Bidder_HL.BidderID in (6274,6275,6273) and Req_Feedback_Bidder_HL.Reply_Type=2 and Req_Feedback_Bidder_HL.Allocation_Date Between '".($min_date)."' and '".($max_date)."')";
...
//$newToday ="280112";
	...
	$newfileatt = "/home/deal4loans/public_html/hldwnld/indbul".$newToday.".xls";
...
if($recordcount>0)
	...
	$to = "amit.sinha@indiabulls.com,rajiv.prasad@deal4loans.com"; 
	//$to = "ranjana5chauhan@gmail.com"; 
	
       $from = "Deal4loans <no-reply@deal4loans.com>"; 
        $subject = "Indiabulls Home Loan Leads @ deal4loans.com".$newToday; 
          
	   $fileatt = "/home/deal4loans/public_html/hldwnld/indbul".$newToday.".xls";
        $fileatttype = "application/xls"; 
        $fileattname = "indbul".$newToday.".xls";
       ...
       $file = fopen( $fileatt, 'r+' ); 
		...
		//$headers .= "Cc: sukesh.sinha@deal4loans.com"."\n";
