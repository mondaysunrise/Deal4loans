...
if($_SERVER['REQUEST_METHOD'] == 'POST' && ($IP=="122.176.100.27" || $IP=="122.176.100.28" || $IP=="122.176.122.134" || $IP=="122.161.196.68"))
{
	$Email = "baruch_sbi_hl@d4l.com";
	$PWD = "baruch0109152";
