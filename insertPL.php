...
list($checkNum,$getCompanyQuery)=MainselectfuncNew($getCompanySql,$array = array());
$Company_Name = $getCompanyQuery[0]['company_name'];
	...
	{	$Dated = ExactServerdate();
		...
		{	
			header('Location: http://www.loansninsurances.com/get-personal-loans-continue.php?'.$request);
		}
		else
		{
			header('Location: http://www.loansninsurances.com/get-personal-loan-continue.php?'.$request);
		}
	exit();
}
