...
{
	var gifName = form;
	document.frmsearch.action="comments_admin.php?search=y"+gifName;
...
<div style="text-align:center; font-size:14px; font-weight:bold;">Comments</div>
 ...
 <? 
		...
		$sql = "select * from comments_pages where parent=0 group by Page_Name ";
...
$recordcount = mysql_num_rows($result);
 ...
 ?>	  <tr>
   ...
   <tr>
     ...
     <td width="728" align="center" bgcolor="#FFFFFF" class="style2">Page Name</td>
	 <td width="122" align="center" bgcolor="#FFFFFF" class="style2">Pending Comment</td>
      <td width="82" align="center" bgcolor="#FFFFFF" class="style2">Validate</td>
   ...
   <tr>
     <td  bgcolor="#DFF6FF" class="style3" height="25" style="padding-left:6px;" >
<?php echo str_replace("/", "", $row["Page_Name"]); ?></td>
	  <td style="padding-left:4px;" bgcolor="#DFF6FF" class="style3">
	  <?php 
	  	$getPendingSql = "select * from comments_pages where Page_Name= '".$row["Page_Name"]."' and Status=0";
	    $getPendingQuery = ExecQuery($getPendingSql);
		$countPending = mysql_num_rows($getPendingQuery);
		if($countPending>0)
		{
			echo "Pending";		
		}
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3"><a href="comments_edit.php?Rid=<?php echo $row["Rid"] ?>">Edit</a></td>
	</tr>
<?	$i=$i+1;
			}
	?>
