...
{
	var gifName = form;
	document.frmsearch.action="callers_calling_login.php?search=y"+gifName;
...
<tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#45B2D8">
			<tr><td style="padding-top:5px; padding-right:10px; font-size:13px; text-align:right;">&nbsp;&nbsp;<a  href="/callers_calling_index.php" style="color:#FFFFFF;"><b>Calling</b></a> | <a  href="/callers_calling_appointment.php" style="color:#FFFFFF;"><b>Appointment</b></a></td></tr>
      <tr>
...
<? if (((!isset($val) && $viewtexttype==1) || ($val=="Req_Loan_Personal")) || ((!isset($val) && $viewtexttype==2) || ($val=="".$val."")))
  ...
  <tr>
	...
	<h1 style="line-height:18px; " class="auto-style1">Dashboard - Login </h1>
	  </td>
  </tr>
  </table>
</td>
	...
	<? } ?>
	    <tr><td>
		<form name="frmsearch" action="callers_calling_login.php?search=y" method="post" onSubmit="return chkform();">
...
<input type="hidden" name="cmbfeedback" id="cmbfeedback" value="Appointment" />
  ...
  <tr>
   ...
   <select name="cmbfeedback" id="cmbfeedback" class="input-lead">
		 ...
		 <option value="5"<?php if($varCmbFeedback==5){ echo "selected";} ?>>Logged In</option>
      <option value="4"<?php if($varCmbFeedback==4){ echo "selected";} ?>>Return To Sales</option>    
      <option value="6"<?php if($varCmbFeedback==6){ echo "selected";} ?>>Approved</option>    
            <option value="7"<?php if($varCmbFeedback==7){ echo "selected";} ?>>Disbursed</option>    
                  <option value="8"<?php if($varCmbFeedback==8){ echo "selected";} ?>>Post Login Reject</option>  
                 <option value="9"<?php if($varCmbFeedback==9){ echo "selected";} ?>>Cancelled - AUD</option>                                                           
...
<?php } ?>
     ...
     <td width="171" align="center" bgcolor="#FFFFFF" class="style2">Feedback</td>
...
<?php } ?>
	...
	?><span id="clkNum<?php echo $i; ?>" onClick="return getNumberValue(<?php echo $i; ?>,<?php echo $row["RequestID"]; ?>,<?php echo $getParameterVal; ?>)" style="cursor:hand;"><?php echo $row["City"]; ?></span><?php } else { ?><?php echo $row["City"]; ?><?php } ?></td>
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Net_Salary"]; ?></td>
	  ...
	  <td align="center" bgcolor="#DFF6FF" class="style3"><?php	echo getDocStatus($row["docStatus"]); ?></td>
		  <td align="center" bgcolor="#DFF6FF" class="style3">
          <textarea readonly cols="30" rows="3"><? echo $row["doc_pickup_remark"]; ?></textarea></td><td align="center" bgcolor="#DFF6FF" class="style3"><input type="button" name="chkCall" value="Call" onClick="checkCall(<?php echo $row['RequestID'] ?>,<?php echo $BidderIDstatic ?>)" /></td>
    </tr>
	<?		
				$i=$i+1;	
		}
