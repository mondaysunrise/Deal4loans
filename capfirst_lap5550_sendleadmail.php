...
function retrivedataforcapfirst()
	{
	...
	$stancquery="SELECT * FROM Req_Feedback_Bidder_LAP,Req_Loan_Against_Property WHERE Req_Feedback_Bidder_LAP.AllRequestID=Req_Loan_Against_Property.RequestID and Req_Feedback_Bidder_LAP.BidderID in (5528,5529,5530,5531,5532,5533,5534,5535,5536,5537,5538,5539,5540,5541,5542,5543,5544,5545,5550) and Req_Feedback_Bidder_LAP.Reply_Type=5 and Req_Feedback_Bidder_LAP.Allocation_Date Between '".($min_date)."' and '".($max_date)."'  ";
	...
	$newfileatt = "/home/deal4loans/public_html/lapdwnld/capfirst5550".$newToday.".xls";
...
if($recordcount>0)
	...
	function sendexcelfileattachment($emailid,$session_id)
	{
	    ...
	    $fileatt = "/home/deal4loans/public_html/lapdwnld/capfirst5550".$newToday.".xls";
        $fileatttype = "application/xls"; 
        $fileattname = "capfirst5550".$cityname."".$newToday.".xls";
