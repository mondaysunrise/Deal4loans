...
<title>PNB Housing Finance | PNB Housing Loan | PNB Home Loan</title>
<meta name="keywords" content="PNB Housing finance Home loans India, Apply PNB Home Loans, Compare PNB Home Loans in Mumbai Hyderabad Pune kolkata Delhi Noida Bangalore">
          ...
          <tr>
            <td colspan="4"><table width="99%"  border="0"   cellpadding="0" cellspacing="0">
              <tr>
			   ...
			   <tr>
                <td height="25"  style=" padding-left:10px; " ><div style="color:#5e5e5e; font-size:13px; font-weight:bold;line-height:24px;  ">Features & Benefits of PNB Housing Finance Home Loan | PNB Home Loan</div></td>
              </tr>
              <tr>
                  ...
                  <tr>
                    <td ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="623"><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Purchase/ Construction of House/ Flat from Punjab National Bank Home loans</div></td>
                      </tr>
                      <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Fixed rate schemes for 3-5 years.</div></td>
                      </tr>
					   <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">No prepayment charges.
</div></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  "> Lowest rates from 10.50% - 12%.</div></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
			...
			<ul>
			  <li>
                <div align="center" class="orgtext" style="width:280px;"><img  src="new-images/hl/slider/pnb-hllogo.jpg" alt="PNB Housing Finance" width="218"  height="47" style="border:none;"/><br>
                  PNB Housing Finance </div>
			    <div align="center" class="orgtext" style="width:130px;"><img   src="new-images/hl/slider/icici-bank-h.jpg" alt="ICICI Bank Home Loan" width="128" height="47" style="border:none;"/><br>
			      ICICI Bank Home Loan</div>
			    <div align="center" class="orgtext" style="width:130px;"><img  src="new-images/hl/slider/hdrc-ltd.jpg" alt="HDFC Ltd" width="128" height="47"  style="border:none;"/><br>
			      HDFC Ltd</div>
			    </li>
			  <li>
...
<div align="center" class="orgtext"><img   src="new-images/hl/slider/bank-india.jpg" alt="Bank of India" width="128" height="47" style="border:none;"/><br> 
  Bank of India </div>
  <div align="center" class="orgtext"><img  src="new-images/hl/slider/lic-housing.jpg" alt="PNB Housing Finance" width="128" height="47"  style="border:none;"/><br>
PNB Housing Finance</div>
...
HDFC Ltd</div>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="new-images/hl/pnbfrm-hdng.jpg" width="289" height="88" /></td>
              </tr>
              <tr>
                <td valign="top" style="border-left:1px solid #c2c2c2; border-right:1px solid #c2c2c2; padding-top:15px;">
				<form name="home_loan" action="pnb-home-loan-apply-continue.php" onSubmit="return submitform(document.home_loan);" method="post">
                            <table width="93%" border="0" align="right" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td class="bldtxt"><font class="style4">+91</font>
                                    <input type="text"  style="width:113px;" maxlength="10"  name="Phone" id="Phone"  onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();">
                                </td>
                              </tr>
                             <tr>
		  <td colspan="2"><div id="myDiv" style="color:#7d0606; font-family:Verdana; font-size:11px;"></div></td>
                              ...
                              <tr>
                                ...
                                <td class="bldtxt"><input class="style4" style="width:140px;" name="Email" id="Email" onBlur="onBlurDefault(this,'Email Id');"  onFocus="removetooltip();"  onChange="insertData();">                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td class="bldtxt"><input disabled value="Other City"  onfocus="onFocusBlank(this,'Other City');" name="City_Other" id="City_Other" style="width: 140px;"  onBlur="onBlurDefault(this,'Other City');" onKeyUp="searchSuggest();" />
                              ...
                              <tr>
                                ...
                                <td class="bldtxt"><input   name="Loan_Amount"  id="Loan_Amount" onFocus="this.select();" onChange="intOnly(this);"  onKeyUp="intOnly(this); getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onKeyPress="intOnly(this); getDigitToWords('Loan_Amount', 'formatedlA','wordloanAmount');" style="width:140px;" onKeyDown="getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onBlur="getDigitToWords('Loan_Amount', 'formatedlA', 'wordloanAmount'); onBlurDefault(this,'Loan Amount');">
                                   <input type="hidden" name="referrer" value="<? echo $_REQUEST['referrer'] ?>">
                                    ...
                                    <input type="hidden" name="source" value="HLPNB">
...
I authorize Deal4loans.com & its partnering banks to contact me to explain the product & I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.<br></td>
							  ...
							  <tr>
             <td height="22"  colspan="4" align="left" class="frmbldtxt" style="font-weight:normal; "><div id="hdfclife"></div></td>
			  </tr>
                              <tr>
