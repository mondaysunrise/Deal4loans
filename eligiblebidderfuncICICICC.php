...
{   
	...
	$mvarCity = $strCity;
	$mvarType = 4;
   $qry = "SELECT * FROM Bidders_List WHERE (Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and BidderID in (3662,3663,3664,3665,3666,3778,3820,3821,3822,3823,4499,4500,4501,4502,4503,4905))";
	...
	$Total4LifeTime = $row_result_LT[0]['SumLifeTime'];
		...
		$query = str_replace("and Req_Credit_Card.lead_cost=1", "", $query);
