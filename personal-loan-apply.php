...
<title>Apply Personal Loan - Deal4loans</title>
...
<div  class="content-deal">The one-stop shop for best on all Personal loan requirements
 Now get Offers from <font color="#4C2306">All major banks   </font>and choose the best deal!</div>
...
<input type="hidden" name="source" value="personalloan"> 
...
<div class="form-bg"><span class="form-text">Full Name</span> <input name="Name" type="text" <? if(isset($loan_type)) { ?>value="<? echo $name; ?>" <? }else {?>value="Name"<? }?> id="Name" style="margin-left:60px; width:140px; margin-top:2px;" onBlur="onBlurDefault(this,'Name');"  onFocus="onFocusBlank(this,'Name');" onchange="insertData();"/></div>
	...
	<div class="form-bg" style="vertical-align:top;">
	 <div style="width:319px;display:block; height:22px; margin:0px; padding-bottom:12px;"><span class="form-text">City</span> <select style="width:142px; margin-left:100px; height:18px; margin-top:2px; "  name="City" id="City" onchange="othercity1(this); insertData(); "  >
        <?=plgetCityList($City)?>
      </select></div>
</div>
	...
	<div class="form-bg"><span class="form-text">Employment Status</span>
	  <select   style="width:140px; margin-left:0px; margin-top:2px; height:18px; "  name="Employment_Status" id="Employment_Status" >
	...
	<div class="form-bg">Annual Income
...
<div style="margin-left:15px; margin-bottom:8px; font-size:9px;"><input type="checkbox" class="style4" name="accept" style="border:none;"  > I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a></div>
