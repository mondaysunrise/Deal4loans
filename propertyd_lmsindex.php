...
{
	var gifName = form;
	document.frmsearch.action="propertyd_lmsindex.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="propertyd_lmsindex.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
 ...
 <td width="30%" valign="middle" class="style1">Feedback:</td>
   ...
   <tr>
	...
	if(strlen(trim($RequestID))>0)
	{
		...
		{
			$strSQL="Insert into Req_Feedback(AllRequestID, BidderID, Feedback) Values (";
			$strSQL=$strSQL.$RequestID.",".$_SESSION['BidderID'].",'".$Feedback."')";
		}
 ...
 <? 
		...
		$search_qry="SELECT * FROM property_deal_leads LEFT OUTER JOIN Req_Feedback ON Req_Feedback.AllRequestID=property_deal_leads.prprtydl_id AND Req_Feedback.BidderID= '".$_SESSION['BidderID']."' WHERE ( property_deal_leads.prprtydl_dated  Between '".($min_date)."' and '".($max_date)."') ";	
		$search_qry=$search_qry.$FeedbackClause;
		$search_qry=$search_qry."group by ".$val."prprtydl_mobile_no";
		$search_qry=$search_qry." order by ".$val."prprtydl_dated DESC";

		$qry="SELECT * FROM property_deal_leads LEFT OUTER JOIN Req_Feedback ON Req_Feedback.AllRequestID=property_deal_leads.prprtydl_id AND Req_Feedback.BidderID= '".$_SESSION['BidderID']."' WHERE ( property_deal_leads.prprtydl_dated  Between '".($min_date)."' and '".($max_date)."') ";
			$qry=$qry.$FeedbackClause;
		$qry=$qry."group by ".$val."prprtydl_mobile_no";
 ...
 ?>
   ...
   <tr>   
	 ...
	 <td width="149" align="center" bgcolor="#FFFFFF" class="style2">Email</td>
     ...
     <td width="91" align="center" bgcolor="#FFFFFF" class="style2">DOB</td>
	...
	<?
		...
		$qry=$qry.$FeedbackClause;
		$qry=$qry."group by ".$val."prprtydl_mobile_no";
		$qry=$qry." order by ".$val."prprtydl_dated DESC";
...
//echo $qry;
   ...
   <tr> 
     <td align="center" bgcolor="#DFF6FF" class="style3" ><? echo $row["prprtydl_name"]; ?></td>
	 <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["prprtydl_email"]; ?></td>
	 <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["prprtydl_city"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["prprtydl_mobile_no"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["prprtydl_dob"]; ?></td>
	  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo getJumpMenu("propertyd_lmsindex.php",$row["prprtydl_id"],"1",$row["Feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val) ?>
 ...
 <br>
 <form name="frmdownload" action="propertyd_download.php" method="post"> 
