...
<tr>
 ...
 <table  width="90%" cellpadding="0" cellspacing="0">
   <tr>
     <td valign="middle" colspan="3" class="upoadtext" align="right"> <a href="bidders_update_feedback_ref.php">Back</a> </td>
       </tr>
   <tr>
   ...
   <tr>
     ...
     include 'reader.php';
  		...
  		function getLeadBidderID($id)
		{
    	 ...
    	 $getBidderIDSql = "select BidderID from Bidders where Global_Access_ID in (".$BidderIDstatic.") and Global_Access_ID>100";
