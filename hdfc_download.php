<?
	...
	list($numRows,$row)=MainselectfuncNew($qry1,$array = array());

	for($ii=0;$ii<$numRows;$ii++)
	{
		$dataInsert = array('session_id'=>$session_id, 'name'=>$row[$ii]["hdfclife_name"], 'email'=>$row[$ii]["hdfclife_email"], 'dob'=>$row[$ii]["hdfclife_dob"], 'city'=>$row[$ii]["hdfclife_city"], 'mobile_number'=>$row[$ii]["hdfclife_mobile_number"], 'doe'=>$row[$ii]["hdfclife_dated"], 'net_salary'=>$row[$ii]["hdfclife_income"]);
		$result1 = Maininsertfunc ("temp", $dataInsert);
	}
