...
{
	var gifName = form;
	document.frmsearch.action="bidders_fulmlrview.php?search=y"+gifName;
...
<tr><td>&nbsp;</td></tr>
 ...
 <form name="frmsearch" action="bidders_fulmlrview.php?search=y" method="post" onSubmit="return chkform();">
 ...
 <? 
	$search_qry="SELECT *  FROM fullerton_exclusivecamp where ((Dated  Between '".($min_date)."' and '".($max_date)."') and Bidderid_Details='".$_SESSION['BidderID']."' )";
		...
		$qry="SELECT RequestID FROM fullerton_exclusivecamp where ((Dated  Between '".($min_date)."' and '".($max_date)."') and Bidderid_Details='".$_SESSION['BidderID']."' )";
 ...
 <td width="71" align="center" bgcolor="#FFFFFF" class="style2">Feedback</td>
	...
	<?
		...
		$qry="SELECT * FROM fullerton_exclusivecamp where ((Dated  Between '".($min_date)."' and '".($max_date)."') and Bidderid_Details='".$_SESSION['BidderID']."' )";
		$qry=$qry.$FeedbackClause;
		$qry=$qry."group by fullerton_exclusivecamp.Mobile_Number";
...
//echo $qry."<br>";
   ...
   <tr>  
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3"><? if($row["Employment_Status"]==0) { echo "Self Employed"; } else { echo "Salaried"; }?></td> 
   	    ...
   	    <td align="center" bgcolor="#DFF6FF" class="style3"><? echo getJumpMenu("bidders_fulmlrview.php",$row["RequestID"],"1",$row["Feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val) ?>		</td>
	<!--<td align="center" bgcolor="#DFF6FF" class="bodyarial11" ></td>-->  </tr>
	<?
				$i=$i+1;
		}
	?>
