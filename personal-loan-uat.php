...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source']; }else{	$retrivesource="Cibil_UAT";}
?>
<!DOCTYPE html>
<html>
<head>
...
$TypeLoan = "Req_Loan_Personal";
 include "personal-loan-widget-uat.php"; ?>
  </div></div>
...
<td style="text-align: center;">10.99% - 14.50%</td>
<td style="text-align: center;">ZERO for ALL</td>
