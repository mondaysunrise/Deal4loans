...
//$ProductValue=580954;
$getValuesQuery= ("select * from Req_Loan_Personal Where (RequestID='".$ProductValue."')");
...
$Employment_Status = $getValuesQuery[0]['Employment_Status'];
	...
	$getAppcodeSql = ("SELECT AppID FROM `pl_icici_leads` WHERE 1 =1 ORDER BY `RequestID` DESC LIMIT 0 , 1");
	...
	$dtSql = "SELECT Allocation_Date as Dated FROM Req_Feedback_Bidder1 WHERE AllRequestID ='".$ProductValue."'"; 
	list($recordcount,$dtQuery)=MainselectfuncNew($dtSql,$array = array());

	$Dated = $dtQuery[0]['Dated'];
...
//Page 1 Start
include "iciciPDF1.php";
//Page 1 End

$msg .="</td></tr>";
$msg .= "<tr>  <td width='850' align='left' valign='middle'>";
//Page2 Start
include "iciciPDF2.php";
//Page 2 End
$msg .="</td></tr>";
$msg .="</table></body>";
...
$files_to_zip = array($fileName1, 'pdf/frmprt2.pdf');
