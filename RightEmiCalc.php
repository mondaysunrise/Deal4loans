...
<div style="float:right; clear:right; background-color:#dde4e9; width:335px;  margin-top:18px;">
<div class="text3" style="width:335px; margin:auto; height:auto; font-size:11px; color:#88a943; margin-top:0px;">
<table align="center">
<tr><td align="right" style="color:#000000;">
...
<tr>
<td><div id="tblpaymentsDetails" align="center" style="color:#000000;"><table align="center" cellpadding="0" cellspacing="0">
  <tr>
  <td>
...
<tr>
	...
	<td  align="left" valign="top" width="270" bgcolor="#21405F">
		<table width="270" border="0" cellpadding="0" cellspacing="3" align="center">
		<tr>
...
<div class="text11" style="width:210px; margin:auto; height:auto;  color:#4c4c4c; margin-top:1px; text-align:left;">( Last edited on :  <? $tomorrow  = mktime(0, 0, 0, date("m")  , date("d")-1, date("Y"));
echo $currentdate=date('d M Y',$tomorrow);
?>
</div>
<div style="clear:both; height:5px;"></div>
<table border="0" cellpadding="0" cellspacing="1" bgcolor="#e0eaf1" align="center">
                <tr>
...
<div class="text11" style="width:210px; margin:auto; height:auto;  color:#4c4c4c; margin-top:px; text-align:left;">( Last edited on : <? $tomorrow  = mktime(0, 0, 0, date("m")  , date("d")-1, date("Y"));
echo $currentdate=date('d M Y',$tomorrow); ?> )</div>
<div style="clear:both; height:3px;"></div>
