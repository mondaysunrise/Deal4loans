...
{
	var gifName = form;
	document.frmsearch.action="sbihl_callingview_int.php?search=y"+gifName;
...
<table width="100%" border="0"  align="center" cellpadding="0" cellspacing="0" >
    ...
    <td align="center">
			...
			<td style="padding-top:10px;">
				...
				?>
					<tr>
						...
						<td width="104" height="20" align="right" bgcolor="#45B2D8">
							<a href="/sbihl_callingview_callerint.php" target="_blank"><b>Caller LMS</b></a>
						</td>
						<td width="200" height="20" align="right" bgcolor="#45B2D8">
							<a href="/sbi_hllms_internal_refer_form.php" target="_blank"><b>Internal Reference Form</b></a>
						</td>
					</tr>
				</table>
			</td>
	    ...
	    <tr>
		<td>
		<form name="frmsearch" action="sbihl_callingview_int.php?search=y" method="post" onSubmit="return chkform();">
		<div class="wrapper-leads">   
            ...
            <div class="div-lead-left">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="40%" class="style1">ASM Wise</td>
						<td width="60%"><? 
			...
			<div class="div-lead-left-smallest">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="40%" class="style1">ASM Feedback</td>
						<td width="60%">
