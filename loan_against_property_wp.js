...
function cityother()
{
	if(document.lap_loan_form.City.value=="Others")
	{
		document.lap_loan_form.City_Other.disabled = false;
	}
	else
	{
		document.lap_loan_form.City_Other.disabled = true;
	}
}
function validmobile(mobile) 
{
	...
	if(!checkData(document.lap_loan_form.Phone, 'Mobile number', 10))
		return false;
...
{
	if(document.lap_loan_form.Email.value!="")
	{
...
function chkform()
{
	...
	if (document.lap_loan_form.Loan_Amount.value=="")
	{
		document.getElementById('loanAmtVal').innerHTML = "<span  class='hintanchor'>Enter Loan Amount!</span>";
		document.lap_loan_form.Loan_Amount.focus();
		return false;
	}
	
	if (document.lap_loan_form.Employment_Status.selectedIndex==0)
	{
		alert("Please enter Employment Status to Continue");
		document.lap_loan_form.Employment_Status.focus();
		return false;
	}	
	if(document.lap_loan_form.Net_Salary.value=="")
	{
		document.getElementById('netSalaryVal').innerHTML = "<span  class='hintanchor'>Enter Annual Income!</span>";	
		document.lap_loan_form.Net_Salary.focus();
		return false;
	}
					
	if (document.lap_loan_form.City.selectedIndex==0)
	{
		document.getElementById('cityVal').innerHTML = "<span  class='hintanchor'>Enter City to Continue!</span>";	
		document.lap_loan_form.City.focus();
		return false;
	}
	
	if(document.lap_loan_form.FName.value=="")
	{
		document.getElementById('nameVal').innerHTML = "<span  class='hintanchor'>Please Enter Your name</span>";		
		document.lap_loan_form.FName.focus();
		return false;
	}
	 if(document.lap_loan_form.FName.value!="")
	{
	 if(containsdigit(document.lap_loan_form.FName.value)==true)
	{
	   document.getElementById('nameVal').innerHTML = "<span  class='hintanchor'>Please Enter Your name</span>";		
		document.lap_loan_form.FName.focus();
	return false;
  ...
  for (var i = 0; i <document.lap_loan_form.FName.value.length; i++) {
  	if (iChars.indexOf(document.lap_loan_form.FName.value.charAt(i)) != -1) {
	...
	if(document.lap_loan_form.Phone.value=="")
	{
		document.getElementById('phoneVal').innerHTML = "<span  class='hintanchor'>Fill Mobile Number!</span>";
		document.lap_loan_form.Phone.focus();
		return false;
	}
	if(isNaN(document.lap_loan_form.Phone.value)|| document.lap_loan_form.Phone.value.indexOf(" ")!=-1)
	{
		document.getElementById('phoneVal').innerHTML = "<span  class='hintanchor'>Enter numeric value!</span>";
		document.lap_loan_form.Phone.focus();
		return false;  
	}
	if (document.lap_loan_form.Phone.value.length < 10 )
	{
	  	document.getElementById('phoneVal').innerHTML = "<span  class='hintanchor'>Enter 10 Digits!</span>";	
		document.lap_loan_form.Phone.focus();
		return false;
	}
	if ((document.lap_loan_form.Phone.value.charAt(0)!="9") && (document.lap_loan_form.Phone.value.charAt(0)!="8") && (document.lap_loan_form.Phone.value.charAt(0)!="7"))
	{
	...
	if(document.lap_loan_form.Email.value=="")
	{
		...
		document.lap_loan_form.Email.focus();
		return false;
	}
	
	var str=document.lap_loan_form.Email.value
	var aa=str.indexOf("@")
	var bb=str.indexOf(".")
	...
	if(document.lap_loan_form.day.value=="" || document.lap_loan_form.day.value=="dd")
	{
		document.getElementById('dobVal').innerHTML = "<span  class='hintanchor'>Fill Day of Birth!</span>";
		document.lap_loan_form.day.focus();
		return false;
	}
	if(document.lap_loan_form.day.value!="")
	{
		if((document.lap_loan_form.day.value<1) || (document.lap_loan_form.day.value>31))
		{
	...
	if(!checkData(document.lap_loan_form.day, 'Day', 2))
		return false;
	
	if(document.lap_loan_form.month.value=="" || document.lap_loan_form.month.value=="mm")
	{
		document.getElementById('dobVal').innerHTML = "<span  class='hintanchor'>Fill month of Birth!</span>";
		document.lap_loan_form.month.focus();
		return false;
	}
	if(document.lap_loan_form.month.value!="")
	{
		if((document.lap_loan_form.month.value<1) || (document.lap_loan_form.month.value>12))
		{
	...
	if(!checkData(document.lap_loan_form.month, 'month', 2))
		return false;

	if(document.lap_loan_form.year.value=="" || document.lap_loan_form.year.value=="yyyy")
	{
		document.getElementById('dobVal').innerHTML = "<span  class='hintanchor'>Fill Year of Birth!</span>";
		document.lap_loan_form.year.focus();
		return false;
	}
	if(document.lap_loan_form.year.value!="")
	{
		if((document.lap_loan_form.year.value < maxage) || (document.lap_loan_form.year.value >minage))
		{
	...
	if(!checkData(document.lap_loan_form.year, 'Year', 4))
		return false;
	

	if((document.lap_loan_form.City.value=="Others") && ((document.lap_loan_form.City_Other.value=="" || document.lap_loan_form.City_Other.value=="Other City"  ) || !isNaN(document.lap_loan_form.City_Other.value)))
	{
		document.getElementById('othercityVal').innerHTML = "<span  class='hintanchor'>Enter Other City to Continue!</span>";		
		document.lap_loan_form.City_Other.focus();
		return false;
	}
	for (var i = 0; i <document.lap_loan_form.City_Other.value.length; i++) {
  	if (iChars.indexOf(document.lap_loan_form.City_Other.value.charAt(i)) != -1) {
	...
	if (document.lap_loan_form.Pincode.value=="")
	{
		document.getElementById('pincodeVal').innerHTML = "<span  class='hintanchor'>Enter Pincode!</span>";	
		document.lap_loan_form.Pincode.focus();
		return false;
	}
	if (document.lap_loan_form.Pincode.value!="")
	{
		if(document.lap_loan_form.Pincode.value.length < 6)
		{
...
if((document.lap_loan_form.Company_Name.value=="") || (document.lap_loan_form.Company_Name.value=="Company Name"))
	{
		document.getElementById('companyNameVal').innerHTML = "<span  class='hintanchor'>Fill Company Name!</span>";	
		document.lap_loan_form.Company_Name.focus();
		return false;
	}
	else if(document.lap_loan_form.Company_Name.value.length < 3)
	{
		document.getElementById('companyNameVal').innerHTML = "<span  class='hintanchor'>Fill Company Name!</span>";	
		document.lap_loan_form.Company_Name.focus();
		return false;
	...
	if (document.lap_loan_form.Property_Value.value=="")
	{
		document.getElementById('propertyVal').innerHTML = "<span  class='hintanchor'>Enter Property Value!</span>";
		document.lap_loan_form.Property_Value.focus();
		return false;
	}	
		
	if(!document.lap_loan_form.accept.checked)
	{
		document.getElementById('acceptVal').innerHTML = "<span  class='hintanchor'>Read and Accept Terms & Conditions!</span>";	
		document.lap_loan_form.accept.focus();
		return false;
	}
...
function addhdfclife()
{
	...
	var cit = document.lap_loan_form.City.value;
	var otrcit = document.lap_loan_form.City_Other.value;
	//alert(cit);	
