...
<input type="hidden" name="section" id="section" value="<? echo $_REQUEST["section"]; ?>" />
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" >
  ...
  <ul>
<li>Reduce your interest on Credit Cards debts<br/></li></ul>  
<div style="clear:both;"></div>
  ...
  <tr>
    <td bgcolor="#E9E9E9" scope="row"><table border="0" cellspacing="1" cellpadding="2" width="100%">
          <tr>
            ...
            <td width="271" height="30" align="center" valign="middle" bgcolor="#5faddd" style="color:#FFF;">Flexi    Loan Account Repayment</td>
            <td width="332" height="30" align="center" valign="middle" bgcolor="#5faddd" style="color:#FFF;">Normal 
              Credit Card Debt 
              Repayment</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">Loan    Amount</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">100000</td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">100000</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">ROI</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">15.25%</td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">36.00%</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">Tenor    (In Months)</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">48</td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">48</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">Part    Prepayment (3rd&nbsp;Month)</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">30000</td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">30000</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">Withdrawal    (4th&nbsp;month)</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">10000</td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">10000</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">Part    Pre Payment (8th&nbsp;month)</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">25000</td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">25000</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">Withdrawal    (9th&nbsp;Month)</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">15000</td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">15000</td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;">Total    Interest Paid</td>
            <td width="271" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;"><strong>30,950</strong></td>
            <td width="332" height="15" align="center" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;"><strong>79,856</strong></td>
          </tr>
          <tr>
            <td width="319" height="15" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:13px; color:#0199cd;"><strong>Net    Savings (Per Lac)</strong></td>
            <td height="15" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF" style="color:#090 !important; font-family:Verdana, Geneva, sans-serif; font-size:13px;"><strong>48,906</strong></td>
          </tr>
          <tr>
            <td width="319" height="15" align="left" valign="middle" bgcolor="#FFFFFF" style="font-family:'Raleway'; font-size:11px; color:#0199cd; font-weight:600;" ><strong>Interest    Saved (In %)</strong></td>
            <td height="15" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF" style="color:#090; font-family:Verdana, Geneva, sans-serif; font-size:13px; color:#0199cd;"><strong>61%</strong></td>
          </tr>
        </table></td>
  </tr>
</table>
