...
if($ProductType==3)
			{
$InsertFeedBackSqlCL = "Insert into Req_Feedback_Bidder_CL1 (AllRequestID,BidderID,Reply_Type,Allocation_Date) Values ('$LeadID', '$BiddersValue[$l]','$ProductType', Now())";
...
$InsertFeedBackSqlCC = "Insert into Req_Feedback_Bidder_CC (AllRequestID,BidderID,Reply_Type,Allocation_Date) Values ('$LeadID', '$BiddersValue[$l]','$ProductType', Now())";
	...
	if($ProductType==5)
			{
$InsertFeedBackSqlCC = "Insert into Req_Feedback_Bidder_LAP (AllRequestID,BidderID,Reply_Type,Allocation_Date) Values ('$LeadID', '$BiddersValue[$l]','$ProductType', Now())";
	$InsertFeedBackResultCC = ExecQuery($InsertFeedBackSqlCC);
		}
...
$dateFormat15min = date("j M y g:i A", $aheadTime);
	$Message="<table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' style='border:1px ridge #0099FF;'>  <tr>    <td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='40%' valign='top'></td><td width='60%' align='right' style='padding-top:5px;'><img src='http://www.deal4loans.com/images/cc/crdt-crd-logo.gif'  /><br />  <span style='font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 10px; color:#0A71D9;'>Loans by Choice not by Chance!</span></td></tr></table></td></tr><tr><td style='font-family:Verdana; font-size:12px; color:#333333; padding-top:20px; padding-left:10px; padding-right:10px;'><p><b>Dear ".$full_name.",</b></p>
Thank you for choosing Deal4loans.com, we are pleased to inform you that your registration for Car Loan has been successful. By giving a consent on application form and you have authorized below mentioned banks/agents to call you on <$mobile_no> even if your number is registered with DNC or DND.<br /><br /> 
...
1) Compare exact Emi|Processing fee | Tenure | Documents before choosing bank.<br />
2) Never pay any fee to any person to get loan sanctioned.Pr ocessing fee are deducted from Loan amount.<br />
3) Only give documents to one bank and check whether he is authorized Bank employee or vendor.<br /><br />
...
$Message.="<tr><td style='font-family:Verdana; font-size:10px; color:#333333; padding-top:15px ;padding-bottom:15px; padding-left:10px; padding-right:10px;'><a href='http://www.deal4loans.com/thanks-customer-consent.php?request_id=".$CustomerID."&noreqd_banks=".$BidCL2."' style='text-decoration:none;'>Deactivate your request for ".$ExpBidderName[$m2]."</a></td></tr>";
			}
...
//		echo $SMSMessage.$SMSMessageBidders."<BR>";
		...
		{
	//		SendSMS($SMSMessage.$SMSMessageBidders, $Phone);   By Upendra
		}
	...
	if(strlen(trim($sms_4barclays))>0)
	{
		...
		if(strlen(trim($Phone)) > 0)
		{
//			SendSMS($sms_4barclays, $Phone);By Upendra
		}
	...
	if(strlen(trim($sms_4barclaysBid))>0)
	{
		...
		{
//			SendSMS($sms_4barclaysBid, $bdPhone);   By Upendra
