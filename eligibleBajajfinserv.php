<?php
function getBiddersList($strRequestID,$strCity,$strBidderID)
{   
    $RequestID = $strRequestID;
	$mvarCity = $strCity;
	$mvarType = 2;
   // $mvarType = getCodeValue("ReplyType_$strProduct");
	 $qry = "SELECT * FROM Bidders_List WHERE Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and BidderID='".$strBidderID."'";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $City = trim($row["City"]);
		...
		$qry2 = str_replace("!=","=",$qry2);
		$qry2 = str_replace("Req_Loan_Home","Req_Bajaj_HomenBT",$qry2);	
