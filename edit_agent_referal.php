<?php
	...
	$sql = "select * From Req_Partner Where Partner_ID='".$AgentID."'";
	$query = ExecQuery($sql);
	
	$Name = mysql_result($query,0,'Partner_Name');
	$Phone = mysql_result($query,0,'Partner_Mobile');
	$Email = mysql_result($query,0,'Partner_Username');
	$City = mysql_result($query,0,'Partner_City');
	$City_Other = mysql_result($query,0,'Partner_City_Other');
	$pwd = mysql_result($query,0,'Partner_Password');
?>
  ...
  <Script Language="JavaScript">
   function validateMe(theFrm){
	...
	var str=theFrm.Email.value
		...
		else if((theFrm.City.value=='Others')  && ((theFrm.City_Other.value=='')||!isNaN(theFrm.City_Other.value)||(theFrm.City_Other.value=="Other City")))
		{
	...
	function othercity1()
	{
		if(document.rm_form.City.value=='Others')
		{
			document.rm_form.City_Other.disabled=false;
		}
		else
		{
			document.rm_form.City_Other.disabled=true;
		}
	}
...
<table width="438"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
			...
			<tr align="left">
				  <td height="58" colspan="2" align="center" background="images/logintop_bg.gif"><h1>Agent Registration</h1></td>
				  </tr>
              ...
              <tr>
                <td valign="top"  background="images/login-form-login-bg.gif" ><form name="rm_form"  action="edit_agent_referal_continue.php" method="POST" onSubmit="return validateMe(this);">
<input name="Partner_ID" type="hidden" id="Partner_ID" value="<?php echo $AgentID; ?>" />
<table width="95%"  border="0" align="right" cellpadding="0" cellspacing="0"  >
			
				<tr align="left">
				  <Td width="14%" class="frmbldtxt">&nbsp;</Td>
				<Td width="35%" height="27" class="frmbldtxt">Full Name </Td>
 				<Td width="51%"><input name="Name" type="text" id="Name" style=" width:140px;" onBlur="onBlurDefault(this,'Name');"  onFocus="onFocusBlank(this,'Name');"  value="<?php echo $Name; ?>" /></Td>
				</tr>
				<tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">Email Id </Td>
				  <Td><input name="Email" id="Email" type="text" style="width:140px; "  onblur="onBlurDefault(this,'Email Id');"  value="<?php echo $Email; ?>" /></Td>
				  </tr>
                <tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">Mobile No. </Td>
				  <Td class="frmbldtxt">+91 
	  <input name="Phone" id="Phone" type="text" style="width:111px; " onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"  maxlength="10"  /  value="<?php echo $Phone; ?>" ></Td>
				  </tr>
<tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">City</Td>
				  <Td>
                  <select style="width:144px; "  name="City" id="City" onChange="othercity1(this);" >
			        	<?=plgetCityList($City)?>
		     	  </select>
				  </Td>
				  </tr>
				  ...
				  <Td><input name="City_Other" id="City_Other" type="text" value="Other City" style="width:140px; " onBlur="onBlurDefault(this,'Other City');"  onfocus="onFocusBlank(this,'Other City');" disabled  /></Td>
                   ...
                   <tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">Password</Td>
				  <Td><input name="pwd" id="pwd" type="text" style="width:140px; "  onblur="onBlurDefault(this,'Email Id');"  value="<?php echo $pwd; ?>" /></Td>
				  </tr>		
                  <tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">Product</Td>
				  <Td class="frmbldtxt">
                  <input type="hidden" name="product[]" value="Personal Loan"  >
                  <input type="checkbox" value="Personal Loan" checked disabled > Personal Loan
                  </Td>
				  </tr>		
        		<tr align="left">
				<td>&nbsp;</td>
				...
				<tr align="center" valign="middle">
                  ...
                  <input type="image" name="Submit"  src="images/submit.jpg"  style="width:50px; height:18px; border:none; " /></Td>
				  </tr>
                </table>
				</form>
					</td>
