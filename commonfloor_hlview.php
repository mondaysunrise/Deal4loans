...
{
	var gifName = form;
	document.frmsearch.action="commonfloor_hlview.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="commonfloor_hlview.php?search=y" method="post" onSubmit="return chkform();">
 ...
 <? 
 $comp_source="commonfloor";
	if($comp_source=="commonfloor")
		{
			$qry2="SELECT * from commonfloor_hlcampaign Where (cf_dated between '".$min_date."' and '".$max_date."')";
			$qry2=$qry2." group by cf_mobile_number 	 ";
		}
		else
		{
			echo "PLease Login Again";
		}
list($recordcount,$result2)=MainselectfuncNew($qry2,$array = array());
...
<td width="141" align="center" bgcolor="#FFFFFF" class="style2">Mobile Number</td>
...
<td width="141" align="center" bgcolor="#FFFFFF" class="style2">Property Value</td>
<td width="141" align="center" bgcolor="#FFFFFF" class="style2">Date</td>
  </tr>
  <?  
	 $qry="SELECT * from commonfloor_hlcampaign Where (cf_dated between '".$min_date."' and '".$max_date."')";
$qry=$qry." group by cf_mobile_number  LIMIT $startrow, $pagesize";
list($row2count,$row2)=MainselectfuncNew($qry,$array = array());		
...
if($recordcount>0)
		{
for($ii=0;$ii<$rows2count;$ii++)
		{ ?>
 <tr>
  <td width="141"align="center" bgcolor="#DFF6FF" class="style3"><? echo $row2[$ii]["cf_name"]; ?></td>
<td width="141" align="center" bgcolor="#DFF6FF" class="style3"><? echo $row2[$ii]["cf_mobile_number"]; ?></td>
<td width="141" align="center" bgcolor="#DFF6FF" class="style3"><? echo $row2[$ii]["cf_email_id"]; ?></td>
<td width="141" align="center" bgcolor="#DFF6FF" class="style3"><? echo $row2[$ii]["cf_city"]; ?></td>
<td width="141" align="center" bgcolor="#DFF6FF" class="style3"><? echo $row2[$ii]["cf_property_value"]; ?></td>
<td width="141" align="center" bgcolor="#DFF6FF" class="style3"><? echo $row2[$ii]["cf_dated"]; ?></td>
  </tr>
   <? $i=$i+1; }  
		}?>
    </table>
