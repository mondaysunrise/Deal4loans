...
<!--<script type="text/javascript" src="ajax-dynamic-oc.js"></script> -->
...
<style type="text/css">
	...
	#ajax_listOfOptionsOC div{	/* General rule for both .optionDiv and .optionDivSelected */
		margin:1px;		
		padding:1px;
		cursor:pointer;
		font-size:10px;
	...
	#ajax_listOfOptionsOC .optionDivSelectedOC{ /* Selected item in the list */
		background-color:#2375CB;
		color:#FFF;
	}

	#ajax_listOfOptions_iframeOC{
		background-color:#F00;
		position:absolute;
		z-index:5;
	}
...
<!--Database Driven -->
        ...
        <td  valign="top">
          <table width="210" align="left" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              <td height="45" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow[$cntr]["pl_bank_prepayment"];?></b> </td>
	        </tr>
            <tr>
	...
	<div style="height:30px; padding-top:10px;">Before apply for personal loan, Calculate your personal loan emi with <a href="/Contents_Calculators.php">EMI Calculator</a></div>
<div class="sldrpnl" >
	<div id="slider" >
		<ul>				
