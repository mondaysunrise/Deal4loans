...
function chgtxtsal(){
	...
	if(citemp==0){
				niadtxt.innerHTML="<table cellpadding='0' cellspacing='0' width='100%'><tr align='left'>				  <Td height='26' class='bldtxt' width='41%'>Annual Turnover </Td>				  <Td width='60%'> <select name='Annual_Turnover' id='Annual_Turnover'  style='width:140px;'>		<option value=''>Please Select</option>	<option value='1' > 0 - 40 Lacs</option>	<option value='4' > 40 Lacs - 1 Cr</option>		<option value='2' > 1Cr - 3Crs </option>	<option value='3' >3Crs & above</option>	</select></Td>				  </tr></table>"; }
		else{ niadtxt.innerHTML="";}}
	  ...
	  <input name="Phone" id="Phone" type="text"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?>style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();" maxlength="10"  /></Td>
        ...
        <option value="0">Self Employed</option>
				...
				<tr align="left">
				  ...
				  <tr align="left">
  <Td colspan="2" width="100%" id="myanualtDiv"></Td>
</tr>
				 	<tr align="left">
...
No</Td>
    ...
    <!--<tr>
            <td class="frmbldtxt" colspan="2" align="left"><input type="checkbox" name="cpp_card_protect" value="1" style="border:none;">&nbsp;Now make your wallet safe with CPP Card Protection.</td>
            </tr>-->
				<tr align="left">
