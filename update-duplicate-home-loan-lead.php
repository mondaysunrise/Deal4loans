...
$getpersonal_Lead="select Name, Employment_Status, Company_Name, City, City_Other, Mobile_Number, Net_Salary, Loan_Amount, DOB, Updated_Date,Email From Req_Loan_Home where RequestID=".$custid;
...
<h1>You have already applied with us for Home Loan
on <? echo $showDate; ?>. Your application is under process.
You will hear from our team to process your application.<br />
</h1>
<form name="loan_form" method="post" action="/duplicate-home-loan-values.php" onSubmit="return chkform();">
  ...
  <tr>
        ...
        <tr>
          <td height="74" valign="middle" background="new-images/apl-tp.gif" style="background-repeat:no-repeat;"><h1 >Your Home	 Loan Details</h1></td>
      </tr>
  <tr>
          <td valign="top" class="aplfrm" style="padding-left:30px; "><table width="380" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="30" class="frmbldtxt" style="font-weight:normal; "><b>Mobile</b></td>
