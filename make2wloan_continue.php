...
$getPageSql = "select * from city_pages where City='".$City."' and Product='2Wheeler'";
...
{
	$sql = "INSERT INTO city_pages (Product ,City ,State, Title ,MetaKeyword ,MetaDescription ,PageDescription ,HeaderDEscription ,Dated ,Status) VALUES ('2Wheeler',  '".$City."', '".$State."', '".$Title."',  '".$keyword."',  '".$metadesc."',  '".$mainDesc."', '".$header."', Now(), '1')";
	$query = ExecQuery($sql);
	//echo "<br>".$sql;
	$report = "Inserted";
...
<tr>
    <td ><div align="center">2 Wheeler Loan</div></td>
    </tr>
<tr><td>
<?php
echo $report;
...
<a href="make2wloan_index.php">Make Other Page</a>
</td></tr></table>
</body>
</html>