...
<meta name="description" content="Personal loan emi calculator tool for EMI calculation for  ✍ calculate Equated Monthly Installment (EMI) with interactive charts. Get EMI details for ✓ 1 ✓ 2 ✓ 3 ✓ 4 ✓ 5 years in seconds."/>
<?php
...
<div class="pl_emi_cal_table" style="margin-top:15px;"><table  style=' clear: both;    background: none repeat scroll 0 0 #FCFCFC; margin: 0 0 20px 0;   text-align: center; ' width="100%">
    <tr >
      ...
      <td   style='border: 1px solid #DBDAD7; background: #4572A7;	border-top: 0; width:210px; color:#FFFFFF;' ><div id="intr_text" align="center"><span style="width:170px;" align="center">Estimated EMI as Per Lac (for 5 years)</span></div></td>
    </tr>
    <tr>
      <td align="center"   class="default_td" style="height: 18px"><a href="http://www.deal4loans.com/hdfc-personal-loan-eligibility.php">HDFC Bank</a></td>
      <td align="center"  class="default_td" style="height: 18px">10.99% - 19.50%</td>
      <td align="center"  class="default_td" style="height: 18px"><div id="hdfc_bnk"><span>Rs. 2,250 - Rs. 2,301</span></div></td>
    </tr>
	<tr height="18">
      <td height="18" align="center"   class="default_td"><a href="http://www.deal4loans.com/personal-loan-icici-bank.php">ICICI Bank</a></td>
      <td align="center"  class="default_td">11% - 17.50%</td>
      <td align="center"  class="default_td"><div id="icici_bnk"><span>Rs. 2174 - Rs. 2,419</span></div></td>
    </tr>
	<tr height="18">
      <td height="18" align="center"   class="default_td"><a href="http://www.deal4loans.com/loans/personal-loan/bajaj-finserv-lending-personal-loan-eligibility-documents-interest-rates-apply/">Bajaj Finserv</a></td>
      <td align="center"  class="default_td">11.99% - 16%</td>
      <td align="center"  class="default_td"><div id="bajaj_bnk"><span>Rs. 2,224 - Rs. 2,432</span></div></td>
    </tr>
	<!--
    <tr height="18">
	...
	-->
    <tr height="18">
      <td height="18" align="center"   class="default_td"><a href="http://www.deal4loans.com/kotak-personal-loan-eligibility.php">Kotak Mahindra Bank</a></td>
      <td align="center"  class="default_td">10.99% - 17.25%</td>
      <td align="center"  class="default_td"><div id="kotak_bnk"><span>Rs. 2,224 - Rs. 2,658</span></div></td>
    </tr>
     <tr height="18">
      <td height="18" align="center"   class="default_td">Indusind Bank</td>
      <td align="center"  class="default_td">12.99% - 20%</td>
      <td align="center"  class="default_td"><div id="Indusind_bnk"><span>Rs. 2,275 - Rs. 2,649</span></div></td>
    </tr>
        <tr height="18">
      <td height="18" align="center"   class="default_td">Tata Capital</td>
      <td align="center"  class="default_td">11.99% - 17%</td>
      <td align="center"  class="default_td"><div id="Tata_bnk"><span>Rs. 2,250 - Rs. 2,594</span></div></td>
    </tr>
     <tr height="18">
      <td height="18" align="center"   class="default_td">Standard Chartered</td>
      <td align="center"  class="default_td">10.99% - 14.49%</td>
      <td align="center"  class="default_td"><div id="Standard_bnk"><span>Rs. 2,224 - Rs. 2,300</span></div></td>
    </tr>
     <tr height="18">
      <td height="18" align="center"   class="default_td">Fullerton India</td>
      <td align="center"  class="default_td">19.50% - 37.00%</td>
      <td align="center"  class="default_td"><div id="Fullerton_bnk"><span>Rs. 2,499 - Rs. 2,622</span></div></td>
    </tr>
     <tr>
      <td align="center"   class="default_td" style="height: 18px">Citibank</td>
      <td align="center"  class="default_td" style="height: 18px">11.49% - 16.50%</td>
      <td align="center"  class="default_td" style="height: 18px"><div id="Citi_bnk"><span>Rs. 2,199 - Rs. 2,458</span></div></td>
    </tr>
     <tr height="18">
      <td height="18" align="center"   class="default_td">Capital First</td>
      <td align="center"  class="default_td">14% to 20%</td>
      <td align="center"  class="default_td"><div id="Capital_bnk"><span>Rs. 2,327 - Rs. 2,649</span></div></td>
    </tr>
</table></div> 
...
<div class="hdfc_la_offer">&nbsp;
      ...
      <br />
  <p>If you are looking for how much you have to pay per month for the Personal loan that you want to take, you are at the right place.</p>
  <p>To get the exact amount </p><br />
  <p>1.You need to know your Loan amount </p>
  <p>2.The rate of interest that bank is going to charge you   </p>
  <p>3.How much time would you require to repay the loan</p><br />
<p>If you know the  above three variables, use our calculator and find the exact EMI, amount, total  interest and the extra amount you are required to pay for the loan. Just in  case, the information is not matching your criteria, please fill in your  professional details, on the basis of same and we will let you know:</p><br />
<p>1.Maximum loan amount offered by  each bank.</p>
  <p>2.Rate of interest to be charged from the borrower.</p>
  <p>3.What is the net interest pay out and tenure to repay the loan?</p><br />
<p><strong>Personal loan EMI is calculated on the basis of:</strong></p>
  <p>1.Loan amount</p>
  <p>2.Interest rates</p>
  <p>3.Tenure</p>
  <p>4.Other loans EMI</p>
  <p>5.Your work profile-Salaried or Self-employed</p>
  <p>6.The company in which you work.  For e.g.- If you work in top 5000 companies, Banks are ready to fund more  Personal loan at lower rates.</p>
