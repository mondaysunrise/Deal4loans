...
<form id="calc_Form">
<div class="lamount" >
<strong> Personal Loan Amount</strong>
Rs.
<input id="L_Amt" name="L_Amt" value="1,00,000" type="text" style="width:80px;" />
</div>
...
<div ><strong>Loan Tenure</strong>
  <input id="tenure" name="tenure" value="4" type="text"/><input name="loantenure" id="tenure_years" value="tenure_years" checked type="radio" style="display:none;"/><span><strong> Years</strong></span></div>
<div class="clear"></div>
