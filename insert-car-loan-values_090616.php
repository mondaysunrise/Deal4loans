<?php
	...
	require 'eligiblebidderfuncCL_090616.php';
	session_start();
	...
	else
	{
		...
		list($alreadyExist,$Arrrow)=MainselectfuncNew($CheckSql,$array = array());
			...
			//	echo "<br>if".$InsertProductSql;
				$dataInsert = array('UserID'=>$UserID, 'Name'=>$Name, 'Employment_Status'=>$Employment_Status, 'City'=>$City, 'City_Other'=>$City_Other, 'Mobile_Number'=>$Phone, 'Net_Salary'=>$Net_Salary, 'Loan_Amount'=>$Loan_Amount, 'Car_Type'=>$Car_Type, 'Dated'=>$Dated, 'source'=>$source, 'Pincode'=>$Pincode, 'Referrer'=>$Referrer, 'Creative'=>$Creative, 'Section'=>$Section, 'IP_Address'=>$IP, 'DOB'=>$DOB, 'Car_Insurance'=>$Car_Insurance, 'Car_Varient'=>$Car_Varient, 'Car_Model'=>$Car_Model, 'Updated_Date'=>$Dated, 'Email'=>$Email, 'Loan_Tenure'=>$Loan_Tenure, 'Cpp_Compaign'=>$cpp_card_protect, 'Reference_Code'=>$Reference_Code, 'Privacy'=>$accept);
...
function adddel_dt()
{
	var ni = document.getElementById('clDeliDate').style.display="block";
	
	}
function removedel_dt()
{
		var ni = document.getElementById('clDeliDate').style.display="none";
...
<div class="pl_sbi_wrapper">
  ...
  <div class="text12" style="margin:auto; width:100%;">
    <? if($source=="CLQuickapply")
	  {$lastInserted = $QArequestid; }?>
    <form name="car_loan_verify" action="thank_cl.php" method="post" onSubmit="return chkform();" >
      ...
      <div class="hl_emi_cal_form" style="background-color:#0e79b9 !important;">
        ...
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="64%"><span class="text" style=" float:left;  height:auto; color:#FFF; font-size:14px; text-transform:none;">Activation Code</span></td>
              <td width="36%" align="left"><input name="activation_code" id="activation_code" type="text" style="width:150px; height:18px;" onkeydown="validateDiv('nameVal');"  maxlength="5"/></td>
            </tr>
          </table>
        </div>
        ...
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="51%" align="center"><span class="text" style="height:auto; color:#FFF; font-size:14px; text-transform:none;">Age</span></td>
              <td width="49%" align="left"><select onchange="validateDiv('AgeVal');" class="inputtext" name="Age" id="Age" style="width:150px; height:25px;" ><option value="">Select Age</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option><option value="50">50</option><option value="51">51</option><option value="52">52</option><option value="53">53</option><option value="54">54</option><option value="55">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option><option value="60">60</option><option value="61">61</option><option value="62">62</option><option value="63">63</option><option value="64">64</option><option value="65">65</option></select><div id="AgeVal"></div></td>
            </tr>
          </table>
        </div>
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="65%"><span class="text" style=" float:left;  height:auto; color:#FFF; font-size:14px; text-transform:none;">Company Name</span></td>
              <td width="35%" align="left"><input type="text" name="Company_Name" class="d4l-input" onfocus="addrest();" style="width:150px; height:18px;" onkeydown="validateDiv('companyNameVal');" tabindex="11" onKeyUp="ajax_showOptions(this,'getCountriesByLetters',event)" autocomplete="off"/> <div id="companyNameVal"></div> </td>
            </tr>
          </table>
        </div>
        ...
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="51%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Residence Status</span></td>
              <td width="49%"><select name="Residence_Status" id="Residence_Status" style="width:150px; height:25px;" class="inputtext" tabindex="10">
        ...
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="67%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Years at current residence:</span></td>
              <td width="33%" align="left"><input type="text" name="Resi_Stability" id="Resi_Stability"  onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" style="width:150px; height:18px;" /></td>
            </tr>
          </table>
        </div>
        <div style="clear:both;"></div>
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="51%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Car Make</span></td>
              <td width="49%" align="left"><select name="car_manufacturer" id="car_manufacturer"  onChange="ajaxpage();" style="height:25px; width:150px;">
...
?>
        ...
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="56%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Car Model:</span></td>
              <td width="44%"><div class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;" id="contentarea">
                  <select name="car_model" id="car_model"  style="width:150px;height:25px;" onChange="return addMagma();">
        ...
        <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="67%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Total Work Experience:</span></td>
              <td width="33%" align="left"><input type="text" name="total_experience" id="total_experience"  onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" style="width:150px; height:18px;" /></td>
            </tr>
          </table>
        </div>
         <div style="clear:both;"></div>
         <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="51%"><span class="text" style=" float:left;  height:auto; color:#FFF; font-size:14px; text-transform:none;">Car Type</span></td>
              <td width="49%" align="left"><select  class="d4l-select" name="Car_Type" style="height:25px; width:150px;" onchange="validateDiv('carTypeVal');" tabindex="12"><option selected value="-1">Interested In</option>	<option  value="1">New Car</option>	<option value="0">UsedCar</option></select>        <div id="carTypeVal"></div></td>
            </tr>
          </table>
        </div>
         <div class="inser_cl_input">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="36%"><span class="text" style=" float:left;  height:auto; color:#FFF; font-size:14px; text-transform:none;">Car Booked</span></td>
              <td width="64%" align="left"><input type="radio" value="2" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="adddel_dt();" onkeydown="validateDiv('carbukedVal'); " tabindex="13" > Yes  <input type="radio" value="1" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="removedel_dt();" onkeydown="validateDiv('carbukedVal'); " tabindex="14" > No  <div id="carbukedVal"></div></td>
            </tr>
          </table>
        </div>
         <div class="inser_cl_input" style="display:none;" id="clDeliDate">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="36%"><span class="text" style=" float:left;  height:auto; color:#FFF; font-size:14px; text-transform:none;">Delivery Date</span></td>
              <td width="64%" align="left"><input type="text" name="cldelivery_date" id="cldelivery_date" placeholder="DD-MM-YYYY" class="d4l-input" onkeydown="validateDiv('delivry_dtVal');"/><div id="delivry_dtVal"></div></td>
            </tr>
          </table>
        </div>
        <div style="clear:both;"></div>
