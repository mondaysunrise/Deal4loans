  ...
  <table cellspacing="2" cellpadding="0" width="100%" align="center" border="0" >
    ...
    <tr>
     ...
     <tr bgcolor="#F0F0F0" >
      ...
      <td align="left" valign="top" bgcolor="#F0F0F0" ><input name="pldob" type="text" class="inputsms" id="pldob" value="<? echo $DOB;?>" style=" width:87%; " > <a href="javascript:NewCal('pldob','yyyymmdd',false,24)"><img src="../images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
    ...
    <tr>
      ...
      <td align="left"><select name="plcity" size="1" class="inputsms" id="plcity" style="height:28px;">
          <?=plgetCityList($City)?>
        </select></td>
    ...
    <tr bgcolor="#F0F0F0">
      ...
      <td width="30%"  >  <input type="radio" name="Gender" id="Gender" value="1" class="css-checkbox"  <? if($Gender==1) { echo "checked"; } ?>  />            <label for="Gender" class="css-label radGroup2">Male</label>            <input type="radio" name="Gender" id="Gender2" value="0" class="css-checkbox"  <? if($Gender==0) { echo "checked"; } ?> />            <label for="Gender" class="css-label radGroup2">Female </label>    </td>
     
    </tr>
	<tr bgcolor="#F0F0F0">
<td><strong>Marital Status</strong></td>
      <td><select name="Marital_Status" class="inputsms" id="Marital_Status" style="height: 28px;">
     ...
     <td><strong>Higher Qualification</strong></td>
      <td><select name="higherQualification" class="inputsms" id="higherQualification" style="height: 28px;">
 ...
 <tr>
      <td colspan="4" align="center" bgcolor="#F0F0F0" class="heading" style="border-top:1px solid #CCC; border-bottom:1px solid #CCC;"><strong>Business Details</strong></td>
    </tr>
    <tr>
      ...
      <td align="left" valign="top" ><select class="inputsms" name="plemployment_status" id="plemployment_status" style="height:28px;" onChange="getProfDetails();">
       
          <option value="SEP" <?php if($viewEmp_Status=='SEP') echo $selected; ?>>Self Employed Professional</option>
          <option value="Manufacture" <?php if($viewEmp_Status=='Manufacture') echo $selected; ?>>Manufacture</option>
          <option value="Trader" <?php if($viewEmp_Status=='Trader') echo $selected; ?>>Trader</option>
      	  <option value="Service" <?php if($viewEmp_Status=='Service') echo $selected; ?>>Service</option>
          <option value="Others" <?php if($viewEmp_Status=='Others') echo $selected; ?>>Others</option>
        </select></td>
      
    <tr bgcolor="#F0F0F0" >
      <td><strong>Are you Filling ITR</strong></td>
      <td><input type="radio" name="ITR_filing" id="ITR_filing1" value="1" class="css-checkbox" <? if($ITR_filing==1) { echo "checked"; } ?>  onClick="getTypeFields();" />
  ...
  <tr>
    <tr>
      <td valign="top" ><strong>Annual Net Profit
</strong></td>
      <td ><input type="text" name="pl_amt" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" value="<?php echo $viewpl_amt; ?>" ></td>
         <td valign="top" ><strong>Since How long are you doing this Business</strong></td>
    ...
    <tr bgcolor="#F0F0F0">
       <td width="25%"  ><strong>Do you have registration proof</strong></td>
      ...
      <td id="typeITR" ><b>Business Registration Date</b></td>
      <td bgcolor="#F0F0F0" id="typeITRField" ><input type="text" id="BusinRegDate" name="BusinRegDate" class="noBrdr" /></td>
      </tr>
    <tr>
       ...
       <td width="21%"  ><strong>Name of Bank </strong></td>
         ...
         <tr bgcolor="#F0F0F0">
          <td><strong>Loan Amount Required</strong></td>
      <td valign="top" bgcolor="#F0F0F0" ><input name="plloan_amount" type="text" class="inputsms" id="plloan_amount" onBlur="getDigitToWords('plloan_amount','formatedloan','wordloan');" onKeyPress="getDigitToWords('plloan_amount','formatedloan','wordloan');"  onKeyUp="getDigitToWords('plloan_amount','formatedloan','wordloan');" value="<?php echo $Loan_Amount;?>"></td>
       ...
       <tr>
      <td colspan="4" align="center" bgcolor="#F0F0F0" class="heading"  style="border-top:1px solid #CCC; border-bottom:1px solid #CCC;"><strong>Loans Surrogate Details</strong></td>
    </tr>
  <tr>
...
font-weight:bold;color:666699;font-Family:Verdana;text-transform: capitalize;'></span></td>
    ...
    <tr>
      <td colspan="4" align="center" bgcolor="#F0F0F0" class="heading" style="border-top:1px solid #CCC; border-bottom:1px solid #CCC;"><strong>Others Details </strong></td>
    </tr>
    <tr>
        <td><strong>Current Residence Address</strong></td>
        <td><textarea name="CurResAdd"></textarea></td>
        <td><strong>Office Address</strong></td>
        <td><textarea name="OfficeAdd"></textarea></td>
    </tr>
    <tr bgcolor="#F0F0F0">
        <td><strong>Company Name</strong></td>
        <td><input type="text" name="CompanyName" /></td>
        <td><strong>Residence Status</strong></td>
        <td><select name="plresidential_status" class="inputsms" id="plresidential_status" style="height: 28px;">
          <option value="0">Please Select</option>
    ...
    <tr>
        <td><strong>Office Status</strong></td>
        <td><select name="OfficeStatus" class="inputsms" id="OfficeStatus" style="height: 28px;">
          <option value="">Please Select</option>
          <option value="1">Owned</option>
          <option value="2">Rented</option>
          <option value="3">Resi-cum-office</option>
          </select></td>
        <td><strong>Approved Loan</strong></td>
        <td><input type="text" name="ApprovedLoan" /></td>
    </tr>
    <tr bgcolor="#F0F0F0">
        <td><strong>ROI</strong></td>
        <td><input type="text" name="roi" id="roi" /></td>
        <td><strong>Tenure</strong></td>
        <td><input type="text" name="tenure" /></td>
    </tr>
    <tr>
        <td><strong>Business Key:- (ABFL Approved ID)</strong></td>
         <td><input type="text" name="businessKey" id="businessKey" /></td>
        <td><strong>SFDC ID:- (CFL Approved ID)</strong></td>
        <td><input type="text" name="SFDC" id="SFDC" /></td>
    </tr>
...
<tr>
    ...
    <option value="">Please Select</option>
    <option value="1" <?php if(trim($BusinessDetails)=="1") {echo "Selected";} ?>>Business continuity proof Ã¢â‚¬â€œ 3 years  and  more income tax return & income statements</option>
      ...
      <option value="4" <?php if(trim($BusinessDetails)=="4") {echo "Selected";} ?>>In the case of transfer of a loan: Last 12 months ofÃ‚Â  loans statementÃ‚Â  along with the Sanction Letter of your previous bank</option>
     ...
     <option value="7" <?php if(trim($BusinessDetails)=="7") {echo "Selected";} ?>>Business incorporation date proof Ã¢â‚¬â€œ PAN Card</option>    <option value="8" <?php if(trim($BusinessDetails)=="8") {echo "Selected";} ?>>MOA(Memorandum of Association) and AOA (Articles of Association)</option>   
    ...
    <option value="12" <?php if(trim($BusinessDetails)=="12") {echo "Selected";} ?>>Partnership Deed</option>   
      ...
      <option value="14" <?php if(trim($BusinessDetails)=="14") {echo "Selected";} ?>>Proof of continuation:Ã‚Â  Trade license /Establishment /Sales Tax certificate</option>      
    ...
    <option value="16" <?php if(trim($BusinessDetails)=="16") {echo "Selected";} ?>>Brief Business Profile on the Letter Head of the firm by the applicant</option>   
      <option value="17" <?php if(trim($BusinessDetails)=="17") {echo "Selected";} ?>>Copy of Tax Deduction Certificate 26 AS  / Form Ã¢â‚¬â€œ 16A (if applicable)</option>
