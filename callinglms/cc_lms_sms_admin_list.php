    ...
    <table width="98%" border="0">
	  <!---<tr><td align="right"><a href="/commonlms_report.php?bidderid=<?php echo $_SESSION['BidderID'];?>&product=4" target="_blank">
        ...
        <td align="center" width="100%"><div align="center">
            <form name="frmsearch" action="cc_lms_sms_admin_list.php" method="get" onSubmit="return chkform();"><table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
