...
$DisplayNumber="";
if($_SESSION['BidderID']==7607 || $_SESSION['BidderID']==7608 || $_SESSION['BidderID']==7609 || $_SESSION['BidderID']==7610 || $_SESSION['BidderID']==7611)
        {
	  ...
	  <!--<tr><td align="right"><a href="/commonlms_report.php?bidderid=<?php echo $_SESSION['BidderID'];?>&product=4" target="_blank">today's Report</a></td></tr>
       <tr><td align="right"><a href="/bidders_update_feedback_ref.php">Upload Feedback</a></td></tr>
        ...
        <td align="center" width="100%"><div align="center">
                <form name="frmsearch" action="scb_lms_index.php" method="get" onSubmit="return chkform();">
...
<? }?>
	...
	if(strlen(trim($RequestID))>0)
	{
		$strSQL="";
		$Msg="";
		$fbqry="select leadid,AllRequestID,BidderID,Feedback_ID from client_lead_allocate where AllRequestID=$RequestID and BidderID=".$_SESSION['BidderID']." AND Reply_Type=1";
 ...
 ?>
	...
	?>
		  ...
		  <tr  bgcolor="<?php echo $colorvar;?>">			 
			...
			?><a href="/personalloaneditlead_scbagents.php?id=<? echo urlencode($row->RequestID); ?>&bid=<? echo $_SESSION['BidderID'];?>" target="_blank"><? echo $row->Name; ?></a></td>
...
<span id="clkNum<?php echo $color; ?>" onClick="getNumValue(<?php echo $color; ?>,<?php echo $row->RequestID; ?>,<?php echo $getParameterVal; ?>);" style="cursor:hand;"><? echo $row->Net_Salary; ?></span> <?php } else {  echo $row->Net_Salary; } ?>
	   ...
	   ?>              
		<td class="bodyarial11">
<? echo getJumpMenu("scb_lms_index.php",$row->RequestID,"4",$row->Feedback,$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val); ?>
     </td>
