...
do { 
		...
		$leadsource="SMS_Digi_Lead_YesBank";
...
$currentdatetime = date('Y-m-d')." 23:59:59";
 ...
 $getdetails="select RequestID From ".$tblname." Where ( Mobile_Number not in (9811215138,9971396361,9953696361) and Mobile_Number='".$data[1]."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
...
<div align="center"><b>UPLOAD FOR CREDIT CARD FOR Yes Bank</b></div>
