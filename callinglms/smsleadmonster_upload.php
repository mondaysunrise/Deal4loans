...
do { 
		if(strlen($data[0])>1  && strlen($data[2]>5)) { 
			//echo "dddddddddddd";
...
$alreadyExist = $obj->fun_db_get_num_rows($checkavailability);
			...
			{			
			   $insertleadqry=("INSERT INTO ".$tblname." (Name, Email, Mobile_Number, City, Net_Salary, source, Employment_Status, Dated, Updated_Date) VALUES 
				( 
					'".FixString($data[0])."', 
					'".FixString($data[1])."', 
					'".FixString($data[2])."', 
