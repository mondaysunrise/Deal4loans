 ...
 <tr>
        ...
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="cclms_admin_sr_index.php" method="get" onSubmit="return chkform();">
...
//echo "<br>".$strSQL;
	...
	?>       <p class="bodyarial11">
		...
		if($_SESSION['BidderID']!="")
		{
			...
			$qry = "SELECT * FROM Req_Credit_Card RIGHT OUTER JOIN cards_curing_queue ON cards_curing_queue.RequestID=Req_Credit_Card.RequestID WHERE ((( Req_Credit_Card.Updated_Date Between '".($min_date)."' and '".($max_date)."') or (cards_curing_queue.modified_date Between '".($min_date)."' and '".($max_date)."'))  and cards_curing_queue.identifier= 'sales reject' and cards_curing_queue.process!= '10') ";
 ...
 ?>
	...
	?>
              ...
              <tr  bgcolor="<?php echo $colorvar;?>">			 
                <td class="bodyarial11"><a href="/sbiccleadlms-details.php?postid=<? echo urlencode($row->RequestID); ?>&biddt=<? echo $row->AgentID; ?>&process=sr" target="_blank"><? echo $row->Name; ?></a></td>
