...
div.pagination span.disabled {
	...
	color: #CCC;
		...
		<?php
	 if($_SESSION['leadidentifier']=='amercianexpresscallerlms_cc')
	{
	?>	 
	  ...
	  <tr><td align="right"><a href="/commonlms_report.php?bidderid=<?php echo $_SESSION['BidderID'];?>&product=4" target="_blank">today's Report</a></td></tr>
        ...
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="amexcreditcardlms_index.php?search=y" method="get" onSubmit="return chkform();">
 ...
 ?>
              ...
              <tr>
               ...
               <?php 
				if($showsbibtnflag== 1){
				?>
				<td class="head1">Link for SBI</td>
				<?php 
				}
				?>
	...
	?>
              ...
              <tr  bgcolor="<?php echo $colorvar;?>">			 
				...
				if($showsbibtnflag== 1){
				?>
				<td class="bodyarial11"><a href="/sbiccleadlms-details.php?postid=<? echo urlencode($row->RequestID); ?>&biddt=<? echo $_SESSION['BidderID'];?>" target="_blank">Click for SBI</a></td>
				<?php 
				}
				?>
	   ...
	   ?>              
		<td class="bodyarial11">
<? 
               echo getJumpMenu("amexcreditcardlms_index.php",$row->RequestID,"4",$row->Feedback,$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val); ?>
     </td>
