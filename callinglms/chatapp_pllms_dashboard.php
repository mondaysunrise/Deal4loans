...
<div style="clear:both; height:15px;"></div>
    ...
    <table width="98%" border="0">
	  <tr><td align="right"><a href="/personal-loan-chatapp.php?biddt=<?php echo $_SESSION['BidderID'];?>" target="_blank">Add Lead</a> | <a href="/commonlms_report.php?bidderid=<?php echo $_SESSION['BidderID'];?>&product=1" target="_blank">today's Report</a></td></tr>
              <tr>
        <td align="right"></td>
      </tr>
              <tr>
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="chatapp_pllms_dashboard.php" method="get" onSubmit="return chkform();">
...
//echo $strSQL;
	...
	?>       <p class="bodyarial11">
		...
		$qry="SELECT * FROM ".TABLE_REQ_LOAN_PERSONAL." LEFT OUTER JOIN Req_Feedback_PL ON Req_Feedback_PL.AllRequestID=".TABLE_REQ_LOAN_PERSONAL.".RequestID AND Req_Feedback_PL.BidderID= '".$_SESSION['BidderID']."' WHERE Req_Feedback_PL.BidderID= '".$_SESSION['BidderID']."' and (".TABLE_REQ_LOAN_PERSONAL.".Updated_Date Between '".($min_date)."' and '".($max_date)."' or Req_Feedback_PL.Followup_Date Between '".($min_date)."' and '".($max_date)."') group by Mobile_Number ";
 ...
 ?>
	...
	?>
              ...
              <tr  bgcolor="<?php echo $colorvar;?>">			 
                <td class="bodyarial11"><a href="/personalloan_smsleaddetails.php?postid=<? echo urlencode($row->RequestID); ?>&biddt=<? echo $_SESSION['BidderID'];?>" target="_blank"><? echo $row->Name; ?></a></td>
	   ...
	   ?>              
		<td class="bodyarial11">
                 <? echo getJumpMenu("chatapp_pllms_dashboard.php",$row->RequestID,"4",$row->Feedback,$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val) ?>
     </td>
...
<?	  if($_SESSION['BidderID']==5926 && $search=="y")
			{ ?>
