...
<script type="text/javascript">
	...
	function drawChartPre() {
		var data = google.visualization.arrayToDataTable([
			...
			$qrySMSPrePie = QueryProcess('Iccs', $AgentIDSMSPre);
...
<body style="margin:0px 0px 0px 0px; padding:0px 0px 0px 0px; background-color:#45B2D8;">
	<?php include "header_cc_admin_iccs_lms.php"; ?>
	...
	<div class="lead_wrapper">
		...
		<div>
			...
			$qrySMSPreAll = QueryProcess('Iccs', $BidderIDsPreAll);
			$resCountSMSPreAll = $objAdmin->fun_get_num_rows($qrySMSPreAll);
			?>
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					<td colspan="2"><h3>Product Name(ICCS)</h3><strong>Total Lead Count - <?php echo $resCountSMSPreAll; ?></strong></td>
				</tr>
				<tr><td colspan="2">
				...
				while ($rowSMSPre = $obj->fun_db_fetch_rs_object($qryCheckSMSPre)) {
					...
					$QuerySMSPre = QueryProcess('Iccs', $AgentIDSMSPre);
