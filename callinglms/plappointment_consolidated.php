...
<div style="clear:both; height:15px;"></div>
   ...
   <tr><td align="right" style="font-size:10px; font-weight:bold;"><a href="plappointment_consolidated.php">WishFin Appointment</a></td>
    ...
    <tr><td align="center" style="font-size:22px; font-weight:bold;">WishFin Appointments </td></tr>
              <tr>
        <td align="right"></td>
      </tr>
              <tr>
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="plappointment_consolidated.php" method="get" onSubmit="return chkform();">
...
<?php
$qury = "SELECT BankID,Bidder_Name,BidderID FROM Bidders_List Where Reply_Type=1 and lms_block_flag=1 and BankID NOT IN (66,80) GROUP BY BankID ORDER BY Bidder_Name ASC";
    ...
    $BanksIDS[] = $BankID;
			...
			<?php
               ...
               $AllBanks = implode(",",$BanksIDS);
                ?>
                        <option value="<?php echo $AllBanks; ?>" <? if($_REQUEST['BankID']==$AllBanks) echo "selected"; ?>>All</option>
...
//echo $strSQL;
	...
	{		
		...
		?>       <p class="bodyarial11">
            ...
            $queryfrBidd = "SELECT BankID,Bidder_Name,BidderID FROM Bidders_List Where Reply_Type=1 and lms_block_flag=1 and BankID NOT IN (66,80) and BankID in (".$_REQUEST['BankID'].")"; 
    ...
    $GetBidIDs = implode(',',$arrVal);
		...
		if($BidderIDstatic!="")
		{
		    $qry="SELECT *, Req_Feedback_Bidder_PL.BidderID as Bidder_ID FROM Req_Feedback_Bidder_PL,Req_Loan_Personal LEFT OUTER JOIN Req_Feedback_PL ON Req_Feedback_PL.AllRequestID=Req_Loan_Personal.RequestID AND Req_Feedback_PL.BidderID in (".$BidderIDstatic.") WHERE Req_Feedback_Bidder_PL.AllRequestID=Req_Loan_Personal.RequestID and Req_Feedback_Bidder_PL.BidderID in (".$GetBidIDs.") and ((Req_Feedback_Bidder_PL.Allocation_Date Between '".($min_date)."' and '".($max_date)."' or Req_Feedback_PL.Followup_Date Between '" . ($min_date) . "' and '" . ($max_date) . "'))";
