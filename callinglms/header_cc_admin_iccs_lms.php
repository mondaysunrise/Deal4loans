<style type="text/css">
		...
		.lms-text-wrapper{ float:left; width:40%; text-align:left; font-size:35px;}
		.lms-btn-wrapper{ float:right; text-align:right; width:60%;}
...
<div class="lms-text-wrapper"> ICCS Credit Card Admin <span style="font-size:12px;"><?php echo $showHeader ?></span> </div>
...
<a href="cc_lms_dashboard_iccs_sbi.php" class="logout-btn1">SBI Status</a>
<a href="cc_lms_dashboard_iccs.php" class="logout-btn1">Dashboard</a>
...
<a href="../getUserDetailsSBI.php" class="logout-btn1">Get Leads Info</a>-->
