...
$DisplayNumber="";
if($_SESSION['BidderID']==7526 || $_SESSION['BidderID']==7527)
        {
	  ...
	  <!--<tr><td align="right"><a href="/commonlms_report.php?bidderid=<?php echo $_SESSION['BidderID'];?>&product=4" target="_blank">today's Report</a></td></tr>
       <tr><td align="right"><a href="/bidders_update_feedback_ref.php">Upload Feedback</a></td></tr>
        ...
        <td align="center" width="100%"><div align="center">
                <form name="frmsearch" action="capitalfirst_sal_lms_index.php" method="get" onSubmit="return chkform();">
                ...
                <tr>
                  ...
                  <td width="29%"><select name="cmbfeedback" id="cmbfeedback">
					...
					<option value="Ringing" <? if($varCmbFeedback == "Not Contactable") { echo "selected"; }?>>Ringing</option>
				...
				<option value="Not Eligible" <? if($varCmbFeedback == "Not Eligible") { echo "selected"; }?> >Not Eligible</option>
					...
					<option value="Approved" <? if($varCmbFeedback == "Approved") { echo "selected"; }?> >Approved</option>
                                        ...
                                        <option value="Approved - Followup" <? if($varCmbFeedback == "Approved - Followup") { echo "selected"; }?> >Approved - Followup</option>
                                        <option value="Approved - Not Interested" <? if($varCmbFeedback == "Approved - Not Interested") { echo "selected"; }?> >Approved - Not Interested</option>
                                        <option value="Approved - Appointment" <? if($varCmbFeedback == "Approved - Appointment") { echo "selected"; }?> >Approved - Appointment</option>
                                        
                                        <option value="Approved - Docs Collected" <? if($varCmbFeedback == "Approved - Docs Collected") { echo "selected"; }?> >Approved - Docs Collected</option>
                                        <option value="Approved - Login" <? if($varCmbFeedback == "Approved - Login") { echo "selected"; }?> >Approved - Login</option>
                                        <option value="Approved - Rejected" <? if($varCmbFeedback == "Approved - Rejected") { echo "selected"; }?> >Approved - Rejected</option>
                 <option value="Application-Punch Rejected" <? if($varCmbFeedback == "Application-Punch Rejected") { echo "selected"; }?> >Application-Punch Rejected</option>                       
                    </select></td>
 ...
 ?>
	...
	?>
		  ...
		  <tr  bgcolor="<?php echo $colorvar;?>">			 
			...
			?><a href="/callinglms/capitalfirst_sal_agents_editlead.php?id=<? echo urlencode($row->RequestID); ?>&bid=<? echo $_SESSION['BidderID'];?>" target="_blank"><? echo $row->Name; ?></a></td>
...
<span id="clkNum<?php echo $color; ?>" onClick="getNumValue(<?php echo $color; ?>,<?php echo $row->RequestID; ?>,<?php echo $getParameterVal; ?>);" style="cursor:hand;"><? echo $row->Net_Salary; ?></span> <?php } else {  echo $row->Net_Salary; } ?>
	   ...
	   ?>              
		<td class="bodyarial11">
<? echo getJumpMenu("capitalfirst_sal_lms_index.php",$row->RequestID,"4",$row->Feedback,$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val); ?>
     </td>
			  ...
			  <option value="" <? if($varFeedback == "") { echo "selected"; }?>>No Feedback</option>
				...
				<option value="<? echo $strURL.'&Feedback=Not Eligible'?>" <? if($varFeedback == "Not Eligible") { echo "selected"; }?> >Not Eligible</option>
					...
					<option value="<? echo $strURL.'&Feedback=Approved'?>" <? if($varFeedback == "Approved") { echo "selected"; }?> >Approved</option>
                                        ...
                                        <option value="<? echo $strURL.'&Feedback=Approved - Followup'?>" <? if($varFeedback == "Approved - Followup") { echo "selected"; }?> >Approved - Followup</option>
                                        <option value="<? echo $strURL.'&Feedback=Approved - Not Interested'?>" <? if($varFeedback == "Approved - Not Interested") { echo "selected"; }?> >Approved - Not Interested</option>
                                        <option value="<? echo $strURL.'&Feedback=Approved - Appointment'?>" <? if($varFeedback == "Approved - Appointment") { echo "selected"; }?> >Approved - Appointment</option>
                                        <option value="<? echo $strURL.'&Feedback=Approved - Docs Collected'?>" <? if($varFeedback == "Approved - Docs Collected") { echo "selected"; }?> >Approved - Docs Collected</option>
                                        <option value="<? echo $strURL.'&Feedback=Approved - Login'?>" <? if($varFeedback == "Approved - Login") { echo "selected"; }?> >Approved-Login</option>
                                        <option value="<? echo $strURL.'&Feedback=Approved - Rejected'?>" <? if($varFeedback == "Approved - Rejected") { echo "selected"; }?> >Approved - Rejected</option>
                                         <option value="<? echo $strURL.'&Feedback=Approved - Disbursed'?>" <? if($varFeedback == "Approved - Disbursed") { echo "selected"; }?> >Approved - Disbursed</option>
                                         <option value="<? echo $strURL.'&Feedback=Application-Punch Rejected'?>" <? if($varFeedback == "Application-Punch Rejected") { echo "selected"; }?> >Application-Punch Rejected</option>
