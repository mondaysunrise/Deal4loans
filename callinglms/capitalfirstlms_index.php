...
if(isset($_REQUEST['salaryrange']))
{
   ...
   $val = "apply_pl_capitalfirst";
	...
	$lead_allocatetype="";
	if(isset($_REQUEST['lead_allocatetype']))
	{
		$lead_allocatetype=$_REQUEST['lead_allocatetype'];
	}
...
<div style="clear:both; height:15px;"></div>
    ...
    <table width="98%" border="0">
	               <tr>
        <td align="right"><a href="capitalfirstlms_ref_index.php" target="_blank">View Other leads</a></td>
      </tr>
              <tr>
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="capitalfirstlms_index.php" method="get" onSubmit="return chkform();">
                ...
                <tr>
                 ...
                 <tr>
                  <td>Status</td>
                  <td>
					  <select name="lead_allocatetype" id="lead_allocatetype">
						<option value="1" <? if($lead_allocatetype==1) { echo "Selected"; } ?>>Direct</option>
						<option value="0" <? if($lead_allocatetype==0) { echo "Selected"; } ?>>Calling</option>
						<option value="2" <? if($lead_allocatetype==2) { echo "Selected"; } ?>>Referred</option>
					  </select>
				  </td>
                  <td>&nbsp;</td>
...
//echo $strSQL;
 ...
 ?>
	...
	?>
              <tr  bgcolor="<?php echo $colorvar;?>">			 
                <td class="bodyarial11"><? echo $row->capitalfirst_name; ?></td>
				...
				<td class="bodyarial11"><? echo $row->capitalfirst_company_name; ?></td>
				<td class="bodyarial11"><? echo $row->capitalfirst_purpose_ofloan; ?></td>
                 </tr>
                <?
		$color++;
		}		
 ...
 ?>            </div></td>
	  ...
	  <?	  if($_SESSION['BidderID']==5692 && $search=="y")
			{ ?>
