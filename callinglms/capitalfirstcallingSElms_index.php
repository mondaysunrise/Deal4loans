...
$days2check  = mktime(0, 0, 0, date("m")  , date("d")-2, date("Y"));
  $days2checkdate=date('Y-m-d',$days2check);
	  ...
	  <tr><td align="right"><a href="/commonlms_report.php?bidderid=<?php echo $_SESSION['BidderID'];?>&product=4" target="_blank">today's Report</a></td></tr>
        ...
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="capitalfirstcallingSElms_index.php" method="get" onSubmit="return chkform();">
...
?>       <p class="bodyarial11">
	...
	$qry="SELECT * FROM ".TABLE_REQ_LOAN_PERSONAL." LEFT OUTER JOIN Req_Feedback_PL ON Req_Feedback_PL.AllRequestID=".TABLE_REQ_LOAN_PERSONAL.".RequestID AND Req_Feedback_PL.BidderID in (5808) WHERE (".TABLE_REQ_LOAN_PERSONAL.".Employment_Status=0 and (".TABLE_REQ_LOAN_PERSONAL.".City in ('Kolkata','Bhubneshwar','Lucknow','Dehradun','Delhi','Ludhiana','Jalandhar','Chandigarh','Jodhpur','Jaipur','Udaipur','Hyderabad','Vishakapatman','Vijayawada','Chennai','Coimbatore','Banglore','Baroda','Ahemdabad','Surat','Pune','Indore','Bhopal','Cuttack','Gurgaon','Faridabad','Anand','Madurai','Ambala','Mumbai','Nagpur','Nasik','Noida','Navi Mumbai','Thane','Mohali','Kharar','Ziragpur','Vizag','Vadodara','Rajkot','Cochin','Kochi','Ernakulam','Siliguri','Guwahati','Mysore','Raipur') or ".TABLE_REQ_LOAN_PERSONAL.".City_Other in ('Kolkata','Bhubneshwar','Lucknow','Dehradun','Delhi','Ludhiana','Jalandhar','Chandigarh','Jodhpur','Jaipur','Udaipur','Hyderabad','Vishakapatman','Vijayawada','Chennai','Coimbatore','Banglore','Baroda','Ahemdabad','Surat','Pune','Indore','Bhopal','Cuttack','Noida','Gurgaon','Faridabad','Anand','Madurai','Ambala','Mumbai','Nagpur','Nasik','Noida','Navi Mumbai','Thane','Mohali','Kharar','Ziragpur','Vizag','Vadodara','Rajkot','Cochin','Kochi','Ernakulam','Siliguri','Guwahati','Mysore','Raipur')) and source not in ('SMS_Lead_Appointment_Model','SMS_APP_MODEL') and ( ".TABLE_REQ_LOAN_PERSONAL.".Updated_Date Between '".($min_date)."' and '".($max_date)."' or Req_Feedback_PL.Followup_Date Between '".($min_date)."' and '".($max_date)."'))";
...
$result = $obj->fun_db_query($qry);
 ?>
	...
	if(($myrow->capitalfirst_requestid) >1)
	   ...
	   ?>              
		<td class="bodyarial11">
          <? echo getJumpMenu("capitalfirstcallingSElms_index.php",$row->RequestID,"4",$row->Feedback,$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val) ?>
     </td>
	 <?php if($varCmbFeedback == "Send Now" ) { 
