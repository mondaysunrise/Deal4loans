...
<td align="center" width="100%"><div align="center">
	<table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
		<form name="frmsearch" action="ybankccverifier_index.php" method="get" onSubmit="return chkform();">
	...
	<table width="958" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
		...
		<tr bgcolor="<?php echo $colorvar;?>">			 
			<td class="bodyarial11">
				<a href="/yesbankccleadverifier-details.php?postid=<? echo urlencode($row->RequestID); ?>&biddt=<? echo $_SESSION['BidderID'];?>" target="_blank"><? if(strlen($full_name)>0) {echo $row->Name;  } else { echo "Customer"; } ?></a>
			</td>
			...
			<td class="bodyarial11">
				<? echo getJumpMenu("ybankccverifier_index.php",$row->RequestID,"4",$row->Feedback,$pageno,$varmin_date,$varmax_date,$varCmbFeedback); ?>
			</td>
