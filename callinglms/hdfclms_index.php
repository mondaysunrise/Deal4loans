...
if (restore) selObj.selectedIndex=0;
    ...
    {	
	   $.ajax({ type: 'post',  url: '/dialerclick2callplhdfc.php',  data: {  RequestID:RequestID,agent_user:agent_user, },
	  ...
	  <tr><td align="right"><a href="/commonlms_report.php?bidderid=<?php echo $_SESSION['BidderID'];?>&product=4" target="_blank">today's Report</a></td></tr>
        ...
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="hdfclms_index.php" method="get" onSubmit="return chkform();">
                ...
                <tr>
                  ...
                  <td width="29%"><select name="cmbfeedback" id="cmbfeedback">
					...
					<option value="Appointment" <? if($varCmbFeedback == "Appointment") { echo "selected"; }?> >Appointment Made</option>
 ...
 ?>
	...
	?>
		  ...
		  <tr  bgcolor="<?php echo $colorvar;?>">			 
			...
			?><a href="/plallocatedleadlms-detailshdfc.php?postid=<? echo urlencode($row->RequestID); ?>&biddt=<? echo $_SESSION['BidderID'];?>" target="_blank"><? echo $row->Name; ?></a></td>
...
<? if($processing_status==1 || $processing_status==7) { } else { 
               echo getJumpMenu("hdfclms_index.php",$row->RequestID,"4",$row->Feedback,$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val); ?>
     </td>
