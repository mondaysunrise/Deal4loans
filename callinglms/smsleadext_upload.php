...
$currentdatetime = date('Y-m-d')." 23:59:59";
 ...
 $getdetails="select RequestID From ".$tblname." Where ( Mobile_Number not in (9811215138) and Mobile_Number='".$data[0]."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
...
$alreadyExist = $obj->fun_db_get_num_rows($checkavailability);
			...
			else
			{
			   ...
			   $insertleadqry=("INSERT INTO ".$tblname." (Mobile_Number, Name, City, Net_Salary, source, Employment_Status , Dated, Updated_Date) VALUES 
				( 
					'".FixString($data[0])."', 
					'Customer 1', 
					'Delhi',
