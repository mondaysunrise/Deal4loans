...
$alreadyExist = $obj->fun_db_get_num_rows($checkavailability);
			...
			{
			   $insertleadqry=("INSERT INTO ".$tblname." (Name, Mobile_Number, City, Net_Salary, source, Employment_Status, Dated, Updated_Date, Allocated, Bidderid_Details) VALUES 
				( 
					'".FixString($data[1])."', 
					'".FixString($data[2])."', 
					'".FixString($data[3])."',
...
<div align="center"><b>UPLOAD FOR ICICI PERSONAL LOAN</b></div>
