...
$currentdatetime = date('Y-m-d')." 23:59:59";
  ...
  $getdetails="select RequestID From ".$tblname." Where ( Phone not in (9811215138) and Phone='".$data[2]."' and Phone>999 and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
// echo  $getdetails;  echo "<br>";
...
//print_r($data); echo "<br>";
			...
			{
				//print_r($data); echo "Line 38 <br>";
			   $insertleadqry=("INSERT INTO ".$tblname." (Name, Phone, City, Net_Salary, source, Dated, Updated_Date) VALUES 
				( 
					'".$data[1]."', 
					'".$data[2]."', 
					'".$data[3]."',
