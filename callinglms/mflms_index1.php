            ...
            <tr>
                <td align="center" width="100%"><div align="center">
                        <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
                            <form name="frmsearch" action="mflms_index1.php" method="get" onSubmit="return chkform();">
...
<option value="Appointment" <? if ($varCmbFeedback == "Appointment") {
    ...
    echo "selected";
                                ...
                                <tr><td width="29%" align="center"  valign="middle" class="bidderclass">Invest Ready</td><td>
                                ...
                                <?php 
               echo "Invest Ready - ".                 $is_invest_ready;
                                ?>
                                </td><td>&nbsp;</td><td>&nbsp;</td></tr>
                                <tr>
                                    <td>&nbsp;</td>
	...
	<input type="hidden" name="bidderid" id="bidderid" value="<? echo $BidderIDstatic;?>">
                            ...
                            ?></td>
                                ...
                                echo "Self Employed";
                                            ...
                                            ?>              
                                            <td class="bodyarial11">
                                                <? getJumpMenu("mflms_index1.php", $row->RequestID, "11", $row->Feedback, $pageno, $varmin_date, $varmax_date, $varCmbFeedback, $val); ?>
                                            </td>
