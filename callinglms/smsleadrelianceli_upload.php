...
$alreadyExist = mysql_num_rows($checkavailability);
			...
			{
				$selbidqry="Select BidderID From Bidders_List Where (BidderID in (2757,2758,2759,2760,2761,2762,2763,2764,2765,3246,3386,3442) and City like '%".$data[3]."%' and Restrict_Bidder=1)";
				$selbidqryresult = ExecQuery_bima($selbidqry);
				$bidrow=mysql_fetch_array($selbidqryresult);
			   ...
			   $insertleadqry=("INSERT INTO ".$tblname." (Name, Phone, City, Email, DOB, Allocated, Bidderid_Details, Net_Salary ,source, Dated, Updated_Date) VALUES 
				( 
					'".FixString($data[1])."', 
					'".FixString($data[2])."', 
					'".FixString($data[3])."',
