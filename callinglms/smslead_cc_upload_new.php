...
$currentdatetime = date('Y-m-d')." 23:59:59";
 ...
 $getdetails="select RequestID From ".$tblname." Where ( Mobile_Number not in (9811215138,9971396361) and Mobile_Number='".$data[1]."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
...
$alreadyExist = $obj->fun_db_get_num_rows($checkavailability);
			...
			{
				 $getdetails1="select RequestID From Req_Credit_Card Where ( Mobile_Number not in (9811215138,9971396361) and Mobile_Number='".$data[1]."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
	$checkavailability1 = $obj->fun_db_query($getdetails1);
	$alreadyExist1 = $obj->fun_db_get_num_rows($checkavailability1);
				if($alreadyExist1>0)
				{					}
				else
				{	
...
<div align="center"><b>UPLOAD FOR CREDIT CARD</b></div>
