...
class DB{
	...
	function fun_db_connect(){
		if($this->dbConnectPersistant){
			$this->dbLink = mysqli_pconnect($this->dbHost, $this->dbUsername,  $this->dbPassword, $this->dbDatabase) or die("<font color='#ff0000' face='verdana' face='2'>Error: Could not connect to database server!</font> ". mysqli_connect_error());
		}else{
			$this->dbLink = mysqli_connect($this->dbHost, $this->dbUsername,  $this->dbPassword, $this->dbDatabase) or die("<font color='#ff0000' face='verdana' face='2'>Error: Could not connect to database server!</font> " . mysqli_connect_error());
		}
