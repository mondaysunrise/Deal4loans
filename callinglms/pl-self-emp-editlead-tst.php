  ...
  <table style='border:1px dotted #9C9A9C;' cellspacing="2" cellpadding="5" width="600" height="80%" align="center" border="0" >
    ...
    <tr>
      ...
      <td class="fontstyle">+91
        <input type="text" name="plmobile" size="15" value="<?echo $Mobile;?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="fontstyle"> <input type="radio" name="IncomeAmount" id="IncomeAmount1" value="200000" class="css-checkbox" onClick="validateDiv('NetSalaryVal')" <? if($Net_Salary>=200000 && $Net_Salary<250000) { echo "checked"; } ?>/>
            <label for="IncomeAmount1" class="css-label radGroup2">Upto 2 Lacs</label><br>
            <input type="radio" name="IncomeAmount" id="IncomeAmount2" value="250000" class="css-checkbox" onClick="validateDiv('NetSalaryVal')" <? if($Net_Salary>=250000 && $Net_Salary<450000) { echo "checked"; } ?>/>
            <label for="IncomeAmount2" class="css-label radGroup2">2 To 3 Lacs</label><br><input type="radio" name="IncomeAmount" id="IncomeAmount3" value="450000" class="css-checkbox" onClick="validateDiv('NetSalaryVal')" <? if($Net_Salary>=450000 && $Net_Salary<550000) { echo "checked"; } ?>/>
            <label for="IncomeAmount3" class="css-label radGroup2">3 To 5 Lacs</label><br>
            <input type="radio" name="IncomeAmount" id="IncomeAmount4" value="550000" class="css-checkbox" onClick="validateDiv('NetSalaryVal')" <? if($Net_Salary>=550000) { echo "checked"; } ?>/>
    ...
    <tr>
      ...
      <td class="fontstyle" colspan="2"><input type="radio" name="Total_Experience" id="running_business1" value="1" class="css-checkbox" onClick="validateDiv('TotalExperienceVal')" <? if($Total_Experience>=1 && $Total_Experience<2) { echo "checked"; } ?> />
            <label for="running_business1" class="css-label radGroup2">Less Than 2 Yrs</label>
            &nbsp;&nbsp;<input type="radio" name="Total_Experience" id="running_business2" value="2.5" class="css-checkbox" onClick="validateDiv('TotalExperienceVal')" <? if($Total_Experience>=2 && $Total_Experience<4) { echo "checked"; } ?> />
            <label for="running_business2" class="css-label radGroup2">2 To 3 Yrs</label><br>
        <input type="radio" name="Total_Experience" id="running_business3" value="4" class="css-checkbox" onClick="validateDiv('TotalExperienceVal')" <? if($Total_Experience>=4  && $Total_Experience<5) { echo "checked"; } ?> />
            <label for="running_business3" class="css-label radGroup">3 To 5 Yrs</label>&nbsp;&nbsp;
        <input type="radio" name="Total_Experience" id="running_business4" value="5" class="css-checkbox" onClick="validateDiv('TotalExperienceVal')" <? if($Total_Experience>=5) { echo "checked"; } ?> />
