...
if ($_FILES[csv][size] > 0) {
	...
	do {
		if (strlen($data[1]>5)) {
			...
			$getdetails="select RequestID From ".$tblname." Where ( Mobile_Number not in (9971396361) and Mobile_Number='".$data[1]."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
...
<div align="center"><b>UPLOAD FOR CREDIT CARD FOR American Express</b></div>
