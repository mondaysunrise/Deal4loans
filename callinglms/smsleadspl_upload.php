...
$currentdatetime = date('Y-m-d')." 23:59:59";
 ...
 $getdetails="select RequestID From ".$tblname." Where ( Mobile_Number not in (9811215138,9811555306,9971396361,9810316335) and Mobile_Number='".$data[1]."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
...
<div align="center"><b>UPLOAD FOR PL SMS Appoinment Model</b></div>
