...
<div style="clear:both; height:15px;"></div>
    ...
    <table width="98%" border="0">
        ...
        <td align="center" width="100%"><div align="center">
            <table width="600" border="0" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF">
              <form name="frmsearch" action="experian_index.php" method="get" onSubmit="return chkform();">
                ...
                <tr>
                  <td width="12%"></td>
                  <td width="29%"><?php $qrySource="SELECT * FROM Bidders WHERE (BidderID='".$_SESSION["BidderID"]."' ) ";	
					...
					while($rowSource = $obj->fun_db_fetch_rs_object($resultSource))
					{
						...
						echo '<input type="hidden" name="source" id="source" value="'.$Process_Name.'" />';
					}
					?>
</td>
	...
	?>       <p class="bodyarial11">
		...
		if($_SESSION['BidderID']!="" && strlen($source)>0)
		{
