              ...
              <form name="frmsearch" action="cclmstwl_index.php" method="get" onSubmit="return chkform();">
                ...
                <tr>
                  ...
                  <td width="29%"><select name="cmblms_feedback" id="cmblms_feedback">
					  ...
					  <option value="No Response SBI" <? if($varCmblms_feedback == "No Response SBI") { echo "selected"; } ?>>No Response SBI</option>
					  <option value="Already SBI Card User" <? if($varCmblms_feedback == "Already SBI Card User") { echo "selected"; } ?>>Already SBI Card User</option>
                    </select></td>
...
?>
	<select name="type" id="type" onChange="MM_jumpMenu('parent',this,0)">
		...
		<option value="<? echo $strURL.'&lms_feedback=No Response SBI'?>" <? if($varlms_feedback == "No Response SBI") { echo "selected"; } ?>>No Response SBI</option>
		<option value="<? echo $strURL.'&lms_feedback=Already SBI Card User'?>" <? if($varlms_feedback == "Already SBI Card User") { echo "selected"; } ?>>Already SBI Card User</option>
	</select>	
<?
}
?>
