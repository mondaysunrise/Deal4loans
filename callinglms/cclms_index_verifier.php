...
<div> 
	<table width="98%" border="0">
		<tr>
			<td align="right">
				<a href="/callinglms/cclms_index_twl_verifier.php?BidderIDstatic=<?php echo base64_encode($_SESSION["BidderID"]);?>" target="_blank">TWL Leads</a>
			</td>			
		</tr>
		<tr>
			<td align="right"></td>
		...
		<tr>
			<td align="center" width="100%"><div align="center">
				...
				<form name="frmsearch" action="cclms_index_verifier.php" method="get" onSubmit="return chkform();">
				...
				<tr bgcolor="<?php echo $colorvar;?>">
					<td class="bodyarial11">
						<a href="/sbiccleadlms-details-verifier.php?postid=<? echo urlencode($RequestID); ?>&biddt=<? echo $BidderIDstatic;?>" target="_blank"><? if(strlen($Name)>0) {echo $Name; } else { echo "Customer"; } ?></a>
					</td>
					<td class="bodyarial11">
					<?php 
					...
					<td class="bodyarial11">
						<?
						echo getJumpMenu("cclms_index_verifier.php",$RequestID,"4",$Feedback,$pageno,$varcurrent_date,$varCmbFeedback);
						?>
					</td>
