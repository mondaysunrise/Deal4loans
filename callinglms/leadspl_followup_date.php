...
$get_followup = $get_followup." ".date("h:i:s");
$getTableName = $_REQUEST['getTableName'];
...
if (strlen(trim($get_requestid)) > 0) {
    ...
    $strSQL = "";
    $Msg = "";
    $result = "select FeedbackID from Req_Feedback_PL where AllRequestID=" . $get_requestid . " and BidderID=" . $get_bidderid;
    ...
    if ($num_rows > 0) {
        ...
        Mainupdatefunc('Req_Feedback_PL', $dataUpdate, $wherecondition);
    }
    echo "insert";
    if ($result == 1) {
