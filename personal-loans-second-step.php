...
var ajaxRequestMain;  // The variable that makes Ajax possible!
		...
		{
			var i;
			for (i=document.getElementById('LoanAny').length-1; i > -1; i--) {
			if (document.getElementById('LoanAny').checked) {
			var get_loanany = document.getElementById('LoanAny').value;
			var emi_paid= document.getElementById('EMI_Paid').value
			}
			else
				{
				var get_loanany = 0;
			...
			var get_residence_stat = document.getElementById('Residential_Status').value;
			var get_current_exp = document.getElementById('Years_In_Company').value;
			var get_total_exp = document.getElementById('Total_Experience').value;
			
			var get_bankid = document.getElementById('bankid').value;
			var leadid = document.getElementById('leadid').value;
			var city = document.getElementById('city').value;
			
			
			var get_product ="1";
if(get_loanany==1 && emi_paid>0)
			{
			var queryString = "?get_residence_stat=" + get_residence_stat +"&get_current_exp=" + get_current_exp + "&get_total_exp=" + get_total_exp +"&get_loanany=" + get_loanany + "&get_bankid=" + get_bankid + "&leadid=" + leadid + "&emi_paid=" + emi_paid +"&city=" + city  ;
			}
			else
			{
			var queryString = "?get_residence_stat=" + get_residence_stat +"&get_current_exp=" + get_current_exp + "&get_total_exp=" + get_total_exp + "&get_bankid=" + get_bankid + "&leadid=" + leadid + "&city=" + city ;
			}
			//alert(queryString); 
			ajaxRequestMain.open("GET", "get_eligible_banks_pl.php" + queryString, true);
				// Create a function that will receive data sent from the server
			ajaxRequestMain.onreadystatechange = function(){
			if(ajaxRequestMain.readyState == 4)
					{
						document.getElementById('eligible_banks').innerHTML=ajaxRequestMain.responseText;
					}
				}
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><form name="personalloan_form"  action="insert_pl_value_second_step.php" method="POST" onsubmit="return submitform(document.personalloan_form); ">
	<input type="hidden" value="<? echo $_SESSION['Temp_LID'];?>" name="leadid" id="leadid"/>
	<input type="hidden" value="PersonalLoan" name="type" />
	<input type="hidden" value="<? echo $_SESSION['city']; ?>" name="city" id="city" />
	<input type="hidden" value="<? echo $_SESSION['bank_id'];?>" name="bankid" id="bankid" />
		  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td  align="left" ><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="6%" ><input type="radio" style="border:none;" value="1" name="Residential_Status" id="Residential_Status" checked="checked" /></td>
                    <td width="19%" >                        Owned</td>
                    <td width="6%" ><input type="radio" style="border:none;" value="2" name="Residential_Status" id="Residential_Status"/></td>
                    <td width="19%" >                        Rented</td>
                    <td width="6%" ><input type="radio" style="border:none;" value="3" name="Residential_Status" id="Residential_Status" /></td>
            ...
            <tr>
              <td height="35" align="left" class="bldtxt" >No. of years in  
                this Company</td>
              <td align="left" ><input type="text" name="Years_In_Company" id="Years_In_Company" style="width:200px;" maxlength="15"></td>
            </tr>
            <tr>
              <td height="42" align="left" class="bldtxt" >Total Experience (Years)/
                Total Years  
                in Business</td>
              <td align="left" ><input style="width:200px;"  name="Total_Experience" id="Total_Experience" onfocus="this.select();">              </td>
            </tr>
           
            <tr>
              <td height="30" align="left" class="bldtxt" >Any Loan running?</td>
              <td align="left" ><input type="radio" style="border:none;"  value="1" id="LoanAny" name="LoanAny"  onclick="addElementLoan();" /> Yes &nbsp;  <input size="10" type="radio" style="border:none;" name="LoanAny"  onclick="removeElementLoan();" id="LoanAny" value="0"> No</td>
            </tr>
            <tr>
			...
			<tr>
              <td width="234" height="35" align="left" class="bldtxt">Primary Account 
                in which bank?</td>
              <td width="313" height="20"  align="left"><input type="text" style="width:200px;" name="Primary_Acc" id="Primary_Acc" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event); getstatementlink();" onchange="insertData();" onkeydown="insertData();"></td>
            </tr>
			   <tr>
		  ...
		  <option value="0">Please Select</option>
            ...
            <tr>
              <td  colspan="2" align="left" class="bldtxt" ><div  id="eligible_banks" ></div></td>
            </tr>
            <tr>
