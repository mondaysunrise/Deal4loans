...
<h2 style=" color:#FFF; font-size:18px; text-transform:none; padding-left:25px;">
...
<h2 class="text3" style=" color:#FFF; font-size:20px; text-transform:none; padding-bottom:3px; padding-top:3px; "><strong>Get instant quotes on Interest Rates & EMI on personal loan from top 10 banks of India</strong></h2>
<? }
else 
{ ?>
