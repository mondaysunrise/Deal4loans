<?php
	...
	{
			if($Email=="iciciprulifespace@d4l.com" && $PWD=="icicipruls")
			{
				$_SESSION["client_name"] = "iciciprulife";
				$_SESSION["UserType"] = "bidder";
				$_SESSION['UName'] = "icicipru";
			}
			...
			else
		{
			...
			$Msg =  "** You are not Authorized. Please try again **";
		  		 ...
		  		 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."icicipru_campaignview.php");
			exit;
