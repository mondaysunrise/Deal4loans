...
if($row["BidderID"]==5105)
			{
				header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."fullertonpllms_view.php");
				exit;
			}
			elseif($row["BidderID"]==95)
			{
				header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."fullertonpllms_verifyview.php");
				exit;
			}
			elseif($row["BidderID"]==96)
			{
				header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."fullertonpllms_adminview.php");
				exit;
			}
			else{
			global $Msg;
