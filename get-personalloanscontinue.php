...
$maxage=date('Y')-62;
$minage=date('Y')-18;
$getpldetails = "select Net_Salary From Req_Loan_Personal Where (RequestID='".$RequestID."')";
list($alreadyExist,$plnsrow)=MainselectfuncNew($getpldetails,$array = array());
$myrowcontr = count($plnsrow)-1;
$AnnualIncome=$plnsrow[$myrowcontr]['Net_Salary'];
?>
<!doctype html>
<html lang="en">
<head>
...
function addElementLoan()
{
	...
	ni2.innerHTML = '<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="sbi_text_c"  ><tr> <td    height="20" align="left" ><input type="checkbox" style="border:none;" id="Loan_Any" name="Loan_Any[]"  value="hl" /> Home</td><td align="left" class="sbi_text_c"><input type="checkbox" style="border:none;"  id="Loan_Any" name="Loan_Any[]" value="pl" /> Personal</td><td align="left">&nbsp;</td></tr><tr> <td  height="20" align="left" ><input type="checkbox" style="border:none;"  name="Loan_Any[]"  id="Loan_Any" value="cl" /> Car</td><td  align="left"  ><input type="checkbox" style="border:none;" name="Loan_Any[]" id="Loan_Any"  value="lap" /> Property</td><td  align="left"  ><input type="checkbox" style="border:none;" name="Loan_Any[]" id="Loan_Any"  value="other" /> Other</td></tr></table>';
	ni3.innerHTML = '<div style="height:50px;">How many EMI paid?</div> ';
	ni4.innerHTML = '<select name="EMI_Paid" class="sbi_input" > <option value="0">Please select</option><option value="1">Less than 6 months</option> <option value="2">6 to 9 months</option> <option value="3">9 to 12 months</option> <option value="4">more than 12 months</option ></select><div id="emiVal"></div>';
	return true;
}
...
"><span class="sbi-bank">Sbi (State Bank)</span>, Hdfc Bank</span>, <span class="bajaj-finserv">	Bajaj Finserv</span>, <span class="kotak">Kotak</span>, <span class="ing-vysya">Ing Vsaya,</span> <span class="fullerton">Fullerton</span>, <span class="pnb-bank">PNB</span>  <strong>and </strong><span class="Standard-Chart">Standard Chartered.</span></div>
  <div id="content">
  <? if($AnnualIncome<=239000)
  {
	  ?>
	  <form method="post"  name="loan_form"  action="insertPLstep2_lessd4l.php"  onSubmit="return chkpersonalloan();">
 <? }
  else
  { ?>
    <form method="post"  name="loan_form"  action="insertPLstep2_d4l.php"  onSubmit="return chkpersonalloan();">
	<? } ?>
...
<input type="hidden" name="ID" id="RequestID" value="<?php echo $ID; ?>" />
		  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			    <td height="35" valign="middle" bgcolor="#FFFFFF" class="heading_text_c">Other Details</td>
		      </tr>
			  <tr>
   ...
   <span class="hint">[DD-MM-YYYY].</span>
      <div id="dobVal"></div></td>
			  ...
			  <tr>
			    <td height="25" valign="middle" bgcolor="#FFFFFF" class="alert_msg" ><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			      <tr>
		        ...
		        </table>   <div id="empStatusVal"></div> </td>
		    </tr>
			  <tr>
      ...
      <div id="pincodeVal"></div></td>
			  ...
			  <tr>
</tr>			    <td height="35" valign="middle" bgcolor="#FFFFFF" class="alert_msg" style="color:#000000;"> Yes
       ...
       <input type="radio"  name="CC_Holder" id="CC_Holder" onClick="removeIdentified();" value="0" style="border:none;" checked="checked" /> 
           <div id="ccholderVal"></div></td>
               ...
               <tr  class="text_bg"> 
         <td id="myDiv1" class="sbi_text_c"></td></tr><tr><td id="myDiv2" class="alert_msg"></td>
   </tr>   
      ...
      <option value="0">Please Select</option>
		...
		<option value="5">PSU (Public sector Undertaking)</option>
             ...
             <tr  class="text_bg"> 
         <td id="myDivLoan1" class="sbi_text_c"></td></tr><tr><td id="myDivLoan2" class="alert_msg"></td>
   </tr>  
     <tr  class="text_bg"> 
         <td id="myDivLoan3" class="sbi_text_c"></td></tr><tr><td id="myDivLoan4" class="alert_msg"></td>
   </tr>  
