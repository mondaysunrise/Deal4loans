...
.yelobrder {
	border-left: 1px solid #fde37a;
	border-right: 1px solid #fde37a;
}
#txt {
	font-family: Arial, Helvetica, sans-serif;
	font-size: 13px;
...
.frmrgtbrdr {
	border-bottom: 22px solid #802891;
...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td height="75" ><table width="1004" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
    <td height="70" align="center" style="color:#000099; font-family: Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; color:#802891;">Personal Loan Quote</td>
  </tr>
      <?php
$city = $City;
$leadid = 553204;
...
?>
      <tr>
    <td style="color:#000099; font-family: Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; ">Dear <?php echo $Name; ?>,</td>
  </tr>
      <tr>
    <td><?php
...
$aa  =citibank($monthsalary,$PL_EMI_Amt,$getCompany_Name,$age,$citicategory,$getCompany_Name);
print_r($aa);

		if($citigetloanamout>0 && $citigetemicalc>0 && $cititerm>0)
		{
		?>
	...
	{?>
        ...
        <tr>
              <td height="45" align="center" bgcolor="#FFFFFF"><b style="font-size:12px; font-family:Verdana, Arial, Helvetica, sans-serif;"><? echo $citigetloanamout; ?></b></td>
              <td align="center" bgcolor="#FFFFFF"><b style="font-size:12px; font-family:Verdana, Arial, Helvetica, sans-serif;"><? echo $citigetemicalc; ?></b></td>
              <td align="center" bgcolor="#FFFFFF"><b style="font-size:12px; font-family:Verdana, Arial, Helvetica, sans-serif;"><? echo $cititerm; ?></b></td>
            </tr>
        <tr>
              <td height="45" align="right" bgcolor="#FFFFFF" colspan="3" style="padding-right:7px;"><?php
    if($Employment_Status==1 )
	{
    ?>
            <form action="get-citibankquote-submit.php" method="post" name="loan_form"  onSubmit="return submitform(document.loan_form);">
	  ...
	  ?></td>
        ...
        <tr>
              <td height="70" align="center" style="color:#000099; font-family: Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; color:#802891;">Sorry You are not eligible as per the policy.</td>
            </tr>
      </table>
          <? }
...
*/		$currentYear = date("Y");
	...
	?>
          <table width="661"  border="0" align="center" cellpadding="0" cellspacing="1" >
        <tr>
              <td height="70" align="center" style="color:#000099; font-family: Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; color:#802891;">Thank You for registering with fullertonindialoans.com, our representative will call you shortly.</td>
            </tr>
      </table>
          <?php	
