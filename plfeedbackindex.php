...
{
	var gifName = form;
	document.frmsearch.action="plfeedbackindex.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="plfeedbackindex.php?search=y" method="post" onSubmit="return chkform();">
...
//	MOD(Req_Loan_Personal.RequestID,4)=2
	...
	{
		$search_qry = "SELECT * FROM Bidders, Req_Feedback_Bidder1 LEFT JOIN pl_feedback ON pl_feedback.lead_id = Req_Feedback_Bidder1.AllRequestID WHERE ( Req_Feedback_Bidder1.Allocation_Date BETWEEN '".($min_date)."' AND '".($max_date)."'  AND Req_Feedback_Bidder1.BidderID = Bidders.BidderID AND Bidders.Define_PrePost = 'PostPaid' AND Req_Feedback_Bidder1.Reply_Type =1 ) ".$FeedbackClause." ".$ContactedClause." GROUP BY AllRequestID";
		$qry = "SELECT * FROM Bidders, Req_Feedback_Bidder1 LEFT JOIN pl_feedback ON pl_feedback.lead_id = Req_Feedback_Bidder1.AllRequestID WHERE ( Req_Feedback_Bidder1.Allocation_Date BETWEEN '".($min_date)."' AND '".($max_date)."'  AND Req_Feedback_Bidder1.BidderID = Bidders.BidderID AND Bidders.Define_PrePost = 'PostPaid' AND Req_Feedback_Bidder1.Reply_Type =1 ) ".$FeedbackClause." ".$ContactedClause." GROUP BY AllRequestID";
	}
...
<table width="500" border="0" cellspacing="1" cellpadding="4">
 <form name="frmdownload" action="plfeedbackindex.php" method="post">
   <tr>
     <td align="center">
...
<?php	
	...
	?>
<table width="500" border="0" cellspacing="1" cellpadding="4">
 <form name="frmdownload" action="plfeedback_download_c.php" method="post">
   <tr>
     <td align="center">
