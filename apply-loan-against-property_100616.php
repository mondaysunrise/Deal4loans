...
<div class="lap_inner_wrapper" style="margin:auto;">
  ...
  <?php include "loan-against-property-widget_100616.php"; ?>
...
$getRatesSql = "select * FROM  `lap_interest_rate` where Status =1 and B_id in (1,2,4,17,7,3,6,5) order by Sequence asc";
