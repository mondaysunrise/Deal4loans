...
{
	var gifName = form;
	document.frmsearch.action="bajajmailer_hlview.php?search=y"+gifName;
...
<tr>
 ...
 <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
     <td align="center" valign="middle" background="images/login-form-login-bg.gif"> <form name="frmsearch" action="bajajmailer_hlview.php?search=y" method="post" onSubmit="return chkform();"><table width="95%" border="0"  cellpadding="1" cellspacing="0"> 
 ...
 <? 
		$search_qry="SELECT * FROM bajaj_finserv_mailer_leads WHERE	(bajajf_sent=1 and (bajajf_source='bfsmailerhl' or bajajf_source='bfsmailerhlTJ') and (bajajf_dated Between '".($min_date)."' and '".($max_date)."'))";	
		...
		$qry="SELECT * FROM bajaj_finserv_mailer_leads WHERE (bajajf_sent=1 and (bajajf_source='bfsmailerhl' or bajajf_source='bfsmailerhlTJ') and (bajajf_dated Between '".($min_date)."' and '".($max_date)."'))";
   ...
   <tr>
       <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["bajajf_name"]; ?></td> 
	    <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["bajajf_mobile"]; ?></td> 
		 ...
		 <td align="center" bgcolor="#DFF6FF" class="style3"><? echo getJumpMenu("bajajmailer_hlview.php",$row["bajaj_finservid"],"1",$row["bajajf_feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback); ?>
		</td>
