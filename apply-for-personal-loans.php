...
<script type="text/javascript" src="http://www.deal4loans.com/js/jquery-ui-personalized-1.5.2.packed.js"></script>
...
{ var citemps=document.personalloan_form.Employment_Status.value;
	var ni = document.getElementById('myCmpDiv');
		...
		if(document.personalloan_form.Employment_Status.selectedIndex >0 && citemps==1)
			{
				ni.innerHTML ='<table cellpadding="0" cellspacing="0" width="100%"><tr align="left">				  <td height="26" class="bldtxt" width="40%">Company Name </td><td width="60%" class="alert_msg"><input name="Company_Name" id="Company_Name" type="text" style="width:140px; "  onBlur="onBlurDefault(this,\'Type slowly for Autofill\');"  onFocus="onFocusBlank(this,\'Type slowly for Autofill\');"  onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event)" value="Type slowly for Autofill" tabindex=10 onkeydown="validateDiv(\'companyVal\');" /><div id="companyVal"></div></Td>				  </tr></table>';
							}
		}
		else
	{
...
<div class="pl_top_text_box">Personal Loans by Choice not by Chance!</div>
  ...
  <tr>
    <td bgcolor="#FFFFFF">&nbsp;</td>
          ...
          <div id="sidebar">
<div class="widget_b"><img src="new-images/pl/frm-hdng-nw030313.gif"></div>  
...
<input type="hidden" name="source" value="new personalloan New"> 
<input type="hidden" name="Activate" id="Activate" >
<input type="hidden" name="PostURL" value="<?php echo $_SERVER['REQUEST_URI']; ?>">
		  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="42%" height="35" class="form_text_pl">Full Name</td>
    <td width="58%"  class="alert_msg"><input name="Name" type="text" class="input_box" id="Name" tabindex=1  onFocus="onFocusBlank(this,'Name');"  onBlur="onBlurDefault(this,'Name');" onChange="insertData();" <? if(isset($loan_type)) { ?>value="<? echo $name; ?>" <? }else {?>value=""<? }?>  onkeydown="validateDiv('nameVal');"/>
<div id="nameVal"></div></td>
  </tr>
  <tr>
    <td height="28" class="form_text_pl">DOB</td>
    <td  class="alert_msg"><input name="day" type="text" class="dd_input" id="day" tabindex=2  onFocus="onFocusBlank(this,'dd');" onBlur="onBlurDefault(this,'dd');" onChange="intOnly(this);" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="dd" maxlength="2" onKeyDown="validateDiv('dobVal');"/> <input name="month" type="text" class="dd_input" id="month" tabindex=3 onFocus="onFocusBlank(this,'mm');" onBlur="onBlurDefault(this,'mm');" onChange="intOnly(this);" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="mm" maxlength="2" onKeyDown="validateDiv('dobVal');" /> <input name="year" type="text" class="dd_input" id="year" tabindex=4  onFocus="onFocusBlank(this,'yyyy');"   onBlur="onBlurDefault(this,'yyyy');" onChange="intOnly(this); insertData();" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="yyyy" maxlength="4" onKeyDown="validateDiv('dobVal');" /><div id="dobVal"></div></td>
  </tr>
  <tr>
    <td height="28" class="form_text_pl">Mobile No.</td>
    <td  class="form_text_pl"  >+91<input name="Phone" type="text" class="mobo_input" id="Phone"  tabindex=5 onFocus="addtooltip();" onChange="intOnly(this); tosendsms(); insertData();" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" maxlength="10"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?> onKeyDown="validateDiv('mobileVal');" /><div id="mobileVal" class="alert_msg"></div></td>
  </tr>
  <tr>
    <td height="28" class="form_text_pl">Email Id</td>
    <td class="alert_msg"><input name="Email" id="Email" type="text" <? if(isset($loan_type)) { ?>value="<? echo $Email; ?>" <? }else { ?>value=""<? } ?>   onblur="onBlurDefault(this,'Email Id');" onFocus="removetooltip();"  onChange="insertData();" tabindex=6 onKeyDown="validateDiv('emailVal');" /><div id="emailVal"></div></td>
  </tr>
  <tr>
    <td height="28" class="form_text_pl">City</td>
    <td class="alert_msg"><select name="City" class="select-input_box" id="City"  tabindex=7 onChange="validateDiv('cityVal'); addcty_oth(); addhdfclife(); insertData(); validateDiv('cityVal');"><?=plgetCityList($City)?></select><div id="cityVal"></div></td>
  </tr>
...
<tr align="left">
  ...
  <tr>
    <td height="28" class="form_text_pl">Are you a Credit card holder?</td>
    <td  class="form_text_pl"><input type="radio"  name="CC_Holder" id="CC_Holder" value="1"  style="border:none;" onClick="addElement(); validateDiv('ccholderVal');" > Yes <input type="radio"  name="CC_Holder" id="CC_Holder" style="border:none;" value="0" onClick="removeElement(); validateDiv('ccholderVal'); "> No  <div id="ccholderVal" class="alert_msg" ></div> </td>
  </tr>
	<tr align="left"> <Td colspan="2" ><div  id="myDivcc"></div></Td>		  </tr>
  <tr>
    <td height="0" colspan="2"align="center" class="form_text_pl" style="font-size:10px; text-align:left;"><input type="checkbox"  name="accept" style="border:none;" checked  > I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.<div id="acceptVal" class="alert_msg"></div></td>
  </tr>
  <tr>
    <td height="0" colspan="2" align="center">&nbsp;</td>
  </tr>
  <tr>
    <td height="28" colspan="2" align="center"><input type="image" name="Submit" src="new-images/pl/quote.gif" style="width:115px; height:29px; border:none;" /></td>
    </tr>
          </table>
          </form>
		  </div></div>
