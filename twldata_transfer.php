...
$gethdfccompany="select * from  Req_Loan_Bike_Quicktest";
...
if($i>30)
  ...
  $getinst ="INSERT INTO `Req_Loan_Bike_Quick_2010` (`Name`, `Mobile_Number`, `City`, `Age`, `Email`, `Net_Salary`, `source`, `Dated`, `Updated_Date`) VALUES ( '".$Name."', '".$Mobile_Number."', '".$City."', '".$Age."', '".$Email."', '".$Net_Salary."', 'SRC_DIRECT', '".$Dated."', '".$Dated."')";
			ExecQuery($getinst);
