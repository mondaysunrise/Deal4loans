...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO `telecaller_fullerton` (`name` ,dated, status) VALUES ('".$rm_name."', Now(),'1')";
 	$query=ExecQuery($sql);
...
<tr>
  ...
  <form name="rm_insert" action="add_tc_fullerton.php" method="post" onSubmit="return validate(document.rm_insert)">
  <table width="50%" height="100" border="0" cellpadding="5" cellspacing="0" align="center">

<tr>
      <td colspan="2"><b>Name: * </b></td>
      <td colspan="2"><input type="text" name="rm_name" >       </td>
    </tr>
