...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($page_name=="SMS LMS")
	{
		$page_name="SMS LMS";
	}
	else if($page_name=="LMS")
	{
		$page_name="LMS";
	}
	else
...
if($page_name=="SMS LMS" || $page_name=="LMS")
{//226947
	echo "<br>";
	$sql = "select * from credit_card_banks_apply where id ='".$ProductValue."'";
	list($alreadyExist,$myrow)=Mainselectfunc($sql,$array = array());
	$response_data=json_decode($myrow['response_data']);
	echo "<br>";

	echo "Application ID - <b>".$response_data->ApplicationId."</b>";
	echo "<br>";
	echo "Decision - <b>".$response_data->Decision."</b>";
	echo "<br>";
	echo "Error Message - <b>".$response_data->ErrorMessage."</b>";
	echo "<br>";
	echo "Reason - <b>".$response_data->Reason."</b>";
	echo "<br>";
