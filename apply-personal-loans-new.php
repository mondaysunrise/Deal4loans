...
.bldtxt{font-weight:bold;line-height:16px;color:#4f4d4d;}
.txt ul{	margin:0px 0px 0px 2px;	padding:0px 0px 0px 2px;}
.txt ul li{	background: url(images/cl/arrow.gif) no-repeat 0px 4px;	list-style-type:none;	color:#292323;	padding-left:15px; 	padding-right:0; 	padding-top:0; 	padding-bottom:4px}
	#ajax_listOfOptions{		position:absolute;			width:250px;			height:160px;		overflow:auto;		border:1px solid #317082;		background-color:#FFF;	color: black;		font-family:Verdana, Arial, Helvetica, sans-serif;		text-align:left;		font-size:10px;		z-index:100;	}
...
{	var ni2 = document.getElementById('myDivOC');
		...
		else
	{
		if(document.personalloan_form.City.value=="Others")
			{
				ni2.innerHTML = '<table width="100%"><tr align="left">				  <Td height="26" class="bldtxt" width="90">Other City </Td>				  <Td><input name="City_Other" id="City_Other" type="text" value="Other City" style="width:140px; " onblur="onBlurDefault(this,\'Other City\');" onchange="addhdfclife();"  onKeyUp="addhdfclife();" onfocus="onFocusBlank(this,\'Other City\');" disabled  /></Td> </tr></table>';
			}
			else
			{
				ni2.innerHTML="";
...
<input type="hidden" name="source" value="PostPaid Sent"> 
...
<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif;" color="#FF0000"><strong><?php if(isset($_GET['msg'])) echo "Kindly give Valid Details"; ?></strong></font></div><table width="95%"  border="0" align="right" cellpadding="0" cellspacing="0">
	  ...
	  <input name="Phone" id="Phone" type="text"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?>style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();" maxlength="10"  /></Td>
		  ...
		  <td colspan="2"><div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:11px;"></div></td>
				...
				<tr align="left">
				  ...
				  <Td><select style="width:142px; height:18px;  "  name="City" id="City" OnChange="addOtherCity(); addhdfclife();"  >
        <?=plgetCityList($City)?>
      </select>
 	  </Td>  </tr>
				  <tr align="left">
	...
	<span id='wordIncome' style='font-size:11px;font-weight:bold;color:666699;font-Family:Verdana;text-transform: capitalize;   margin-left:10px; margin-bottom:5px;'></span></td>
				  ...
				  <tr>
			  <td colspan="2" class="bldtxt"><div id="adtxt"></div></td></tr>
				<tr align="left">
...
No</Td>
				...
				<tr align="left">
				  <Td colspan="2" ><div  id="myDiv"></div></Td>
					...
					<tr align="left">
				  <Td height="50" colspan="2" style="font-size:9px;"><input type="checkbox"  name="accept" style="border:none;" checked  > I authorize Deal4loans.com & its partnering banks to contact me to explain the product & I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a><br /></Td>
				  </tr>
				   <tr>
