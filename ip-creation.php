<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$Email = $_POST['Email'];
		$PWD = $_POST['PWD'];
		if($Email=="ipwhitelist@d4l.com" && $PWD == "d4liplistnw")
		{
			$_SESSION['Email'] = "ipwhitelist@d4l.com";
			$_SESSION['UName'] = "ipwhitelist Creation";
			$_SESSION['BidderID'] = "190015";
			$_SESSION['UserType'] = "ipwhitelist";
//			echo "upendra";
			header("Location: create-ip.php");
			exit();
		}
		else
		{
