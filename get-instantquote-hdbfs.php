...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="450" height="75" align="left" valign="top">
    <img src="images/logo-hdhfs.jpg"  border="0" />
    &nbsp;</td>
    <td width="387" >&nbsp;</td>
    ...
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" class="hdng-bg">HDBFS Apply Application</td>
          </tr>
          <tr>
...
<form name="loan_form" method="post" action="get-instantquotehdbfs-continue.php" onSubmit="return submitform(document.loan_form);">
...
<select name="Residential_Status" id="Residential_Status" gtbfieldid="16"  style="width:143px;   height:21px;" >
 ...
 <tr>
	...
	<td width="3%" align="center" class="frmtxt">&nbsp;</td>
	<td width="54%" align="left" class="nrmltxt"><input name="other_emi" id="other_emi" type="text" style="width:140px;  height:21px;" maxlength="11" onfocus="this.select();"   /> </td>
  </tr> 
  <tr valign="bottom">
