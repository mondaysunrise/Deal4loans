...
<div class="ccs_inner_wrapper">
  ...
  <div class="common-bread-crumb"><a href="index.php" style="color:#0e79b9; font-size:14px;">Home</a><span style="color:#0e79b9; font-size:14px;"> » </span><a href="credit-cards.php" style="color:#0e79b9; font-size:14px;"> Credit Card</a> <span style="color:#0e79b9; font-size:14px;">» <span style="color:#4c4c4c; font-size:14px;">Credit Card Mustread</span></div></span>
  <div class="ccs_left_box">
    <h1 class="cc-h1" itemprop="name">Credit Card Mustread</h1>
    ...
    <div id="txt">The origin of the Credit card industry can be traced back to as far as 1914. The Credit cards have definitely come a long way since.<br>
      For many the Credit card has become a necessity - Be it paying for your lunch in a restaurant or buying clothes at a designer outlet or getting your hands on the latest gadgets, nothing compares to <a href="http://www.deal4loans.com/credit-cards.php" title="credit card">credit  card</a> when  it comes to convenience.<br>
      <br>
      ...
      <br>
      When you <a href="http://www.deal4loans.com/apply-credit-card.php" title="apply Credit card"> apply  Credit card</a>, the application  you submit is carefully analyzed and the documents you provide are verified. Then a credit limit for your card is set for you, based on your net income, your credit history and other such factors.<br>
      <br>
      ...
      <ul>
        ...
        <li>Also do not discard your <a href="http://www.deal4loans.com/loans/credit-card/know-your-credit-card-statement-in-a-better-way/" title="Credit card statements"> Credit card statements</a>or receipt that has your PIN or account number. Shredding or burning them would be wise. Here are few features that you should not miss.</li>
...
<br>
  ...
  <div class="rightpanel-new"> <?php include "right-cc-dc-widget.php"; ?> </div>
</div>
<div style="clear:both;"></div>
<div class="hide-top">
