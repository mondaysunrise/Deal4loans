...
?>
<!--<div style="position:absolute; z-index:100; margin-left:500px; top:110px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; color:#a41c2b;">
	PIE CHART
<img src="http://chart.apis.google.com/chart?chs=250x100&cht=p3&chd=t:<? echo $lnpre; ?>,<? echo $inper; ?>,<? echo $pfper; ?>&chxt=x,y&chds=0,100&chxr=0,0,90|1,0,90&chxl=0:|<? echo $lnpre." %"; ?>|<? echo $inper." %"; ?>|<? echo $pfper." %"; ?>&chco=A2D7F6,F4E46C,A56119"/>
 <table width="98%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="86%" style="font-size:11px; font-family:Verdana, Arial, Helvetica, sans-serif; color:#5b5b5b ">Interest Ammount - <? //echo "Rs. ".number_format($total_interest); ?></td>
  </tr>
  <tr>
