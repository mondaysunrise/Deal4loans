...
{
	var gifName = form;
	document.frmsearch.action="indusind_indmlrindex.php?search=y"+gifName;
...
<tr><td>&nbsp;</td></tr>
 ...
 <form name="frmsearch" action="indusind_indmlrindex.php?search=y" method="post" onSubmit="return chkform();">
 <input type="hidden" name="citys" id="citys" value="<? echo $citys; ?>">
   ...
   <td colspan="3" align="center"><table border="0" cellpadding="0" cellspacing="0" width="85%">
     ...
     <td width="30%"  valign="middle" class="bidderclass">
        ...
        <td><table><tr><td width="15%" valign="middle" class="style1">Feedback:</td>
...
//echo $qry;
 ...
 ?>
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3"><? if($row["indusbnk_occupation"]==0) { echo "Self Employed"; } else { echo "Salaried"; }?></td> 
   	    <td align="center" bgcolor="#DFF6FF" class="style3"><? echo getJumpMenu("indusind_indmlrindex.php",$row["indusbnkid"],"1",$row["feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val) ?>		</td>
