        ...
        <td height="33" bgcolor="#f6f6f6" class="hdng">Features of HDFC Bank Personal Loan</td>
              ...
              <tr>
                <td><table width="97%"  border="0" align="right" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td width="21"><img src="new-images/hdfc-pl/bullet.gif" width="8" height="8"></td>
                    <td height="35" class="blutxt" >Rate of Interest ranges between 13.99-22.25 %</td>
                    <td width="24"><img src="new-images/hdfc-pl/bullet.gif" width="8" height="8"></td>
            ...
            <td width="276" height="369"  align="right" valign="top" class="rgtfrmbg"><form name="hdfc_calc" method="POST" action="hdfc-personal-loan-newcontinue.php" onSubmit="return chkpersonalloan(document.hdfc_calc);">
...
<td colspan="2"  ></td></tr>
			   <!-- <tr>
                ...
                <tr align="left" valign="middle">
                  <td height="35" colspan="2"><input type="checkbox" style="border:none ;" name="accept" id="accept" tabindex="8" checked="checked"><font style="font-family: verdana; font-size:10px; font-weight:normal; "> I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a></font></td>
                </tr>
