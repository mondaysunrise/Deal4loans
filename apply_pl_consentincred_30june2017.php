    ...
    <head>
        ...
        <script Language="JavaScript" Type="text/javascript">
            ...
            function ckhcreditcard(Form)
            {
                ...
                {
                    alert("Please Choose Bank Statement");
				...
				if (Form.doc_name.value == "")
                {
				 ...
				 if (Form.uploadFile_another.value == "")
                {
                    alert("Please Choose KYC Doc");
                    Form.uploadFile_another.focus();
                    return false;
                }
                ...
                <div id="content"><form name="cibil_form" method="post" action="/apply_pl_consentincred_continue.php" target="_blank" enctype="multipart/form-data" onSubmit="return ckhcreditcard(document.cibil_form);">
                        ...
                        <table align="center"  cellpadding="5" cellspacing="0"  width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="designation" id="designation" class="bajaj-fin_input"/></td></tr>
                            <tr>
							...
							<tr>
								...
								<tr>
                                <td class="sbi_text_c" height="25">Which Document:</td>
                                <td>
