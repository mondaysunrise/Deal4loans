...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$strUpdateSQL="Update Req_Loan_Personal Set Name='".$_REQUEST['Name']."',DOB='".$DOB."',Pancard='".$_REQUEST['PANCard']."', Cibilscore='".$_REQUEST['cibilScore']."', Cibilok='".$_REQUEST['cibilOk']."' Where RequestID=".$_REQUEST["postid"];
...
$followup_date="";
$ccdetails = "select Employment_Status,CC_Holder,Dated,DOB,Name,Email,Company_Name,City,City_Other,Mobile_Number,Net_Salary,Loan_Amount,Pincode,IP_Address,Add_Comment,Residence_Address,Total_Experience,Pancard, Cibilscore, Cibilok from Req_Loan_Personal Where (RequestID=".$requestid.")";
//echo $ccdetails."<br>";
...
function formValidate(Form){
	...
	//alert(Form.PANCard.value.charAt(3));
	if(a!="")
	{
