...
$showRatingStr = "select avg(rating) as averageR,count(page_name) as total_review from product_rating where page_name='".$page_name."' and status=1";
list($alreadyExist2,$showRatingQry)=MainselectfuncNew($showRatingStr,$array = array());

$avg_rating = round($showRatingQry[0]['averageR'],1);
//$total_records = mysql_result($showRatingQry,1);
$showtotalReviewStr = "select id from product_rating where page_name='".$page_name."' and status=1";
list($total_records,$showtotalReviewQry)=MainselectfuncNew($showtotalReviewStr,$array = array());
...
.lowest_form_left_text{ float:left; width:431px; margin-top:25px;}
...
<link rel="stylesheet" type="text/css" href="menu-style.css"></head>
...
<div class="pl_titile_wraper">
	<h1 class="text3" id="title_pl">Personal Loan</h1>
</div>
...
<div class="pl_titile_wraper" style="width:100%;">
  	<div itemscope itemtype="http://schema.org/Product">
   	<h1 id="title_pl" itemprop="name"><strong>Personal Loan</strong></h1>
    <div itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" style="float:right; margin-top:25px;">
...
<div style=" color: #fff; float: left;  font-size: 15px; margin-left: 20px;  text-transform: none;">
<div class="lowest_form_left_text"><strong class="text3" style=" color:#FFF; font-size:15px; text-transform:none; "> Compare Personal Loan Rates - Eligibility - Process of All Banks.</strong></div>
<div class="lowest_form_right_text"><a href="http://www.deal4loans.com/lowestratequote.php" style="text-decoration:none;" target="_blank"><img src="new-images/personal-loans.jpg" width="203" height="58" border="0" /></a></div>
...
<div class="pl_input_box" style="float:right; padding-right:-7px;">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
    	<td height="25" align="right" id="otherCityName"><img src="images/get1.gif" border="0" width="114" height="45" /></td>
    </tr>
</table>
</div>
<div style="clear:both;"></div>
...
<div style="clear:both;"> </div>
 ...
 <div class="pl_compare_a"><img src="images/compare-offers1.jpg" width="371" height="80" /></div>
 
 <div class="pl_compare_c">
   <?php include "special-offers_table1.php"; ?>
 </div>
<div class="pl_text_wrapper">
<div style=" width:100%; height:auto; margin-top:5px; text-align:justify;"><br /><span class="style9">
<a href="http://www.deal4loans.com/loans/personal-loan/personal-loan-charges-india/" class="text12" style="color:#0080d6;" target="_blank"><strong>Charges</strong></a> | <a href="http://www.deal4loans.com/loans/personal-loan/important-pointers-in-personal-loan-india-deal4loans/" class="text12" style="color:#0080d6;" target="_blank"><strong>Pointers</strong></a> | <a href="http://www.deal4loans.com/loans/personal-loan/latest-personal-loan-trends/" class="text12" style="color:#0080d6;" target="_blank"><strong>Latest Trends</strong></a></span><br />

<span class="style3" style="color:#4c4c4c; size:18px;; font-weight: normal; font-variant: normal; color: #005399; text-decoration: none; font-style: italic; @import url(http://fonts.googleapis.com/css?family=Droid+Serif);"><h3 class="style4" style="font-weight:normal;">Most borrowed Personal loans in India</h3>
</span>
<table border="1" cellspacing="0" cellpadding="5" width="100%">
  <tbody>
    <tr>
        <td valign="top" class="table_text"><strong>Bank Name</strong></td>
        <td valign="top" class="table_text"><strong>Pre Payment Charges</strong></td>
        <td valign="top" class="table_text"><strong>Processing Fees</strong></td>
        <td valign="top" class="table_text"><strong>Loan Disbursement Time</strong></td>
        <td valign="top" class="table_text"><strong>Maximum Loan Amount</strong></td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/hdfc-personal-loan-eligibility.php" target="_blank">HDFC Bank Personal Loan</a></td>
        <td valign="top" class="table_text">4.00%</td>
        <td valign="top" class="table_text">0.8% – 1.75% (for Special Companies) 2% (HDFC)</td>
        <td valign="top" class="table_text">2-3 working Days</td>
        <td valign="top" class="table_text">Rs.50,000 to 15 lakhs</td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/personal-loan-icici-bank.php" target="_blank">ICICI Personal Loan</a></td>
        <td valign="top" class="table_text">5% Or Nil (For Loan Amount More Than 10 Lacs)</td>
        <td valign="top" class="table_text">0.8% for special companies else 2%</td>
        <td valign="top" class="table_text">3-4 Working Days</td>
        <td valign="top" class="table_text">Rs.50,000 to 15 lakhs</td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/personal-loan-sbi.php" target="_blank">State Bank of India Personal Loan</a></td>
        <td valign="top" class="table_text">Nil</td>
        <td valign="top" class="table_text">2.02%-3.03%</td>
        <td valign="top" class="table_text">1 Week</td>
        <td valign="top" class="table_text">Determined by your income and repayment capacity.</td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/loans/personal-loan/bajaj-finserv-lending-personal-loan-eligibility-documents-interest-rates-apply/" target="_blank">Bajaj Finance Personal Loan</a></td>
        <td valign="top" class="table_text">Nil</td>
        <td valign="top" class="table_text">2.00% – 2.50%</td>
        <td valign="top" class="table_text">48 Working Hours</td>
        <td valign="top" class="table_text">Upto 25 lakhs</td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/fullerton-personal-loan-eligibility.php" target="_blank">Fullerton India</a></td>
        <td valign="top" class="table_text">4.00%</td>
        <td valign="top" class="table_text">2.00%</td>
        <td valign="top" class="table_text">2-8 Working Days</td>
        <td valign="top" class="table_text">&nbsp;</td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/loans/personal-loan/indusind-bank-personal-loan-interest-rates-eligibility-documents/" target="_blank">IndusInd Bank</a></td>
        <td valign="top" class="table_text">&nbsp;</td>
        <td valign="top" class="table_text">N.A</td>
        <td valign="top" class="table_text">4 Working Days</td>
        <td valign="top" class="table_text">Rs.50,000 to 15 lakhs</td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/personal-loan-axis-bank.php" target="_blank">Axis Bank Personal Loan</a></td>
        <td valign="top" class="table_text">Nil</td>
        <td valign="top" class="table_text">2.00%</td>
        <td valign="top" class="table_text">1 Week</td>
        <td valign="top" class="table_text">Rs.50,000 to 15 lakhs</td>
    ...
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/personal-loan-ingvysya-bank.php" target="_blank">ING Vysya</a></td>
        <td valign="top" class="table_text">0% (Valid till 31st December 14 )</td>
        <td valign="top" class="table_text">0.5 -  2%</td>
        <td valign="top" class="table_text">1-4 Working Days</td>
        <td valign="top" class="table_text">Loan up to 15 Lac*</td>
    </tr>
    <tr>
        <td valign="top" class="table_text"><a href="http://www.deal4loans.com/kotak-personal-loan-eligibility.php" target="_blank">Kotak Mahindra</a></td>
        <td valign="top" class="table_text">5.00%</td>
        <td valign="top" class="table_text">1.50% - 2.00%</td>
        <td valign="top" class="table_text">3-4 Working Days</td>
        <td valign="top" class="table_text">Rs. 50000 to Rs. 15 Lakhs</td>
    </tr>
  </tbody>
</table>
...
<h3 class="style4" style="font-weight:normal;">Tips for Best Personal loan deal</h3>
</span>
...
<div class="text" style=" width:100%; height:auto; margin-top:5px; text-align:justify;">
  <h3 class="style5" style="font-weight:normal;">Basics to Compare Personal Loans</h3>
</div>
  <p class="text11" style="color:#4c4c4c; ">
    •&nbsp;<strong>Compare  Interest Rates:</strong>&nbsp;Unsecured Loan can be compared primarily on the basis  of interest rates which vary across banks depending on your profile which is  further linked to your occupation, salary/income, credit history etc and the  company that you work with. The personal loan interest rates ranges from 12% to 25%, you must go for that loan which  is offering you at the minimum rate. These rates are lowest if you are working  in top 5000 companies in India and you have income  above 75000 and you have a good cibil track.<br />
  <br />
  ...
  <br />
    •&nbsp;<strong>EMIs:</strong>&nbsp;EMI  is the monthly equated installment which constitutes the principal amount and  the interest on the principal equally divided across each month in the loan tenure. <br />
  <br />
  ...
  <br />
    •&nbsp;<strong>Eligibility  Check:</strong>&nbsp;Before taking a loan you must know the eligibility criteria’s  offered by various banks on the basis of which they offer loans and also  compare personal loan banks. Checking the eligibility  parameters will help you find the best loan deal.&nbsp;<a href="http://deal4loans.com/Contents_Personal_Loan_Eligibility.php">Check out  your eligibility by various banks</a>.<br />
  <br />
