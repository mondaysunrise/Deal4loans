...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="border:#0033CC 1px solid;">
 ...
 <form name="frmsearch" action="hl_mis_log.php?search=y" method="post" >
   <tr>
...
$table .= "<tr>";
	...
	$totalBiddSql = "SELECT BidderID,Bidder_Name,Start_Time,End_Time,IP from LMSLoginDetails WHERE (BidderID='".$BidderID[$j]."' and Product_Type=2 and (Start_Time Between '".$sDate."' and '".$eDate."'))";
	//echo $totalBiddSql."<br>";	
		$totalBiddQuery = ExecQuery($totalBiddSql);
...
$table .= "<table border='1' cellspacing='0' cellpadding='3' width='100%'>";
		if($totalNumBidd>0)
		{
			...
			for($tm=0;$tm<$totalNumBidd;$tm++)
			{
				...
				$Bidd_Name = mysql_result($totalBiddQuery,$tm,'Bidder_Name');
				...
				$table .= "<td class='data_text_a' >".$Bidd_Name."</td>";
