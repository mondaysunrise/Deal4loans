...
function addElementLoan()
{
	...
	ni1.innerHTML = 'Any Loan running with Fullerton India?';
	ni2.innerHTML = '<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="sbi_text_c"  ><tr><td align="left" height="30" class="bldtxt"> <input type="radio" style="border:none;"  value="1"  name="fullerton_loan"  /> Yes &nbsp;  <input size="10" type="radio" style="border:none;" name="fullerton_loan"  value="0"> No</td></tr></table>';
      ...
      <div id="dobVal"></div></td>
			  ...
			  <tr>
			    <td height="25" valign="middle" bgcolor="#FFFFFF" class="alert_msg" ><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			      <tr>
			        <td width="4%" ><select name="Residential_Status" class="sbi_input" id="Residential_Status"  onchange="validateDiv('resiStatusVal');" >
