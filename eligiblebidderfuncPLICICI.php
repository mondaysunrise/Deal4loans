...
{   
	...
	$qry = "Select * from Bidders_List Where (BankID=66 and City like '%".$strcity."%' and Restrict_Bidder=1 and Reply_Type=1) order by Bidder_Name ASC";
	...
	$Total4LifeTime = $row_result_LT[0]['SumLifeTime'];
		...
		else
		{
			...
			$ValidBidder_Day=1;
			$ValidBidder_Week=1; $ValidBidder_Month=1; $ValidBidder_LT=1;
