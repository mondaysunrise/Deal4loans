...
<? //}?></td>
           ...
           <tr>
              <td height="25"  align="left" colspan="2"><font color="#330101">Which of the folLowing Deocuments you Have?</font></td></td>
            </tr>
            <tr>
              <td colspan="2"><!--      <h3>FAQs</h3>-->
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td height="20" align="center" valign="middle"><input type="checkbox" value="Latest 3 months Salary Slip" name="Document_proof[]" id="income_proof"  style="border:none;"/></td>
                            <td align="left">Latest 3 months Salary Slip</td>
							<td width="4%" align="center" valign="middle"><input type="checkbox" value="Latest 3 months Salary Slip" name="Document_proof[]" id="income_proof"  style="border:none;"/></td>
                          ...
                          <tr>
                            <td width="4%" height="20" align="center" valign="middle"><input type="checkbox" value="Pancard" name="id" / style="border:none;" /></td>
                          ...
                          <tr>
                            ...
                            <td align="center" valign="middle"><input type="checkbox" value="Driving Licence" name="Document_proof[]" id="Document_proof"  style="border:none;"/></td>
                          ...
                          <tr>
                            <td height="20" align="center" valign="middle"><input type="checkbox" value="Telphone Bill" name="Document_proof[]" id="Document_proof"  style="border:none;"/></td>
