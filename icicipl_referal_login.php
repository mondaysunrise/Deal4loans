<?php
	...
	$PWD =  trim($_POST["PWD"]);
	if(isset($PWD) && isset($Email) && $Email=="icicipl_referal@d4l.com" && $PWD=="icicipl")
	{
$_SESSION["UserType"] = "bidder";
				$_SESSION['UName'] = "ICICI";

	 $strDir = dir_name();
	header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."icicipl_referal_index.php");
	exit;
