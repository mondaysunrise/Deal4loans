<?php
	...
	$getpldetails="select Employment_Status,RequestID,Email,City,Net_Salary,source From Req_Loan_Personal Where (RequestID='".$leadid."')";
...
$getplnwdetails="select City,Net_Salary From Req_Loan_Personal Where (RequestID='".$plrow["RequestID"]."')";
	...
	//$plnrow = mysql_fetch_array($getplnwdetails);
