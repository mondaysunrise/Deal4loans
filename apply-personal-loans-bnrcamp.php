...
<div id="nameVal" class="alert_msg"></div></td>
  ...
  <tr>
    ...
    <td><select name="Employment_Status" class="select_input_bnr" id="Employment_Status" tabindex=9 onChange="chgtxtsal(); validateDiv('empStatusVal');" >        <option selected value="-1">Employment Status</option><option value="1">Salaried</option><option value="0">Self Employed</option></select><div id="empStatusVal" class="alert_msg"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center"><input type="image" name="Submit"  src="new-images/apply-aduncle.jpg"  style="width:115px; height:29px; border:none; " tabindex="13" /></td>
    </tr>
          </table>
          </form>
		  </div>
