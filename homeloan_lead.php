...
if(strlen($Final_Bid)>0)
	 ...
	 if(strlen($hlfeedback)>0)
	{
		...
		$result = ExecQuery("select FeedbackID,not_contactable_counter from Req_Feedback_HL where AllRequestID=".$post." and BidderID in (732,812,460,207,64) AND Reply_Type=2");	
...
<?php
//if($source=="Balance Transfer Calc")
//{
?>
<tr>
