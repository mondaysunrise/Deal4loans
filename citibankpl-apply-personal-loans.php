...
<input type="hidden" name="source" value="PC0BL"> 
...
<div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:11px; font-weight:normal; padding-left:10px; padding-bottom:3px;"></div>

	<div class="form-bg"><span class="form-text">Email Id</span>
	  <input name="Email" id="Email" type="text" <? if(isset($loan_type)) { ?>value="<? echo $Email; ?>" <? }else { ?>value="Email Id"<? } ?> style="margin-left:72px; width:140px; margin-top:2px;"  onblur="onBlurDefault(this,'Email Id');" onFocus="removetooltip();"  onChange="insertData();"/>
	</div>
	...
	<div class="form-bg"><span class="form-text">Annual Income</span>
...
<div style="margin-left:15px; margin-bottom:8px;"><input type="checkbox"  name="accept" style="border:none;" checked  >I authorize Deal4loans.com & its partnering banks to contact me to explain the product & I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a></div>
