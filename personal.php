...
<?php include "pl-formcity-widget.php";?>
</div>
...
<tr>
<td height="47" width="13%" align="center" bgcolor="#eceffa" class="apply_pl_table_text_new" style=" padding-left:5px; padding-right:5px;">Banks</td>
<td height="47" width="10%" align="center" bgcolor="#eceffa" class="apply_pl_table_text_new" style="padding-left:5px; padding-right:5px;" nowrap="nowrap">Rate of Interest</td>
<td height="47" width="17%" align="center" bgcolor="#eceffa" class="apply_pl_table_text_new" style="padding-left:5px; padding-right:5px;" nowrap="nowrap">Processing Fee</td>
        <td height="47" width="18%" align="center" bgcolor="#eceffa" class="apply_pl_table_text_new" style="padding-left:5px; padding-right:5px;" nowrap="nowrap">Loan Amount</td>
        <td height="47" width="18%" align="center" bgcolor="#eceffa" class="apply_pl_table_text_new" style="padding-left:5px; padding-right:5px;" nowrap="nowrap">Prepayment Charges</td>
        <td height="47" width="13%" align="center" bgcolor="#eceffa" class="apply_pl_table_text_new" style="padding-left:5px; padding-right:5px;" nowrap="nowrap">Disbursal Time</td>
        <td height="47" width="10%" align="center" bgcolor="#eceffa" class="apply_pl_table_text_new" style="padding-left:5px; padding-right:5px;">Part Payment Option</td>
    </tr>
	<?php
	...
	?>    
    <tr>
        <td height="64" align="center" <?php echo $addBgcolor; ?> class="apply_pl_table_text_new-c" style="border-right:#fbf9f6 solid thin; font-size:14px;"><strong><?php echo $showBankInfoResult[$j]['pl_bank_name']; ?></strong></td>
        <td height="64" align="center" <?php echo $addBgcolor; ?> class="apply_pl_table_text_new-c" style="border-right:#fbf9f6 solid thin;"><?php echo $showBankInfoResult[$j]['pl_bank_roi']; ?></td>
        <td height="64" align="center" <?php echo $addBgcolor; ?> class="apply_pl_table_text_new-c" style="border-right:#fbf9f6 solid thin;"><?php echo nl2br($showBankInfoResult[$j]['pl_bank_processing_fee']); ?></td>
        <td height="64" align="center" <?php echo $addBgcolor; ?> class="apply_pl_table_text_new-c" style="border-right:#fbf9f6 solid thin;"><?php echo $showBankInfoResult[$j]['pl_bank_loan_amt']; ?></td>
        <td height="64" align="center" <?php echo $addBgcolor; ?> class="apply_pl_table_text_new-c" style="border-right:#fbf9f6 solid thin;"><?php echo nl2br($showBankInfoResult[$j]['pl_bank_prepayment']); ?></td>
        <td height="64" align="center" <?php echo $addBgcolor; ?> class="apply_pl_table_text_new-c" style="border-right:#fbf9f6 solid thin;"><?php echo $showBankInfoResult[$j]['pl_bank_disbursal_time']; ?></td>
        <td height="64" align="center" <?php echo $addBgcolor; ?> class="apply_pl_table_text_new-c"><?php echo $showBankInfoResult[$j]['part_payment_option']; ?></td>
    </tr>
    <?php 
		}
	}else{ 
...
<?php 
$getStateSql = "select * from city_pages where City='".$CityN."' and Product='Personal Loan' ";
list($CountVal,$getSateQuery)=MainselectfuncNew($getStateSql,$array = array());
$State = $getSateQuery[0]['State'];
$getCitySql = "select * from city_pages where City!='".$CityN."' and state='".$State."' and Product='Personal Loan' ";
list($CityCount,$getCityQuery)=MainselectfuncNew($getCitySql,$array = array());
?>
<div class="state-main-box">
<div class="head-left">Find Personal Loan Deals in Your City</div>
<div class="righthead"><a style="text-decoration:none !important;" href="http://www.deal4loans.com/loans-in/<?php echo $State;?>">Personal Loan <?php echo ucwords($State);?></a></div>
<div style="clear:both;"></div>
<div>
...
?>
<li class="state-box"><a href="http://www.deal4loans.com/personal-loan/<?php echo $City;?>" alt="<?php echo ucfirst($City);?> Personal Loan"><?php echo ucfirst($City); ?></a></li>
<?php 
	}
