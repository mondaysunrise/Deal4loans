...
{
?><body class="<?php //echo $model; ?>" style="width:800px; overflow-y:hidden; overflow-x:hidden; border-radius:8px 8px 8px 8px; background-color:#000000;" >
<?php
}
 else
 {
 ?>
 <body class="<?php //echo $model; ?>" style="width:800px; background: #F5F5F5; border-radius:8px 8px 8px 8px; overflow-y:hidden; overflow-x:hidden;  background-color:#000000;">
 <?php
 }
...
<div class="<?php echo $model; ?>_menu_top_text_box" style="color:#FFFFFF;"><?php 
...
$getLowestQuery = ExecQuery($getLowestSql);
$hdfc_car_name = mysql_result($getLowestQuery,0,'hdfc_car_name');
?>


      <td align="center" width="150" height="120"><table width="122"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="100" align="center" valign="middle"><a href="https://www.deal4loans.com/car-loan-hdfc-bank-step2.php?car_name=<?php echo $hdfc_car_name; ?>" style="font-size:16px; text-decoration:none;" target="_parent"><div id="<?php echo $model; ?>bgColor"><div class="<?php echo $model; ?>-body_text3" style="font-size:16px;"><br /><br /><?php echo ucfirst($hdfc_car_model_display); ?></div></div></a> </td></tr></table>
