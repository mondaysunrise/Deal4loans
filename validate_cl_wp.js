...
function addPersonalDetails()
{
	...
	ni3.innerHTML = '<div><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="21%"  align="left" style="font-size:19px; padding-top:5px;"> Personal Details</td><td><img src="/images/security.png" width="14" height="16"> Your Information is secure with us and will not be shared without your consent</td></tr></table></div> <div style="clear:both;"></div><div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td  class="formhlwpbody-text">Full Name:<span style="color:#FF0000; font-weight:bold;">*</span></td>  </tr><tr>    <td  height="25"><input name="Name" id="Name"  class="input" type="text"  /><div id="nameVal"></div></td>    </tr>    </table>    </div><div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text">Mobile:<span style="color:#FF0000; font-weight:bold;">*</span></td>  </tr><tr>       <td>      <table><tr><td class="text" style=" padding-top:3px;">+91</td><td class="text"> <input type="text" class="mobile" name="Phone" id="Phone" maxlength="10"   onkeyup="intOnly(this);" onkeypress="intOnly(this)"; onchange="intOnly(this);" onblur="return Decorate1(\' \')" onfocus="addtooltip();" tabindex="5"/></td></tr></table>              </td>    </tr>        </table>    </div><div class="input_box"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">  <tr>      <td class="formhlwpbody-text" >Email ID :<span style="color:#FF0000; font-weight:bold;">*</span></td>   </tr><tr>    <td height="25" >      <input type="text" name="Email" id="Email"   class="input"  tabindex="6" /></td>    </tr>  </table></div><div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text">DOB:<span style="color:#FF0000; font-weight:bold;">*</span></td>   </tr><tr>    <td height="25" ><input name="day" type="text" id="day"  value="DD" class="dd" onblur="onBlurDefault(this,\'dd\');" onfocus="onFocusBlank(this,\'dd\');" maxlength="2" onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="2"/> <input  name="month" type="text" id="month" class="dd" value="MM" onblur="onBlurDefault(this,\'mm\');" onfocus="onFocusBlank(this,\'mm\');" maxlength="2" onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="3"/> <input name="year" type="text" id="year" class="yy" value="YYYY" onblur="onBlurDefault(this,\'yyyy\');" onfocus="onFocusBlank(this,\'yyyy\');" maxlength="4" onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="4"/> </td></tr></table></div> ';
	var ni20 = document.getElementById('City').value;
	if(ni20=='Others')
	{
		ni1.innerHTML = '<div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td class="formhlwpbody-text">Other City:</td></tr><tr><td height="25"><input type="text" name="City_Other" value="Other City" onfocus="this.select();" class="input" tabindex="8" /> </td></tr></table>    </div>  <div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text">Company Name:</td> </tr><tr>      <td>      <input type="text" name="Company_Name" class="input" onfocus="addrest();" tabindex="9" onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event)" autocomplete="off"/>    </td>    </tr>  </table></div><div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text">Car Type:</td>   </tr><tr>     <td height="25" >  <select  class="select" name="Car_Type" tabindex="12">                          <option selected value="-1">Interested In</option>				<option  value="1">New Car</option>				<option value="0">UsedCar</option>                       </select>                      </td>    </tr>        </table>    </div>   <div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text"><em>Car Booked:</em></td>  </tr><tr>    <td  style=" color:#FFF; font-size:12px;">      <table cellpadding="0" cellspacing="0"><tr><td class="formhlwpbody-text"><input type="radio" value="2" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="adddel_dt();" > Yes </td><td class="formhlwpbody-text"><input type="radio" value="1" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="removedel_dt();" > No</td></tr></table>      </td>    </tr> <tr>                <td  colspan="2"><div  id="myDivdel_dt"></div>          </td>    </tr>  </table></div><div style="clear:both;"></div><div class="box_term"><input type="checkbox"  name="accept" style="border:none;"  > I Agree to&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  class="text">privacy policy</a> and&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow" class="text" >Terms and Conditions</a>.</div>                   <div class="hl_emi_get_quote"><input type="image" src="/images/wp-loan-get-quote.png" margin-bottom: 0px;" value=""/></div><div style="clear:both;"></div><div style="clear:both;"></div>';
	}
	else
	{
		ni1.innerHTML = '<div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td class="formhlwpbody-text">Other City:</td></tr><tr><td ><input type="text" name="City_Other" disabled  value="Other City" onfocus="this.select();" class="input" tabindex="8" /> </td></tr></table>    </div>  <div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text">Company Name:</td> </tr><tr>      <td>      <input type="text" name="Company_Name" class="input" onfocus="addrest();"    tabindex="9" onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event)" autocomplete="off"/>    </td>    </tr>  </table></div><div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text">Car Type:</td>   </tr><tr>     <td height="25" >  <select  class="select" name="Car_Type" tabindex="12">                          <option selected value="-1">Interested In</option>				<option  value="1">New Car</option>				<option value="0">UsedCar</option>                       </select>                      </td>    </tr>        </table>    </div>   <div class="input_box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td class="formhlwpbody-text"><em>Car Booked:</em><span style="color:#FF0000; font-weight:bold;">*</span></td>  </tr><tr>    <td  style=" color:#FFF; font-size:12px;">      <table cellpadding="0" cellspacing="0"><tr><td class="formhlwpbody-text"><input type="radio" value="2" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="adddel_dt();" > Yes </td><td class="formhlwpbody-text"><input type="radio" value="1" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="removedel_dt();" > No</td></tr></table>      </td>    </tr> <tr>                <td  colspan="2"><div  id="myDivdel_dt"></div>          </td>    </tr>  </table></div><div style="clear:both;"></div><div class="box_term"><input type="checkbox"  name="accept" style="border:none;"  > I Agree to&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  class="text">privacy policy</a> and&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow" class="text" >Terms and Conditions</a>.</div>                   <div class="hl_emi_get_quote"><input type="image" src="/images/wp-loan-get-quote.png" margin-bottom: 0px;" value=""/></div><div style="clear:both;"></div>  <div style="clear:both;"></div>';
