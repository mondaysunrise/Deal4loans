...
$age=$currentyear-$year;
	...
	list($Getnum,$plrow)=Mainselectfunc($getpldetails,$array = array());
...
$monthsalary =$Net_Salary/12;
	...
	if($leadid>0)
				...
				$DataArray = array("ABMMU_flag"=>$ABMMU_flag, "Company_Type"=>$Company_Type, "PL_EMI_Amt"=>$PL_EMI_Amt,"Primary_Acc"=>$Primary_Acc, "Residential_Status"=>$Residential_Status, "Card_Limit"=> $Credit_Limit, "Years_In_Company"=>$Years_In_Company, "Total_Experience"=>$Total_Experience, "EMI_Paid"=>$EMI_Paid, "Loan_Any"=>$Loan_A, "identification_proof"=>$Document_proof_doc);
...
<META HTTP-EQUIV="Refresh" CONTENT="5;URL=apply-pl-bajajfinserv3.php"> 
