...
if((strlen(trim($requestid))<=0))
	...
	$query="SELECT Employment_Status,BidderID, RequestID, Feedback_ID, DOB, Name, Email, Mobile_Number, Net_Salary, Company_Name, Pincode, City, Gender, State, Pancard, Residence_Address, applied_card_name, Allocation_Date FROM Req_Feedback_Bidder_CC,Req_Credit_Card WHERE Req_Feedback_Bidder_CC.AllRequestID= Req_Credit_Card.RequestID and Req_Feedback_Bidder_CC.BidderID=5737 and Req_Feedback_Bidder_CC.Reply_Type=4 and  Req_Feedback_Bidder_CC.Feedback_ID='1627809' order by Feedback_ID ASC LIMIT 0,10";
...
if($Feedback_ID>0)
	{
$update=ExecQuery("Update Req_Compaign set RequestID=".$Feedback_ID." Where (Reply_Type='4' and Bank_Name='HDFC Bank' and BidderID=5737)");

$qrydt= ExecQuery("INSERT INTO webservice_bidder_details (leadid,product,feedback,bidderid,doe, cust_requestid) VALUES('".$Feedback_ID."','4','".$result."','5737',NOW(),'".$RequestID."')");
	}
}
}
...
$hdfcqryresult = ExecQuery($checkduplicate);
$rowhdfc=mysql_fetch_array($hdfcqryresult);
