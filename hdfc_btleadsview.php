...
{
	var gifName = form;
	document.frmsearch.action="hdfc_btleadsview.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="hdfc_btleadsview.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="0"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><?$current_date=date('Y-m-d');?> 
	   <input name="min_date" type="text" id="min_date" size="15" <? if($min_date=="") { ?>value="2013-03-01"<? } else { ?>value="<? echo $min_date; ?>" <? }?>></td>
	   <td>
 ...
 <? 
	$qry="SELECT * from  HDFC_homeloanBT WHERE (HDFC_homeloanBT.hdfchlbt_date Between '".$min_date."' and '".$max_date."')";
   ...
   <tr>
     <td class="head1">Name</td>
       <td class="head1">City</td>
          ...
          <td class="head1">Outstanding Amount </td>
     </tr>
	<?
		...
		$qry="SELECT * from  HDFC_homeloanBT WHERE (HDFC_homeloanBT.hdfchlbt_date Between '".$min_date."' and '".$max_date."') LIMIT $startrow, $pagesize";
		...
		while($row=mysql_fetch_array($result))
		{
			...
			?>
             <tr>
     <td class="bodyarial11"><? echo $row["hdfchlbt_name"]; ?></td>
       <td class="bodyarial11"><? echo $row["hdfchlbt_mobile"]; ?></td>
              <td class="bodyarial11"><? echo $row["hdfchlbt_city"]; ?></td>
          <td class="bodyarial11"><? echo $row["hdfchlbt_outstandingloan"]; ?></td>
     </tr>
            <?
