...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="requestpersonal-loans-new"; }

if((strncmp("komlipl", $retrivesource,7))==0 || $retrivesource=="valuefirstpl")
{
}
else
{
