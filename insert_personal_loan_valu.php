...
if ($leadid>0 && $Is_Valid==1 && (($Salary_Drawn==2) || ($Salary_Drawn==3)))
 ...
 list($recordcount,$grow)=MainselectfuncNew($getcompany,$array = array());
		$j=0;
$hdfccategory= $grow[$grow]["hdfc_bank"];
$fullertoncategory= $grow[$grow]["fullerton"];
$citicategory= $grow[$grow]["citibank"];
$barclayscategory= $grow[$grow]["barclays"];
$stanccategory = $grow[$grow]["standard_chartered"];
...
if($recordcount>0)
				{
		$identification_prf=$myrow[$l]["identification_proof"];
	$residence_prf=$myrow[$l]["residence_proof"];
	$income_prf=$myrow[$l]["income_proof"];
...
<? echo $getbankid[$i];?></td>
 ...
 <td width="400" height="45" colspan="4"   bgcolor="#FFFFFF" class="fontbld10">&nbsp;</td>
   ...
   <td width="400" bgcolor="#FFFFFF" height="53" colspan="4"><b>&nbsp;</b></td>
		<? 
	...
	{
	?>
    <form action="get-instantquote-continue.php" method="POST" target="_blank" >
	...
	while($m<count($myrow))
        {?>
            <td valign="top" ><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="crdbg">
                <tr>
                  <td height="30" class="crdbhdng"><a href="<? if (strlen($myrow[$m]["cc_bank_url"])>0) {echo $myrow[$m]["cc_bank_url"];} else {echo "#";}?>" target="_blank"><? echo $myrow[$m]["cc_bank_name"];?></a></td>
                </tr>
                <tr>
                  <td height="255" align="center" valign="bottom"><a href="<? if (strlen($myrow[$m]["cc_bank_url"])>0) {echo $myrow[$m]["cc_bank_url"];} else {echo "#";}?>" target="_blank"><img src="<? echo $myrow[$m]["card_image"];?>"  width="150" height="244" /></a></td>
                </tr>
                <tr>
                  <td height="22" valign="bottom" class="crdbold">Features</td>
                </tr>
                <tr>
                  <td height="270" valign="top" class="crdtext"><? echo $myrow[$m]["cc_bank_features"];?></td>
                </tr>
                <tr>
                  <td align="center" valign="bottom"><a href="<? if (strlen($myrow[$m]["cc_bank_url"])>0) {echo $myrow[$m]["cc_bank_url"];} else {echo "#";}?>" target="_blank">
