...
<div id="img-lft"></div>
<div id="img-rgt"></div>
<div class="content-pnl">Apply for Loans to Buy</div>
<div  class="content-deal">Laptop, Desktop pc, LCD Monitors TFT/Plazma Screen TV and Latest Computer peripherals. </div>
...
<form name="personalloan_form"  action="apply-personal-loans-laptop-continue.php" method="POST" onSubmit="return chkpersonalloan(document.personalloan_form);">
...
<div class="form-bg"><span class="form-text">Full Name</span> <input name="Name" type="text" <? if(isset($loan_type)) { ?>value="<? echo $name; ?>" <? }else {?>value="Name"<? }?> id="Name" style="margin-left:60px; width:140px; margin-top:2px;" onBlur="onBlurDefault(this,'Name');"  onFocus="onFocusBlank(this,'Name');" onchange="insertData();"/></div>
	...
	<div class="form-bg"><div name="nettab" id="nettab" style="width:100px; float:left; margin-left:15px; ">Annual Income</div>
