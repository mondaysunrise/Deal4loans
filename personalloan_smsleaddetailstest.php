...
<tr>
	<td style="border:1px solid black;" colspan="4" bgcolor="#DAEAF9" align="center" class="fontstyle" ><b>Personal Details</b></td></tr>
		...
		<td class="fontstyle"><b>DOB</b></td>
			...
			<td class="fontstyle">+91 <?php echo $Mobile; ?><input type="hidden" name="plmobile" size="15" value="<? echo $Mobile;?>"></td>
			</tr>
		<tr>
...
<tr>
 ...
 <tr>
   ...
   <tr><td colspan="4" ><br><br><br><br><br><br><br><br><br><?php echo "query - ".$updatelead."<br>"; ?></td></tr>
</table>
</form>
</body>
</html>
