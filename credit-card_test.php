...
<title>Credit Card | Credit Cards in India 2016</title>
...
<div class="banner-credit-card" style="margin-top:70px;" itemscope itemtype="http://schema.org/Product">
<div class="banner_a-credit-card">
<div class="h1-credit-card" itemprop="name">Find the credit card that's right for you</div>
...
<select name="Age" class="age-input-credit-card" onChange="validateDiv('ageVal');" tabindex="9">
