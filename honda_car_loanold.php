		...
		/*function tosendsms()
{
			...
			//var get_product ="3";
				...
				{
					//alert(queryString); 
					ajaxRequest.open("GET", "insertactivation.php" + queryString, true);
	...
	var ni = document.getElementById('tataaig_compaign');
		...
		if(ni.innerHTML=="")
		{
			if(document.loan_form.City.value=="Delhi" || document.loan_form.City.value=='Delhi' || document.loan_form.City.value=='Noida'  ||  document.loan_form.City.value=='Gurgaon'  ||  document.loan_form.City.value=='Faridabad'  ||  document.loan_form.City.value=='Gaziabad'  ||  document.loan_form.City.value=='Faridabad'  ||  document.loan_form.City.value=='Greater Noida'  || document.loan_form.City.value=='Chennai'  ||  document.loan_form.City.value=='Mumbai'  ||  document.loan_form.City.value=='Thane'  ||  document.loan_form.City.value=='Navi mumbai'  ||  document.loan_form.City.value=='Kolkata'  ||  document.loan_form.City.value=='Kolkota'  ||  document.loan_form.City.value=='Hyderabad'  ||  document.loan_form.City.value=='Pune'  || document.loan_form.City.value=='Bangalore')
			{
				...
				ni.innerHTML = '<input type="checkbox" style="border:none;" name="Accidental_Insurance" id="Accidental_Insurance" value="1" checked>&nbsp;<a href="tata-aig-personal-accident-cover.php" target="_blank" >Get free personal accident insurance from<br> TATA AIG</a>';
			}
			else 
			{
			//alert(document.loan_form.CC_Holder.value);
...
<form name="loan_form" method="post" action="thank_cl.php" onSubmit="return submitform(document.loan_form);">
<input type="hidden" name="referrer" value="<? echo $_REQUEST['referrer'] ?>"><input type="hidden" name="Type_Loan" value="Req_Loan_Car"><input type="hidden" name="creative" value="<? echo $_REQUEST['creative'] ?>"><input type="hidden" name="section" value="<? echo $_REQUEST['section'] ?>"><input type="hidden" name="source" value="Car-Loan1">
...
<table width="92%"  border="0" align="right" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td align="left"><select size="1" align="left" style="width:142px;"  name="City" id="City" onChange="othercity1(this);insertData(); tataaig_comp();" >
           <?=getCityList1($City)?>
         </select></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input style="width:140px; " value="" name="IncomeAmount" id="IncomeAmount" onFocus="this.select();"  onChange="intOnly(this);"  onKeyUp="intOnly(this);getDigitToWords('IncomeAmount','formatedIncome','wordIncome'); adddiv();" onKeyPress="intOnly(this);"onKeyDown="getDigitToWords('IncomeAmount','formatedIncome','wordIncome');" onBlur="getDigitToWords('IncomeAmount','formatedIncome','wordIncome'); onBlurDefault(this,'Annual Income');"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="left" id="tataaig_compaign">&nbsp;</td>
  </tr>
  <tr>
    <td height="50" colspan="2" align="left" ><input type="hidden" name="Activate" id="Activate" ><input type="checkbox"  name="accept" style="border:none; " checked> I have read the <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and agree<br> 
