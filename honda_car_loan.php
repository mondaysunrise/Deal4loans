...
else if(Form.year.value > parseInt(mdate-21) || Form.year.value < parseInt(mdate-60))
{
              ...
              <tr>
                <td align="left" class="txt"><ul>
                  ...
                  <li> Documents required and disbursal period.</li>
					<li>Car Loan Quotes are free for customers. It's a totally free service for customers.</li>
...
<tr>
  ...
  <tr>
    <td height="50" colspan="2" align="left" ><input type="hidden" name="Activate" id="Activate" ><input type="checkbox"  name="accept" style="border:none; " checked> I authorize Deal4loans.com & its partnering banks to contact me to explain the product & I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.</td>
    </tr>
<tr>
