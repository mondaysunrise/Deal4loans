...
$getAgentSql = "select BidderID from Bidders Where leadidentifier NOT IN ('diallercallerccpredictive','diallerleadccsmsnew','sbicallerdigilms_cc') AND BidderID='".$_SESSION["BidderID"]."'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$upcctblenw="Update Req_Credit_Card_Sms set Name='".$Name."',DOB='".$DOB."',Company_Name='".$Company_Name."',Std_Code='".$resiSTD."',Landline='".$resi_landline."', Email='".$Email."',Net_Salary='".$Net_Salary."',Gender='".$Gender."',Residence_Address ='".$ResidenceAddress."',State='".$State."', Office_Address='".$OfficeAddress."',Employment_Status='".$Employment_Status."',CC_Holder='".$CC_Holder."', Pancard='".$panno."', Updated_Date=Now(), Pincode='".$pincode."' ".$cityclause." ".$othercityclause." Where (RequestID=".$RequestID.")";
...
<?php
	...
	*/
	...
	if($_SESSION['leadidentifier'] != 'sbicallerdigilms_cc'){
		//Show Button For SCB 
