...
{
	var gifName = form;
	document.frmsearch.action="bidders_consolidate_appointment2.php?search=y"+gifName;
...
<td>&nbsp;</td></tr>
 ...
 <form name="frmsearch" action="bidders_consolidate_appointment2.php?search=y" method="post" onSubmit="return chkform();">
...
<!--			  <tr>       <td width="19%" align="center"  valign="middle" class="bidderclass">Mobile</td>
   ...
   <tr>
	...
	if($search=="y")
	{
		...
		{
			$FeedbackClause=" AND (".$bidderAllocationTbl.".Feedback IS NULL OR ".$bidderAllocationTbl.".Feedback='' OR ".$bidderAllocationTbl.".Feedback='No Feedback') ";
		}
		...
		{
			$FeedbackClause=" AND ".$bidderAllocationTbl.".Feedback='".$varCmbFeedback."' ";
		}
...
$search_qry=$qry;
 ...
 ?>
   ...
   <tr>
	 ...
	 <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Uploaded Comments</td>
	       <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Uploaded Feedback</td>
