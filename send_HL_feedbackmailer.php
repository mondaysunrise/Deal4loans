...
$Query ="Select RequestID,Loan_Amount,Email,Name,Updated_Date from Req_Loan_Home where (Bidder_Count>0  and ( Dated between '".$min_date."' and '".$max_date."')) GROUP BY `Email`";

//$Query ="SELECT RequestID,Loan_Amount,Name,Updated_Date,Email FROM Req_Loan_Home WHERE ( Bidder_Count >0 AND (Dated BETWEEN '2009-02-01 00:00:00' AND '2009-03-22 23:59:59')) GROUP BY `Email`";
//$Query ="Select RequestID,Loan_Amount,Name,Updated_Date,Email from Req_Loan_Home where RequestID='246603'";
//echo "<br>".$Query;
...
//select bidders 
$selectBidders=ExecQuery("select BidderID From Req_Feedback_Bidder_HL where AllRequestID='".$RequestID."' and Reply_Type=2");
//echo "<br>";
$newbidderid="";

//echo "select BidderID From Req_Feedback_Bidder_HL where AllRequestID='".$RequestID."' and Reply_Type=1";
...
<table width='560' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#edf2f7'>
  <tr bgcolor='#FFFFFF' >
    <td align='center' valign='bottom'  style='font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#000000; padding:15px 0px 5px 0px; '>If you are not able to view this mailer properly, please <a href='http://www.deal4loans.com/emailer/hl-mailer-09.php?requestid=".$RequestID."' target='_blank'>Click  here</a></td>
  </tr>
  <tr>
  <tr>
