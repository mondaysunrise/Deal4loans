...
if($_SESSION["Comp_Source"]=="komlipl") {$cmpdate="2012-05-10"; } else { $cmpdate="2011-12-01"; }
?>
<html>
<head>
...
{
	var gifName = form;
	document.frmsearch.action="banner-comp-clicks.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="banner-comp-clicks.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>  
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="0"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><?$current_date=date('Y-m-d'); if($_SESSION["Comp_Source"]=="komlipl") {$cmpdate="2012-05-10"; } else { $cmpdate="2011-12-01"; } ?> 
 ...
 <? 
	if(isset($comp_source) || strlen($_SESSION["Comp_Source"])>0 )
		{
		if($comp_source=="infomedia")
			{
			if($min_date>='2014-05-01 00:00:00' && $max_date<='2014-05-31 23:59:59')
				{
				$selcount="Select capture_clicks from captute_banner_click where (banner_name='infomedia' and dated between '".$min_date."' and '".$max_date."')";
				}
				else
				{

				$selcount="Select capture_clicks from captute_banner_click where ((banner_name='infomedia' or banner_name='informediamailer') and dated between '".$min_date."' and '".$max_date."') group by ip_address";
				}
			}
		}
		else
...
//echo $selcount;
	list($recordcount2,$row2)=MainselectfuncNew($selcount,$array = array());
...
<td width="141" align="center" bgcolor="#FFFFFF" class="style2">Count </td>
    ...
    <tr>
       <td align="center" bgcolor="#DFF6FF" class="style3">Valid clicks</td>
