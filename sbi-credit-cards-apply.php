    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td colspan="4"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #CCCCCC;"><tr>
                <td class="bldtxt" style="font-size:17px; font-family:Arial, Helvetica, sans-serif; " >&nbsp;</td>
              </tr>
			<tr>
                <td height="30" bgcolor="#FDF4AE" class="bldtxt" style="font-size:17px; font-family:Arial, Helvetica, sans-serif; color:#000000; padding-left:20px;" >Features of Sbi Credit Card</td>
              </tr>
			  <tr>
                <td><table width="597" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="597" style="padding-left:15px; "><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="33" height="25" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="15" height="17" /></td>
                        <td width="520"><div style="color:#7e5a09; font-size:13px; font-weight:bold; line-height:24px;  ">Joining gift of Kingfisher Airline return Ticket Absolutely Free.</div></td>
                      </tr>
                      <tr>
                        <td width="33" height="25" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="15" height="17" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; line-height:24px;  ">Access to 600 luxury airport lounges with elite priority pass membership.</div></td>
                      </tr>
					  <tr>
                        <td width="33" height="25" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="15" height="17" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; line-height:24px;  ">5X Cash Points on Dining, Departmental Store and International Spends.</div></td>
                      </tr>
			  ...
			  <tr>
                <td height="30" bgcolor="#FDF4AE" class="bldtxt" style="font-size:17px; font-family:Arial, Helvetica, sans-serif; color:#000000; padding-left:20px;" >Credit Card Partners</td>
              </tr>
			  <tr>
                <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <!--<td width="15">&nbsp;</td>-->
                    <td width="590" colspan="2" style="padding-left:15px; "><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                     
                      <tr >
                        
                        <td height="35"><img src="new-images/pl/hdfc.jpg" width="99" height="29" /></td>
                      
                        <td height="35"><img src="new-images/thnk-stanc.jpg" width="62" height="25" /></td>
                        <td height="35"><img src="new-images/thnk-american.jpg" width="54" height="27" /></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>                  </td>
...
<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif;" color="#FF0000"><strong><?php if(isset($_GET['msg'])) echo "Kindly give Valid Details"; ?></strong></font></div><table width="97%"  border="0" align="right" cellpadding="0" cellspacing="0">
		  ...
		  <td colspan="2"><div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:10px;"></div></td>
				...
				<tr align="left">
				  ...
				  <Td width="144"><select style="width:142px; height:18px;  " class="field"  name="City" id="City" onchange="othercity1(document.creditcard_form); addhdfclife(); insertData(); "  >
         <?=CCgetCityList($City)?>
      </select>	  </Td>
				  </tr>
				<tr align="left">
				  <Td width="134" height="26" class="bldtxt">Other City </Td>
				  <Td width="144"><input name="City_Other" id="City_Other" type="text" value="Other City" class="field" style="width:140px; " disabled  /></Td>
				  </tr>
				
				<tr align="left">
				  <Td width="134" height="26" class="bldtxt">Occupation</Td>
				  <Td width="144"><select   style="width:140px;"  name="Employment_Status" id="Employment_Status" class="field" >
        ...
        <option value="0">Self Employed</option>
				  ...
				  <Td width="144"> <input name="Company_Name"  id="Company_Name" value="Company Name" type="text" style="width:140px;padding-left:5px;" class="field" onblur="onBlurDefault(this,'Company Name');" onKeyUp="ajax_showOptions(this,'getCountriesByLetters',event)" onfocus="onFocusBlank(this,'Company Name');" /></Td>
				  </tr>
				<tr align="left">
...
font-weight:bold;color:666699;font-Family:Verdana;text-transform: capitalize;'></span></td></tr>
			...
			<tr>
				...
				<tr align="left">
				  <Td height="50" colspan="2" style="font-family:verdana; font-size:10px; color:#000000; font-weight:normal;"><input type="checkbox"  name="accept" style="border:none;" checked  > I authorize Deal4loans.com & its partnering banks to contact me to explain the product & I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.</Td>
				  </tr>
					
				<tr align="center">
				  <Td colspan="2"><br /><input type="image" name="Submit"  src="new-images/pl/quote.gif"  style="width:115px; height:29px; border:none; " /></Td>
				  </tr>
                </table>
				</form></td>
              </tr>
