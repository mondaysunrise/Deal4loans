...
<div style="padding-top:5px; color:#FFF;">Welcome Rewards
  <br>
  <span  class="text_2" style="font-size:12px; color:#FFF;"> Get cash back gifts upto Rs. 18000 on disbursal*</span> </div></div>
      ...
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="25" bgcolor="#fbfbfb" class="pl_why_bullet_newone">Tenure - <span style="font-size:18px; font-weight:bold; color:#f36100;">minimum 1 year</span> to <span style="font-size:18px; font-weight:bold; color:#f36100;">maximum 7 years</span>.</td>
            </tr>
          ...
          <tr>
            <td height="25" align="center" bgcolor="#fbfbfb"><img src="images/bullet-apl.png" width="17" height="16" /></td>
            <td height="25" bgcolor="#fbfbfb" class="pl_why_bullet_newone">Compare top <span style="font-size:18px; font-weight:bold; color:#f36100;">10 Banks</span> rates from  <span style="font-size:18px; font-weight:bold; color:#f36100;">10.99% to 19%</span>.</td>
            </tr>
          <tr align="center">
          ...
          <tr>
            ...
            <tr>
<td height="7" colspan="2" align="center" valign="top" bgcolor="#fbfbfb"></td>
              </tr>
          <tr align="center">
...
<? if($source=="rediff_160x600banner")
{
	...
	$dataInsert = array('banner_name'=>$source, 'capture_clicks'=>'1', 'ip_address'=>$IP,'dated'=>$Dated);
