...
{
	var gifName = form;
	document.frmsearch.action="content_list_hleligibility.php?search=y"+gifName;
...
?>
<div style="text-align:center; font-size:14px; font-weight:bold;">Home Loan Eligibility Pages List</div>
 <form name="frmsearch" action="" method="post">
 <table width="950" border="0" align="center" cellpadding="1" cellspacing="3" bgcolor="#FFFFFF" >
 <? 

		$sql = "select * from city_hl_pages where 1=1 and 	Product='HLEligibility' ";
 ...
 ?>	  <tr>
   ...
   <tr>
     <td align="center" bgcolor="#DFF6FF" class="style3" >
		 <a href="http://www.deal4loans.com/propertyeligibility-calculator/<?php echo $row["City"]; ?>" target="_blank"><strong><? echo ucfirst($row["City"]); ?></strong></a></td>
	  <td style="padding-left:4px;" bgcolor="#DFF6FF" class="style3"><? echo $row["Title"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><a href="content_edit_hleligibility.php?pid=<?php echo $row["pid"]; ?>">Edit</a></td>
	</tr>
<?	$i=$i+1;
			}
	?>
