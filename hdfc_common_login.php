<?php
	...
	function formHandler(){
		...
		$result = ExecQuery("select *  from Bidders where Email='$Email' and PWD='$PWD' and Is_Verified>2");
		...
		if($num_rows > 0){
			...
			mysql_free_result($result);
			 ...
			 /* Redirect browser */
			 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."hdfc_common_index.php");
			exit;
		}
		else{
			global $Msg;
