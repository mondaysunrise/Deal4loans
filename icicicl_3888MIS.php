...
$citifinid =array('Ahmedabad','Bangalore','Chandigarh','Chennai','Delhi n NCR','Hyderabad','Indore','Jaipur','Kochi','Kolkata','Mumbai n Suburbs','Pune','Total');
...
for($i=0; $i<count($citifinid);$i++)
  {
	  $content.='<tr>';
$slectqry="Select icici_city,".$filedstr.",total_count from icicihl_lapreport Where (icici_product=3 and stat_flag=1 and icici_city='".$citifinid[$i]."')";
...
$email = "s.dhirendra@icicibank.com,gurpinder.taneja@icicibank.com,amitd.kumar@icicibank.com,shweta.sharma@deal4loans.com";
...
$headers = "From: Deal4loans <no-reply@deal4loans.com>";
		...
		$message = "This is a multi-part message in MIME format.\n\n" . 
                ...
                $content . "\n\n";
//$email="ranjana5chauhan@gmail.com";
mail($email,'ICICI CL MIS Till Date ', $message, $headers);
