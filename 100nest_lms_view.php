...
{
	var gifName = form;
	document.frmsearch.action="100nest_lms_view.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="100nest_lms_view.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="0"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><?$current_date=date('Y-m-d');?> 
	   <input name="min_date" type="text" id="min_date" size="15" <? if($min_date=="") { ?>value="2010-04-14"<? } else { ?>value="<? echo $min_date; ?>" <? }?>></td>
	   <td>
...
<tr><td>Product</td><td colspan="2"><select name="product">
...
<!--<option value="Req_Loan_Home"  <? //if($product=="Req_Loan_Home") { echo "selected";} ?>>Home Loan</option>-->
 ...
 <? 
	if(strlen($source)>0)
		...
		$qry="SELECT RequestID,source from  ".$product." WHERE ((".$product.".Updated_Date Between '".$min_date."' and '".$max_date."') and source='100nest')";
