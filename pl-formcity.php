...
<h2 class="text3" style=" color:#FFF; font-size:20px; text-transform:none; padding-bottom:3px; padding-top:3px; "><strong>Get instant lowest quote on Personal loan in <?php echo $City; ?> from top 10 Banks</strong></h2>
<? }
else 
{ ?>
<h2 class="text3" style=" color:#FFF; font-size:20px; text-transform:none;"><strong>Get instant lowest quote on Personal loan in <?php echo $City; ?> from top 10 Banks</strong></h2>
<? } ?></div>

<!--<div class="pl_emi_cal_blink_b" style="padding-top:3px;"><img src="http://www.deal4loans.com/images/animated_pl.gif"></div>-->
<div style="clear:both;"></div> 
  <div class="hl_emi_input_form" style="width:970px; padding-left:10px;">
...
Professional Details
  ...
  <div style="clear:both;"></div> 
  <div class="hl_emi_input_form" style="padding-left:10px;">
    <table width="98%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30"><input name="Loan_Amount" id="Loan_Amount" maxlength="8" onKeyPress="intOnly(this);" onKeyUp="intOnly(this); getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');"  onblur="getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');"  type="text" class="hl_emi_input" onKeyDown="validateDiv('loanAmtVal');" tabindex="1"  autocomplete="off" />
...
font-weight:normal; color:#ffffff;font-Family:Verdana;text-transform: capitalize;'></span></td>
    ...
    <table width="98%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30"><select name="Employment_Status" id="Employment_Status"  onchange="change_empstst(); validateDiv('empStatusVal');" class="hl_emi_select"  style="font-family:Verdana, Geneva, sans-serif; font-size:11px; color:#4c4c4c;" tabindex="2" >
...
<div id="empStatusVal"></div></td>
    ...
    <table width="98%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30"><select name="City" id="City" class="hl_emi_select" style=" font-family:Verdana, Geneva, sans-serif; font-size:11px; color:#4c4c4c;"  onchange=" othercity1(); addhdfclife(); validateDiv('cityVal');" tabindex="3">
<?=plgetCityList($City)?>
...
<div id="cityVal"></div></td>
    ...
    <table width="98%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30"><input type="text" name="IncomeAmount" id="IncomeAmount" class="hl_emi_input"  onkeyup="intOnly(this); getDigitToWords('IncomeAmount','formatedIncome','wordIncome');" onKeyPress=" addPersonalDetails(); intOnly(this); "  onblur="getDigitToWords('IncomeAmount','formatedIncome','wordIncome');"  onchange="ShowHide('incomeShow','IncomeAmount'); addPersonalDetails();" onKeyDown="validateDiv('netSalaryVal');" tabindex="4"  autocomplete="off"  />
...
font-weight:normal; color:#ffffff;font-Family:Verdana;text-transform: capitalize;'></span></td>
  ...
  <div style="width:100%; padding-left:15px;" id="personalDetails">
