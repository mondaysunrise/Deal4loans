...
<div style="float:left; clear:right; width:714px; height:84px; margin-top:3px; text-align:right;">
<div style="float:right; clear:right;  width:240px; height:24px; ">
  &nbsp;
 </div>
<div style="float:right; clear:right; width:720px; margin-right:-30px; <?php if((strlen(strpos($_SERVER['HTTP_USER_AGENT'], "MSIE 6.0")) > 0) || (strlen(strpos($_SERVER['HTTP_USER_AGENT'], "MSIE 7.0")) > 0) || (strlen(strpos($_SERVER['HTTP_USER_AGENT'], "MSIE 8.0")) > 0)) { echo 'padding-top:2px;'; ?>  margin-buttom:20px;  height:32px; background-image:url(/images/nav_bg.gif ); <?php } else {	echo 'padding-top:12px; margin-top:14px;'; ?>  height:42px; background-image:url(/images/nav_bg.gif ); <?php } ?> background-repeat:no-repeat;" >
<ul class="menu" id="menu"  >
<li style="text-align:center; width:116px; z-index:999;">
<a href="/personal-loan.php" class="btn" style="margin-left:1px;">Personal Loan</a>
 <ul>
...
<li style="text-align:left;">  <a href="/personal-loan-emi-calculator.php" class="btn">Personal Loan EMI Calculator</a></li>
 <li style="text-align:left;" >  <a href="/business-loans.php" class="btn" >Apply Business Loan</a> </li>
<li style="text-align:left;">  <a href="/Contents_Personal_Loan_Faqs.php" class="btn">Personal Loan FAQs</a> </li>
</ul>

</li>
<!--<li  style="text-align:center; width:95px;"><a href="homeloan.html" class="btn" style="margin-left:-5px;">Home Loan </a>    -->
...
<li style="text-align:left;"><a href="/home-loan-eligibility-calculator.php" class="btn">Home Loan Eligibility Calculator</a></li>
...
<li style="text-align:left;"> <a href="/apply-two-wheeler-loans.php" class="btn">Apply Two Wheeler Loan</a></li>
...
<a href="/credit-card.php" class="btn">Credit Cards </a> 
<ul>
...
<li style="text-align:left;">  <a href="/loan-against-property-emi-calculator.php" class="btn">Loan Against Property EMI Calculator</a></li>
<li style="text-align:left;">  <a href="/Contents_Loan_Against_Property_Eligibility.php" class="btn">Loan Against Property Eligibility</a></li>
<li style="text-align:left;">  <a href="/Contents_Loan_Against_Property_Mustread.php" class="btn">Loan Against Property Must Read</a></li>
<li style="text-align:left;">  <a href="/Contents_Loan_Against_Property_Faqs.php" class="btn">Loan Against Property FAQs</a>  </li>
</ul>
</li>
...
<a href="gold-loan.php" class="btn"  style="margin-left:-5px;">Gold Loan</a>
<ul style="margin-left:-139px;" >
<li style="text-align:left;"><a href="/apply-gold-loans.php" class="btn">Apply Gold Loan</a></li>
<li style="text-align:left;"><a href="/Contents_Calculators.php" class="btn">EMI Calculator</a></li>
</ul>
</li>
 <?php 
 }
...
<ul  style="margin-left:-139px;" >
<li style="text-align:left;"><a href="/apply-education-loans.php" class="btn">Apply Education Loan</a></li>
<li style="text-align:left;"><a href="/Contents_Calculators.php" class="btn">EMI Calculator</a></li>
</ul>
</li>
<?php 
