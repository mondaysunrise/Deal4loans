...
$upcctblenw="Update Req_Credit_Card_Sms set Name='".$Name."',DOB='".$DOB."',Company_Name='".$Company_Name."',Std_Code='".$resiSTD."',Landline='".$resi_landline."', Email='".$Email."',Net_Salary='".$Net_Salary."',Gender='".$Gender."',Residence_Address ='".$Residence_Address."',State='".$State."', Office_Address='".$Office_Address."',Employment_Status='".$Employment_Status."',CC_Holder='".$CC_Holder."', Pancard='".$panno."', Updated_Date=Now(), Pincode='".$pincode."' ".$cityclause." ".$othercityclause." Where (RequestID=".$RequestID.")";
...
<tr><td>
<table style='border:1px dotted #9C9A9C;' cellspacing="0" cellpadding="5" width="700" height="80%" align="center" border="1" >
<?php require 'common_buttons.php'; ?>
</table>
</td></tr>
</table>
</body>
