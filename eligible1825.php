...
{   
   ...
   // $mvarType = getCodeValue("ReplyType_$strProduct");
	 $qry = "SELECT * FROM Bidders_List WHERE Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and BidderID=1825";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $City = trim($row["City"]);
		...
		$qry2 = str_replace("Req_Loan_Car","hdfc_car_loan_leads",$qry2);	
