...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if(isset($_POST['hitApi']) && ($_POST['hitApi'] == 'checked')){
		...
		$dataArr = array();
		$dataArr['ApplicantFirstName'] = $first_name;
		$dataArr['ApplicantMiddleName'] = $middle_name;
		$dataArr['ApplicantLastName'] = $last_name;
		$dataArr['Gender'] = $Gender;
		$dataArr['DateOfBirth'] = $dobstr;
		$dataArr['ResidenceAddress1'] = $ResidenceAddress1;
		$dataArr['ResidenceAddress2'] = $ResidenceAddress2;
		$dataArr['City'] = $resiCity;
		$dataArr['ResidencePincode'] = $pincode;
		$dataArr['ResidenceState'] = $resistate;
		$dataArr['STDCode'] = $Stdcode;
		$dataArr['ResidenceMobileNo'] = $Mobile_Number;
		$dataArr['PanNo'] = $panno;
		$dataArr['ICICIBankRelationship'] = $relation_with_bank;
		$dataArr['ICICIRelationshipNumber'] = $bank_relationship_number;
		$dataArr['CustomerProfile'] = $EmpType;
		$dataArr['CompanyName'] = $CompanyName;
		$dataArr['SalaryAccountWithOtherBank'] = $SalaryAccountWithOtherBank;
		$dataArr['Total_Exp'] = $total_exp;
		$dataArr['Income'] = $monthlyincome;
		$dataArr['SalaryAccountOpened'] = $SalaryAccountOpenedDuration;
		
		ICICIWebservice($dataArr, $ProductValue);
