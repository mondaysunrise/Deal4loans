...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="lowestrateLP"; }
?>
<!DOCTYPE html>
<html>
<head>
...
<? if($retrivesource=="komlipl" || $retrivesource=="timesmobpl"  || $retrivesource=="logicserve"  || $retrivesource=="dgm_ploct13" || $retrivesource=="infomedia" || $retrivesource=="hindustantimes" || $retrivesource=="inuxu_oct13" || $retrivesource=="netcorepl" || $retrivesource=="pyxelconnectpl" || $retrivesource=="icubespl" || $retrivesource=="ibiboplnw" || $retrivesource=="monsterpl" || $retrivesource=="yahoopl" || $retrivesource=="valuefirstpl" || $retrivesource=="adshreempl" || $retrivesource=="proformicspl"  || $retrivesource=="monsterplnw" || $retrivesource=="timesjobspl")
		{ ?>
<form name="personalloan_form" action="apply-personal-loans-bnrcampvalidate.php" method="POST" onSubmit="return chkpersonalloan(document.personalloan_form);">
<? }
else
{ ?>
...
<tr align="left">
 ...
 <div class="menu_display"><table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td align="center" style="color:#cd5a13; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; height: 23px;">Fullerton</td>
    <td align="center" style="color:#0076bc; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; height: 23px;"> Bajaj Finserv</td>
    <td align="center" style="color:#0076bc; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; height: 23px;">SBI</td>
  </tr>
  </table></td></tr>
</table>
</div>
...
$total_amtcntrStr="select Amount From totalLoans Where (Name='Totalcountr' and flag=1)";
list($alreadyExist2,$total_amtcntr)=MainselectfuncNew($total_amtcntrStr,$array = array());
...
<div style="clear:both;"></div>
 ...
 <div class="why_text_box">
   <table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr>
       <td class="lowest_ratenew_text" style="color:#CC0000;"><ul>
         ...
         <li>Rate starts as low as <span style="font-size:17px; font-weight:bold;">
		 11.50%</span></li>
 ...
 <div class="table_bg" style="background:#FFF; ">
   <div style="clear:both; height:5px;"></div>
   <img src="images/yellow-banner-lowestrate_lp.jpg" width="100%" style="max-width:460px;">   <div style="clear:both;"></div>
 </div>
  </div>
  <div style="clear:both;"></div>
