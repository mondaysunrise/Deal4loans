...
{
	var gifName = form;
	document.frmsearch.action="hdfcmeritus_index.php?search=y"+gifName;
...
function chkform()
{
	...
	if(ss.length<10 || ss.length>10)
	{
		...
		if(document.frmsearch.min_date.value<"2009-02-03")
	{
		alert("Sorry!!!! Your minimum date is 2009-02-03.Please Select.");
		document.frmsearch.min_date.value="";
		document.frmsearch.min_date.focus();
		return false;
	}
...
<tr>
 ...
 <form name="frmsearch" action="hdfcmeritus_index.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="0"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><?$current_date=date('Y-m-d');?> 
	   <input name="min_date" type="text" id="min_date" size="15" <? if($min_date=="") { ?>value="2009-02-03"<? } else { ?>value="<? echo $min_date; ?>" <? }?>></td>
	   <td>
 ...
 <? 
		...
		$search_qry="SELECT * FROM `hdfc_meritus_scholarships`  WHERE (`hdfc_meritus_scholarships`.Date_Of_Entry Between '".($min_date)."' and '".($max_date)."' ) ";	
		//$search_qry=$search_qry.$FeedbackClause;
		
		$search_qry=$search_qry."group by `hdfc_meritus_scholarships`.Mobile_No";
		$search_qry=$search_qry." order by `hdfc_meritus_scholarships`.Date_Of_Entry DESC";

		$qry="SELECT * FROM `hdfc_meritus_scholarships`  WHERE (`hdfc_meritus_scholarships`.Date_Of_Entry Between '".($min_date)."' and '".($max_date)."' ) ";
		$qry=$qry."group by `hdfc_meritus_scholarships`.Mobile_No";
 ...
 ?>
   ...
   <tr>
     ...
     <td width="149" align="center" bgcolor="#FFFFFF" class="style2">Father Name</td>
	  <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Student Name</td>
     <td width="88" align="center" bgcolor="#FFFFFF" class="style2">Student Class</td>
     <td width="91" align="center" bgcolor="#FFFFFF" class="style2">City </td>
	   <td width="75" align="center" bgcolor="#FFFFFF" class="style2">DOB</td>
     <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Mobile Number </td>
     <!--<td width="90" align="center" bgcolor="#FFFFFF" class="style2">IP Address</td>-->
	  <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Date</td>
	...
	<?
		...
		$qry=$qry."group by `hdfc_meritus_scholarships`.Mobile_No";
		$qry=$qry." order by `hdfc_meritus_scholarships`.Date_Of_Entry DESC";
...
//echo $qry;
		...
		{
		list($date,$time) = split('[ ]', $row["Date_Of_Entry"]);
	?>
	
			
   <tr>
  
     <td align="center" bgcolor="#DFF6FF" class="style3" ><? echo $row["Father_Name"]; ?></td>
	  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Student_Name"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Student_Class"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["City"]; ?></td>
	     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["DOB"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Mobile_No"]; ?></td>
     <!--<td align="center" bgcolor="#DFF6FF" class="style3">--><? //echo $row["IP_Address"];?><!--</td> -->
	      <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $date;?></td> 
 ...
 <form name="frmdownload" action="hdfcmeritus_download.php" method="post">
   <tr>
     <td align="center">
