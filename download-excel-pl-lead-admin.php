...
if($_REQUEST['GlobalID']=='7074'){
    $qry2 = "insert into temp (session_id, name, dob, email,  emp_status, c_name, city, city_other, car_make, car_model, car_type, loan_tenure, property_type, property_value,year_in_comp) values ('" . $session_id . "','" . $ReferenceID . "', '" . $AgentID . "', '" . $Name . "', '" . $City . "', '" . $City_Other . "', '" . $DOB . "', '" . $Pancard . "', '" . $LANNo . "', '" . $Feedback . "', '" . $Remarks . "', '" . $BankFeedback . "', '" . $BankRemarks . "', '" . $Doe . "', '" . $VerifireFollowup_Date . "')";
}
elseif($_REQUEST['GlobalID']=='7340'){
    $qry2 = "insert into temp (session_id, name, dob,  email, emp_status, city, city_other, car_make, car_model, car_type, loan_tenure, property_type, property_value, year_in_comp, total_exp, mobile_number, std_code, landline, std_code_o, landline_o, net_salary, gender, marital_status, vehicle_owned, loan_any, emi_paid ) values ('" . $session_id . "','" . $RequestID . "', '" . $AgentID . "', '" . $Email . "', '" . $Gender . "', '" . $Company_Name . "', '" . $City . "', '" . $City_Other . "', '" . $Std_Code . "', '" . $Landline . "', '" . $Mobile_Number . "', '" . $Employment_Status . "', '" . $Std_Code_O . "', '" . $Landline_O . "', '" . $Net_Salary . "', '" . $Pincode . "', '" . $IP_Address . "', '" . $DOB . "', '" . $Pancard . "', '" . $No_of_Banks . "', '" . $Residence_Address . "', '" . $Office_Address . "', '" . $Updated_Date . "', '" . $Name . "', '" . $Feedback . "', '" . $Comments . "')";
}
else{
    
    $qry2 = "insert into temp (session_id, name, dob,  email, emp_status, city, city_other, car_make, car_model, car_type, loan_tenure, property_type, property_value, year_in_comp, total_exp, mobile_number, std_code, landline, std_code_o, landline_o, net_salary, gender, marital_status, vehicle_owned ) values ('" . $session_id . "','" . $RequestID . "', '" . $AgentID . "', '" . $Email . "', '" . $Gender . "', '" . $Company_Name . "', '" . $City . "', '" . $City_Other . "', '" . $Std_Code . "', '" . $Landline . "', '" . $Mobile_Number . "', '" . $Employment_Status . "', '" . $Std_Code_O . "', '" . $Landline_O . "', '" . $Net_Salary . "', '" . $Pincode . "', '" . $IP_Address . "', '" . $DOB . "', '" . $Pancard . "', '" . $No_of_Banks . "', '" . $Residence_Address . "', '" . $Office_Address . "', '" . $Updated_Date . "', '" . $Name . "')";
}
    //// ".."
    //echo 	$qry1."<br>";	
    ExecQuery($qry2);
...
if($_REQUEST['GlobalID']=='7074'){ 
   $qry = "select name as UniqueReferenceID, dob as AgentID, email as Name, emp_status as City, c_name as CityOther, city as DOB, city_other as PANCardNumber, car_make as LANNo, car_model as Feedback, car_type as Remarks, loan_tenure as BankFeedback, property_type as BankRemarks, year_in_comp AS FollowUpDate, property_value as DOE from temp where session_id='" . $session_id . "' order by doe DESC "; 
}else if($_REQUEST['GlobalID']=='7340'){
   $qry = "select name as RequestID, dob as AgentID, vehicle_owned as Name,  city as CompanyName, city_other as City, car_make as CityOther, car_model as StdCode, car_type as Landline, property_type as EmpStatus, property_value as StdOffice, year_in_comp as LandlineOffice, total_exp as Salary, mobile_number as Pincode, std_code as IPAddress, landline as DOB, std_code_o as Pancard, landline_o as NoofBanks, net_salary as ResidenceAddress, gender as OfficeAddress, marital_status as DOE, loan_any as Feedback, emi_paid as Remarks from temp where session_id='" . $session_id . "' order by doe DESC ";
}else{

$qry = "select name as RequestID, dob as AgentID, vehicle_owned as Name,  city as CompanyName, city_other as City, car_make as CityOther, car_model as StdCode, car_type as Landline, property_type as EmpStatus, property_value as StdOffice, year_in_comp as LandlineOffice, total_exp as Salary, mobile_number as Pincode, std_code as IPAddress, landline as DOB, std_code_o as Pancard, landline_o as NoofBanks, net_salary as ResidenceAddress, gender as OfficeAddress, marital_status as DOE from temp where session_id='" . $session_id . "' order by doe DESC ";
}
$header = "";
$data = "";
