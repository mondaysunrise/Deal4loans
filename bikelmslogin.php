...
if($IP=="122.176.100.27" || $IP=="122.176.100.28" || $IP=="122.176.100.29"  || $IP=="122.177.167.80" || $IP=="122.177.152.42" || $IP=="122.177.217.1" || $IP=="122.176.122.134" || $IP=="115.240.116.39")
			{
		if($num_rows > 0){
			 /* Get Resultset */
			...
			setSessionBidder($Email, $row);
			 ...
			 /* Redirect browser */
			 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."bikelms_index.php");
			exit;
		}
		else{
			global $Msg;
