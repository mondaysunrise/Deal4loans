...
<script language="javascript" type="text/javascript" src="supersleight.js"></script>
...
<style>
		.black_overlay {display: none; position: absolute; top: 0%; left: 0%;			width: 100%;			height: 825px;;			background-color:#CCCCCC;			z-index:1001;			-moz-opacity: 0.8;			opacity:.80;			filter: alpha(opacity=80);		}
		.white_content {			display: none;			position: absolute;			top: 25%;			left: 25%;			width: 50%;			height: 50%;			padding: 6px;			 z-index:1002;			overflow: auto;		}
...
<td colspan="2"  ></td></tr>
            ...
            <td width="280" height="306" align="right" valign="top">
...
<form action="" method="post" name="chatFrm">
<table width="495" cellpadding="0" cellspacing="0" border="0" align="center">
		<tr>
		<td valign="top" height="206"  background="new-images/hdfc-pl/chat_bg.png" style="background-repeat:no-repeat; background-position:center; ">
		<table width="92%" border="0" align="right" cellpadding="0" cellspacing="0"><tr><td colspan="2" align="right" style="padding-right:8px; padding-top:4px; " > <a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'"><img src="images/crossarrow.gif" border="0"></a></td></tr>
<tr align="left"><td height="35" colspan="2" class="blutxt" style="color:#034a87; "><b>Give Details for Instant Chat</b></td></tr>
<tr>
  <td width="63" height="25"><b style="color:#3a5c6d; ">Name</b></td><td width="392">
<input name="full_name" id="full_name" type="text" style="width: 145px;" /></td></tr>
<tr>
  <td height="25"><b style="color:#3a5c6d; ">Mobile</b></td><td  style="color:#3a5c6d; ">+91 <input type="text" style="width:117px;" name="Phone" id="Phone" maxlength="10"   onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onChange="intOnly(this);"/>
                        </td>
</tr>
<tr>
  <td height="25"><b style="color:#3a5c6d; ">Email</b></td><td><input name="email_id" id="email_id" type="text"    style="width: 145px;" /></td></tr>
<tr>
  <td height="25"></td><td><input name="image"  value="Submit" type="image" src="new-images/hdfc-pl/chat_now.gif" width="109" height="27"  style="border:0px;" /></td></tr>
</table>
		</td>
		</tr>	
		</table>
