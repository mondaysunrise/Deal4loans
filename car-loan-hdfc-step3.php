...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
	...
	//check DND stat
include 'checkDND.php';
$result=dncSingleScrubStatus($Phone, FALSE);
$DNDstatus= $result['call'];
	//END Check DND Stat
...
<script src="http://code.jquery.com/jquery-1.8.3.min.js"></script>
	<script src="http://www.deal4loans.com/hdfc_cl/jquery.ui.widget.js"></script>
	<script src="http://www.deal4loans.com/hdfc_cl/jquery.ui.mouse.js"></script>
	<script src="http://www.deal4loans.com/hdfc_cl/jquery.ui.slider.js"></script> 
	<script src="scripts/hdfc_cljquery_new.js"></script>
    <script type="text/javascript" src="sliding.form.js"></script>
	<link href="hdfc_car/style.css" rel="stylesheet" type="text/css">
	<link rel="stylesheet" href="http://www.deal4loans.com/hdfc_cl/base/jquery.ui.all.css"> 
...
//	alert(i);
	...
	window.open("car-loan-hdfc-step4.php"+ queryString ,"_self");
}
	</script>
...
<div id="wrapper" align="center">
  <div id="steps">
<form id="formElem" name="formElem" action="car-loan-hdfc-step5.php" method="POST">    
...
for($j=0; $j<=count($listofcars); $j++)
{
	...
	list($resultvediocount,$resultvedio)=MainselectfuncNew($getvediodetails,$array = array());
...
list($numGiftsQuery, $getGiftsQuery)=MainselectfuncNew($getGiftsSql, $array = array());
		...
		for($gS=0;$gS<$numGiftsQuery;$gS++)
		{
            ...
            <?php
		echo "</td></tr><tr><td align='center' valign='top' style='font-size:10px; font-family:Verdana, Arial, Helvetica, sans-serif;'>";
			echo $Name;
			echo '</td></tr>';
			echo '</table></td>';
		}
