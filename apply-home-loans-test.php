...
function getEligibleBidders()
	{
		var insID_All = document.loan_form.insID_All.value;
				
		if(document.loan_form.insID_All.checked)
		{
		
			chkvaluer=document.loan_form.elements['bnkID[]'];
			for (r=0;r<chkvaluer.length;r++)
			{
				chkvaluer[r].disabled = true;
			}
			//document.health_insurance_form.txtmusic.disabled = true;
		} else
		{
			chkvaluer=document.loan_form.elements['bnkID[]'];
			for (r=0;r<chkvaluer.length;r++)
...
<div id="container">
 ...
 <form name="loan_form" method="post" action="insert_home_loan_step1.php" onSubmit="return chkform();">
               ...
               <tr>
                 <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                   <tr valign="middle">
                     ...
                     <td width="31%" height="28" class="frmbldtxt"  style="padding-top:3px; "><select name="City" id="City" style="width:154px;" onchange="cityother(); edelweiss_comp(); insertData();" tabindex="7">
                         <?=getCityList($City)?>
                     </select></td>
                   </tr>
                   <tr valign="middle">
...
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
     ...
     <td class="frmbldtxt" colspan="5">
       Interested in : (You can select maximum of 4 Banks)</td></tr>
 <tr>
     <td class="frmbldtxt" colspan="5" >
	<table cellpadding="0" cellspacing="0" border="1" width="100%">
	
	<td colspan="4" class="frmbldtxt"><table border="0" cellpadding="3" cellspacing="3">
<tr><td class="frmbldtxt"><input type="checkbox" name="insID_All" value="All" onclick="return getEligibleBidders(); " checked/></td><td colspan="3" class="frmbldtxt" align="left">Any Top 4</td></tr>
	<tr>
	 <?php 
	 $getBiddersSql = "SELECT Bank_Master.Bank_Name as Company , Bank_Master.BankID as bnkID FROM `Bidders_List` left join Bank_Master on Bank_Master.BankID = Bidders_List.BankID  WHERE (Bidders_List.Reply_Type =2 and Bank_Master.BankID not in (16,26,7,31,41,42,25,6,22,8,5,40,36) AND Bidders_List.Restrict_Bidder =1 and Bank_Master.BankID = Bidders_List.BankID ) GROUP BY Bidders_List.BankID";
	 $getBiddersQuery = ExecQuery($getBiddersSql);
	 $getBiddersNumRows = mysql_num_rows($getBiddersQuery);
	 for($i=0;$i<$getBiddersNumRows;$i++)
	 {
	 	$check = '';
		$Company = mysql_result($getBiddersQuery,$i,'Company');
	 	$bnkID =  mysql_result($getBiddersQuery,$i,'bnkID');
		$check = $i%2;
		//echo $i."<br>";
		?>			
		<td class="frmbldtxt"><input type="checkbox" name="bnkID[]" value="<?php echo $bnkID; ?>" onClick="return validate();" disabled/></td><td class="frmbldtxt"><?php echo $Company; ?></td>
		<?php
	 ...
	 <input type="hidden" name="insBiddersCount" id="insBiddersCount" value="<?php echo $getBiddersNumRows; ?>" />
	 </table>
	 </td>
</tr>
           <tr>
          ...
          <td align="left">&nbsp;</td>
           ...
           <tr>
             <td height="22"  colspan="2" align="left" class="frmbldtxt" style="font-weight:normal; "><input type="checkbox" name="accept" style="border:none;" value="1" checked> 
I agree to <a href="Privacy.php" target="_blank">Terms and Conditions</a> and agree to receive communication from Deal4loans and chosen partnering Banks even if I am  registered in NCPR/Dnc.<br>
 This is to ensure you get more  information and best deal for your Loan requirement.</td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF" class="text" ><b>9.50% - 9.75%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>9.50% - 10%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>9.00% - 10%</b></td>
	 <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>9.25% - 9.75% </b></td>
  </tr>
  <tr>
