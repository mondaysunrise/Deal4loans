...
<td   bgcolor="#FFFFFF" height="57" colspan="5"><b><img src="new-images/ne_bnk.jpg" border="0" width="190" height="48" /></b></td>
	...
	?>
		...
		<tr>
		 <td background="new-images/hl-thnk-bnkbg1-new.gif" style="background-repeat:no-repeat; background-height:80px;"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
    ...
    if($Property_Identified==0)
	{
		...
		//echo $chkdlqry."<br>";
		list($chkdlresultcont,$chkdl)=MainselectfuncNew($chkdlqry,$array = array());
		
		while($chkdl=mysql_fetch_array($chkdlresult))
		{
		$property_dlmrk_prc[] = $chkdl[$chkdlresultcont]['propertyd_market_price'];
		$property_dloff_prc[] = $chkdl[$chkdlresultcont]['propertyd_offer_price'];
		$property_dlttl[] = $chkdl[$chkdlresultcont]['property_title'];
		$propertyd_dlid[] = $chkdl[$chkdlresultcont]['propertyd_id'];
		}
