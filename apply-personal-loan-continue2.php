...
{
	$retrivesource="Internal Campaign-Upendra";
}
else
{
	$retrivesource="Internal Campaign-Upendra";
               ...
               <tr>
                 <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                   <tr valign="middle">
                     ...
                     <td width="31%" height="28" class="frmbldtxt"  style="padding-top:3px; "><select name="City" id="City" style="width:154px;" onchange="othercity1(); insertData();" tabindex="7">
                         <?=plgetCityList($City)?>
                     </select></td>
                   </tr>
                   <tr valign="middle">
                     ...
                     <td height="28" class="frmbldtxt"><input type="text" name="City_Other" id="City_Other" disabled  value="Other City" onfocus="this.select();" style="width:148px;" tabindex="8" onKeyUp="searchSuggest();" /><div id="CityOLayer"></div></td>
                   </tr>
                   <tr valign="middle">
...
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
 ...
 I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.  </td>
...
sales team on its own and we just help you to compare loans .All loans are on discretion of the associated Banks.<br><br>
   <?
      ...
      <tr>
        <td width="115" valign="top">
          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
            <tr><td width="150" height="30"bgcolor="#494949" class="txt-hd" style="color: #FFFFFF; text-align:center; font-weight:bold;  border-right:1px solid #d5cfb1;" valign="middle">Banks</td>
	        </tr>
            <tr>
            ...
            <tr><td height="45" align="center"  valign="middle" bgcolor="#FFFFFF" class="txt-hd" style="border:1px solid #d5cfb1; border-top:none;"><b>Prepayment Charges</b></td>
	        </tr>
...
<!--Database Driven -->
        ...
        <td  valign="top">
          <table width="210" align="left" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              <td height="45" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow[$i]["pl_bank_prepayment"];?></b> </td>
	        </tr>
            <tr>
           ...
           <? 
			   ...
			   ?>
			   <tr>
          <td align="center" valign="top" bgcolor="#FFFFFF" class="txt-hd" style="border:1px solid #d5cfb1; border-top:none;"><b>Basic Documents</b></td>
            <td align="left" colspan="4" class="txt-hd" valign="top" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><table  border="0" cellpadding="0" cellspacing="0" >
                <tr>
                <td class="tblpdng_txt"><b>Identity Proof : </b>  Passport/ Driving License/PAN card/                                              
              ...
              <tr>
                <td class="tblpdng_txt"><b>Age Proof : </b> PAN Card/ Passport/ Driving  License                                                                                                           / School leaving certificate/ Voter&rsquo;s card/BirthCertificate/ LIC policy (only for                                                    
                  age Proof). <strong>(Anyone of the above) </strong></td>
              </tr>
              <tr>
               <td class="tblpdng_txt"><b>Address Proof : </b> Passport/ Telephone bill 
              ...
              <tr>
                 <td class="tblpdng_txt"><b>Income Proof : </b> Latest salary slip/current dated salary                    
                  Certificate with latest form 16 <strong>(Anyone of the above)</strong></td>
              </tr>
              <tr>
                  <td  class="tblpdng_txt"><b>Job Continuity Proof : </b> Form 16/relieving letter/appointment                   
                  Letter (for last two months)<strong> (Anyone of the above)</strong></td>
              </tr>
              <tr>
                
                <td  class="tblpdng_txt"><b>Banking History : </b> Bank statements of latest 2 months/                   
	...
	<div style="height:30px; padding-top:10px;"><a href="/Contents_Calculators.php">EMI Calculator</a></div>
<div class="sldrpnl" >
	<div id="slider" >
		<ul>				
			        <li style="width:800px;	height:136px;	overflow:hidden;">
<div style="display:block; 	float:left;	width:145px;"><img  src="new-images/slider/thumb/partner_fullerton.gif" alt="Fullerton India" width="124" height="36"  style="border:none;"/></div>
<div style="display:block; 	float:left;	width:165px;"><img src="new-images/slider/thumb/hdfc.jpg" alt="HDFC Bank" width="138" height="39"  style="border:none;"/></div>
<div style="display:block; 	float:left;	width:235px;"><img src="new-images/slider/thumb/bajaj-finserv.jpg" alt="Bajaj Finserv" width="221" height="39"  style="border:none;"/></div>

<div style="display:block; 	float:left;	width:210px;"><img src="new-images/slider/thumb/hdbfs_logo.jpg" alt="HDB Financial Services" width="200" height="36"  style="border:none;"/></div>
...
<div style="display:block; 	float:left;	width:165px;"> <img src="new-images/slider/thumb/hdfc.jpg" alt="HDFC Bank" width="138" height="39"  style="border:none;"/></div>
<div style="display:block; 	float:left;	width:235px;"><img src="new-images/slider/thumb/bajaj-finserv.jpg" alt="Bajaj Finserv" width="221" height="39"  style="border:none;"/></div>
<div style="display:block; 	float:left;	width:150px;"><img src="new-images/slider/thumb/stan-chat.jpg" alt="Standard Chartered" width="133" height="45"  style="border:none;"/></div>
