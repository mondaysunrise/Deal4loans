...
if($appointment_date!='0000-00-00' && $appointment_date!='' && strlen($appointment_time)>0 && strlen($appointment_place)>1 && strlen($appointment_address)>1)
	{
...
<td>Alternate Proof for Identity <input type="text" name="alternateidentification_proof" id="alternateidentification_proof" value="<? echo $identification_proof; ?>"></td>
 ...
 <tr><td colspan="4"><input type="radio" name="bankstat_proof" id="bankstat_proof" value="6 Months Bank Statement" <? if($bankstat_proof=="6 Months Bank Statement") {echo "checked";}?>>6 Months Bank Statement </td></tr> 
