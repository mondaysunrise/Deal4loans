...
{
	var gifName = form;
	document.frmsearch.action="content_hleligibility_list.php?search=y"+gifName;
...
?>
 ...
 <? 
		...
		$sql = "select * from property_details_hl where 1=1";
...
$recordcount = mysql_num_rows($result);
 ...
 ?>	  <tr>
   ...
   <tr>
     <td align="center" bgcolor="#DFF6FF" class="style3" ><strong><? echo ucfirst($row["City"]); ?></strong></td>
	  <td style="padding-left:4px;" bgcolor="#DFF6FF" class="style3"><? echo $row["Title"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><a href="content_hleligibilityedit.php?pid=<?php echo $row["PID"]; ?>">Edit</a></td>
	</tr>
<?	$i=$i+1;
			}
	?>
