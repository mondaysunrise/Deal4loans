...
/*function addElement()
{
		...
		if(ni.innerHTML=="")
		{
			...
			if((document.loan_form.City.value=="Mumbai" || document.loan_form.City.value=="Delhi"))
			{
					//alert(document.loan_form.CC_Holder.value);
					ni.innerHTML = '<input type="checkbox" name="cpp_card_protect" value="1" style="border:none;">&nbsp;<b><a href="http://www.deal4loans.com/cpp/cpp.html" target="_blank">Yes, I want to protect all my bank cards against thefts/frauds @ just Rs. 5/day! Tell me about CPP Card Protection now!</a></b>';
			}		
...
function removeElement()
{
		...
		if(ni.innerHTML!="")
		{
			...
			if(document.creditcard_form.CC_Holder.value="on")
			{
				//alert(document.loan_form.CC_Holder.value);
				ni.innerHTML = '';
...
<div id="container">
 ...
 <form name="loan_form" method="post" action="apply-home-loanscontinuet-test.php" onSubmit="return chkform();">
 <input type="hidden" name="Activate" id="Activate" ><input type="hidden" name="source" value="<? echo $retrivesource; ?>">
     ...
     <td><table width="98%" border="0" align="right" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            <td colspan="4" style="padding:12px;" ><table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"  bgcolor="#FFFFFF" class="frmbldtxt" ><h1 style="margin:0px; padding:0px;">Apply Home Loan</h1></td>
  </tr>
</table></td>
<td align="right" style="padding-right:10px;"><a href="/balance-transfer-home-loans.php" style="text-decoration:none;"><img src="new-images/baltransfer.jpg" border="0"  /></a></td>
            </tr>
               ...
               <tr>
                 <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                   ...
                   <tr valign="middle">
                     ...
                     <td height="28" class="frmbldtxt"><input type="text" name="City_Other" id="City_Other" disabled  value="Other City" onfocus="onFocusBlank(this,'Other City');" style="width:148px;" tabindex="8" onKeyUp="searchSuggest();" />
...
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
 ...
 I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.  </td>
  ...
  <tr>
    ...
    <td width="22%" align="center" bgcolor="#3d60a4" class="wttext" style="color:#FFFFFF; "><b>HSBC Bank</b></td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF" class="text" ><b>10.5% - 11.5%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b> 	10.75% - 11.75%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>11% - Regular Home Loan<br /> 
11.50% - Smart Home 
</b></td>
	 <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>10.75% - 11.25% </b></td>
  </tr>
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>0.5% plus applicable service tax and cess</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b><img src="new-images/rupees.gif" />10,000 plus service tax & cess 
</b></td>
...
<td align="center" valign="middle" bgcolor="#FFFFFF" class="text"  ><b>Rs.8,00,000 - Maximum
 <br />80% of the Cost of the Property</b>
 <br />
(Subject to Income Eligibility)</td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>80% of the Cost of the Property</b><br />
(Subject to Income Eligibility)</td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>Maximum upto <img src="new-images/rupees.gif" />10 crores 
</b>
 <br />
(Subject to Income Eligibility)</td>
...
<td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>Rs.10,000 - or 2%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>If 25% of outstanding amount is paid within 3 years - No Penalty , otherwise 2% of outstanding amount</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>NIL upto 25% of the loan amount sanctioned in every financial year & at a pre-payment charge of 3% for any excess amount.
</b></td>
