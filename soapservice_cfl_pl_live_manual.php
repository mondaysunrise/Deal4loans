...
{	
	...
	echo $webquery="Select * from apply_pl_capitalfirst Where (`capitalfirst_requestid`
IN ( 2028778, 2035748, 2030105, 2038154, 2038005, 2035391 ) )";
...
{	
	...
	$webquery="Select capitalfirstid,first_webservice from apply_pl_capitalfirst Where capitalfirstid in (36058,36059,36063)";
	$webqueryresult = ExecQuery($webquery);
	while($row=mysql_fetch_array($webqueryresult))
	{	
		$capitalfirstid = $row["capitalfirstid"];
