...
<table width="438"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
			...
			<tr align="left">
              ...
              <tr>
                <td valign="top"  background="images/login-form-login-bg.gif" ><form name="rm_form"  action="add_agent_referal_continue.php" method="POST" onSubmit="return validateMe(this);">
