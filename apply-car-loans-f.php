...
<div id="container">
 ...
 <font face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><strong><?php if(isset($_GET['msg']) && ($_GET['msg']=="NotAuthorised")) echo "Kindly give Valid Details"; ?></strong></font>
     ...
     <form name="loan_form" method="post" action="/insert-car-loan-values-f.php" onSubmit="return chkform();">
               ...
               <tr>
                 <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                     <tr valign="middle">
                       ...
                       <td width="31%" height="28" class="frmbldtxt"  style="padding-top:3px; "><select name="City" id="City" style="width:154px;" onchange="cityother();  insertData(); addibibo();" tabindex="7">
                           <?=getCityList($City)?>
                       </select></td>
                     </tr>
                     <tr valign="middle">
...
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
				...
				<option value="0">UsedCar</option>
                     ...
                     <tr>
                       <td height="28" class="frmbldtxt" style="font-weight:normal; "><b>Car Booked</b></td>
                       <td class="frmbldtxt"><input type="radio" value="1" name="Car_Booked" id="Car_Booked" style="border:none;"> Yes<input type="radio" value="2" name="Car_Booked" id="Car_Booked" style="border:none;"> No</td>
                     </tr>
                     <tr>
...
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
 ...
 <table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="#d5cfb1">
	  ...
	  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt"><b>11.25% </b></td>
	  </tr>
	  <tr  >
	  ...
	  <td align="center" valign="middle" bgcolor="#FFFFFF" class="tbl_txt"><b>17.25%</b> (up to 3 years)<br />
