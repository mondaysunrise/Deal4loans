...
<input type="hidden" name="referrer" value="<? echo $_REQUEST['referrer'] ?>"><input type="hidden" name="Type_Loan" value="Req_Loan_Car"><input type="hidden" name="creative" value="<? echo $_REQUEST['creative'] ?>"><input type="hidden" name="section" value="<? echo $_REQUEST['section'] ?>"><input type="hidden" name="source" value="CL Int Rates">
...
<table width="92%"  border="0" align="right" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td align="left"><select size="1" align="left" style="width:142px;"  name="City" id="City" onChange="othercity1(this); addhdfclife();" >
           <?=getCityList1($City)?>
         </select></td>
  </tr>
  <tr>
