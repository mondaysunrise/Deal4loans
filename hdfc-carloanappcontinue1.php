...
$getCarSql = "select hdfc_car_model,hdfc_car_name from hdfc_car_list_category where hdfc_car_manufacturer='".$getCar."'  order by hdfc_car_model asc";
...
<div id="<?php echo $model; ?>-model-box" ><div style="margin-top:60px; font-family:Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold;"><?php if($getCar=='Hindustan Motors') { echo 'Hindustan Motors';} else if($getCar=='Land Rover') {echo 'Land Rover'; } else { echo ucfirst($model); } ?></div></div>
</div>
...
for($i=0;$i<$getCarNumRows;$i++)
{
	...
	?>
<li>
<a class="<?php echo $model; ?>-body_text2" href="hdfc-car-loanappoffers.php?car_name=<?php echo $hdfc_car_name ?>"  style="text-decoration:none;" ><?php echo str_replace($carM, "", $hdfc_car_name); ?></a></li>
<?php
	
		/*echo '<li><a class="maruti-body_text2" href="hdfc-car-loan-app-offers_nw.php?car_name='.$hdfc_car_name.'" style="text-decoration:none;">';
