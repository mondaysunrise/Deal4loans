...
<div class="mobile-main-wrapper">
  <div class="mobile-form-left">
    ...
    <form method="post" name="ccstep2frm" id="ccstep2frm" action="sbi-credit-card-thankyou-new_UAT.php"  onSubmit="return Checkvalidateccstep2frm(document.ccstep2frm); ">
