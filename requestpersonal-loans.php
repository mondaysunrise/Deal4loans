...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="remarketting"; }
...
list($recordcount,$total_amtcntr)=MainselectfuncNew($total_amtcntrSql,$array = array());
$total_amtcntrcontr=count($total_amtcntr)-1;
