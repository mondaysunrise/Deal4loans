...
function addPersonalDetails()
{
	...
	ni3.innerHTML = '<div class="p-details"><div><strong>Personal Details</strong></div><div class="termtext"><img src="http://www.deal4loans.com/images/security.png" width="14" height="16"> Your Information is secure with us and will not be shared without your consent</div></div> <div style="clear:both;"></div><div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td  height="25" class="cl-form-text td-no-border">Full Name:</td>  </tr><tr>    <td  height="25" class="td-no-border"><input name="Name" id="Name"  class="d4l-input" type="text" onkeydown="validateDiv(\'nameVal\');" tabindex="5" autocomplete="off" /><div id="nameVal"></div></td>    </tr>    </table>    </div><div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td height="25" class="cl-form-text td-no-border">Mobile:</td>  </tr><tr>       <td height="25" class="td-no-border">      <table width="100%" class="td-no-border"><tr><td class="cl-form-text td-no-border">+91</td><td class="td-no-border"><input type="text" class="d4l-input" name="Phone" id="Phone" maxlength="10"   onkeyup="intOnly(this);" onkeypress="intOnly(this)"; onchange="intOnly(this);" onblur="return Decorate1(\' \')" onfocus="addtooltip();" tabindex="6" onkeydown="validateDiv(\'phoneVal\');" autocomplete="off" /><div id="phoneVal"></div> </td></tr></table>              </td>    </tr>        </table>    </div><div class="new-input-box"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">  <tr>      <td height="25" class="cl-form-text td-no-border">Email ID :</td>   </tr><tr>    <td height="25" class="td-no-border">      <input type="text" name="Email" id="Email"   class="d4l-input"  tabindex="7" onkeydown="validateDiv(\'emailVal\');" autocomplete="off" /> <div id="emailVal"></div> </td>    </tr>  </table></div>   <div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td height="25" class="cl-form-text td-no-border">Age:</td>   </tr><tr>    <td height="25" class="td-no-border"><select onchange="validateDiv(\'AgeVal\');" class="d4l-select" name="Age" id="Age"><option value="">Select Age</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option><option value="50">50</option><option value="51">51</option><option value="52">52</option><option value="53">53</option><option value="54">54</option><option value="55">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option><option value="60">60</option><option value="61">61</option><option value="62">62</option><option value="63">63</option><option value="64">64</option><option value="65">65</option></select><div id="AgeVal"></div> </td>    </tr>        </table>    </div>';
	var ni20 = document.getElementById('City').value;
	if(ni20=='Others')
	{
		ni1.innerHTML = '<div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td class="cl-form-text td-no-border">Other City:</td>    </tr><tr>    <td height="25" class="td-no-border"> <input type="text" name="City_Other" onfocus="this.select();" class="d4l-input" tabindex="8" onkeydown="validateDiv(\'othercityVal\');"  />                        <div id="othercityVal"></div>   </td>    </tr>        </table>    </div> <div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td class="cl-form-text td-no-border">Company Name:</td> </tr><tr>      <td height="25" class="td-no-border">      <input type="text" name="Company_Name" class="d4l-input" onfocus="addrest();" onkeydown="validateDiv(\'companyNameVal\');" tabindex="11" onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event)" /> <div id="companyNameVal"></div>    </td>    </tr>  </table></div><div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td class="cl-form-text td-no-border">Car Type:</td>   </tr><tr>     <td height="25" class="td-no-border" >  <select  class="d4l-select" name="Car_Type" onchange="validateDiv(\'empStatusVal\');" tabindex="12"><option selected value="-1">Interested In</option>	<option  value="1">New Car</option>	<option value="0">UsedCar</option></select>        <div id="carTypeVal"></div></td>    </tr></table> </div>   <div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border"><tr><td class="cl-form-text td-no-border">Car Booked:</td>  </tr><tr>    <td class="cl-form-text td-no-border"><table cellpadding="0" cellspacing="0" class="td-no-border"><tr><td class="cl-form-text td-no-border"><input type="radio" value="2" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="adddel_dt();" onkeydown="validateDiv(\'carbukedVal\'); " tabindex="13" > Yes </td><td class="cl-form-text td-no-border"><input type="radio" value="1" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="removedel_dt();" onkeydown="validateDiv(\'carbukedVal\'); " tabindex="14" > No  <div id="carbukedVal"></div></td></tr></table>      </td>    </tr> <tr>                <td  colspan="2" class="td-no-border"><div  id="myDivdel_dt"></div>          </td>    </tr>  </table></div><div style="clear:both;"></div><div class="cl_terms_box"><span class="termtext"><input type="checkbox"  name="accept" style="border:none;" tabindex="15" > I authorize Deal4loans.com &amp; its partnering banks to contact me to explain the product &amp; I Agree to&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow" style="color:#fff; text-decoration:underline;">privacy policy</a> and&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow" style=" color:#fff; text-decoration:underline;">Terms and Conditions</a>.</span><div id="acceptVal"></div></div> <div class="cl_bnt_b"> <input type="submit" class="cl-get-quotebtn" value="Get Quote" tabindex="16"></div>   <div style="clear:both;"></div><div id="hdfclife"></div>';
	}
	else
	{
		ni1.innerHTML = '<div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td height="25" class="cl-form-text td-no-border">Company Name:</td> </tr><tr>      <td height="25" class="td-no-border">  <input name="City_Other" id="City_Other" type="hidden" disabled tabindex="10" />    <input type="text" name="Company_Name" class="d4l-input" onfocus="addrest();" onkeydown="validateDiv(\'companyNameVal\');" tabindex="11" onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event)" /> <div id="companyNameVal"></div>    </td>    </tr>  </table></div><div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td height="25" class="cl-form-text td-no-border">Car Type:</td>   </tr><tr>     <td height="25" class="td-no-border" >  <select  class="d4l-select" name="Car_Type" onchange="validateDiv(\'empStatusVal\');" tabindex="12"><option selected value="-1">Interested In</option>	<option  value="1">New Car</option>	<option value="0">UsedCar</option></select>        <div id="carTypeVal"></div>                </td>    </tr>        </table>    </div>   <div class="new-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td-no-border">    <tr>      <td  height="25" class="cl-form-text td-no-border">Car Booked:</td>  </tr><tr>    <td class="td-no-border">      <table cellpadding="0" cellspacing="0" class="td-no-border"><tr><td style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;" class="td-no-border"><input type="radio" value="2" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="adddel_dt();" onkeydown="validateDiv(\'carbukedVal\'); " tabindex="13" > Yes </td><td style=" padding-top:3px; color:#FFF; font-size:12px; text-transform:none;" class="td-no-border"><input type="radio" value="1" name="Car_Booked" id="Car_Booked" style="border:none;" onClick="removedel_dt();" onkeydown="validateDiv(\'carbukedVal\'); " tabindex="14" > No  <div id="carbukedVal"></div></td></tr></table>      </td>    </tr> </table></div><div class="new-input-box"><div  id="myDivdel_dt"></div></div><div style="clear:both;"></div><div class="cl_terms_box cl-form-text"><input type="checkbox"  name="accept" style="border:none;" tabindex="15" > I authorize Deal4loans.com &amp; its partnering banks to contact me to explain the product &amp; I Agree to&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  style=" color:#fff;text-decoration:underline;">privacy policy</a> and&nbsp;<a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow" style=" color:#fff; text-decoration:underline;">Terms and Conditions</a>.<div id="acceptVal"></div></div> <div class="cl_bnt_b"><input  type="submit" class="cl-get-quotebtn" value="Get Quote" tabindex="16"/></div>   <div style="clear:both;"></div><div id="hdfclife"></div>';
	}
