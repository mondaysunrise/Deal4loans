$(document).ready(function(){
	...
	$("#Holding_Current_Account1").click(function(){
            $("#hideButton").fadeOut();
	        $("#pl-personal-details").fadeIn("slow");
                hideButton
    });
...
function formValidate()
{
	...
	for (i=document.personalloan_form.Total_Experience.length-1; i > -1; i--) {
		...
		if(i>=0)
			{
			   // Start Any Credit Card Holding_Current_Account
			   
		 var myOptionHoldingCurrentAccount = -1;
		for (i=document.personalloan_form.Holding_Current_Account.length-1; i > -1; i--) {
		if(document.personalloan_form.Holding_Current_Account[i].checked) {
		myOptionHoldingCurrentAccount = i;
/*		if(i==0)			{
	...
	if (myOptionHoldingCurrentAccount == -1) 
	{
	document.getElementById('HoldingCurrentAccountVal').innerHTML = "<span  class='hintanchor'>Please Check Holding Current Account</span>";	
	return false;
	}
			   //End  Any Credit Card
			}
	...
	{
	document.getElementById('HoldingCurrentAccountVal').innerHTML = "<span  class='hintanchor'>Please Check Any Credit Card!</span>";	
	return false;
	}
			}
