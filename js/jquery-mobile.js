...
$.fn.buttonMarkup = function( options ) {
	...
	for ( var i = 0; i < $workingSet.length; i++ ) {
		...
		buttonClass += o.shadow ? " " : "";
		buttonClass += o.corners ? "" : "";
...
$( document ).bind( "pagecreate create", function( e ) {
	...
	$( ":jqmData(role='button'), .ui-bar > a, .ui-header > a, .ui-footer > a, .ui-bar > :jqmData(role='controlgroup') > a", e.target )
		.jqmEnhanceable()
		.not( "button, input, :jqmData(role='none'), :jqmData(role='nojs')" )
		.buttonMarkup();
});
...
$.fn.controlgroup = function( options ) {
	...
	return this.each(function() {
		var $el = $( this ),
			...
			flCorners = o.direction === "horizontal" ? [ "ui-corner-left", "ui-corner-right" ] : [ "", "ui-corner-bottom" ],
...
$.widget( "mobile.textinput", $.mobile.widget, {
	...
	_create: function() {
		...
		$( "label[for='" + input.attr( "id" ) + "']" ).addClass( "" );

		focusedEl = input.addClass(" ui-body-"+ theme );
...
$.widget( "mobile.selectmenu", $.mobile.widget, {
	...
	_preExtension: function() {
		...
		this.select = this.element.wrap( "<div class='form-select" + classes + "'>" );
		this.selectID  = this.select.attr( "id" );
		this.label = $( "label[for='"+ this.selectID +"']" ).addClass( "form-select" );
...
(function( $, undefined ) {
	...
	$.widget( "mobile.fixedtoolbar", $.mobile.widget, {
		options: {
			...
			fullscreen: false,
			tapToggle: true,
			tapToggleBlacklist: "a, input, select, textarea, .ui-header-fixed, .ui-footer-fixed, .ui-popup",
