$(document).ready(function(){
      	...
      	$("#salariedOptions").fadeIn("slow");
		$("#SelfEmployee").fadeOut("slow");
		$("#get-quote-ar").html("");
	 ...
	 $("#IncomeAmount").keyup(function(){
        $("#CityOptions").fadeIn("slow");
    });
	$("#Employment_Status2").click(function(){
		 $("#SelfEmployee").fadeIn("slow");
        $("#running-business-ar").fadeIn("slow");
		$("#salariedOptions").html("");
		$("#CityOptions").html("");
...
function formValidate()
{
	...
	var myOption = -1;
		for (i=document.personalloan_form.Employment_Status.length-1; i > -1; i--) {
			if(document.personalloan_form.Employment_Status[i].checked) {
				myOption = i;
			//first_name - firstnameVal, middle_name - middlenameVal, last_name - lastnameVal	
				if(i==0)
				{ 
					//salaried
		...
		if ((document.personalloan_form.City.value=="") || (document.personalloan_form.City.value=="Please Select"))
			...
			if (document.personalloan_form.first_name.value=="")
				{
					document.getElementById('firstnameVal').innerHTML = "<span  class='hintanchor'>Please Enter Your First name!</span>";
					document.personalloan_form.first_name.focus();
					return false;
				}
			if (document.personalloan_form.first_name.value.length < 3 )
			{
				document.getElementById('firstnameVal').innerHTML = "<span  class='hintanchor'>Enter min 3 characters!</span>";	
				document.personalloan_form.first_name.focus();
				return false;
			}
			if (document.personalloan_form.last_name.value=="")
				{
					document.getElementById('lastnameVal').innerHTML = "<span  class='hintanchor'>Please Enter Your Last name!</span>";
					document.personalloan_form.last_name.focus();
					return false;
				}					
	...
	if ((document.personalloan_form.Phone.value.charAt(0)!="9") && (document.personalloan_form.Phone.value.charAt(0)!="8") && (document.personalloan_form.Phone.value.charAt(0)!="7"))
	{
		...
		{
			document.getElementById('AgeVal').innerHTML = "<span  class='hintanchor'>Please Enter Day!</span>";
			document.personalloan_form.day.focus();
			return false;
		}
		if(isNaN(document.personalloan_form.day.value)|| document.personalloan_form.day.value.indexOf(" ")!=-1)
			{
				document.getElementById('AgeVal').innerHTML = "<span  class='hintanchor'>Enter numeric value!</span>";
				document.personalloan_form.day.focus();
				return false;
			}
		if (document.personalloan_form.month.value=="")
		{
			document.getElementById('AgeVal').innerHTML = "<span  class='hintanchor'>Please Enter Month!</span>";
			document.personalloan_form.month.focus();
			return false;
		}
		if(isNaN(document.personalloan_form.month.value)|| document.personalloan_form.month.value.indexOf(" ")!=-1)
			{
				document.getElementById('AgeVal').innerHTML = "<span  class='hintanchor'>Enter numeric value!</span>";
				document.personalloan_form.month.focus();
				return false;
		...
		{
			document.getElementById('AgeVal').innerHTML = "<span  class='hintanchor'>Please Enter Year!</span>";
			document.personalloan_form.year.focus();
			return false;
		}
		if(isNaN(document.personalloan_form.year.value)|| document.personalloan_form.year.value.indexOf(" ")!=-1)
			{
				document.getElementById('AgeVal').innerHTML = "<span  class='hintanchor'>Enter numeric value!</span>";
				document.personalloan_form.year.focus();
				return false;
