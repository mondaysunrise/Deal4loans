...
function addPersonalDetails()
{
	...
	ni1.innerHTML = '<div style="clear:both;"></div><div style="text-align:left; text-indent:10px; color:#FFF; "><strong>Personal Details</strong></div><div class="termtext"><img src="http://www.deal4loans.com/images/security.png" width="14" height="16"> <span style="color:#FFF;">Your Information is secure with us and will not be shared without your consent</span></div></div><div class="blnew-input-box">  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="25" style="color:#FFF;" class="td-no-border">Full Name:</td>    </tr>    <tr>      <td height="25" class="td-no-border">   <input name="Name" id="Name" type="text"  class="form-input" onkeydown="validateDiv(\'nameVal\');" autocomplete="off" />   <div id="nameVal"></div>  </td>    </tr>    </table></div><div class="blnew-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td height="25" style="color:#FFF;" class="td-no-border">Email ID :</td>    </tr>    <tr>      <td height="25" class="td-no-border">  <input name="Email" id="Email" type="text" class="form-input" onkeypress="validateDiv(\'emailVal\');" autocomplete="off" />          <div id="emailVal"></div>   </td>    </tr>      </table></div><div class="blnew-input-box">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">    <tr>      <td height="25" colspan="2" style="color:#FFF;"  class="td-no-border">Mobile:</td>    </tr>        <tr>      <td width="4%" height="25" class="td-no-border"><div style="float:left; margin-top:5px; color:#FFF;"><em>+91</em></div>          </td><td width="96%" class="td-no-border"><input name="Phone" id="Phone" maxlength="10" onkeyup="intOnly(this);" onkeypress="intOnly(this)"; onchange="intOnly(this);" type="text" class="form-input" onkeydown="validateDiv(\'phoneVal\');" autocomplete="off" /> <div id="phoneVal"></div> </td></tr>    </table></div><div class="blnew-input-box">  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="25" style="color:#FFF;" class="td-no-border">Age:</td></tr><tr><td height="25" class="td-no-border"><select onchange="validateDiv(\'AgeVal\');" class="form-select" name="Age" id="Age"><option value="">Select Age</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option><option value="50">50</option><option value="51">51</option><option value="52">52</option><option value="53">53</option><option value="54">54</option><option value="55">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option><option value="60">60</option><option value="61">61</option><option value="62">62</option><option value="63">63</option><option value="64">64</option><option value="65">65</option></select><div id="AgeVal"></div></td>    </tr>    </table></div><div style="clear:both;"></div><div class="blnew-input-box" style="margin-top:10px">  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="25" width="100%" style="color:#FFF;"  class="td-no-border">Credit Card:</td></tr><tr><td height="25" style="width:60%;" class="td-no-border"> 	<input type="radio" name="CC_Holder" id="CC_Holder" value="1" class="css-checkbox" onclick="return addIdentified();" /><label for="CC_Holder" class="css-label radGroup2" style="color:#FFF;">Yes</label></td><td height="25" class="td-no-border"> <input type="radio" name="CC_Holder" id="CC_Holder2" value="0" class="css-checkbox" onclick="removeIdentified();" checked="checked" />            <label for="CC_Holder2" class="css-label radGroup2" style="color:#FFF;">No</label></td>    </tr>    </table></div><div class="form-inputox" id="myDiv1"></div>';
