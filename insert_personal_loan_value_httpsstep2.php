...
$age=$currentyear-$year;
	...
	{		foreach($_POST as $a=>$b)
			...
			$PL_EMI_Amt = FixString($PL_EMI_Amt);
			$professional_details = FixString($professional_details);
			$Company_Type = FixString($Company_Type);
...
<META HTTP-EQUIV="Refresh" CONTENT="5;URL=https://www.deal4loans.com/apply_personal_loan_httpsstep2.php"> 
