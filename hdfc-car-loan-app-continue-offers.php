...
$r= ($j+1)*100;
?>
<img src="http://chart.apis.google.com/chart?chs=250x100&cht=p3&chd=t:<? echo $lnpre; ?>,<? echo $inper; ?>&chxt=x,y&chds=0,<? echo $r; ?>&chxr=0,0,90|<? echo $r; ?>,0,90&chxl=0:|<? echo $lnpre." %"; ?>|<? echo $inper." %"; ?>&chco=A2D7F6,F4E46C"/>
<div id="sign">
<ul style="margin:0px; ">
