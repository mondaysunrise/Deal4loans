	...
	function formHandler(){
		...
		if($num_rows > 0){
			...
			mysql_free_result($result);
			 ...
			 /* Redirect browser */
			 $strDir = dir_name();
			 if($_SESSION['BidderID']==935)
			{
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."creditcard_lms.php");
			exit;
			}
			else
			{
				header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."creditcard_lms1.php");
			exit;
			}
		}
		else{
