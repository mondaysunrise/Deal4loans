...
<div class="pkup">
  ...
  <?php           $getdetails="select Amount,countr_amt From totalLoans Where (Name='Totalcountr' and flag=1)";
  	list($alreadyExist,$hlamtcnt)=Mainselectfunc($getdetails,$array = array());
$ttl_hltaken = $hlamtcnt['Amount'];
