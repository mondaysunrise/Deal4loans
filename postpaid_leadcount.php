...
<html>
<head>
<title>PostPaid Bidders List</title>
...
<tr><td colspan="5" height="30" align="center"><strong>List of PostPaid Bidders</strong></td></tr>
	<tr><td bgcolor='#FF3000' align="center"><strong>InActive</strong></td><td bgcolor='#FFFFFF'><div align="center"><strong>Active</strong></div></td><td bgcolor='#FFF200'><div align="center"></div></td><td bgcolor='#F6E769'></td></tr>
...
require 'scripts/functions.php';
	...
	$Sql_3 = "SELECT Bidder_Name, BidderID, City FROM `Bidders` WHERE Define_PrePost = 'PostPaid'";
...
$BidderID = mysql_result($Query_3,$i,'BidderID'); 
 ...
 if($Reply_Type==1)
	...
	$SqlCountLead="SELECT * FROM Req_Feedback_Bidder1,`".$val."` WHERE Req_Feedback_Bidder1.AllRequestID=`".$val."`.RequestID and Req_Feedback_Bidder1.BidderID = '".$BidderID."' and  Req_Feedback_Bidder1.Reply_Type = '".$Reply_Type."' group by ".$val.".Mobile_Number";
	$QueryCountLead = ExecQuery($SqlCountLead);
	$TotalLeadsLMS = mysql_num_rows($QueryCountLead);
	//$TotalLeads = $rowBookKeeping[0];
