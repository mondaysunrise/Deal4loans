...
{
	var gifName = form;
	document.frmsearch.action="cc_sbi_processingstutus_report.php?search=y"+gifName;
...
echo "<font style='Font-size:12px;'>Welcome ".ucwords($_SESSION['UserType'])." <b>".$_SESSION['UName']." ( <a href=/Logout.php>Logout</a> )</b>";
 ...
 ?>
 <form name="frmsearch" action="cc_sbi_processingstutus_report.php?search=y" method="post" onSubmit="return chkform();">
   ...
   <tr>
     ...
     <td style="width: 81%">From 
       ...
       <input name="b12" type="button" class="bluebutton" onClick="javascript:pedirFecha(min_date,'');" value="&lt; Insert">     
        ...
        <option value="simply_save_cards_apply">Select Source</option>
        <option value="simply_save_cards_apply"  <? if($source == "simply_save_cards_apply") { echo "selected"; }?> >Sbi Cards LP (simply_save_cards_apply)</option>
