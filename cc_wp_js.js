...
if((document.loan_form.Name.value=="") || (Trim(document.loan_form.Name.value))==false)
   ...
   for (var i = 0; i <document.loan_form.Name.value.length; i++) 
   {
	...
	{
		if((document.loan_form.year.value < 62) || (document.loan_form.year.value >18))
		{
