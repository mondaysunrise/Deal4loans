...
<title>LIC Housing Finance | LIC Housing Loan | LIC Home Loan</title>
<meta name="keywords" content="LIC Housing finance Home loans India, Apply LIC Home Loans, Compare LIC Home Loans in Mumbai Hyderabad Pune kolkata Delhi Noida Bangalore">
      ...
      <tr>
          ...
          <tr>
            <td colspan="4"><table width="99%"  border="0"   cellpadding="0" cellspacing="0">
              <tr>
			   ...
			   <tr>
                <td height="25"  style=" padding-left:10px; " ><div style="color:#5e5e5e; font-size:13px; font-weight:bold;line-height:24px;  ">Features & Benefits of LIC Housing Finance Home Loan | LIC Home Loan</div></td>
              </tr>
              <tr>
                  ...
                  <tr>
                    <td ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="623"><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Purchase/ Construction of House/ Flat.</div></td>
                      </tr>
                      <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                      ...
                      <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  "> Lowest rates from 10.25% - 11.20%.</div></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="new-images/hl/licfrm-hdng.gif" width="289" height="88" /></td>
              </tr>
              <tr>
