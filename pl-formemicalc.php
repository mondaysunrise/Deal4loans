...
.heaading-plformwrappenew{ float:left; width:640px;}
.heaading-plformwrappenew-img{ float:right; width:211px;}

@media screen and (max-width: 768px) {
.heaading-plformwrappenew{ float:none; width:95%;}
.heaading-plformwrappenew-img{ float:none; margin-top:15px; width:100%;}
}
</style>
...
<div style="color:#FFFFFF; font-size:16px;">Get instant quotes on Interest Rates & EMI on personal loan from top 10 banks of India</div>
<div style="clear:both !important;"></div><div class="heaading-plformwrappenew-img"><a href="https://www.deal4loans.com/lowestratequote.php" style="text-decoration:none;" target="_blank"><img src="/new-images/personal-loans.jpg" width="203" height="58" border="0" /></a></div>
<!--<div class="pl_emi_cal_blink_b" style="padding-top:3px;"><img src="http://www.deal4loans.com/images/animated_pl.gif"></div>-->
<div style="clear:both;"></div> 
  <div class="hl_emi_input_form" style="width:100%; padding-left:5px;">
...
font-weight:normal; color:#ffffff;font-Family:Verdana;text-transform: capitalize;'></span></td>
    ...
    <table width="98%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30"><select name="City" id="City" class="hl_emi_select" style="color:#4c4c4c;"  onchange="addPersonalDetails(); othercity1(); addhdfclife(); validateDiv('cityVal');" tabindex="7">
<?=plgetCityList($City)?>
...
<td   align="right" valign="top" style="padding-top:5px; padding-bottom:5px;"><img src="http://www.deal4loans.com/images/wp-loan-get-quote.png" height="44" width="117" border="0" /></td>
</tr>
