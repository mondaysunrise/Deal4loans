...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($last=="")
	{
		...
		{
		$duplicatepush=1;
		$DataArray = array("cc_requestid"=>$requestID,"relation_with_bank"=>$relation_with_bank, "lead_source" => "Direct", "applied_bankname"=> "ICICI Bank", "billing_preference"=> $billing_preference);
		...
		{
			$duplicatepush=0;
			$InsertProductSql= array("relation_with_bank"=>$relation_with_bank, "lead_source" => "Direct", "applied_bankname"=> "ICICI Bank", "billing_preference"=> $billing_preference);
