...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <form name="personalloan_form"  action="insert_business_loan_value_step2.php" method="POST" onsubmit="return submitform(document.personalloan_form); ">
	...
	<input type="hidden" value="<? echo $_SESSION['Temp_LID'];?>" name="leadid" />
		  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
			 ...
			 <tr>
              <td height="42" align="left" class="bldtxt" >Total Years In Business</td>
              <td align="left" ><input style="width:200px;"  name="Total_Experience" onfocus="this.select();">              </td>
            </tr>
            <tr>
              <td height="35" align="left" class="bldtxt" >No of years in Current Business</td>
