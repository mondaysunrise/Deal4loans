...
//$row=mysql_fetch_array($result);
	...
	//$full_name = $row["icici_name"];
	//$mobile = $row["icici_mobile"];
	//	echo "<br>";
...
$car_price_category = $carow[$i]["car_price_category"];
//echo "cpc ".$car_price_category;
//echo "<br>";
$car_loan_category = $carow[$i]["car_loan_category"];
//echo "clc ".$car_loan_category;
//echo "<br>";
$car_price = $carow[$i]["car_loan_price"];
//echo "cp: ".$car_price;
//echo "<br>";
	}
...
if(strlen($city)>0)
	...
	$rate_flag = $clsrow[$j]["rate_flag"];
	 $car_state_category = $clsrow[$j]["car_state_category"];
...
$output .="<table width='100%' cellpadding='0' border='0'><tr><td colspan='2'>
...
if($maxLoan_Amount>0)
{
 ...
 $output .="<tr>
 <td width='526' align='center' valign='top' background='icici_car/calc-bg1.gif' style='background-repeat:no-repeat;    height:180px; background-position: top;'>
...
$output .="<input type='hidden' name='get_roi' id='get_roi' value='".$roi."'>
<input type='hidden' name='get_rf' id='get_rf' value='".$rate_flag."'>
<input type='hidden' name='get_carprice' id='get_carprice' value='".$car_price."'>";
...
$output .="<input type='hidden' name='get_cpc' id='get_cpc' value='".$get_cpc."'>";
$output .="<table width='100%' cellpadding='0' border='0'>
 <tr>
   <td height='30'>&nbsp;</td>
...
<div id='slider-range-min' onClick='newcomplete_div();' onChange='newcomplete_div();' onMouseUp='newcomplete_div();'>
<div class='ui-slider-range ui-slider-range-min ui-widget-header' style=width: 100%;'></div>
</div>
 ...
 <tr>
   ...
   <td colspan='2' align='left' ><table width='100%'  border='0' cellspacing='0' cellpadding='0'>
     <tr>
       ...
       <td width='43%' style='font-size:9px; font-family:Verdana, Arial, Helvetica, sans-serif; color:#5b5b5b '><b>Max:</b>".$maxLoan_Amount."</td>
     </tr>
   </table></td>
   </tr>
<tr>
...
<div id='slider-range-min1' onClick='newcomplete_div();' onChange='newcomplete_div();' onMouseUp='newcomplete_div();'>
</div>
</td><td width='24%' align='right'>&nbsp;</td></tr>
<tr>
  <td>&nbsp;</td>
  <td colspan='2' align='left' style='font-size:9px; font-family:Verdana, Arial, Helvetica, sans-serif;  color:#5b5b5b '><table width='100%'  border='0' cellspacing='0' cellpadding='0'>
    <tr>
      ...
      <td width='40%'  class='verdblk9'><b>Max:</b>".$maxTenure."(Months)</td>
    </tr>
  </table></td>
  </tr>
</table>
...
$output .="<img src='http://chart.apis.google.com/chart?chs=250x100&cht=p3&chd=t:".$lnpre.",".$inper.",".$pfper."&chxt=x,y&chds=0,100&chxr=0,0,90|1,0,90&chxl=0:|".$lnpre."%|".$inper."%|". $pfper."%&chco=A2D7F6,F4E46C,A56119'/>
<div id='sign'>
<ul style='margin:0px; '>
<li style=' background:url(/icici_car/amount_sign.gif) no-repeat 0px 4px; '>Loan Amount -  Rs. ".number_format($Loan_Amount)."</li>
<li style=' background:url(/icici_car/interest_sign.gif) no-repeat 0px 4px;'>Interest Rate - Rs. ".number_format($total_interest)."</li>
<li style=' background:url(/icici_car/fee_sign.gif) no-repeat 0px 4px; '>Fees + Taxes - Rs. ".$processing_fee."</li>
</ul>
</div>
</div>
      ...
      <tr>
        ...
        <td width='15%' align='center'   class='verdred12'>Rs. ".number_format($total_cost)."</td>
        <td width='20%' align='center'   class='verdred12'>Rs. ".number_format($emiPerLac)."</td>
        <td width='17%' align='center'   class='verdred12'>".$roi."\n</td>
        <td width='21%' align='center'   class='verdred12'>Rs. ".number_format($car_price)."</td>
      </tr>
	  </table>
	  ...
	  <tr><td colspan='2'><form action='icici-car-loan-thank.php' name='car_details' method'='POST' ><table width='100%'><tr><td style='padding-left:30px;'><input type='hidden' name='get_reqid' id='get_reqid' value='".$icici_clid."'><input type='submit' name='apply' value='Apply'></td><td>&nbsp;</td><td><input width='50%' type='submit' name='Continue' value='Click To Call'></td></tr></table></form></td></tr>
	  ";
} 
	  $output .="</table>";
...
function newcomplete_div()
{
  ...
  $('#complete_div').load("get_icici_cl_calc_pchartnew.php" + queryString);
}
...
alert("hello");
//window.opener = null; 
window.opener.location.href = "http://www.deal4loans.com";
self.close();
}
	</script>