...
{
	var gifName = form;
	document.frmsearch.action="csindex.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="csindex.php?search=y" method="post" onSubmit="return chkform();">
 ...
 <? 		
		...
		$qry="SELECT * from Req_Credit_Sudhaar where (Dated Between '".($min_date)."' and '".($max_date)."')";
		$qry=$qry."group by Mobile";
...
//echo $qry;
 ?>
	  <tr>
     <td colspan="5" style="border-bottom:1px solid #45B2D8;"><strong><? echo $startrow+1; ?> to <? echo min($startrow+$pagesize,$recordcount); ?> Out of <? echo $recordcount; ?> Records </strong>
     </tr>
   <tr>
     <td width="189" align="center" bgcolor="#FFFFFF" class="style2">Name</td>
	 <td width="132" align="center" bgcolor="#FFFFFF" class="style2">Mobile</td>
	 <td width="164" align="center" bgcolor="#FFFFFF" class="style2">City</td>
     <td width="179" align="center" bgcolor="#FFFFFF" class="style2">Email</td>
     <td width="270" align="center" bgcolor="#FFFFFF" class="style2">Message</td>
   </tr>
	<?
...
//echo "<br>".$qry;
   ...
   <tr>
	 ...
	 <? echo $row["Name"]; ?></td>
	  ...
	  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Mobile"]; ?></td>
	  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["City"]; ?></td>
   	    <td align="center" bgcolor="#DFF6FF" class="style3">	<? echo $row["Email"]; ?>		</td>
           	    <td align="center" bgcolor="#DFF6FF" class="style3">	<? echo $row["Message"]; ?>		</td>
   </tr>
	<?
		$i=$i+1;
		}
