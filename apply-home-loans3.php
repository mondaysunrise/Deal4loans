...
function addIdentified()
{
		...
		ni.innerHTML = '<table width="100%" align="left" border="0"><tr><td height="20"  align="left" valign="middle" class="formtext"><b style="color:#373737;">Property Location</b></td>	<td colspan="3" align="left" height="20" >&nbsp;&nbsp;&nbsp;<select style="width:150px;" name="Property_Loc" id="Property_Loc" tabindex="16"><?=getCityList1($City)?></select></td></tr></table>';
 ...
 <input type="hidden" name="Activate" id="Activate" ><input type="hidden" name="source" value="<? echo $retrivesource; ?>">
  ...
  <tr>
    <td height="30"  bgcolor="#FFFFFF" class="formtext" ><h1 style="margin:0px; padding:0px;">Apply Home Loan</h1></td>
          ...
          <tr>
            <td colspan="5" valign="top" class="formtext"></td>
            </tr>
           <tr>
             <td  colspan="5" align="left" class="formtext"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                   <tr valign="middle">
                     <td height="28" class="formtext" style="padding-top:3px; "><b style="color:#373737;">First Name :</b></td>
                     <td height="28" class="formtext"  style="padding-top:3px; "><input type="text" name="Name" id="Name" style="width:150px;" maxlength="30"  onchange="insertData();" tabindex="1" /></td>
                     <td width="17%" height="28" class="formtext" style="padding-top:3px; "><b style="color:#373737;">City :</b></td>
                     <td width="31%" height="28" class="formtext"  style="padding-top:3px; "><select name="City" id="City" style="width:154px;" onchange="cityother(); tataaig_comp(); insertData();" tabindex="7">
                         <?=getCityList($City)?>
                     </select></td>
                   </tr>
                   <tr valign="middle">
                     <td height="28" class="formtext"><b style="color:#373737;">DOB :</b></td>
                     ...
                     <td height="28" align="left" class="formtext"><b style="color:#373737;">Other City :</b></td>
                     <td height="28" class="formtext"><input type="text" name="City_Other" disabled  value="Other City" onfocus="this.select();" style="width:148px;" tabindex="8" /></td>
                   </tr>
                   <tr valign="middle">
                     <td height="28" class="formtext"><b style="color:#373737;">Mobile :</b></td>
                     ...
                     <td height="28" class="formtext"><b style="color:#373737;">Pincode :</b></td>
                     <td height="28" class="formtext"><input type="text" name="Pincode" onfocus="this.select();" style="width:148px;" maxlength="6" onkeypress="intOnly(this);" onkeyup="intOnly(this);"   tabindex="9" /></td>
                   </tr>
                   <tr valign="middle">
                     <td width="19%" height="28" class="formtext"><b style="color:#373737;">Email ID :</b></td>
                     <td width="33%" height="28" class="formtext"><input type="text" name="Email" id="Email"  style="width:149px;" onchange="insertData();" tabindex="6" /></td>
                     <td width="17%" height="28" class="formtext"><b style="color:#373737;">Occupation :</b></td>
                     <td width="31%" height="28" class="formtext"><select   name="Employment_Status"  id="Employment_Status" style="width:154px;" tabindex="10" >
                   ...
                   <tr valign="top">
                     <td height="28" colspan="3" style="color:#373737; padding-top:5px;"><b>Total Monthly EMI for all running loans :</b></td>
                     <td height="28" style="padding-top:4px; "><input type="text" name="obligations" id="obligations" style="width:148px;"    onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="17" /></td>
                   </tr>
                 </table></td>
                 <td width="310" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="28" class="formtext"><b style="color:#373737;">Gross Annual Salary :</b></td>
                <td class="formtext"><input type="text" name="Net_Salary" id="Net_Salary" style="width:148px;" onkeyup="intOnly(this); getDigitToWords('Net_Salary','formatedIncome','wordIncome');" onkeypress="intOnly(this);"  onblur="getDigitToWords('Net_Salary','formatedIncome','wordIncome');"  onchange="ShowHide('incomeShow','Net_Salary');" tabindex="11" />
                </td>
              </tr>
              <tr>
                <td   colspan="2" class="formtext"><span id='formatedIncome' style='font-size:11px;
...
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
              ...
              <tr>
                <td height="28" class="formtext"><b style="color:#373737;">Loan Amount :</b></td>
                <td class="formtext"><input name="Loan_Amount" id="Loan_Amount" tabindex="12" type="text" style="width:148px;" maxlength="10" onfocus="this.select();" onchange="ShowHide('loanShow','Loan_Amount');"  onkeyup="intOnly(this);getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');"  onkeydown="getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onkeypress="intOnly(this); getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onblur="getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" />
                </td>
              </tr>
              <tr>
                <td colspan="2" class="formtext"><span id='formatedlA' style='font-size:11px;
font-weight:normal; color:#333333;font-Family:Verdana;'></span><span id='wordloanAmount' style='font-size:11px;
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
              </tr>
              <tr>
                <td height="28" class="formtext"><b>Property Value :</b></td>
                <td class="formtext"><input type="text" name="property_value"  id="property_value" style="width:148px;" maxlength="30"   onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="13" /></td>
              </tr>
              <tr>
                <td height="28" class="formtext"><b style="color:#373737;">Property Identified :</b></td>
                <td class="formtext"><input type="radio" name="Property_Identified" id="Property_Identified" value="1" onclick="addIdentified();" style="border:none;" tabindex="14" />
      Yes&nbsp;&nbsp;
      ...
      No</td>
           ...
           <tr>
             <td height="22"  colspan="5" align="left" class="formtext"><input type="checkbox" name="co_appli" id="co_appli" value="1" onClick="return showdetailsFaq(1,12);" style="border:none;" tabindex="18">&nbsp; <b>Co- Applicant</b></td>
           </tr>
           <tr>
             <td  colspan="5" align="left" class="formtext">
			 			
												<div style="display:none; " id="divfaq1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      <td width="12%" class="formtext" height="30"><b> Name :</b></td>
          <td width="23%" align="left"><span class="formtext">
          ...
          <td width="17%" align="left"><span class="formtext">
            <input type="text" name="co_monthly_income" id="co_monthly_income" style="width:148px;" value="<?php echo $income; ?>"  onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="23" />
                    ...
                    <tr>
                      <td height="30" colspan="3" class="formtext"><b> Total Monthly EMI for all running loans : </b></td>
          ...
          <td align="left">&nbsp;</td>
           ...
           <tr>
             <td height="22"  colspan="4" align="left" class="formtext"><input type="checkbox" name="accept" style="border:none;">
  ...
  <tr>
    <td width="15%" height="22" align="center" bgcolor="#3d60a4" class="wttext" style="color:#FFFFFF; "><b>Banks</b></td>
    <td width="27%" align="center" bgcolor="#3d60a4" class="wttext" style="color:#FFFFFF; "><b>ICICI HFC </b></td>
    <td width="24%" align="center" bgcolor="#3d60a4" class="wttext" style="color:#FFFFFF; "><b>HDFC Bank</b></td>
    <td width="23%" align="center" bgcolor="#3d60a4" class="wttext" style="color:#FFFFFF; "><b>IDBI Bank</b></td>
	    <td width="34%" align="center" bgcolor="#3d60a4" class="wttext" style="color:#FFFFFF; "><b>Axis Bank</b></td>
  </tr>

  <tr>
    <td height="22" align="center" bgcolor="#FFFFFF" class="text"><b>Rate of Interest</b></td>
    <td align="center" bgcolor="#FFFFFF" class="text" ><b>8.25% - 9.75%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>8.25% - 9.50%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>8.25% - 9.25%</b></td>
	 <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>8% - 9.25%</b></td>
  </tr>
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>Rs. 10,000/- or 0.5%</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>0.50%</b></td>
	    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>0.5%</b></td>
  </tr>
  <tr>
    <td height="22" align="center" valign="middle" bgcolor="#FFFFFF" class="text" ><b>Loan Amount</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"  ><b>Rs.2,00,000 - Rs.20,00,000</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>Rs.2,00,000 - Rs.20,00,000</b></td>
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>Rs.2,00,000 - Rs.20,00,000</b></td>
	    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>Rs.1,00,000 - Rs.50,00,000</b></td>
  </tr>
   <tr>
...
<div><img src="new-images/slider/thumb/icici.jpg" alt="ICICI Bank" width="137" height="41"  style="border:none;"/></div>
