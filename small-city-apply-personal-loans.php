	 ...
	 if (( document.personalloan_form.Employment_Status.value=="0" ) || ( document.personalloan_form.Employment_Status.value=="-1" ))
       {
               ...
               document.getElementById('nettab').innerHTML = "<div style='width:100px; float:left; line-height:22px;'>Net Take Home</div>";
			     //document.getElementById('plantype1').innerHTML = strPlan;
       }
...
<div  class="content-deal">The one-stop shop for best on all Personal loan requirements
 ...
 KOTAK and STANDARD CHARTERED </strong>and choose the best deal!</div>
...
<form name="personalloan_form"  action="small-city-apply-personal-loans-continue.php" method="POST" onSubmit="return chkpersonalloan(document.personalloan_form);">
...
<input type="hidden" name="source" value="phh"> 
...
<option value="Select City" >Select City</option><option value="Abhipur">Abhipur</option><option value="Ambala">Ambala</option><option value="Amritsar">Amritsar</option><option value="Bahadurgarh">Bahadurgarh</option><option value="Barnala">Barnala</option><option value="Bathinda">Bathinda</option><option value="Bhiwani">Bhiwani</option><option value="Faridabad">Faridabad</option><option value="Faridkot">Faridkot</option><option value="Fatehabad">Fatehabad</option><option value="Fatehgarh Sahib">Fatehgarh Sahib</option><option value="Ferozepur">Ferozepur</option><option value="Gohana">Gohana</option><option value="Gurdaspur">Gurdaspur</option><option value="Gurgaon">Gurgaon</option><option value="Hamirpur">Hamirpur</option><option value="Hisar">Hisar</option><option value="Hoshiarpur">Hoshiarpur</option><option value="Jajhar">Jajhar</option><option value="Jalandhar">Jalandhar</option><option value="Jhajjar">Jhajjar</option><option value="Jind">Jind</option><option value="Kaithal">Kaithal</option><option value="Kangra">Kangra</option><option value="Kapurthala">Kapurthala</option><option value="Karnal">Karnal</option><option value="Khanna">Khanna</option><option value="Kullu">Kullu</option><option value="Kurukshetra">Kurukshetra</option><option value="Ludhiana">Ludhiana</option><option value="Mahendragarh">Mahendragarh</option><option value="Mandi">Mandi</option><option value="Mandi Gobindgarh">Mandi Gobindgarh</option><option value="Mansa">Mansa</option><option value="Markanda">Markanda</option><option value="Moga">Moga</option><option value="Mohali">Mohali</option><option value="Mohindergarh">Mohindergarh</option><option value="Muktsar">Muktsar</option><option value="Nalagarh">Nalagarh</option><option value="Narnaul">Narnaul</option><option value="Narwana">Narwana</option><option value="Navsari">Navsari</option><option value="Nawanshahr">Nawanshahr</option><option value="Nurpur">Nurpur</option><option value="Palampur">Palampur</option><option value="Panchkula">Panchkula</option><option value="Panipat">Panipat</option><option value="Pathankot">Pathankot</option><option value="Patiala">Patiala</option><option value="Phagwara">Phagwara</option><option value="Railmajra-Ropar">Railmajra-Ropar</option><option value="Rewari">Rewari</option><option value="Rohtak">Rohtak</option><option value="Ropar">Ropar</option><option value="Rupnagar">Rupnagar</option><option value="Samalkha">Samalkha</option><option value="Sangrur">Sangrur</option><option value="Santpur">Santpur</option><option value="Shimla">Shimla</option><option value="Sirsa">Sirsa</option><option value="Solan">Solan</option><option value="Sonepat">Sonepat</option><option value="Sundernagar">Sundernagar</option><option value="Tihra">Tihra</option><option value="Tohana">Tohana</option><option value="Toshan">Toshan</option><option value="Una">Una</option><option value="Yamuna Nagar">Yamuna Nagar</option></select></div>
</div>
	...
	<div class="form-bg"><span  name="nettab" id="nettab" style="width:100px; float:left; padding-left:15px; line-height:22px; " >Annual Income</span>
	  <input name="IncomeAmount" id="IncomeAmount" type="text" value="Annual Income" style="margin-left:29px; width:140px; margin-top:2px;" onFocus="this.select(); onBlurDefault(this,'Annual Income');"  onChange="intOnly(this); addDiv();"  onKeyUp="intOnly(this);PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome'); addDiv();" onKeyPress="intOnly(this); PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome');" onBlur="PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome'); onBlurDefault(this,'Annual Income'); "/></div>
	<span id='formatedIncome' style='font-size:11px; font-weight:bold;color:666699;font-Family:Verdana;'></span>
	<span id='wordIncome' style='font-size:11px;font-weight:bold;color:666699;font-Family:Verdana;text-transform: capitalize;'></span>

	<div class="form-bg"><span class="form-text">Loan Amount</span> <input name="Loan_Amount" id="Loan_Amount" type="text" value="Loan Amount" style="margin-left:40px; width:140px; margin-top:2px;" onFocus="this.select(); onBlurDefault(this,'Loan Amount');" onChange="intOnly(this);"  onKeyUp="intOnly(this);PlgetDigitToWords('Loan_Amount','formatedlA','wordloanAmount');"  onKeyDown="PlgetDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onKeyPress="intOnly(this); PlgetDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onBlur="PlgetDigitToWords('Loan_Amount','formatedlA','wordloanAmount'); onBlurDefault(this,'Loan Amount'); onBlurDefault(this,'Loan Amount');"></div> <span id='formatedlA' style='font-size:11px; font-weight:bold;color:666699;font-Family:Verdana;'></span><span id='wordloanAmount' style='font-size:11px;
...
<!-- Google Code for PHH Conversion Page -->
...
var google_conversion_label = "9AqYCI3IkAEQh8-3_AM";
//-->
</script>
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1066264455/?label=9AqYCI3IkAEQh8-3_AM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
