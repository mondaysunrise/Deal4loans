...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if((strlen($fullname)>0) && (strlen($mobile)>0))
	{
		...
		VALUES ( '', '$fullname', '$email_id', '$mobile', '$Type_Loan', 'popup_hl', Now() )";
		ExecQuery($sql);
		//exit();
...
<html>
<head>
<title>Home Loan | Deal4loans</title>
<meta name="keywords" content="Home Loan applying, Deal4loans, Bimadeals, Insurance" /> 
...
function getformdetails()
{
		...
		if(ni.innerHTML=="")
		{
			...
			ni.innerHTML = "<table bgcolor='#FFFFFF' width='225' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td colspan='2' height='22' valign='middle' bgcolor='#61a4e7' class='blue-line' align='center'>Quick Apply</td></tr><tr><td style='padding-top:5px;'><table width='95%'  border='0' align='center' cellpadding='0' cellspacing='0' > <tr><td width='40%' align='left' class='frmtext' height='23'>Product Type</td><td width='70%' align='right' class='frmtext'> <select style='width:130px;' name='Type_Loan'><option value='1'>Please select</option> <option value='Req_Loan_Personal'>Personal Loan</option> <option value='Req_Credit_Card'>Credit Card</option><option value='Req_Loan_Car'>Car loan</option> <option value='Req_Loan_Against_Property'>Loan against Property <option value='Req_Business_Loan'>Business Loan</option></select></td>	 </tr>  <tr align='left'><td colspan='2'><input type='hidden' name='source' value='QuickApply'></td></tr><tr> <td align='left' class='frmtext' height='23'>Full Name</td><td align='right' ><input type='text' name='fullname' style='width:130px;' maxlength='30'></td></tr><tr><td align='left' class='frmtext' height='23'>Mobile</td><td align='right'  class='frmtext'>+91<input type='text' style='width:100px;' maxlength='10' onChange='intOnly(this);' onKeyUp='intOnly(this);' onKeyPress='intOnly(this);' name='mobile'></td></tr>	 <tr><td align='left' class='frmtext' height='23'>Email id</td> <td align='right' ><input type='text' name='email_id' style='width:130px;'></td></tr><tr><td colspan='2'></td></tr><tr><td colspan='2' align='center' height='30'  class='frmtext'> <input type='submit' class='bluebutton' value='Submit' ></td></tr></table></td></tr></table>";
...
<tr>
    ...
    <td height="45" align="center" valign="middle" class="blue-line">Your Home Loan request has been successfully submitted </td>
  </tr>
 <tr>
