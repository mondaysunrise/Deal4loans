...
{
	var gifName = form;
	document.frmsearch.action="bidders_consolidate_appointment1.php?search=y"+gifName;
...
<td>&nbsp;</td></tr>
 ...
 <form name="frmsearch" action="bidders_consolidate_appointment1.php?search=y" method="post" onSubmit="return chkform();">
