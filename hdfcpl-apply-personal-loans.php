          ...
          <tr>
            <td colspan="4"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
			   ...
			   <tr>
                <td height="25" class="bldtxt" style="font-size:13px; font-family:Verdana, Arial, Helvetica, sans-serif; " >Hdfc Personal Loan Features.
</td>
              </tr>
              <tr>
                  ...
                  <tr>
                    <td align="left"><table   border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td>Lowest Emi & Rates.</td>
                      </tr>
                      <tr>
                        <td width="22" height="22" align="left" valign="middle">2)</td>
                        <td>Loan upto 15 Lakhs for any purpose.</td>
                      </tr>
                      <tr>
                        <td width="22" height="22" align="left" valign="middle">3)</td>
                        <td>Special rates for account holders of Hdfc Bank.</td>
                      </tr>
					  <tr>
                        <td width="22" height="22" align="left" valign="middle">3)</td>
...
<tr>
              ...
              <tr>
                <td>I think that the launch of a service like www.deal4loans.com will ease the loan seeking and deal hunting process for the likes of me. I wish u guys all the success.
                    <div style="float:right; font-weight:bold;" class="bldtxt">Divya</div></td>
              </tr>
              <tr>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="new-images/pl/hdfcfrm-hdng.gif" width="289" height="88" /></td>
              </tr>
              <tr>
...
<input type="hidden" name="source" value="PH1DL"> 
