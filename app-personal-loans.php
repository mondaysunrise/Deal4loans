...
<link href="css/apply-personal-loans-new.css" type="text/css" rel="stylesheet" />
		...
		if(document.personalloan_form.Employment_Status.selectedIndex >0 && citemps==1)
			{
				...
				ni1.innerHTML ='<input name="Company_Name" id="Company_Name" type="text" class="apply_pl_input" onBlur="onBlurDefault(this,\'Type slowly for Autofill\');"  onFocus="onFocusBlank(this,\'Type slowly for Autofill\');"  onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event)" value="Type slowly for Autofill" tabindex=10 autocomplete="off" onkeydown="validateDiv(\'companyVal\');" /><div id="companyVal"></div>';
							}
		}
		else
	{
...
function addPersonalDetails()
{
	...
	ni1.innerHTML = '<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td align="left" valign="middle" class="bldtxt" colspan="2" style="padding-top:3px;" ><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="48%"  align="left" class="pl_detail_text" colspan="2"> Personal Details</td></tr><tr><td width="4%" style="font-size:10px; font-weight:normal; color:#7e5a09;"><img src="http://www.deal4loans.com/images/security.png" width="14" height="16"></td><td width="96%" align="left" style="font-size:10px; font-weight:normal; font-family:Verdana, Geneva, sans-serif;  color:#7e5a09;">Your Information is secure with us & will not be shared without your consent</td></tr></table></td></tr>    <tr>    <td width="42%" height="45" class="text_3">Full Name</td>    <td width="58%"  class="alert_msg"><input name="Name" type="text" class="apply_pl_input" id="Name" tabindex=6  onFocus="onFocusBlank(this,\'Name\');"  onBlur="onBlurDefault(this,\'Name\');" onChange="insertData();" value=""  onkeydown="validateDiv(\'nameVal\');"/><div id="nameVal"></div></td>  </tr>  <tr>    <td height="45" class="text_3">DOB</td>    <td  class="alert_msg"><input name="day" type="text" class="dd_pl" id="day" tabindex=7  onFocus="onFocusBlank(this,\'dd\');" onBlur="onBlurDefault(this,\'dd\');" onChange="intOnly(this);" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="dd" maxlength="2" onKeyDown="validateDiv(\'dobVal\');"/> <input name="month" type="text" class="dd_pl" id="month" tabindex=8 onFocus="onFocusBlank(this,\'mm\');" onBlur="onBlurDefault(this,\'mm\');" onChange="intOnly(this);" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="mm" maxlength="2" onKeyDown="validateDiv(\'dobVal\');" /> <input name="year" type="text" class="yy_pl" id="year" tabindex=9  onFocus="onFocusBlank(this,\'yyyy\');"   onBlur="onBlurDefault(this,\'yyyy\');" onChange="intOnly(this); insertData();" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="yyyy" maxlength="4" onKeyDown="validateDiv(\'dobVal\');" /><div id="dobVal"></div></td>  </tr>  <tr>   <td height="45" class="text_3">Mobile No.</td>    <td  class="text_3"  >+91 <input name="Phone" type="text" class="mobile_pl" id="Phone"  tabindex=10 onFocus="addtooltip();" onChange="intOnly(this); tosendsms(); insertData();" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" maxlength="10"  value=""  onKeyDown="validateDiv(\'mobileVal\');" /><div id="mobileVal" class="alert_msg"></div></td>  </tr>  <tr>    <td height="45" class="text_3">Email Id</td>    <td class="alert_msg"><input name="Email" id="Email" type="text" value=""   onblur="onBlurDefault(this,\'Email Id\');" onFocus="removetooltip();"  onChange="insertData();" tabindex=11 onKeyDown="validateDiv(\'emailVal\');" class="apply_pl_input" /><div id="emailVal"></div></td>  </tr><tr>    <td height="45" class="text_3">Are you a Credit card holder?</td>    <td  class="text_3"><input type="radio"  name="CC_Holder" id="CC_Holder" value="1" tabindex="12" style="border:none;" onClick="addElement(); validateDiv(\'ccholderVal\');" > Yes <input type="radio"  name="CC_Holder" id="CC_Holder" style="border:none;" tabindex="13" value="0" onClick="removeElement(); validateDiv(\'ccholderVal\'); "> No  <div id="ccholderVal" class="alert_msg" ></div> </td>  </tr>	<tr align="left"> <Td id="myDivcc"  class="form_text" ></Td><Td id="myDivcc1"  ></Td>		  </tr>  <tr>    <td height="0" colspan="2"align="center" class="text_3" style="font-size:10px; text-align:left;"><input type="checkbox"  name="accept" style="border:none;" checked tabindex="15" > I authorize Deal4loans.com & its <a href="http://www.deal4loans.com/pl-partnering-banks.php" target="_blank" rel="nofollow">partnering banks</a> to contact me to explain the product & I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.<div id="acceptVal" class="alert_msg"></div></td>  </tr>  <tr>    <td height="0" colspan="2" align="center">&nbsp;</td> </tr>  <tr>    <td height="45" colspan="2" align="center"><input type="image" name="Submit" src="d4limages/quote_btn-new.jpg" style="width:128px; height:32px; border:none;" tabindex="16" /></td>    </tr>    </table>';
...
<div class="pl_form_radius_top">Welcome Rewards
  <br>
  <span  class="text_2"> Get cash back gifts upto Rs. 13500 on disbursal*</span> </div>
...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr>
    <td height="28" colspan="2" align="center" bgcolor="#c99c2d" class="pl_detail_text_a">Personal Loan Request</td>
  </tr>
  <tr>
...
<div style="clear:both;"></div>
<div class="pl_steps_box" style="margin-top:10px;"><img src="d4limages/steps-img.gif" width="516" height="78"></div>
</div>
<div class="pl-right_img_box"><div class="table_sample"><img src="d4limages/apply-pl-main-img.jpg" width="461" height="143"></div>
<div class="pkup">
  <img src="d4limages/sample-table.jpg" width="461" height="79"> </div>
  <div class="why_box"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="35" class="text_4">Why Deal4loans.com - Widest Choice of Banks</td>
  </tr>
  <tr>
    <td><table width="100%" style="border:#6dcbe1 solid thin;" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="8%" height="35" align="center" bgcolor="#F4F9FC"><img src="d4limages/bullet-why_pl.jpg" style="width:27px; height:21px;" width="27" height="21"></td>
            <td width="92%" bgcolor="#F4F9FC" class="pl_why_bullet">Get instant quote on Rates, Emi, Eligibility, <span style="font-size:18px; font-weight:bold;">Fees</span> &amp; Documents from all Banks.</td>
            </tr>
          <tr>
            <td style="height:5px;"></td>
            </tr>
          <tr>
            <td height="35" align="center" bgcolor="#F4F9FC"><img src="d4limages/bullet-why_pl.jpg" style="width:27px; height:21px;" width="27" height="21"></td>
            <td height="35" bgcolor="#F4F9FC" class="pl_why_bullet">Top <span style="font-size:18px; font-weight:bold;">9 Banks</span> with  <span style="font-size:18px; font-weight:bold;">3 Banks</span> having NIL Prepayment Charges</td>
            </tr>
          <tr>
            <td style="height:5px"></td>
            </tr>
          <tr>
            <td height="35" align="center" bgcolor="#F4F9FC"><img src="d4limages/bullet-why_pl.jpg" style="width:27px; height:21px;" width="27" height="21"></td>
            <td bgcolor="#F4F9FC" class="pl_why_bullet"> It's a totally <span style="font-size:18px; font-weight:bold;">free</span> service.</td>
            </tr>
          <tr>
            <td style="height:5px;"></td>
            </tr>
          <tr>
            <td height="35" align="center" bgcolor="#F4F9FC"><img src="d4limages/bullet-why_pl.jpg" style="width:27px; height:21px;" width="27" height="21"></td>
            <td height="35" bgcolor="#F4F9FC" class="pl_why_bullet">Your Information is secure with us and will not be shared without your consent.</td>
            </tr>
          <tr>
            <td height="35" align="center" bgcolor="#F4F9FC"><img src="d4limages/bullet-why_pl.jpg" style="width:27px; height:21px;" width="27" height="21"></td>
            <td height="35" bgcolor="#F4F9FC" class="pl_why_bullet"> Loans quotes taken from Deal4loans <table width="130" border="0" align="right" cellpadding="0" cellspacing="2"> <tr><td style="padding-left:3px;">
<?php         
$hlamtcnt="select Amount,countr_amt From totalLoans Where (Name='Totalcountr' and flag=1)";
list($numPL,$row)=Mainselectfunc($hlamtcnt,$array = array());
...
<div class="pl_bank_logo"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <li ><img src="d4limages/ing-logo-d4l.jpg" width="81" height="27"></li>
