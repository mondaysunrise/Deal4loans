...
if(Form.salary_mode.selectedIndex==0)
{
	alert("Please select mode of salary");
	Form.salary_mode.focus();
	return false;
}
...
<tr>
    ...
    <tr>
	<td  height="26" align="right" class="bldtxt" >How do you receive<br /> 
	  your salary</td>
	<td width="16" align="center" class="bldtxt" >:</td>
	<td width="250" align="left"><select name="salary_mode" style="width:142px; "><option value="">Please Select</option><option value="Direct">Direct deposited in Bank</option><option value="cash">via cash</option><option value="cheque">via cheque</option></select></td>
  </tr>
  <tr>
