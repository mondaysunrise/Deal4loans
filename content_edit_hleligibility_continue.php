...
$pid = $_POST['pid'];
	...
	$sql = "update city_hl_pages set State= '".$State."',  City= '".$City."', Title='".$Title."', MetaKeyword='".$keyword."', MetaDescription='".$metadesc."' ,PageDescription='".$mainDesc."' ,HeaderDEscription='".$header."' where pid='".$pid."'";
	$query = ExecQuery($sql);
	//echo "<br>".$sql;
	$report = "Updated";
	$creadetPage = '<a href="http://www.deal4loans.com/propertyeligibility-calculator/'.$City.'" target="_blank">Updated Page</a>';
...
<a href="content_list_hleligibility.php">Go to List</a>
</td></tr></table>
</body>
</html>