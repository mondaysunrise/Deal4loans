...
//	require 'scripts/functions.php';
	...
	$checkSql = "select * from citi_appointments where RequestID='".$RequestIDVal."' and Reply_Type=1";
	...
	if($checkNum>0)
	{
		...
		$wherecondition ="(citi_appointments.RequestID=".$RequestIDVal." and citi_appointments.Reply_Type='1')";
