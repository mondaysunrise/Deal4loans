<?php
header("Location: home-loan-eligibility-calculator.php");
exit();
...
<?php include "top-menu.php";  include "main-menu.php"; ?></div>
<div class="hl_emi_cal_wrapper">
<div class="pl_logo"><img src="images/logo.gif" width="243" height="90" /></div>
<div style="clear:both;"></div>
<div class="text12" style="margin:auto; width:100%; height:11px; margin-top:11px; color:#0a8bd9;"><u><a href="index.php" class="text12" style="color:#0080d6;" >Home</a></u> > <span  class="text12" style="color:#4c4c4c;">Home Loan Eligibility Calculator </span></div>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="2"><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="100%" colspan="2"><h1 class="text3" style=" color:#FFF; font-size:24px; text-transform:none; ">Home Loan Eligibility Calculator <span style="font-size:18px;">- Get Instant Quote from Top 10 Banks</span></h1></td>
        </tr>
        <tr>
...
font-weight:normal; color:#ffffff;font-Family:Verdana;text-transform: capitalize;'></span></td>
        ...
        <div class="hl_emi_input_form-new" style="padding-left:5px;">
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="30"><select name="City" id="City" class="hl_emi_select"  style="font-family:Verdana, Geneva, sans-serif; font-size:11px; color:#4c4c4c;"  onchange="addPersonalDetails(); addhdfclife(); validateDiv('cityVal');" tabindex="7"><?=getCityList($City)?></select><div id="cityVal"></div>  </td>
              </tr>
            </table>
          </div></td>
    </tr>
...
<div style=" width:100%; height:auto; margin-top:5px; margin-left:10px; text-align:justify;">
 ...
 Employment Status - <strong>Salaried</strong> | Annual Income - <strong>Rs. 12 Lacs</strong> | Property Value - <strong>Rs. 75 Lacs</strong> | Tenure - <strong>20 Yrs</strong></p>
  ...
  <tr>
    <td bgcolor="#EBEBEB"><table width="100%" align="center" cellpadding="2"  cellspacing="2" style="border:#CCC solid thin;"><tr><td bgcolor="#FFFFFF" class="body_text1"><table width="100%" align="center" cellpadding="2"  cellspacing="2" style="border:#CCC solid thin;">
      <tr>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="body_text1" align="center"> 10.65 %</td>
        <td bgcolor="#FFFFFF" class="body_text1" align="center">Rs.50524</td>
      ...
      <tr>
        ...
        <td align="center" bgcolor="#FFFFFF" class="body_text">10.65 %</td>
        <td align="center" bgcolor="#FFFFFF" class="body_text">Rs. 55577</td>
      ...
      <tr>
        ...
        <td align="center" bgcolor="#FFFFFF" class="body_text">10.65 %</td>
        <td align="center" bgcolor="#FFFFFF" class="body_text">Rs.50830</td>
        <td align="center" bgcolor="#FFFFFF" class="style100">Rs. 5040323</td>
      </tr>
      <tr>
        <td align="center" bgcolor="#FFFFFF"  height="45"><span class="fed_bank">SBI</span></td>
