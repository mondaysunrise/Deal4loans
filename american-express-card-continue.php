...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	{
		$alreadyExists = 0;
		$Card_Name = 'American Express Platinum ReserveSM Credit Card';
		...
		//echo $insertSQl;
//		echo "<br>";
		if(($City=="Bahadurgarh" || $City=="Bangalore" || $City=="Chennai" || $City=="Delhi" || $City=="Faridabad" || $City=="Gaziabad" || $City=="Greater Noida" || $City=="Gurgaon" || $City=="Hyderabad" || $City=="Kolkata" || $City=="Mumbai" || $City=="Navi Mumbai" || $City=="Noida" || $City=="Pune" || $City=="Thane") && $CC_Holder==1 && (($Employment_Status==1 && ($Net_Salary>=900000)) || ($Employment_Status==0 && ($Net_Salary>=1500000))))
		{
			$verifiedLead = 1;
...
header("Location: american-express-card-thanks.php");
exit();
?>
<!DOCTYPE html>
<html>
...
<body>
<form action="american-express-card-thanks.php" method="post" name="validate" onSubmit="return validateFrm();">
