...
?>
<div style="text-align:center; font-size:14px; font-weight:bold;">Gold Loan</div>
 <form name="frmsearch" action="" method="post">
 <table width="950" border="0" align="center" cellpadding="1" cellspacing="3" bgcolor="#FFFFFF" >
 <? 

		$sql = "select * from city_pages where 1=1 and 	Product='Gold' ";
 ...
 ?>	  <tr>
   ...
   <tr>
     <td align="center" bgcolor="#DFF6FF" class="style3" >
		 <a href="http://www.deal4loans.com/gold-loan/<?php echo $row["City"]; ?>" target="_blank"><strong><? echo ucfirst($row["City"]); ?></strong></a></td>
	  <td style="padding-left:4px;" bgcolor="#DFF6FF" class="style3"><? echo $row["Title"]; ?></td>
     <td align="center" bgcolor="#DFF6FF" class="style3"><a href="content_edit_gl.php?pid=<?php echo $row["pid"]; ?>">Edit</a></td>
	</tr>
<?	$i=$i+1;
			}
	?>
