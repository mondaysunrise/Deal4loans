...
exit;
	...
	function formHandler(){
		...
		$result = ExecQuery("select *  from Bidders where Email='$Email' and PWD='$PWD' and Is_Verified=69");
		...
		if($num_rows > 0){
			...
			mysql_free_result($result);
			 ...
			 /* Redirect browser */
			 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."hdfcbangalore_pl_index.php");
			exit;
		}
		else{
			global $Msg;
...
<Script Language="JavaScript">
   function validateMe(theFrm){
	...
	if(!checkData(theFrm.PWD, 'Password', 2))
		return false;
	return true;
    }
 </Script>
