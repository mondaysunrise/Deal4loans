...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		$requestid_Mob = $_POST['requestid_Mob'];
		$Name = $_POST['Name2'];
		$Phone= $_POST['Phone2'];
		$source = $_POST['source2'];
		$Employment_Status = $_POST['Employment_Status2'];
		$City2 = $_POST['City2'];
		$Net_Salary = $_POST['Net_Salary2'];
	...
	if($requestid_Mob>0)
	{
		$dataUpdate = array('Name'=>$Name, 'Employment_Status'=>$Employment_Status, 'City'=>$City2, 'Mobile_Number'=>$Phone, 'Dated'=>$Dated, 'source'=>$source, 'Updated_Date'=>$Dated, 'IP_Address'=>$IP, 'Net_Salary'=>$Net_Salary);
		$wherecondition = "(RequestID='".$requestid_Mob."')";
