...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="mobilechat"; }
...
<tr align="left">
 ...
 <!--<script type='text/javascript' data-cfasync='false'>window.purechatApi = { l: [], t: [], on: function () { this.l.push(arguments); } }; (function () { var done = false; var script = document.createElement('script'); script.async = true; script.type = 'text/javascript'; script.src = 'https://app.purechat.com/VisitorWidget/WidgetScript'; document.getElementsByTagName('HEAD').item(0).appendChild(script); script.onreadystatechange = script.onload = function (e) { if (!done && (!this.readyState || this.readyState == 'loaded' || this.readyState == 'complete')) { var w = new PCWidget({c: 'b8b15edf-0a74-4301-a6e0-7796fb68d91d', f: true }); done = true; } }; })();</script>-->
 	
<!-- <script src="http://uhchat.net/code.php?f=55ca01"></script>-->
<div id='tawk_5683a9fb1c9dbe63110c83e7'></div>
<!--Start of Tawk.to Script-->
<script type="text/javascript">
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date(); Tawk_API.embedded='tawk_5683a9fb1c9dbe63110c83e7';
(function(){
var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
s1.async=true;
s1.src='https://embed.tawk.to/5683a9fb1c9dbe63110c83e7/1a85ieu5r';
s1.charset='UTF-8';
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr>
       <td class="text_head-bullet" style="color:#CC0000;"><ul>
         ...
         <li>Lowest Rate starting as low as <strong>11.90% </strong></li>
         <li>Processing Fee offers starts 999</li>
...
$dataInsert = array("banner_name"=>$retrivesource, "capture_clicks"=>'1', "ip_address"=>$IP, "dated"=>$Dated);

$ProductValue = Maininsertfunc ('captute_banner_click', $dataInsert);
if($retrivesource=="AFL_MLR_OPTMED_PL")
{ ?>
	<script type="text/javascript" src="https://track.in.omgpm.com/854965/transaction.asp?APPID=1&MID=854965&PID=16204&status="></script>
<noscript><img src="https://track.in.omgpm.com/apptag.asp?APPID=1&MID=854965&PID=16204&status=" border="0" height="1" width="1"></noscript>
<? }
}
?>
