...
{
  	$getlapdata="
Select  RequestID, Bidderid_Details, City, City_Other, Net_Salary, Loan_Amount, DOB, Is_Valid, Employment_Status from Req_Loan_Against_Property where ((Allocated =0 or Allocated =2) and Is_Valid=1 and source!='LAP RBL testpage' and (Updated_Date >=DATE_SUB(CURDATE(),INTERVAL 0 DAY)))";
	 
	// $getlapdata="Select  RequestID, Bidderid_Details, City, City_Other, Net_Salary, Loan_Amount, DOB, Is_Valid, Employment_Status from Req_Loan_Against_Property where (RequestID=81368)";
...
$BankNameID="";
     ...
     {   
		...
		{   
			...
			echo $InsertFeedBackSqlPL = "Insert into Req_Feedback_Bidder_LAP1 (AllRequestID,BidderID,Reply_Type,Allocation_Date) Values ('$LeadID', '$BiddersValue[$l]','$ProductType', Now())";
...
$dateFormat15min = date("j M y g:i A", $aheadTime);
	...
	Thank you for choosing Deal4loans.com, we are pleased to inform you that your registration for Loan Against Property has been successful. By verifying your mobile number via sms verification and you have authorized below mentioned banks/agents to call you on $mobile_no even if your number is registered with DNC or DND.<br /><br /> 
