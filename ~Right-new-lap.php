...
for($j=0;$j<$hlrowcount;$j++)
	...
	?>
  <tr>
    <td width="56%" height="22"><? echo $hlrow[$j]["bank_name"]; ?> </td>
     <td width="44%"><b><? echo $hlrow[$j]["ndtv_rates"]; ?></b></td>
    </tr>
	   <tr>
...
<div style="background:url(new-images/bg-bt.jpg); background-repeat:no-repeat; width:250px; height:19px;"></div>
			...
			<div style=" background:url(new-images/rgt-bg.gif); background-repeat:repeat-y; width:250px;">
              <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
<? $getplrates="Select cat_a,bank_name,others From personal_loan_interest_rate_chart where (flag=1 and rateid in (1,2,3,7))";
...
<td width="44%"><b><? echo $plrow[$j]["cat_a"]."-".$plrow[$j]["others"]; ?></b></td>
</tr>
