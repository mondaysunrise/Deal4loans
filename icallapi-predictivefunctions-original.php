...
//	print_r($row);
	...
	$max_date = $currentdate." 23:59:59";
		...
		$qry = "SELECT RequestID,Name,Mobile_Number FROM Req_Credit_Card_Sms LEFT OUTER JOIN lead_allocate ON lead_allocate.AllRequestID=Req_Credit_Card_Sms.RequestID WHERE ( Req_Credit_Card_Sms.source='SMS_Lead_ICCS' and RequestID>'".$total_lead_count."' and lead_allocate.BidderID=6449 and (Req_Credit_Card_Sms.Section IS NULL OR Req_Credit_Card_Sms.Section='') and Req_Credit_Card_Sms.Updated_Date Between '".$min_date."' and '".$max_date."')";
	}
		echo $qry."<br>";
