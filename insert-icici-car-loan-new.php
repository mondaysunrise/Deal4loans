...
$annual_income = $_REQUEST["annual_income"]*12;

$current_experience = $_REQUEST["current_experience"];
$day = $_REQUEST["day"];
...
$car_manufacturer = $_REQUEST["fm_category_id"];

$car_model = $_REQUEST["fm_subcategory"];

$icici_company_name =$_REQUEST["company_name"];
...
if($maxLoan_Amount>0)
	{
$Dated = ExactServerdate();
		$DataArray = array("icici_eligible_loanamt"=>$maxLoan_Amount , "icici_eligible_interestrate"=>$roi , "icici_eligible_emi"=>$emiPerLac, "icici_eligible_tenure"=>$tenure );
		$wherecondition ="(icici_clid='".$strProductValue."')";
...
<tr>
 ...
 <tr>
  ...
  <td><table width="93%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="70%" align="left"  class="verdred13"> Tenure in months:</td>
...
<li style=" background:url(icici_car/fee_sign.gif) no-repeat 0px 4px; ">Fees + Taxes - <? echo "Rs. ".$processing_fee;?></li>
	  ...
	  <!--</div>-->	</div>
	   ...
	   <tr><td colspan='2' align="center"><form action="icici-car-loan-thank.php" name="car_details" method="POST">
	   <table width='70%'><tr><td style="padding-left:30px;"><input type="hidden" name="get_reqid" id='get_reqid' value="<? echo $strProductValue; ?>">
	   <input type='submit' name='apply' value='Apply Now'></td><td>&nbsp;</td><td><input width='50%' type='submit' name='Continue' value='Click To Call'></td></tr></table></form></td></tr>
	  <? } ?>
	<tr>
        <td >
