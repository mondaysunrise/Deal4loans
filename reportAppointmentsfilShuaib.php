...
$endDate = date("Y-m-d", $mkDate)." 23:59:59";
	...
	$getDocSql = "select * from fil_appointments left join Req_Feedback_Bidder1 on Req_Feedback_Bidder1.AllRequestID = fil_appointments.RequestID where (Req_Feedback_Bidder1.Allocation_Date between '".$startDate."' and '".$endDate."') and Req_Feedback_Bidder1.BidderID in (1050,1000,1015,1012,1037,996) group by fil_appointments.RequestID";
...
mail($Email,'Appointments Leads - Deal4loans - Main Cities', $message, $headers);
