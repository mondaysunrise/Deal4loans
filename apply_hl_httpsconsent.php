...
{
	$selqry="select PL_Bank,Loan_Amount,Name,DOB,Company_Name,Net_Salary,City,Mobile_Number,Email,source from Req_Loan_Home Where RequestID=".$pl_requestid;
...
<div style="clear:both;"></div>
<div class="common-bread-crumb" style="margin:auto; width:74%; margin-top:70px; color:#0a8bd9;"><u><a href="index.php" class="text12" style="color:#0080d6;" >Home</a></u> > <a href="#"  class="text12" style="color:#0080d6;"><u>Home Loan</u></a> <span class="text12" style="color:#4c4c4c;">> Apply for Home Loan</span></div>
<div style="clear:both; height:15px;"></div>
<div style="width:995px;  margin:auto;">
<div id="content"><form name="cibil_form" method="post" action="/apply_hl_httpsconsent_thank.php"  onSubmit="return ckhcreditcard(document.cibil_form); ">
