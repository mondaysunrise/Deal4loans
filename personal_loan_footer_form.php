...
if(!document.loan_form.accept.checked)
	{
		document.getElementById('acceptRVal').innerHTML = "<span class='hintanchorqa'>Read and Accept Terms & Condition!</span>";	
...
<input type="hidden" name="source" value="Quick Apply New PL" />
