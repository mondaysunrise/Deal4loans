...
function addIdentified()
{
		...
		if(ni.innerHTML=="")
		{
			...
			if(document.loan_form.Property_Identified.value="on")
			{
				...
				ni.innerHTML = '<table width="100%" align="left" border="0"><tr><td height="20"  align="left" valign="middle" class="formtext"><b style="color:#373737;">Property Location</b></td>	<td colspan="3" align="left" height="20" >&nbsp;&nbsp;&nbsp;<select style="width:150px;" name="Property_Loc" id="Property_Loc" tabindex="17"><?=getCityList1($City)?></select></td></tr></table>';
			}
...
<div id="container">
 ...
 <input type="hidden" name="Activate" id="Activate" ><input type="hidden" name="source" value="<? echo $retrivesource; ?>">
              <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="aplfrm" >
     ...
     <td><table width="98%" border="0" align="right" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            <td colspan="6" style="padding:12px;" ><table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"  bgcolor="#FFFFFF" class="formtext" ><h1 style="margin:0px; padding:0px;">Apply Home Loan</h1></td>
  </tr>
</table></td>
            </tr>
          <tr>
            <td height="25" class="formtext"><b style="color:#373737;">First Name :</b></td>
            <td height="28" class="formtext"><input type="text" name="Name" id="Name" style="width:150px;" maxlength="30"  onChange="insertData();" tabindex="1"></td>
            <td width="10%" height="25" class="formtext"><b style="color:#373737;">City :</b></td>
            <td width="22%" height="25" class="formtext"><select name="City" id="City" style="width:154px;" onchange="cityother(); tataaig_comp(); insertData();" tabindex="7">
                <?=getCityList($City)?>
            </select></td>
            <td width="16%" height="25" class="formtext"><b style="color:#373737;">Gross
              Annual 
              Salary :</b></td>
            <td width="20%" height="25" class="formtext"><input type="text" name="Net_Salary" id="Net_Salary" style="width:148px;" onblur="getDigitToWords('Net_Salary','formatedSalary','wordSalary');" onkeyup="getDigitToWords('Net_Salary','formatedSalary','wordSalary'); intOnly(this);" onkeypress="intOnly(this);" tabindex="11" /></td>
          </tr>
          <? if(!isset($_SESSION['UserType'])) {?>
          <tr>
            <td height="25" class="formtext"><b style="color:#373737;">Date of Birth  :</b></td>
            <td height="28" class="formtext"><input name="day" type="text" id="day"  value="DD" style="  width:35px; " onblur="onBlurDefault(this,'dd');" onfocus="onFocusBlank(this,'dd');" maxlength="2" onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="2"/>
            ...
            <td height="25" align="left" class="formtext"><b style="color:#373737;">Other City :</b></td>
            <td height="25" class="formtext"><input type="text" name="City_Other" disabled value="Other City" onfocus="this.select();" style="width:148px;" tabindex="8" /></td>
            <td height="25" class="formtext"><b style="color:#373737;">Loan Amount :</b></td>
            <td height="25" class="formtext"><span class="formtext" style="padding-top:2px;">
              <input type="text"  id="Loan_Amount" name="Loan_Amount" style="width:148px;" maxlength="30" onblur="getDigitToWords('Loan_Amount','formatedIncome','wordIncome');" onkeyup="getDigitToWords('Loan_Amount','formatedIncome','wordIncome'); intOnly(this);" onkeypress="intOnly(this);" tabindex="12" />
            </span></td>
          </tr>
          <tr>
            <td height="25" class="formtext"><b style="color:#373737;">Mobile :</b></td>
            <td height="28" class="formtext">+91
            ...
            <td height="25" class="formtext"><b style="color:#373737;">Pincode :</b></td>
            <td height="25" class="formtext"><input type="text" name="Pincode" onfocus="this.select();" style="width:148px;" maxlength="6" onkeypress="intOnly(this);" onkeyup="intOnly(this);"   tabindex="9" /></td>
            <td valign="top" class="formtext" style="padding-top:6px;"><b>Property Value :</b></td>
            <td height="25" valign="top" class="formtext" style="padding-top:4px;"><input type="text" name="property_value"  id="property_value" style="width:148px;" maxlength="30"   onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="13" />            </td>
          </tr>
          <tr>
            <td width="11%" height="25" class="formtext"><b style="color:#373737;">Email ID :</b></td>
            <td width="21%" height="28" class="formtext"><input type="text" name="Email" id="Email"  style="width:149px;" onChange="insertData();" tabindex="6"></td>
            <td width="10%" height="25" class="formtext"><b style="color:#373737;">Occupation :</b></td>
            <td width="22%" height="25" class="formtext"><select   name="Employment_Status"  id="Employment_Status" style="width:154px;" tabindex="10" >
                  <option value="-1">Employment Status</option>
                  <option value="1">Salaried</option>
                  <option value="0">Self Employment</option>
                </select></td>
            <td valign="middle" class="formtext"><b style="color:#373737;">Property Identified :</b></td>
            <td height="25" valign="middle" class="formtext" style="padding-top:2px;"><input type="radio" name="Property_Identified" id="Property_Identified" value="1" onclick="addIdentified();" style="border:none;" tabindex="14" />
              Yes&nbsp;&nbsp;
  <input type="radio"  name="Property_Identified" id="Property_Identified" onclick="removeIdentified();" value="0" style="border:none;" tabindex="15" />
          ...
          <tr>
            <td height="28" colspan="3" align="left" valign="top" class="formtext" style="padding-top:4px;"><b style="color:#373737;">Total Monthly Emi for all running loans :</b></td>
            <td height="25" valign="top" class="formtext" style="padding-top:2px;">              <input type="text" name="obligations" id="obligations" style="width:148px;"    onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="16" />            </td>
          ...
          <tr>
            <td colspan="4" valign="top" class="formtext"></td>
            <td  ></td>
            <td  ></td>
          </tr>
           <tr>
            <td  colspan="6" align="left" class="formtext"><input type="checkbox" name="co_appli" id="co_appli" value="1" onClick="return showdetailsFaq(1,12);" style="border:none;" tabindex="18">&nbsp; <b>Co- Applicant</b></td>
            </tr>
          <tr>
			<td   colspan="6" align="left"><div style="display:none;" id="divfaq1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      <td width="11%" class="formtext" height="30"><b> Name :</b></td>
          <td width="21%" align="left"><span class="formtext">
            <input type="text" name="co_name" id="co_name" style="width:130px;" tabindex="19" maxlength="30" value="<?php echo $co_name; ?>" >
            </span></td>
          <td width="10%" align="left"><b>Date of Birth : </b></td>
          <td width="22%" align="left"><input onfocus="insertData();" name="co_day" type="text" id="co_day" style="width:40px;" maxlength="2" onchange="intOnly(this);" onkeyup="intOnly(this);" onkeypress="intOnly(this)"; value="DD" tabindex="20" />
            ...
            <input name="co_year" type="text" id="co_year" style="width:55px;" maxlength="4" onchange="intOnly(this);" onkeyup="intOnly(this);" onkeypress="intOnly(this);" value="YYYY" tabindex="22" /></td>
          <td width="16%" height="30" class="formtext"><b> Net Monthly Income : </b></td>
          <td width="20%" align="left"><span class="formtext">
            <input type="text" name="co_monthly_income" id="co_monthly_income" style="width:130px;" value="<?php echo $income; ?>"  onkeyup="intOnly(this);" onkeypress="intOnly(this);" tabindex="23" />
          </span></td>
                    </tr>
          ...
          <td align="left"><span class="formtext">
            <input type="text" name="co_obligations" id="co_obligations" tabindex="24" style="width:130px;" value="<?php echo $obligations; ?>"  onKeyUp="intOnly(this);" onKeyPress="intOnly(this);">
            </span></td>
          <td align="left">&nbsp;</td>
          <td align="left">&nbsp;</td>
          <td align="left">&nbsp;</td>
          ...
          <tr>
		  <td colspan="5" align="left"><input type="checkbox" name="accept" style="border:none;">
			...
			<td><input value="" type="submit" style="background-image:url(new-images/quote-btn.jpg); border:0px; width:128px; height:31px; margin-bottom:0px;"  /> </td>
      </tr>
...
<div style="padding-top:15px; padding-left:15px; padding-bottom:0px;">
<img src="new-images/prnr.gif" alt="Loan Partners" />
</div>
<div class="sldrpnl" style="background-color:#999999;">
<div class="lftsldr"></div>
<div class="sldrbg">
 <div id="slider">
			<ul>				
				<li>
<div><img   src="new-images/thumb/hdfc.jpg" alt="HDFC Bank" width="146" height="67" style="border:none;"/></div>
<div><img  src="new-images/thumb/axis.jpg" alt="HDFC Bank" width="146" height="67" style="border:none;"/></div>
<div><img  src="new-images/thumb/icici.jpg" width="146" height="67" style="border:none;" alt="ICICI Bank"/></div>
<div><img  src="new-images/thumb/idbi-h.jpg" width="146" height="67" style="border:none;" alt="ICICI Bank"/></div>
				</li>
