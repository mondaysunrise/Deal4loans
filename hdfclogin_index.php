...
{
	var gifName = form;
	document.frmsearch.action="hdfclogin_index.php?search=y"+gifName;
...
function chkform()
{
	...
	if(document.frmsearch.min_date.value<"2007-06-05")
	{
		alert("Sorry!!!! Your minimum date is 2007-06-05.Please Select.");
		document.frmsearch.min_date.value="";
		document.frmsearch.min_date.focus();
		return false;
	}
...
<div align="center">
 ...
 <form name="frmsearch" action="hdfclogin_index.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
  ...
  <tr><td>&nbsp;</td><td><a href="bidders_index.php"><b>Click here</b> </a>to view leads after <?php echo $_SESSION['definedate'];?> </td></tr>
   <tr>
     ...
     <td width="80%">From 
       <input name="min_date" type="text" id="min_date" size="15" <? if($min_date=="") { ?>value="2007-06-05"<? } else { ?>value="<? echo $min_date; ?>" <? }?>>
 ...
 <p>&nbsp;</p>
	...
	if($search=="y")
	{
		...
		{
			$min_date=$min_date." 00:00:00";
			$search_date=$search_date." and UNIX_TIMESTAMP(Req_Loan_Personal.Dated)>='".strtotime($min_date)."'";
		}
		else if($min_date=="" and $max_date!="")
		{
			$max_date=$max_date." 23:59:59";
			$search_date=$search_date." and UNIX_TIMESTAMP(Req_Loan_Personal.Dated)<='".strtotime($max_date)."'";
		}
		else
		{
 ...
 <?
		if((($min_date>="2007-06-05 00:00:00") && ($max_date<="2007-06-15 23:59:59")) || (($min_date>="2007-06-25 00:00:00") && ($max_date<="2007-07-10 23:59:59")) || (($min_date>="2007-07-19 00:00:00")  && ($max_date<="2007-08-01 23:59:59")) || ($min_date>="2007-09-10 00:00:00") )
	{
		$search_qry="select * from Req_Loan_Personal, wUsers where Req_Loan_Personal.UserID=wUsers.UserID and ( Req_Loan_Personal.City='Delhi'or Req_Loan_Personal.City='Noida' or Req_Loan_Personal.City='Gurgaon' or Req_Loan_Personal.City='Gaziabad' or Req_Loan_Personal.City_Other='Faridabad' ) and ((Req_Loan_Personal.Net_Salary>=240000 and Req_Loan_Personal.Employment_Status=1) or (Req_Loan_Personal.Net_Salary>100000 and Req_Loan_Personal.Employment_Status=0))".$search_date." and (wUsers.IsPublic=1 or Req_Loan_Personal.IsPublic=1) and Req_Loan_Personal.Loan_Amount>=100000 and wUsers.DOB!='' and DATE_SUB(CURDATE(),INTERVAL 26 YEAR) >= wUsers.DOB";
		$qry="select * from Req_Loan_Personal, wUsers where Req_Loan_Personal.UserID=wUsers.UserID and ( Req_Loan_Personal.City='Delhi'or Req_Loan_Personal.City='Noida' or Req_Loan_Personal.City='Gurgaon' or Req_Loan_Personal.City='Gaziabad' or Req_Loan_Personal.City_Other='Faridabad' ) and  ((Req_Loan_Personal.Net_Salary>=240000 and Req_Loan_Personal.Employment_Status=1) or (Req_Loan_Personal.Net_Salary>100000 and Req_Loan_Personal.Employment_Status=0))".$search_date." and (wUsers.IsPublic=1 or Req_Loan_Personal.IsPublic=1)and Req_Loan_Personal.Loan_Amount>=100000 and wUsers.DOB!='' and DATE_SUB(CURDATE(),INTERVAL 26 YEAR) >= wUsers.DOB order by Req_Loan_Personal.Dated desc";
	}
	
	else
	{
		echo "<script>alert('Please try dates b/w 2007-06-25 to 2007-07-10 or 2007-07-19 to 2007-08-01 or 2007-09-10 onwards')</script>";
	}
 ...
 ?>
   ...
   <tr>
	...
	if((($min_date>="2007-06-05 00:00:00") && ($max_date<="2007-06-15 23:59:59")) || (($min_date>="2007-06-25 00:00:00") && ($max_date<="2007-07-10 23:59:59")) || (($min_date>="2007-07-19 00:00:00")  && ($max_date<="2007-08-01 23:59:59")) || ($min_date>="2007-09-10 00:00:00") )
	{
		$qry="select * from Req_Loan_Personal, wUsers where Req_Loan_Personal.UserID=wUsers.UserID and ( Req_Loan_Personal.City='Delhi'or Req_Loan_Personal.City='Noida' or Req_Loan_Personal.City='Gurgaon' or Req_Loan_Personal.City='Gaziabad' or Req_Loan_Personal.City_Other='Faridabad' or Req_Loan_Personal.City_Other='Greater Noida' ) and ((Req_Loan_Personal.Net_Salary>=240000 and Req_Loan_Personal.Employment_Status=1) or (Req_Loan_Personal.Net_Salary>100000 and Req_Loan_Personal.Employment_Status=0))".$search_date." and  (wUsers.IsPublic=1 or Req_Loan_Personal.IsPublic=1)  and Req_Loan_Personal.Loan_Amount>=100000 and wUsers.DOB!='' and DATE_SUB(CURDATE(),INTERVAL 26 YEAR) >= wUsers.DOB order by Req_Loan_Personal.Dated desc LIMIT $startrow, $pagesize";
	}
 ...
 <form name="frmdownload" action="hdfclogin_download.php" method="post">
   <tr>
     <td align="center">
