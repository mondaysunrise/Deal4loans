...
$getPageSql = "select * from city_pages where City='".$City."' and Product='Car Loan'";
...
{
	$sql = "INSERT INTO city_pages (Product ,City , State, Title ,MetaKeyword ,MetaDescription ,PageDescription ,HeaderDEscription ,Dated ,Status) VALUES ('Car Loan',  '".$City."', '".$State."',  '".$Title."',  '".$keyword."',  '".$metadesc."',  '".$mainDesc."', '".$header."', Now(), '1')";
	$query = ExecQuery($sql);
	//echo "<br>".$sql;
	$report = "Inserted";
	$creadetPage = '<a href="http://www.deal4loans.com/car-loan/'.$City.'" target="_blank">Created Page</a>';
...
<tr>
    <td ><div align="center">Car Loan</div></td>
    </tr>
<tr><td>
<?php
echo $report;
...
<a href="make_cl_page_index.php">Make Other Page</a>
</td></tr></table>
</body>
</html>