...
$getPageSql = "select * from city_pages where City='".$City."' and Product='Gold'";
...
{
	$sql = "INSERT INTO city_pages (Product ,City ,State, Title ,MetaKeyword ,MetaDescription ,PageDescription ,HeaderDEscription ,Dated ,Status) VALUES ('Gold',  '".$City."', '".$State."', '".$Title."',  '".$keyword."',  '".$metadesc."',  '".$mainDesc."', '".$header."', Now(), '1')";
	$query = ExecQuery($sql);
	//echo "<br>".$sql;
	$report = "Inserted";
	$creadetPage = '<a href="http://www.deal4loans.com/gold-loan/'.$City.'" target="_blank">Created Page</a>';
...
<tr>
    <td ><div align="center">Gold Loan</div></td>
    </tr>
<tr><td>
<?php
echo $report;
...
<a href="makegoldloan_index.php">Make Other Page</a>
</td></tr></table>
</body>
</html>