...
<div style=" text-align:left !important;">Personal Details</div>
  ...
  <input type="hidden" name="iciciappid" id="iciciappid" value="<? echo $ProductValue; ?>">
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr>
           <td width="50%" align="left" class="formbodytext">Name</td>
           <td width="50%" align="left" class="formbodytext">Mobile</td>
         </tr>
         <tr>
           <td colspan="2" class="formbodytext" height="7"></td>
         </tr>
         <tr>
           <td class="formbodytext"> <input name="Name" id="Name" type="text" class="input-bx" tabindex="1"  onKeyDown="validateDiv('nameVal');" autocomplete="off" />
                           <div id="nameVal" class="alert_msg"></div> </td>
           <td class="formbodytext"><input type="text" name="Phone" id="Phone" class="input-bx" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" tabindex="2" onKeyDown="validateDiv('phoneVal');" maxlength="10" autocomplete="off"  />
     <div id="phoneVal" class="alert_msg"></div></td>
         </tr>
         <tr>
           <td colspan="2" class="formbodytext" height="7"></td>
         </tr>
     ...
     <div id="panVal" class="alert_msg"></div> </td>
         ...
         <tr>
           <td colspan="2" class="formbodytext" style="font-size:11px;" height="7"></td>
         </tr>
         <tr>
