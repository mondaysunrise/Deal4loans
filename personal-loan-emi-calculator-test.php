...
<table id='pmtTab' style=' clear: both; background: none repeat scroll 0 0 #FCFCFC; margin: 0 0 20px 0;   text-align: center; '> 
 ...
 <tr height="18">
    ...
    <td align="center" width="64"  class="default_td">Rs. 39,761</td>
    <td align="center" width="64"  class="default_td">Rs. 26,426</td>
    <td align="center" width="64"  class="default_td">Rs. 1,60,239</td>
  </tr>
 <tr height="18">
    <td height="18" align="center" width="64"  class="default_td">2</td>
    <td align="center" width="64"  class="default_td">Rs. 45,925</td>
    <td align="center" width="64"  class="default_td">Rs. 20,262</td>
    <td align="center" width="64"  class="default_td">Rs. 1,14,314</td>
  </tr>
 <tr height="18">
    <td height="18" align="center" width="64"  class="default_td">3</td>
    <td align="center" width="64"  class="default_td">Rs. 53,045</td>
    <td align="center" width="64"  class="default_td">Rs. 13,142</td>
    <td align="center" width="64"  class="default_td">Rs. 61,269</td>
  </tr>
 <tr height="18">
    <td height="18" align="center" width="64"  class="default_td">4</td>
    <td align="center" width="64"  class="default_td">Rs. 61,269</td>
    <td align="center" width="64"  class="default_td">Rs. 4,918</td>
...
<div class="pl_emi_cal_table" style="margin-top:15px;"><table  style=' clear: both;    background: none repeat scroll 0 0 #FCFCFC; margin: 0 0 20px 0;   text-align: center; ' width="100%">
    ...
    <tr height="18">
      <td height="18" align="center"   class="default_td"><a href="http://www.deal4loans.com/hdfc-personal-loan-eligibility.php">HDFC Bank</a></td>
	...
	-->
    <tr height="18">
      <td height="18" align="center"   class="default_td"><a href="http://www.deal4loans.com/kotak-personal-loan-eligibility.php">Kotak Bank</a></td>
