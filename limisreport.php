...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="border:#0033CC 1px solid;">
 ...
 <form name="frmsearch" action="limisreport.php?search=y" method="post" onSubmit="return chkform();">
   ...
   <td colspan="3" align="center"><table border="0" cellpadding="0" cellspacing="0" width="85%">
     ...
     <option value="2614" <? if($lms_details == "2614") { echo "selected"; }?>>LI Evening LMS</option>                 
     </select>
		</td>
...
if($lms_details=="All")
{
	$biddIDS = array(28,80,232,1453,5,2614);
}
else 
{
...
//$biddIDS = array(28,80);
 ...
 <table width="950" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" >
  <tr>
	 ...
	 else if($biddIDS[$j]==2614)
	 {
	 	echo "LI Evening LMS [2614]";
	 }
	 ?>
