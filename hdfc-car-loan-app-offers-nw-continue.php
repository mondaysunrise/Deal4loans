...
<tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="25" bgcolor="#618c9d" class="white_text" colspan="2">Specifications</td>
    </tr>
	<tr>
      <td colspan="2">
	  <table width="100%" border="0" cellpadding="5" cellspacing="2">
	   <tr>
      <td height="30" class="text_car_head_nw" style="border-right:1px solid #FFFFFF;" align="left">Overall Length</td>
	  <td width="80">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	     </tr>
    <tr>
      <td height="30" class="text_car_head_nw" style="border-right:1px solid #FFFFFF;">Power</td>
	  <td>&nbsp;</td>
    </tr>
  <tr>
      <td height="30" class="text_car_head_nw" style="border-right:1px solid #FFFFFF;">Torque</td>
	  <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="30" class="text_car_head_nw" style="border-right:1px solid #FFFFFF;">Seating Capacity</td>
	  <td>&nbsp;</td>
    </tr>
	 <tr>
      <td height="40" class="text_car_head_nw" style="border-right:1px solid #FFFFFF;">Mileage (ARAI specified)</td>
	  <td>&nbsp;</td>
    </tr>
	<tr>
      <td height="30" class="text_car_head_nw" style="border-right:1px solid #FFFFFF;">Top Speed</td>
	  <td>&nbsp;</td>
    </tr>
	</table></td></tr>
  </table>
                                      ...
                                      <td width="300" align="center"><table width="85%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td width="62%" align="left"  class="body_text_b_nw1"> Eligible Loan Amount:</td>
                                  ...
                                  <input name="text" type="text" class="verdblu13" id="amount_<? echo $j; ?>" style="border:0px; width:65px;" /></td>
                                      ...
                                      <td width="300"><table width="74%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td width="62%" align="left" class="body_text_b_nw1"> Tenure in month:</td>
	   ...
	   <input type="hidden" value="<? echo round($maxLoan_Amount); ?>" name="nwLA_<? echo $j; ?>" id="nwLA_<? echo $j; ?>" />
        ...
        <table width="100%"  align="center" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td width="180" class="text_car_head" style="border-bottom:1px solid #FFFFFF;">Car video</td>
          </tr>
          <tr>
            <td height="60" class="text_car_body"><? echo $listofcars[$j] ;?></td>
            ...
            <td class="text_car_body"><? //echo $car_videocode[$j]; ?>                                  </td>
          </tr>
...
?>
  ...
  <div id="navigation" style="display:none; vertical-align:top; padding-top:-100px;">
	...
	<div align="center" class="body_text_nw" style="padding-top:15px;" ><table width="800" style="border:#CCCCCC thin solid;"align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" colspan="5" align="center" valign="middle" bgcolor="#F4F4D3" class="text_car_body">Welcome Rewards</td>
        </tr>
        <tr>
