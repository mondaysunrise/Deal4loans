...
//echo				ingVyasyaLoans ($Company_Name, $Net_Salary, $account_holder,$age,$other_emi,$Loan_Amount);
				list($interestrate,$getloanamout,$getemicalc,$term,$Processing_Fee)= hdbfcLoans ($company_name, $Net_Salary, $account_holder,$age,$other_emi,$Loan_Amount);
			//	echo "<br>&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&<br>";
...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="450" height="75" align="left" valign="top">    <img src="images/logo-hdhfs.jpg"  border="0" /></td>
    <td width="387" >&nbsp;</td>
    <td width="167" height="95" align="right" valign="bottom" ><img src="new-images/beta1.jpg" height="79" width="79"  /></td>
  </tr>
</table></td>

      </tr>

 	  <tr><td height="70" align="center" style="color:#000099; font-family: Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; color:#3533a0;">Personal Loan Quote</td>
...
if($Employment_Status==1 && ( $Residential_Status!="RENTED_AND_STAYING_WITH_FRIENDS" && $Residential_Status!="PAYING_GUEST" && $Residential_Status!="HOSTEL" ) && (in_array($checkCity, $arrCity)))
{
   ...
   <tr><td><b style="font-size:13px; font-family:Verdana, Arial, Helvetica, sans-serif;">Name</b></td><td><input type="text" name="Name" id="Name"  /></td></tr>
	 ...
	 <tr><td height="70" align="center" style="color:#000099; font-family: Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; color:#3533a0;">Sorry You are not eligible as per the policy.</td>
		  </tr></table>
			<? }
...
$city_List = explode(",", $cityList);
	...
	?>
    	<table width="661"  border="0" align="center" cellpadding="0" cellspacing="1" >
 <tr>
   <td height="70" align="center" style="color:#000099; font-family: Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; color:#3533a0;">Thank You for registering with us, our representative will call you shortly.</td>
 	  </tr></table>
	<?php	
	}
	else // Not Eligible
