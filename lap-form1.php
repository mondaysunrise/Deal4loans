...
<h1 class="text3" style=" color:#FFF; font-size:20px; text-transform:none; "><strong>
Apply <?php echo $subjectLine; ?>
</strong></h1>
<div class="text3" style="float:left; width:575px; font-size:24px; color:#FFF; text-transform:none; margin-top:11px" id="imgDisplay"><img src="/images/animated_lap1.gif"  /></div>
</div>
