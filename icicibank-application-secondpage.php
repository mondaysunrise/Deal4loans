...
{
	if(!is_numeric($plength) || $plength <= 0) { $plength = 8; } if($plength > 32)	{ $plength = 32; } $chars = '0123456789';	mt_srand(microtime() * 1000000);
...
//Array ( [ProductValue] => 6 [cust_loan] => 560000 [City] => Delhi [age] => 28 [Employment_Status] => 1 [Company_Name] => G M FABRICS PRIVATE LIMITED [Net_Salary] => 900000.00 [total_emi] => 1200 [other_emi] => 1200 [relationship] => DEMAT [Name] => upendra [Phone] => 9971396361 [accept] => on )

	 	
		$dataUpdate = array('iciciapp_relation'=>$relationship, 'iciciapp_city'=>$City, 'iciciapp_dob'=>$DOB, 'iciciapp_occupation'=>$Employment_Status, 'iciciapp_company_name'=>$Company_Name, 'iciciapp_salary'=>$Net_Salary, 'iciciapp_relation'=>$relationship, 'iciciapp_secure_emi'=>$total_emi, 'iciciapp_unsecure_emi'=>$other_emi, 'iciciapp_name'=>$Name, 'iciciapp_mobile_number'=>$Phone, 'age'=>$age, 'iciciapp_email'=>$Email);
...
//echo "update icici_exclusive_application set status='1' where iciciappid='".$ProductValue."'";
...
<table width="100%" cellpadding="0" border="0" cellspacing="0" height="50">
                      <tr>
                        <td width="300" align="center"><table width="85%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td height="15"><div id="slider-range-min"  class="newdiv" onClick="displayPieChart();"></div></td>
                            </tr>
                            <tr>
                        ...
                        <td width="300"><table width="74%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td height="15"><div id="slider-range-min1" onClick="displayPieChart();"  ></div></td>
                            </tr>
                            <tr>
                              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                  <tr>
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1">
    <tr>
      ...
      <td align="center" bgcolor="#fe9820" class="tble-text padding-td"><input type="text" value="<? if($CAperlacemi>0) {echo $CAperlacemi;} else {echo $iciciperlacemi; } ?>" id="proc_fee" name="proc_fee" style="background:#fe9820; width:95%; border:none; color:#FFFFFF; text-align:center; width:50px;">  
...
<div style="margin-top:20px; margin-left:3px;"><input name="image"  value="Submit" type="image" src="images/eApproval-btn.png" width="145" height="62"  style="border:0px;" tabindex="15" /></div>
...
We're sorry.<br>
Our engine could not locate an offer for you at this time.</div></div>
 <? } ?>
</body>
</html>