<?php
	...
	function formHandler(){
		...
		$result = "select *  from Bidders where Email='$Email' and PWD='$PWD' and BidderID=6693";
	...
	list($num_rows,$row)=Mainselectfunc($result,$array = array());
		if($num_rows > 0){
			...
			mysql_free_result($result);
			 ...
			 /* Redirect browser */
			 $strDir = dir_name();
			header("Location: referral_url_index.php");
			exit;
		}
		else{
			global $Msg;
...
<div align="center">
    ...
    <div id="dvbannerContainer"> <br><br><br><br><br>&nbsp;</div>
...
<Script Language="JavaScript">
 ...
 <table width="250" border="0" cellpadding="4" cellspacing="0" class="blueborder" id="frm">
   <tr>
     <td colspan="2" class="head1">Login&nbsp; for Referral</td>
   </tr>
   <tr>
