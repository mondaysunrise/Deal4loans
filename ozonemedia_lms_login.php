...
//echo $PWD."<br>";
	function formHandler(){
		...
		$result = ExecQuery("select * from Bidders where Email='".$Email."' and PWD='".$PWD."' and  BidderID=1545");
	...
	$num_rows = mysql_num_rows($result);
		...
		if($num_rows > 0){
			...
			setSessionBidder($Email, $row);
			 ...
			 //$strDir = dir_name();
			//header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."ozonemedia_lms_view.php");
			//exit;
		}
		else{
			global $Msg;
