...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	//Update Lead Details
	if($requestid>0){
		$InsertProductDataArray= array("Name"=>$Name, "Email" => $Email, "Gender" => $Gender, "Employment_Status" => $EmpType, "Company_Name" => $CompanyName, "City" => $City, "Net_Salary" => $Net_Salary, "Pincode" => $ResiPin, "DOB" => $DOB, "Pancard" => $panno, "Residence_Address" => $Residence_Address1, "Dated" => $Dated);
	...
	if(isset($_POST['hitApi']) && ($_POST['hitApi'] == 'checked')){
		...
		if(strlen($first_name)>1 && strlen($CompanyName)>2 && $Mobile_Number>0 && strlen($Email)>2 && $AnnIncome>0){
			...
			$cust_details = array("CreditCard"=>array("Version"=>3, "ConUniqRefCode"=>$ConUniqRefCode, "CreditCardApplied"=>$card_type, "HasExistingScbCC"=>$HasExistingScbCC, "IsExtngScbCust"=>$IsExtngScbCust, "CustReltnType"=>$relation_with_bank, "FirstName"=>$first_name, "MiddleName"=>$middle_name, "LastName"=>$last_name, "Gender"=>$gender, "DOB"=>$dobstr, "Qualification"=>$Qualification, "ResAddress1"=>$Residence_Address, "ResAddress2"=>$City, "ResCity"=>$citycode, "ResPIN"=>$ResiPin, "Email"=>$Email, "Mobile"=>$Mobile_Number, "EmpType"=>$EmpType, "SalaryBankAcc"=>340, "AnnIncome"=>$AnnIncome, "GMI"=>$monthlyincome, "CompanyName"=>$CompanyName, "Designation"=>$Designation, "IncomeProof"=>$IncomeProof,"IncomeProofValue"=>$AnnIncome, "PAN"=>$panno));
...
if($process=="cq"){
?>
<form id="loan_form" name="loan_form" method="post" action="<? echo $_SERVER['PHP_SELF'] ?>?postid=<?echo $requestid;?>&biddt=<? echo $bidderid;?>&process="<?php echo $process; ?>"" >
<?php
}
else {Gender
?>
...
<tr>
    ...
    <td width="392" colspan="3"><span class="style21"><input type="text" maxlength="32" size="13" name="first_name" id="first_name" value="<? echo $first_name; ?>" onkeyup="checkValue(this);"/>&nbsp;<input type="text" maxlength="32" size="11" name="middle_name" id="middle_name" value="<? echo $middle_name; ?>" onkeyup="checkValue(this);"  />&nbsp;<input type="text" maxlength="32" size="17" name="last_name" id="last_name" value="<? echo $last_name; ?>" onkeyup="checkValue(this);" /></span></td>
</tr>
<tr>
	...
	<td><span class="style21"><input type="text" value="<? echo $Email; ?>" name="Email" id="Email" onkeyup="checkValue(this);" /></span></td>
</tr>
<tr>
...
<tr>
    ...
    <td><input type="text" class="d4l-input" name="panno" id="panno" value="<? echo $Pancard ;?>"  maxlength="10" onkeyup="checkValue(this);" /></td>
...
<tr>
    ...
    <td><span class="style21">
		<select name="card_id" id="card_id">
			...
			?>
			<option value="<?php echo $ccbankid; ?>" <? //if($ccbankid==$cc_bankid || $cityalias==$City) echo "selected";?>><?php echo $cc_bank_name; ?></option>
			<?php
			}
			?>
		</select></span>
...
<tr>
	...
	<td colspan="3"><span class="style21" ><input type="text" maxlength="39" size=80 name="Residence_Address1" id="Residence_Address1" value="<? echo $Residence_Address; ?>" onkeyup="checkValue(this);" /></span></td>
</tr>
<tr>
...
<tr>
	<td><span class="style2">EmpType</span></td>
    <td><span class="style21">
	...
	<td><span class="style21"><input name="Company_Name" id="Company_Name" type="text" class="d4l-input" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event)"   style="width:200px;" maxlength="100" value="<? echo $Company_Name; ?>" onkeyup="checkValue(this);" /></span></td>
</tr>   
<tr>
...
<tr>
	<td colspan="8"><span class="firstLabel"><input type="checkbox" id="hitApi" name="hitApi" value="checked"><b>Check this to Submit to SCB</b></span><span class="secondLabel"><input type="Submit" name="Submit" value="Submit"></span></td>
