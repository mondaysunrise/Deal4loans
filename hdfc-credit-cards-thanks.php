...
//Array ( [PostURL] => /deal4loans/hdfc-credit-cards.php [Name] => upendra [day] => 12 [month] => 12 [year] => 1989 [Phone] => 9999999999 [Email] => upendra@fdsfd.com [City] => Delhi [Employment_Status] => Salaried [company_name] => W I B DISTRIBUTORS LTD [Net_Salary] => 40000 [hdfc_account] => Non-Salary Account [average_balance] => 16000 [Applied_status] => No [cc_status] => No [Activate] => [accept] => on [x] => 64 [y] => 23 )
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$cc_default = $_POST['cc_default'];
	$identity_proof = $_POST['identity_proof'];
	$address_proof = $_POST['address_proof'];
	$Pincode = $_POST['Pincode'];
	$salary_mode = $_POST['salary_mode'];
	$dataUpdate = array('pancard'=>$Pancard, 'address'=>$Address, 'pincode'=>$Pincode, 'designation'=>$Designation, 'eligible'=>'Yes', 'work_email'=>$work_email, 'std_code'=>$std_code, 'landline_no'=>$landline_no, 'cc_default'=>$cc_default, 'identity_proof'=>$identity_proof, 'address_proof'=>$address_proof);
	$wherecondition ="(RequestID='".$lid."')";
	Mainupdatefunc ('req_hdfc_lead', $dataUpdate, $wherecondition);
}
?>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #eadbc8; ">
  ...
  <tr>
    <td height="250" align="center" valign="top"  style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#990000; font-weight:bold; ">Thanks for your Information.Your application has been accepted.You will soon hear from HDFC Bank for next steps.</td>
  </tr>
</table>
