...
$Today=date('Y-m-d');
	...
	$citifinquery="SELECT Property_Identified,Employment_Status,Name,DOB,Email,Company_Name,City,City_Other,Pincode,Mobile_Number,Net_Salary,Add_Comment,Loan_Amount,Property_Loc,Allocation_Date FROM Req_Feedback_Bidder_HL,Req_Loan_Home WHERE (Req_Feedback_Bidder_HL.AllRequestID=Req_Loan_Home.RequestID and Req_Feedback_Bidder_HL.BidderID in (4351) and Req_Feedback_Bidder_HL.Reply_Type=2 and Req_Feedback_Bidder_HL.Allocation_Date Between '".($min_date)."' and '".($max_date)."')";
...
//$newToday ="280112";
	...
	$newfileatt = "/home/deal4loans/public_html/hldwnld/dhfl".$newToday."4351.xls";
...
if($recordcount>0)
	...
	$to = "sairam.raman@interactive.in,trishna.dattani@dhfl.com,yogi.r@dhfl.com,shweta.sharma@deal4loans.com"; 
//$to = "ranjana5chauhan@gmail.com"; 

       $from = "Deal4loans <no-reply@deal4loans.com>"; 
        $subject = "DHFL Home Loan Leads @ deal4loans.com".$newToday; 
          
	   $fileatt = "/home/deal4loans/public_html/hldwnld/dhfl".$newToday."4351.xls";
        $fileatttype = "application/xls"; 
        $fileattname = "dhfl".$newToday."4351.xls";
