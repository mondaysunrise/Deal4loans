...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$ProductValue = $_POST["hlrequestid"];
	$Phone = $_POST["Phone"];
	$City = $_POST["City"];
...
if($source=="netcorehl" && ($City=="Chennai" || $City=="Bangalore" || $City=="Hyderabad" || $City=="Mumbai" || $City=="Navi Mumbai" || $City=="Thane" || $City=="Delhi" || $City=="Kolkata" || $City=="Ahmedabad" || $City=="Pune" || $City=="Vizag" || $City=="Vishakapatanam" || $City=="Surat" || $City=="Indore" || $City=="Cochin" || $City=="Chandigarh" || $City=="Jaipur" || $City=="Baroda" || $City=="Coimbatore" || $City=="Noida" || $City=="Gurgaon" || $City=="Faridabad" || $City=="Gaziabad") && $Is_Valid==1 && $Net_Salary>=360000)
{ ?>
<!-- Offer Conversion: Bima Deals Home Loan CPL -->
<iframe src="http://tracking.affiliatehub.co.in/SLNA?adv_sub=<? echo $hlrequestid; ?>" scrolling="no" frameborder="0" width="1" height="1"></iframe>
<!-- // End Offer Conversion -->
<? 
$Dated = ExactServerdate();
$dataInsert = array('komli_uniqueid'=>$hlrequestid, 'komli_email'=>$Name, 'komli_city'=>$City, 'komli_date'=>$Dated, 'komli_netsalary'=>$Net_Salary, 'vendor_name'=>$source, 'validated'=>$Is_Valid);
$ProductValue = Maininsertfunc ("komli_plcompaign", $dataInsert);

}
elseif(($source=="allbankngsolnHL" || $source=="creditvidyaHL" || $source=="investmentyogiPL") && $Is_Valid==1)
{ 
$Dated = ExactServerdate();
$dataInsert = array('komli_uniqueid'=>$hlrequestid, 'komli_email'=>$Name, 'komli_city'=>$City, 'komli_date'=>$Dated, 'komli_netsalary'=>$Net_Salary, 'vendor_name'=>$source, 'validated'=>$Is_Valid);
$ProductValue = Maininsertfunc ("komli_plcompaign", $dataInsert);
}
elseif(($source=="inuxuhl") && $Is_Valid==1)
{ ?>
<iframe src="http://inuxu.biz/Tracker/CoT?p1=1093&p2=246" width='0px' height='0px' frameborder='0px'></iframe
><?
$Dated = ExactServerdate();
$dataInsert = array('komli_uniqueid'=>$hlrequestid, 'komli_email'=>$Name, 'komli_city'=>$City, 'komli_date'=>$Dated, 'komli_netsalary'=>$Net_Salary, 'vendor_name'=>$source, 'validated'=>$Is_Valid);
$ProductValue = Maininsertfunc ("komli_plcompaign", $dataInsert);
...
elseif(($source=="AFL_MLR_SHOPATBEST_HL" || $source=="shopatbesthl") && $Is_Valid==1)
{ 
$Dated = ExactServerdate();
$dataInsert = array('komli_uniqueid'=>$hlrequestid, 'komli_email'=>$Name, 'komli_city'=>$City, 'komli_date'=>$Dated, 'komli_netsalary'=>$Net_Salary, 'vendor_name'=>$source, 'validated'=>$Is_Valid);
$ProductValue = Maininsertfunc ("komli_plcompaign", $dataInsert);
