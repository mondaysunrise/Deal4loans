...
list($recordcount1,$getLowestQuery)=MainselectfuncNew($getLowestSql,$array = array());
...
?>
      ...
      <td align="center" width="150" height="120"><table width="122"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="100" align="center" valign="middle"><a href="car-loan-hdfc-step2.php?car_name=<?php echo $hdfc_car_name; ?>" style="font-size:16px; text-decoration:none;" target="_parent"><div id="<?php echo $model; ?>bgColor"><div class="<?php echo $model; ?>-body_text3" style="font-size:16px;"><br /><br /><?php echo ucfirst($hdfc_car_model_display); ?></div></div></a> </td></tr></table>
