...
if($pl_bank_name=='HDFC')
{
	$Comp = "Competitive Lower Interest Rate";
	$NillPre = "Nil Pre-closure after 12 emi's for 10 Lakhs";
	$LnAmount = "Loan Amount upto 30Lakhs";
	$custmerAppr = "72 Hrs Approval for Elite Customers (Salary above 75k with 10 Lakhs above Loan Amount)";
	$SpecialOfferBalan = "Special offers for Balance Transfer of other Bank Personal Loan";
	$SpecialOfferIntRts = "Special offer interest rate for Corporate/Special Companies";
}
else if($pl_bank_name=='IndusInd')
{
	$Comp = "Obtain loan easily with simple documents with quick Disbursal";
	$NillPre = "No Guarantor Required";
	$LnAmount = "Loan Amount upto 25 Lakhs";
	$SpecialOfferBalan = "Balance Transfer your Existing Loan at lower Interest Rate";
	$SpecialOfferIntRts = "Disbursal in 4-5 working days";
}
...
<div id="content"><form name="cibil_form" method="post" action="/apply_pl_httpsconsent_thank.php"  onSubmit="return ckhcreditcard(document.cibil_form); ">
  ...
  <td><input type="text" name="salary" id="salary" value="<? echo round($salary);?>" class="bajaj-fin_input"/></td></tr>
    ...
    <div class="widget">
      <table width="100%" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100%" height="40" class="heading_text1" style="font-size:18px;"><span class="heading_text_b">Why <? echo $pl_bank_name; ?>?</span><br />
         <span style="font-size:12px;"><?php echo $Comp."<br>".$NillPre. "<br>". $LnAmount."<br>".$custmerAppr."<br>".$SpecialOfferBalan."<br>".$SpecialOfferIntRts;?> </span>
          </td>
