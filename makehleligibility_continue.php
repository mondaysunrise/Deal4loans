...
$getPageSql = "select * from city_hl_pages where City='".$City."' and Product='HLEligibility'";
...
{
	$sql = "INSERT INTO city_hl_pages (Product ,City ,State, Title ,MetaKeyword ,MetaDescription ,PageDescription ,HeaderDEscription ,Dated ,Status) VALUES ('HLEligibility',  '".$City."', '".$State."', '".$Title."',  '".$keyword."',  '".$metadesc."',  '".$mainDesc."', '".$header."', Now(), '1')";
	$query = ExecQuery($sql);
	//echo "<br>".$sql;
	$report = "Inserted";
	$creadetPage = '<a href="http://www.deal4loans.com/propertyeligibility-calculator/'.$City.'" target="_blank">Created Page</a>';
...
<tr>
    <td ><div align="center">Home Loan Eligibility Page</div></td>
    </tr>
<tr><td>
<?php
echo $report;
...
<a href="makehleligibility_index.php">Make Other Page</a>
</td></tr></table>
</body>
</html>