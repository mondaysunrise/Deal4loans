...
{
	var gifName = form;
	document.frmsearch.action="appt_index.php?search=y"+gifName;
...
<tr>
  ...
  <tr>
    <td height="40" align="center"  ><h1 style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#052733; line-height:18px; font-weight:bold;">Welcome to Fullerton Appointments</h1></td>
  </tr>
  <tr>
 ...
 <form name="frmsearch" action="appt_index.php?search=y" method="post" onSubmit="return chkform();">
 ...
 //	$getDocSql = "select * from fil_appointments where 	Dated between '".$min_date."' and '".$max_date."'";
...
//	echo $getDocSql."<br>";
	...
	//$getDocSql = "select * from fil_appointments left join Req_Feedback_Bidder1 on Req_Feedback_Bidder1.AllRequestID = fil_appointments.RequestID where (Req_Feedback_Bidder1.Allocation_Date between '".$min_date."' and '".$max_date."') and Req_Feedback_Bidder1.BidderID in (".$bidderStr.") group by fil_appointments.RequestID";

	
		$search_qry="select * from fil_appointments left join Req_Feedback_Bidder1 on Req_Feedback_Bidder1.AllRequestID = fil_appointments.RequestID where (Req_Feedback_Bidder1.Allocation_Date between '".$min_date."' and '".$max_date."') and Req_Feedback_Bidder1.BidderID in (".$bidderStr.") group by fil_appointments.RequestID";	
		$qry="select * from fil_appointments left join Req_Feedback_Bidder1 on Req_Feedback_Bidder1.AllRequestID = fil_appointments.RequestID where (Req_Feedback_Bidder1.Allocation_Date between '".$min_date."' and '".$max_date."') and Req_Feedback_Bidder1.BidderID in (".$bidderStr.") group by fil_appointments.RequestID";
...
<td class="head1" align="center"><b>&nbsp;</b></td>
	...
	<?
		...
		$qry="select * from fil_appointments left join Req_Feedback_Bidder1 on Req_Feedback_Bidder1.AllRequestID = fil_appointments.RequestID where (Req_Feedback_Bidder1.Allocation_Date between '".$min_date."' and '".$max_date."') and Req_Feedback_Bidder1.BidderID in (".$bidderStr.") group by fil_appointments.RequestID ";
		$qry=$qry." order by fil_appointments.Dated DESC";
...
<td bgcolor="#DFF6FF" class="style3" align="center"><a href="editAppointment.php?Lid=<?php echo $row["RequestID"]; ?>" onClick="return popitup('editAppointment.php?Lid=<?php echo $row["RequestID"]; ?>')">EDIT</a></td>
 ...
 <br>
 <form name="xlsdownload" action="appt_download.php" method="post">
