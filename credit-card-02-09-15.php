...
$showCCOfferSql = "SELECT * FROM `credit_card_banks_eligibility` WHERE cc_bank_flag=1";
list($num_rows,$showCCOfferRes)=MainselectfuncNew($showCCOfferSql,$array = array());
?>
<!DOCTYPE html>
...
<link href="css/credit-cards-new-ui-02-09-2015.css" type="text/css" rel="stylesheet" />
...
<div class="h1-credit-card">Find the credit card that's right for you</div>
...
<div class="p-credit-card" align="left"><strong>Please show me credit cards as per my interest and eligibility</strong> </div>
<div class="clearfix"></div>
<div class="row1-credit-card">
<div class="row1_sub-credit-card">
<div class="row1_sub_a-credit-card">I am working as a</div>
<div class="row1_sub_b-credit-card">
<select name="Employment_Status" id="Employment_Status" class="select_input-credit-card selectnegative-margintop" onChange="validateDiv('empStatusVal');" tabindex="2">
...
<div class="row1_sub_2-credit-card"><div class="row1_sub_c-credit-card">with annual income of</div>
<div class="row1_sub_b">
<input type="text" name="Net_Salary" id="Net_Salary" class="input-credit-card" value="e.g. 0000000" onKeyUp="intOnly(this); getDiToWordsIncome('Net_Salary','wordIncome','formatedIncome');" onKeyPress="intOnly(this);" onBlur="if(this.value==''){this.value='e.g. 0000000';}else{ getDiToWordsIncome('Net_Salary','wordIncome','formatedIncome');}" onChange="ShowHide('incomeShow','Net_Salary');" onKeyDown="validateDiv('netSalaryVal');" onFocus="if(this.value=='e.g. 0000000') {this.value='';}" tabindex="3" autocomplete="off"  />
...
<div class="third-row-inn-a-credit-card">and working in</div>
...
<div class="fourth-row_a-credit-card"> and live in</div>
<div class="fourth-row_b-credit-card">
<select name="City" id="City" class="select_input-credit-card selectnegative-margintop" onChange="show_personal_details(); validateDiv('cityVal');" tabindex="5">
<?=plgetCityList($City)?>
</select>
<div id="cityVal"></div>
</div>
...
<div class="personal-detailsabc-in"> <strong>Personal Details</strong><br><div class="termtext" align="left" style="padding-top:7px;"> <img src="images/lock-image.png" alt="lock-img" width="9" height="13" />&nbsp;Your details are secure and will not be shared without your consent.</div>
</div>
<div class="clearfix"></div>

<div class="fifth_wrapper-credit-card"><div style="float:left; margin-top:5px; width:10px; font-family:'Roboto Condensed', sans-serif;font-size:17px;">I</div>
...
<div class="fifth_row_b-credit-card"><div class="fifth_cs">want Complete details at My Contact Number +91 </div>
...
<div class="seventh-row-a-credit-card">I currently have Credit Card with </div>
<div class="seventh-row-b-credit-card">
<select size="1" name="No_of_Banks" id="No_of_Banks" class="select_input-credit-card selectnegative-margintop" onChange="validateDiv('ccbnknmeVal');" tabindex="10">
...
<div class="fifth_wrapper-credit-card">
    <div class="fifth_row-credit-card" style="width:80%; margin-top:15px;">
...
<div class="p-credit-card" style="margin-top:10px;"><input type="image" src="images/blue-quotebtn15.png" border="0" width="118" height="45" /></div>
</div>
</form>
</div>
...
<div class="cc-hanger-middle-text">
    ...
    <br />
        ...
        <p>The Credit card is the most divisive financial tool available. There are a lot of groups of people with mixed responses on credit cards, some find it mighty useful and some consider that credit cards are embodiment of pure evil. In reality, Credit card is nothing but a tool. Whether its effects are harmful or useful, it depends on the individual using it and the way he chooses to use it. </p><br>
        <p>If you talk about the history of Credit cards, they started out as Simple and Standard. Each Card issuer had one card with same set of features. Today credit cards come in multiple ranges with varying features, interest rates, annual fees etc.   It's important an individual knows what kind of Card will suit his/her lifestyle and financial situation.</p><br>
        <p>A brief description of various kinds of credit cards is as follows:</p><br>
    <p><strong>Standard Credit Cards:</strong> These are the most common kind of credit cards. They do not require a security deposit to prove that the loan can be repaid. The way the Annual percentage Rate (APR) is offered or calculated on a standard credit card can vary. Two examples are:</p><br>
    
        <ol type="1">
            <li><strong>•	Balance transfer Credit cards:</strong> Balance transfer credit cards allow consumers to transfer a high interest credit card balance onto a credit card with a low interest rate. In the market today, we have Balance transfer credit cards with an initial annual percentage rate (APR) of 0%. The terms of balance transfer credit cards varies between offers, so be sure to thoroughly read the terms and conditions for each card.</li><br>
            <li><strong>•	Low interest Credit cards:</strong> Low interest credit cards offer either a low introductory APR that jumps to a higher rate after a certain period, or a single low fixed-rate APR. Low interest cards can be very useful when consumers need make a large purchase because it allows several months to a year to pay it off with very low or no interest.</li>
            
        </ol>
        
        <p><strong>Reward Cards:</strong>  A rewards card can be beneficial for the right kind of user. You can earn free airline tickets, hotel stays, cash back, gift cards and even novelty vacations -- there's no shortage of potential perks awaiting a rewards cardholder. </p><br>
        
        <p>Before choosing any reward card, however, one needs to consider his Credit card spending tendencies. Ask yourself: <strong>Are you someone who regularly pays the full monthly balance, or do you carry a balance from month to month?</strong> The interest rate with a rewards card is <strong>quite higher</strong> when compared to typical Credit cards, so it’s an important distinction. If you occasionally carry a balance, it is advised to not go for a rewards card. High interest rates coupled with late fee penalties will mean you will end up losing heavy money while chasing petty rewards.</p><br>
        
       <p> However, if you pay your credit card bills regularly and choose a card that caters to your buying taste, a rewards card can be a great choice. After all, who doesn’t love a gift?</p><br>
<p>To take full advantage of a Credit card, select one whose reward structure matches your lifestyle.</p><br>

<p style="text-align:center"><strong>Different types of reward cards are as follows</strong></p><br>

<p><strong>Cash Back:</strong> This type of credit card allows you to earn cash rewards for making purchases. The more the card is used, the more cash rewards you receive. Most cash back cards earn users around 1 percent of total purchases. I.e. you typically earn cash back worth Rs 100 on purchases of Rs 10,000. Some cards offer a higher cash back percentage with increased usage; others offer a higher cash back percentage at select merchants or for particular types of purchases. E.g. ICICI once offered 5% cash back on purchases at Westside with a minimum purchase of 3,000. Since cash back programs are costly to credit card companies, some of these cards have an annual fee that can vary from Rs. 500 to Rs 3,000<br>
Examples: Citibank Cash Back Credit Card, Shopping Rewards Card.</p><br>

      <p><strong>General Reward Point Credit Cards:</strong> In Reward points Cards, cardholders can accumulate points towards a reward structure, which is based on how much the card is used over time. E.g. Cardholder is awarded is 1 reward point for each rupee he spends. There are certain Bonus spend rewards as well for certain annual spending such as:</p><br>  
...
<p><strong>Hotel/Travel Point Credit cards:</strong> This is a genre of credit cards specific to hotels and travel. Some cards are co-branded with hotels. These credit cards allow you to earn points for all purchases, in addition to bonus points for dollars spent on stays at the respective hotel chain. You can redeem your points for free nights and upgrades at the hotel chain your card is co-branded with.
Then there are broader hotel and travel cards with which points can be redeemed for travel, theme park admission, stays at major hotel chains and more.<br>
<strong>Examples of this kind of Card are "Yatra SBI Card" and American Express make my trip Card.</strong></p><br>
<p><strong>Gas Cards:</strong> Gas Cards with points or rebate have a high reward structure for Fuel purchases/Car maintenance.  If you drive a lot, consider a gas card for more points on gasoline purchases. Gas cards come in two species: general and brand-specific. General cards treat all gas companies equally, while brand-specific cards favor one gas company. A general gas rebate card, for example, may give you 1 percent cash back for general purchases but rewards you with 5 percent back for buying gas or having auto maintenance done at any company. A gas-company-specific card, in contrast, will give you a 1 or 2 percent rebate for regular purchases, but you will earn 5 percent rebate only when buying gas at that company's gas stations.
Ex: Indian Oil Citibank Platinum Credit Card saves over 5% on your fuel bills. <strong>It gets you Reward Points that collect quickly, and convert easily to free fuel. Collect points on all purchases, and 4 times the points on fuel and hundreds of lifestyle purchases.</strong>
</p><br>
