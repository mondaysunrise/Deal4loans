...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$lap_bank_name = FixString($_POST["lap_bank_name"]);
...
if (strlen($lap_bank_name)>1 && $requestid>1)
{
	$dataInsert = array('RequestID'=>$requestid,'Name'=>$name,'City'=>$City,'Mobile_Number'=>$Mobile_Number,'DOB'=>$dob,'Gender'=>$gender,'Pancard'=>$panno,'Company_Name'=>$company_name,'Residence_Address'=>$caddress,'Office_Address'=>$paddress,'Gross_Monthly_Salary'=>$net_salary,'Net_Monthly_Salary'=>$salary,'Bank_Name'=>$lap_bank_name,'dated'=>$Dated);
	$ProductValue = Maininsertfunc('Req_Loan_Against_Property_Bankwise', $dataInsert);
}	
?>
...
<title>Apply for Loan Against Property  | Loan Against Property Application | Loan Against Property Comparison Chart</title>
...
<div id="container">
  <div id="txt"  style="padding-top:15px; height:60px;">
   <h1 style="color:#ae4212 !important; margin:0px; padding:0px; font-size:13px !important; line-height:22px; padding-left:20px;" align="center"> Thanks for applying Loan Against Property from <? echo $lap_bank_name; ?> through Deal4loans.com </h1>
 </div>
</div>
