...
<form name="carloan_form" method="post" action="insert-car-loan-values1.php" onSubmit="return chkcarloan(document.carloan_form);">
...
<div class="text3" style="float:left; width:100%; max-width:575px; font-size:24px; color:#FFF; text-transform:none; margin-top:11px" id="imgDisplay"><img src="images/animated_cl.gif" style="width:100%; max-width:575px;"  /></div>
</div>
