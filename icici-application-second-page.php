...
<form action="icici-application-step3.php" method="POST" name="icici_step2">
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1">
    <tr>
	  ...
	  ?>" id="interest_rate" name="interest_rate" style="background:#fe9820;text-align:center; border:none; width:95%; color:#FFFFFF; width:30px;">%
	</td>
      <td align="center" bgcolor="#fe9820" class="tble-text padding-td" >
...
<div class="tabular-maininnner">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td width="13%"><strong>Loan Amount </strong></td>
