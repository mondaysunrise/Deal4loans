<?php
	...
	function formHandler(){
		foreach($_POST as $a=>$b)
			$$a=$b;
		 $sql = "select *  from Bidders where Email='$Email' and PWD='$PWD' and Is_Verified=7";
		...
		//	$row = mysql_fetch_array($result);
			...
			mysql_free_result($result);
			 ...
			 /* Redirect browser */
			 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."shares-data.php");
			exit;
		}
		else{
			global $Msg;
...
<Script Language="JavaScript">
 ...
 <tr><td width="140"><img src="images/logo.gif"></td></tr>
  <tr>
 <td align="center">
