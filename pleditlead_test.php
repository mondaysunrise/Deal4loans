...
if($IP=="122.176.100.27" || $IP=="122.176.100.28" || $IP=="122.176.122.134" || $IP=="122.161.196.68" || $IP=="122.160.74.241" || $IP=="122.160.74.235" || $IP="182.71.109.218")
{
...
$stancintr = trim($stancrateexact)/1200;
	...
	<td width="11%" align="center"><b style="font-size:12px;"><? echo "1%"; //echo "0 - 4%";// Done by Upendra 02/11/16 as said by Rishi Sir and Balbir [no mail for this] ?></b></td>
...
{	$bflloansmt= round($monthsalary*10);
	...
	<td width="11%" align="center"><b style="font-size:12px;"><? echo "4% (After 1st EMI, Part payment 2% of POS)"; ?></b></td>
