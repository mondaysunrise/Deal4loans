...
<tr>
<td width="11"  align="left" valign="top" style="padding-left:5px; font-size:19px; color:#FFFFFF;" colspan="4">
...
font-weight:normal; color:#ffffff;font-Family:Verdana;text-transform: capitalize;'></span></td>
    ...
    <table width="98%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30"><select name="Employment_Status" id="Employment_Status"  onchange=" addPersonalDetails();  change_empstst(); validateDiv('empStatusVal');" class="hl_emi_select"  style="font-family:Verdana, Geneva, sans-serif; font-size:11px; color:#4c4c4c;" >
