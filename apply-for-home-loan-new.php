...
if(strlen($_REQUEST["source"])>0)	{		$srce=$_REQUEST["source"];	}	else	{		$srce="hlpage for";	}
?>
<!DOCTYPE html>
<html >
<head>
...
<div class="form_box">
<? if($srce=="allbankngsolnHL" || $srce=="creditvidyaHL" || $srce=="investmentyogiHL")
{ ?>
...
Salary Slip</span></td>
  ...
  <div class="row_a margin_top"><span class="list_text_head">List of top Home Loans Banks in India</span><br />
   ...
   <li>Over <strong style="color:#F60; font-size:24px;">4<span style="font-size:24px; color:#F60;">9</span><span style="font-size:28px; color: #06F;">53</span><span style="color: #900;">284</span></strong> customers have taken quote at <strong style="color:#187abe; font-size:15px;">Deal4loans.com</strong></li>
   </ul>
