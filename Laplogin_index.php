...
{
	var gifName = form;
	document.frmsearch.action="Laplogin_index.php?search=y"+gifName;
...
function chkform()
{
	...
	{
		alert("Sorry!!!! Please Select Maximum Date First.");
...
<div align="center">
 ...
 <form name="frmsearch" action="Laplogin_index.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
 ...
 <?
	$search_qry="select Loan_Amount,City_Other,DOB,source,Pincode,RequestID,Name,Company_Name,City,Net_Salary,Employment_Status,Is_Valid from Req_Loan_Against_Property where (1=1) ".$search_date." ";
	$qry="select RequestID,Name,Company_Name,City,Net_Salary,DOB,Employment_Status,Is_Valid from Req_Loan_Against_Property where ((1=1) ".$search_date." ) order by Req_Loan_Against_Property.Dated desc";
 ...
 ?>
   ...
   <tr>
	...
	<?
		...
		$qry="select RequestID,Name,Company_Name,City,Net_Salary,DOB,Employment_Status,Is_Valid from Req_Loan_Against_Property where (1=1) ".$search_date." order by Req_Loan_Against_Property.Dated desc LIMIT $startrow, $pagesize";
		$result=ExecQuery($qry);
		//echo $qry;
   ...
   <tr>
    ...
    <td class="bodyarial11"><? echo $row["Company_Name"]; ?></td>
	 ...
	 <td class="bodyarial11" align="center"><? echo $row["Is_Valid"]; ?></td>
	  <td class="bodyarial11">
	<?  $BidderID="";
	
	$BiddersChurn="SELECT Bidder_Name,Req_Feedback_Bidder1.BidderID As bid FROM Req_Feedback_Bidder1 LEFT OUTER JOIN Bidders_List ON Bidders_List.BidderID = Req_Feedback_Bidder1.BidderID and Bidders_List.Reply_Type =5 WHERE AllRequestID = '".$row["RequestID"]."' AND Req_Feedback_Bidder1.Reply_Type =5";
	//echo $BiddersChurn;
	...
	echo implode(',', $BidderID);
     ...
     <td>
     <?php
	 $client_transaction_id = $row["RequestID"]."_LAP";
	 $getSql = "select * from z2v_transactions where client_transaction_id 	='".$client_transaction_id."'";
...
if($verified==1)
{
 ...
 <form name="frmdownload" action="Laplogin_download.php" method="post">
   <tr>
     <td align="center">
