...
$insert = Maininsertfunc ($table, $dataInsert);
	...
	$qry="select bidderid, name, mobile_number, net_salary AS Salary, loan_amount AS LoanAmount,city, city_other,property_loc, property_value AS EligibleBidder, property_type AS SentToBidders from temp where session_id='".$session_id."'";
