...
{
	var gifName = form;
	document.frmsearch.action="admagnetpl-view.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="admagnetpl-view.php?search=y" method="post" onSubmit="return chkform();">
 ...
 <? 
		$qry2="SELECT RequestID from  Req_Loan_Personal WHERE ((Req_Loan_Personal.Updated_Date Between '".$min_date."' and '".$max_date."') and source='newadmagnetpl' and Is_Valid=1)";
		$qry2=$qry2."group by Mobile_Number";
		list($validCount,$row2)=Mainselectfunc($qry2,$array = array());
		//$result2=ExecQuery($qry2);
		//$validCount= mysql_num_rows($result2);
...
<td align="center" bgcolor="#DFF6FF" class="style3"><? echo $validCount; ?></td>
    
   </tr>
   
   <!-- <tr>
       <td align="center" bgcolor="#DFF6FF" class="style3">In Valid Leads</td>
<td align="center" bgcolor="#DFF6FF" class="style3"><? //echo $inval= $totalCount - $validCount; ?></td>
