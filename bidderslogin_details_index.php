...
{
	var gifName = form;
	document.frmsearch.action="bidderslogin_details_index.php?search=y"+gifName;
...
<div align="center">
 ...
 <form name="frmsearch" action="bidderslogin_details_index.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
 ...
 <?
		...
		$search_qry="select * from Bidders_Login_Details  where 1=1   ".$search_date ;
		$qry="select * from Bidders_Login_Details  where 1=1  ".$search_date ;
		//echo "hello".$qry."<br>";
 ...
 ?>
   ...
   <tr>
	...
	<?
		...
		$qry="select * from Bidders_Login_Details  where 1=1   ".$search_date." order by Bidders_Login_Details.Last_Login_Date DESC LIMIT $startrow, $pagesize";
		//echo $qry;
		$result=ExecQuery($qry);
