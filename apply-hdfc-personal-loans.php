	 ...
	 if (( document.personalloan_form.Employment_Status.value=="0" ) || ( document.personalloan_form.Employment_Status.value=="-1" ))
       {
               ...
               document.getElementById('nettab').innerHTML = "<div style='width:150px; float:left; margin-left:5px; margin-bottom:3px; margin-top:0px; padding:0px;'>Net Take Home<div style='font-weight:normal;'>(Monthly Salary)</div></div>";
			     //document.getElementById('plantype1').innerHTML = strPlan;
       }
...
<div id="txt-bld" style="color:#4C2306;">Personal Loans by Choice not by Chance !</div>

<div id="img-lft"></div>
<div id="img-rgt"></div>

<div class="content-pnl" ><img src="images/hdfc-line.gif" width="234" height="19" /></div>
<div  class="content-deal" style="color:#4C2306; text-align:left;">
Loans from  Rs 50000- 1500000<br />
Loan Tenure 12 months- 60 Months<br />
Age 23-60 yrs
Lowest Rate among All Banks<br />
Special Rate Offers for Salary above 75000<br />
Fastest Loan Disbursal- Apply Now</div>
<div class="content-pnl" style="color:#984002;">Also  Compare with</div>
<div  class="content-deal" style="font-size:12px; color:#4C2306; text-align:left;"><font color="#984002">SBI,Citibank, Citifinancial, Fullerton and Barclays Finance.</font><br />
  <br />

So Apply and Get Instant rate quotes and get your loan approved from fastest Loan Engine.</div>
 <div class="content-pnl" style="color:#984002;">Testimonial</div>
<div  class="content-deal" style="color:#4C2306; text-align:left;">I got an instant call and got my loan process working in 8 hrs.<br /> 
  Thanks , never thought taking a loan would be that easy.
  <div style="float:right; color:#4C2306; font-weight:normal;">by<b> Satya Singh</b></div>
</div>

</div>

<form name="personalloan_form"  action="apply-hdfc-personal-loans-continue.php" method="POST" onSubmit="return chkpersonalloan(document.personalloan_form);">

<div id="form-str">

<div id="form-top-lft">&nbsp;</div>
<div id="form-top-rgt">&nbsp;</div>
<div id="form-bld-text">HDFC Personal Loan Request</div>
...
<div class="form-bg"><span class="form-text">Full Name</span> <input name="Name" type="text" <? if(isset($loan_type)) { ?>value="<? echo $name; ?>" <? }else {?>value="Name"<? }?> id="Name" style="margin-left:60px; width:140px; margin-top:2px;" onBlur="onBlurDefault(this,'Name');"  onFocus="onFocusBlank(this,'Name');" onchange="insertData();"/></div>
	...
	<div class="form-bg"><span class="form-text">Company Name</span> <input name="Company_Name" id="Company_Name" type="text" value="Company Name" style="margin-left:22px; width:140px; margin-top:2px;"  onBlur="onBlurDefault(this,'Company Name');"  onFocus="onFocusBlank(this,'Company Name');" onKeyUp="ajax_showOptions(this,'getCountriesByLetters',event)"/></div>
...
<div style="margin-left:15px; margin-bottom:8px;"><input type="checkbox" class="style4" name="accept" style="border:none;"  > I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a>.</div>
<div align="center"><input type="image" name="Submit"  src="images/hdfc-apl.gif"  style="width:119px; height:34px; border:none; " />
</div>
