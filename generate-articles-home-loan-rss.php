<?php
	...
	//error_reporting(E_ALL);
		...
		$SQL_CC = "select * from Articles where  Art_Main_Title like '%Home Loan%' order by  Art_DOE desc";
...
if ($NumRows_CC != 0) {
 ...
 $file= fopen("results-articles-home-loan.xml", "w");
...
fwrite($file, $_xml);
 ...
 echo "XML has been written.  <a href=\"results-articles-home-loan.xml\">View the XMLz	.</a>";
