...
/*function netsalarytab()
{
	//alert(document.getElementById('Employment_Status').value);
	 if (( document.personalloan_form.Employment_Status.value=="0" ) || ( document.personalloan_form.Employment_Status.value=="-1" ))
       {
                 document.getElementById('nettab').innerHTML = "Annual Income  <input name='IncomeAmount' id='IncomeAmount' type='text' value='Annual Income' style='margin-left:27px; width:140px; ' onFocus='this.select();'  onChange='intOnly(this); addDiv();'  onKeyUp=\"intOnly(this);PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome'); addDiv();\" onKeyPress=\"intOnly(this); PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome');\" onBlur=\"PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome'); \"/></div>";
			     //document.getElementById('plantype1').innerHTML = strPlan;
       }
	else {
		
               document.getElementById('nettab').innerHTML = "<span class='form-text' style='padding-left:0px; margin-left:0px;'>Net Take Home</span> <input name='IncomeAmount' id='IncomeAmount' type='text' value='Monthly Salary' style='margin-left:25px; width:140px; ' onFocus=\"this.select(); onBlurDefault(this,'Annual Income');\"  onChange=\"intOnly(this); addDiv();\"  onKeyUp=\"intOnly(this);PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome'); addDiv();\" onKeyPress=\"intOnly(this); PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome');\" onBlur=\"PlgetDigitToWords('IncomeAmount','formatedIncome','wordIncome'); onBlurDefault(this,'Annual Income'); \"/>";
			     //document.getElementById('plantype1').innerHTML = strPlan;
       }
                  ...
                  <tr>
                    <td style="padding-left:15px; "><table width="98%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Ndtv Chooses Deal4loans.com to empower its Loans Section.</div></td>
                      </tr>
                      <tr>
                        <td width="30" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
          ...
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
				...
				<form name="personalloan_form"  action="personal-loans-application-continue.php" method="POST" onSubmit="return chkpersonalloan(document.personalloan_form);">
...
No</Td>
				...
				<tr align="left">
				  <Td height="50" colspan="2"><input type="checkbox"  name="accept" style="border:none;" checked  > I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a>.</Td>
