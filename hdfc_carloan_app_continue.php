...
list($resultExist,$rowltv)=MainselectfuncNew($getltv,$array = array());
	...
	$ltv_36 = $rowltv[$rowltvcontr]["ltv_36"];
	...
	<div align="center" class="body_text_nw" style="padding-top:15px;" ><table width="970" style="border:#CCCCCC thin solid;"align="center" cellpadding="0" cellspacing="0">
       ...
       <tr>
		...
		for($gS=0;$gS<$numGiftsQuery;$gS++)
		{
			...
			echo "<tr><td align='center' valign='top'><img src='images/brochure/".$image."' border=0 height=100 width=100 /></td></tr><tr><td align='center' valign='top' height='40'>";
			echo $Name;
			echo '</td></tr></table></td>';
		}
		?>
