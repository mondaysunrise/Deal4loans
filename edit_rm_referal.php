...
$sql = "select * from RM_List where BD_ID='".$BD_ID."'";
$query = ExecQuery($sql);
$BD_Name = mysql_result($query,0,'BD_Name');
$BD_Number = mysql_result($query,0,'BD_Number');
$BD_Email = mysql_result($query,0,'BD_Email');
$BD_pwd = mysql_result($query,0,'BD_pwd');
...
<table width="438"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
			...
			<tr align="left">
              ...
              <tr>
                <td valign="top"  background="images/login-form-login-bg.gif" ><form name="rm_form"  action="edit_rm_referal_continue.php" method="POST" onSubmit="return validateMe(this);">
<input name="BD_ID" type="hidden" id="BD_ID" value="<?php echo $BD_ID; ?>" >
<table width="95%"  border="0" align="right" cellpadding="0" cellspacing="0"  >
			
				<tr align="left">
				  <Td width="14%" class="frmbldtxt">&nbsp;</Td>
				<Td width="35%" height="27" class="frmbldtxt">Full Name </Td>
 				<Td width="51%"><input name="Name" type="text" id="Name" style=" width:140px;" onBlur="onBlurDefault(this,'Name');"  onFocus="onFocusBlank(this,'Name');"  value="<?php echo $BD_Name; ?>" /></Td>
				</tr>
				<tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">Email Id </Td>
				  <Td><input name="Email" id="Email" type="text" style="width:140px; "  onblur="onBlurDefault(this,'Email Id');"  value="<?php echo $BD_Email; ?>" /></Td>
				  </tr>
                <tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">Mobile No. </Td>
				  <Td class="frmbldtxt">+91 
	  <input name="Phone" id="Phone" type="text" style="width:111px; " onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"  maxlength="10"  value="<?php echo $BD_Number; ?>"  /></Td>
				  </tr>
				                 <tr align="left">
				  <Td class="frmbldtxt">&nbsp;</Td>
				  <Td height="27" class="frmbldtxt">Password </Td>
				  <Td class="frmbldtxt">
	  <input name="pwd" id="pwd" type="text" style="width:140px; " onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"  maxlength="10"  value="<?php echo $BD_pwd; ?>"  /></Td>
				  </tr>
