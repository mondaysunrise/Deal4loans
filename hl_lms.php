...
<script src="http://www.deal4loans.com/callinglms/js-datepicker/jquery-1.5.1.js"></script>
<script src="http://www.deal4loans.com/callinglms/js-datepicker/jquery.ui.core.js"></script>
...
?>
 ...
 <form name="frmsearch" action="hl_lms.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
...
//echo $qry;
  ...
  <td class="bodyarial11"><?php echo $dated;?></td>
	...
	?></b>
    <?php
	 echo getJumpMenu("hl_lms.php",$row["RequestID"],"1",$row["Feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback, $val) ?></td>
	<?php
...
{
	var gifName = form;
	document.frmsearch.action="hl_lms.php?search=y"+gifName;
