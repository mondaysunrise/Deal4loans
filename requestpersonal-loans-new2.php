...
if(strlen($_REQUEST['source'])>0){	
	...
	$retrivesource="requestpersonal-mobile"; 
}
...
var android = (ni1.indexOf("Android")>=0);
   ...
   // $(window).resize(function() {		
		if (android || IEMobile || iPhone || blackBerry) {
			//alert('Mobile');
			$('div #leavenumber').show();
			$('div #fillform').hide();
		}else{
			//alert('Computer');
			$('div #leavenumber').hide();
			$('div #fillform').show();			
		}
   // });	
});
...
<div class="call_us_box"><div class="toll-free">Call us at <strong style="color:#FFF; background:#0b8cd9; font-weight:normal; padding:2px;">Toll free</strong> number<br />
<span class="number_text">1800 3000 1500</span>
</div></div>
</div>
</div>
<div class="apl_second_container" style="padding-top:3px;">
 <div class="column_wrapper">
  <div class="column_b">
  <div class="personal_loan">Personal Loan Quotes</div>
	<div id="example-two">
		<ul class="nav">
			<div class="tab_new2"><div class="tab_hide"><li class="nav2"><a href="#leavenumber">Leave Your Number</a></li></div></div>
            <div class="tab_new1"><li class="nav-one"><a href="#fillform" class="current">Get Quote</a></li></div>		
		</ul>        
        <!-- Get quote container start here -->
		<div class="list-wrap">
           ...
           <input type="hidden" name="creative"  id="creative" value="<? echo $_SERVER["HTTP_USER_AGENT"]; ?>">
...
<input type="hidden" name="PostURL" value="<?php echo $_SERVER['REQUEST_URI']; ?>">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="179" height="45" class="form_text">Loan Amount</td>
	...
	<tr><td></td><td><span id='formatedIncome' style='font-family: Verdana, Arial, Helvetica, sans-serif;	font-size:11px;	color:#FFF; text-decoration:none; font-weight:bold; text-align:left;'></span><span id='wordIncome' style='font-family: Verdana, Arial, Helvetica, sans-serif;	font-size:11px;	color:#FFF; text-decoration:none; font-weight:bold; text-align:left;'></span></td></tr><tr>
              ...
              <tr>              
                <td height="34" class="form_text"  id="personalDetails" colspan="2">
                <table width="100%" border="0" cellpadding="0">
                	<tr>
                    	<td align="center"><img src="d4limages/aplp_get-quote-btn-new.jpg" width="172" height="40" /></td>
                	</tr>
                </table>    
                </td>
              </tr>
    ...
    <div id="leavenumber" class="hide">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
            	<td colspan="2"align="center" class="form_text" style="font-size:10px; text-align:left;"><input type="checkbox"  name="accept2" style="border:none;" checked  > I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.<div id="acceptVal2" class="alert_msg"></div></td>  
            </tr>
            <tr>
            	<td height="20" colspan="2" align="center" class="form_text">&nbsp;</td>
            </tr>
            <tr>
            	<td height="35" colspan="2" align="center" class="form_text">
                <input type="image" name="Submit2" src="d4limages/aplp_submit_btn-new.jpg" style="width:173px; height:40px; border:none;" />
                </td>
            </tr>
        </table>
        </form>
 ...
 <div class="menu_display"><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td width="40%" height="25" align="center" bgcolor="#FFFFFF" style="color:#083b65; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold;">ICICI Bank</td>
    <td width="31%" height="25" align="center" bgcolor="#FFFFFF" style=" color:#041d6f; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold;">HDFC Bank</td>
    <td width="29%" height="25" align="center" bgcolor="#FFFFFF" style=" color:#041d6f; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold;"><span style=" color:#00003d; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold;">ING Vysya</span></td>
  </tr>
  <tr>
    <td height="25" align="center" bgcolor="#FFFFFF" style=" color:#00003d; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;"><span style="color:#cd5a13; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;">Bajaj Finserv</span></td>
    <td height="25" align="center" bgcolor="#FFFFFF" style="color:#ed1c24; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold;">Kotak</td>
    <td height="25" align="center" bgcolor="#FFFFFF" style="color:#ed1c24; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold;"><span style="color:#0076bc; font-family: Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold;">SBI</span></td>
  </tr>
    </table>
</div>
 ...
 <div class="why_text_box_new1"><table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr>
...
list($numtotal_amtcntr,$total_amtcntrQuery)=MainselectfuncNew($total_amtcntr,$array = array());
$ttl_countrtaken = $total_amtcntrQuery[0]['Amount']; 
 ?>
  <tr>
<? 
...
<div style="clear:both;"></div>
 ...
 <div class="step1"><img src="d4limages/step-banner-new.gif" width="252" height="105"></div>
 <div class="rewards1"><img src="d4limages/welcome-rewards-new.gif" width="252" height="104">  </div> 
  </div>
  <div style="clear:both;"></div>  
</div>
<? if($retrivesource=="logicserve")
	{ ?>
...
<script type="text/javascript">
    try {
        lsTrack._domainName = '(Domain name here)';
        lsTrack.runTracking();
