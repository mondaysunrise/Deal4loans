...
<input type="hidden" name="ID" id="RequestID" value="<?php echo $ID; ?>" />
   ...
   <span class="hint">[DD-MM-YYYY].</span>
      ...
      <div id="pincodeVal"></div></td>
			  ...
			  <tr>
</tr>			    <td height="35" valign="middle" bgcolor="#FFFFFF" class="alert_msg"> <span style="color:#000000;"> Yes</span>
	...
	<section class="widget">
 	  <div class="right-box-d">
			<h4 class="heading_text_b" style="font-size:13px; line-height:20px; font-weight:bold;"><span style="font-size:16px;">Offer1-</span> Personal loan offers from <span style="color:#0a8bd9; font-size:14px;">7 Banks</span> with<span style="color:#0a8bd9; font-size:14px;"> <br>		    3 Banks</span> with No Prepayment charges<br>			</h4>
