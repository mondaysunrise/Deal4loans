...
<div align="center" class="orgtext">
<img  src="new-images/hl/slider/hdrc-ltd.jpg" alt="HDFC Ltd" width="128" height="47"  style="border:none;"/><br>
HDFC Ltd</div>
          ...
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
				...
				<form name="home_loan" action="apply-for-home-loans-continue.php" onSubmit="return submitform(document.home_loan);" method="post">
