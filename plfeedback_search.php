...
{
	var gifName = form;
	document.frmsearch.action="plfeedback_search.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="plfeedback_search.php?search=y" method="post" onSubmit="return chkform();">
  ...
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <table border="0" width="90%" cellpadding="0" cellspacing="3"><tr>
     ...
     <td width="24%" align="left" valign="middle" class="bidderclass" ><input type="text" name="mobile_number" id="mobile_number" value="<?php echo $mobile_number; ?>" >&nbsp;</td>
	   <td>&nbsp;</td>
	...
	<td></td>
	<td colspan="2"  valign="middle" class="style1">&nbsp;</td><td>&nbsp;</td>
	</tr>
	   </table>
	   </td></tr>
  <tr><td colspan="3">&nbsp;</td></tr>
   ...
   <tr>
	...
	if($search=="y")
	{
		...
		$min_date=$mindate." 23:59:58";
		$max_date=$mindate." 23:59:59";
		...
		{
			$Mobile_NumberClause=" AND (Req_Loan_Personal.Mobile_Number = '".$mobile_number."') ";
		}
		
		else
		{
			
			$Mobile_NumberClause=" and (Req_Feedback_Bidder1.Allocation_Date Between '".($min_date)."' and '".($max_date)."' ) ";
		}
...
//		$search_qry = "SELECT * FROM Req_Loan_Personal LEFT JOIN (Req_Feedback_Bidder1, pl_feedback) ON (Req_Feedback_Bidder1.AllRequestID=Req_Loan_Personal.RequestID and pl_feedback.lead_id=Req_Loan_Personal.RequestID ) WHERE Req_Feedback_Bidder1.AllRequestID=Req_Loan_Personal.RequestID and  Req_Feedback_Bidder1.Reply_Type='1' and (Req_Feedback_Bidder1.Allocation_Date Between '".($min_date)."' and '".($max_date)."' ) ".$FeedbackClause." ".$ContactedClause."  group by Req_Feedback_Bidder1.AllRequestID";
				...
				$search_qry = "SELECT * FROM Req_Loan_Personal LEFT JOIN (Req_Feedback_Bidder1, pl_feedback) ON (Req_Feedback_Bidder1.AllRequestID=Req_Loan_Personal.RequestID and pl_feedback.lead_id=Req_Loan_Personal.RequestID ) WHERE Req_Feedback_Bidder1.AllRequestID=Req_Loan_Personal.RequestID and  Req_Feedback_Bidder1.Reply_Type='1' ".$Mobile_NumberClause."  ".$FeedbackClause."  group by Req_Feedback_Bidder1.AllRequestID";
...
//	fbidder_id 
	...
	{
		$search_qry = "SELECT * FROM Req_Loan_Personal, Bidders, Req_Feedback_Bidder1 LEFT JOIN pl_feedback ON pl_feedback.lead_id = Req_Feedback_Bidder1.AllRequestID WHERE ( pl_feedback.fbidder_id='".$_SESSION['BidderID']."' ".$Mobile_NumberClause."  AND Req_Feedback_Bidder1.BidderID = Bidders.BidderID AND Bidders.Define_PrePost = 'PostPaid' AND Req_Feedback_Bidder1.Reply_Type =1 ) ".$FeedbackClause." ".$ContactedClause." GROUP BY Req_Loan_Personal.Mobile_Number";
		
		$qry = "SELECT * FROM Req_Loan_Personal, Bidders, Req_Feedback_Bidder1 LEFT JOIN pl_feedback ON pl_feedback.lead_id = Req_Feedback_Bidder1.AllRequestID WHERE ( pl_feedback.fbidder_id='".$_SESSION['BidderID']."' ".$Mobile_NumberClause."  AND Req_Feedback_Bidder1.BidderID = Bidders.BidderID AND Bidders.Define_PrePost = 'PostPaid' AND Req_Feedback_Bidder1.Reply_Type =1 ) ".$FeedbackClause." ".$ContactedClause." GROUP BY Req_Loan_Personal.Mobile_Number";
	}
...
//		$recordcount = 0;
 ?>
	...
	if($_SESSION['BidderID']==2632)
	{
		$qry = "SELECT Req_Loan_Personal.RequestID as ReqID, pl_feedback.feedback as Pfeedback, pl_feedback.followupdate as followupdate  FROM Req_Loan_Personal LEFT JOIN pl_feedback ON pl_feedback.lead_id = Req_Loan_Personal.RequestID WHERE (pl_feedback.fbidder_id='".$_SESSION['BidderID']."' ".$Mobile_NumberClause." ) ".$FeedbackClause." GROUP BY Req_Loan_Personal.Mobile_Number";
	}
	else if($_SESSION['BidderID']==2633)
	{
		$qry = "SELECT Req_Loan_Personal.RequestID as ReqID, pl_feedback.feedback as Pfeedback, pl_feedback.followupdate as followupdate  FROM Req_Loan_Personal LEFT JOIN pl_feedback ON pl_feedback.lead_id = Req_Loan_Personal.RequestID WHERE (pl_feedback.fbidder_id='".$_SESSION['BidderID']."' ".$Mobile_NumberClause." ) ".$FeedbackClause." GROUP BY Req_Loan_Personal.Mobile_Number";
...
<!--<table width="500" border="0" cellspacing="1" cellpadding="4">
 <form name="frmdownload" action="plfeedback_search.php" method="post">
   <tr>
     <td align="center">
