...
{
	var gifName = form;
	document.frmsearch.action="bajajgrnchnl_lview.php?search=y"+gifName;
...
<tr>
 ...
 <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
     <td align="center" valign="middle" background="images/login-form-login-bg.gif"> <form name="frmsearch" action="bajajgrnchnl_lview.php?search=y" method="post" onSubmit="return chkform();"><table width="95%" border="0"  cellpadding="1" cellspacing="0"> 
   ...
   <tr>
	...
	if(strlen(trim($RequestID))>0)
	{
		$strSQL="";
		$Msg="";
		$result = ExecQuery("select bajajcibilid from bajaj_cibildetails where (bajajcibilid=$RequestID)");		
		$num_rows = mysql_num_rows($result);
		if($num_rows > 0)
		{
			$row = mysql_fetch_array($result);
			$strSQL="Update bajaj_cibildetails Set bajajfg_feedback='".$Feedback."'";
			$strSQL=$strSQL."Where bajajcibilid=".$row["bajajcibilid"];
		}
	...
	if($search=="y")
	{
		...
		{
			$FeedbackClause=" AND (bajaj_cibildetails.bajajfg_feedback IS NULL OR bajaj_cibildetails.bajajfg_feedback='') ";
		}
		...
		{
			$FeedbackClause=" AND bajaj_cibildetails.bajajfg_feedback='".$varCmbFeedback."' ";
		}
 ...
 <? 
		$search_qry="SELECT * FROM bajaj_cibildetails WHERE	((bajaj_dated Between '".($min_date)."' and '".($max_date)."') and bajajf_source!='bfsmailer' and bajajf_source!='bfsmailerhl' and bajajf_source!='bfsmailerhlTJ' and bajajf_source!='bfsmailerTJ')";
		...
		$qry="SELECT * FROM bajaj_cibildetails WHERE ((bajaj_dated Between '".($min_date)."' and '".($max_date)."') and bajajf_source!='bfsmailer' and bajajf_source!='bfsmailerhl' and bajajf_source!='bfsmailerhlTJ' and bajajf_source!='bfsmailerTJ')";
       ...
       <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["bajajf_name"]; ?></td> 
	    <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["bajajf_mobile"]; ?></td> 
		 ...
		 <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["bajajf_loan_amt"]; ?></td> 
		  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo getJumpMenu("bajajgrnchnl_lview.php",$row["bajajcibilid"],"1",$row["bajajfg_feedback"],$pageno,$varmin_date,$varmax_date,$varCmbFeedback); ?>
		</td>
		<td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Referenceno"]; ?></td> 
   </tr>
	<?
					$i=$i+1;
		}
