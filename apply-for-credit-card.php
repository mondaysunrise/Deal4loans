...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="apply-for-cc"; }
$maxage=date('Y')-62;
$minage=date('Y')-18;
?>
<!DOCTYPE html>
...
function addloanElement()
{
	...
	niloan.innerHTML='<table border="0" width="100%" cellpadding="0" cellspacing="0"><tr><td height="42" valign="middle" class="text_b" width="35%">Type of Existing loan ? :</td><td valign="middle" class="text_c" width="65%"><input type="checkbox" id="Loan_Any" name="Loan_Any[]" value="hl" ><em>Home</em><input type="checkbox" class="noBrdr" id="Loan_Any" name="Loan_Any[]" value="pl" ><em>Personal</em><br /><input type="checkbox" id="Loan_Any" name="Loan_Any[]" class="noBrdr"  value="cl" ><em>Car</em> &nbsp;<input type="checkbox" name="Loan_Any[]" id="Loan_Any" class="noBrdr" value="lap" ><em>Property</em><br /><input type="checkbox" name="Loan_Any[]" id="Loan_Any" class="noBrdr" value="other" ><em>Other</em><input type="checkbox" name="Loan_Any[]" id="Loan_Any" class="noBrdr" value="cdl"><em>Consumer Durable</em><div id="Loan_Any"></div></td>			</tr><tr><td colspan="2">&nbsp;</td></tr><tr><td height="42" valign="middle" class="text_b">Bank of Existing Loan ?&nbsp;<a href="#" class="tooltiploan"> <img src="images/questionmark-tooltip.png" width="16" height="16" border="0" /><span> Select multiple Banks if more than one Existing Loan.</span></a></td><td valign="middle" class="text_c"><select name="loanbank_name[]" id="loanbank_name" class="select" style="height:45px;"  onchange=" validateDiv(\'loanbnkVal\');"  multiple><option name="">Please Select</option>				  <option value="HDFC Bank">HDFC Bank</option>				  <option value="ICICI Bank">ICICI Bank</option>				  <option value="IndusInd Bank">IndusInd Bank</option>				  <option value="Kotak Bank">Kotak Bank</option>			  <option value="RBL Bank">RBL Bank</option>	  <option value="Standard Chartered">Standard Chartered</option>				  <option value="Others">Others</option></select><div id="loanbnkVal"></div></td></tr></table>';
}
...
Petro Credit Cards</td>
		 ...
		 <tr>
          ...
          <td valign="middle" class="text_c"><select name="City" id="City" class="select"  onchange=" addhdfclife(); validateDiv('cityVal');" tabindex="4">
                            <?=plgetCityList($City)?>
                        </select>
	 ...
	 <tr>
          <td height="42" valign="middle" class="text_b">Salary/Current Account&nbsp;<a href="#" class="tooltip"> <img src="images/questionmark-tooltip.png" width="16" height="16" border="0" /><span>
    Select multiple Banks if more than one Bank Account.
    </span></a></td>
          <td valign="middle" class="text_c"><select name="salary_account[]" id="salary_account" class="select" onChange="validateDiv('salAccountVal');"   tabindex="3" style="height:50px;" multiple>
...
font-weight:normal; color:#ffffff;font-Family:Verdana;text-transform: capitalize;'></span>
        ...
        <tr>
          ...
          <td valign="middle" class="text_c">
            ...
            <select name="Employment_Status" id="Employment_Status" class="select" onChange="addPersonalDetails(); validateDiv('empStatusVal');" tabindex="2" >
...
list($GetnumVal,$row)=Mainselectfunc($total_amtcntr,$array = array());
$ttl_countrtaken = $row['Amount'];


?>
      <ul class="text_d">
      <li>Over <span style="color:#f88c2c; font-weight:bold; font-size:20px; "><? echo number_format($ttl_countrtaken); ?></span> customers have taken quote at Deal4loans.com</li>
      <li>Credit Card Offers are free for customers.</li>
...
<div class="window-row_a">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td colspan="2" align="center" class="text_e" height="30">Complementary Movie Tickets, Dinning/Grocery/Supermarkets Discounts & Rewards </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<div class="window-row_d">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td align="center" style="font-size:19px;">Joining Rewards offers Credit Cards</td>
    </tr>
    <tr>
      <td align="center" class="text_e">Get welcome gifts:    </td>
    </tr>
    <tr>
      <td align="center" class="text_e"> Get welcome gifts : Provogue Merchandise | Bose Headphones | Sennheiser Gadgets* <br /></td>
    </tr>
    <tr>
      <td  height="25" align="center" valign="bottom"class="text_e" style="font-size:11px; color:#333333;">*Welcome gifts mentioned above are only on selected cards</td>
    </tr>
  </table>
</div>
</div>
