...
function addcty_oth()
{
		var ni = document.getElementById('myDivhl');
...
cit =="Surat" || cit =="Thane" || cit =="Vadodara" || cit =="Vijaywada" || cit =="Vishakapatanam" || cit =="Vizag" )
	{
		//alert("ranjana");
	ni1.innerHTML = '<table  style="border:1px solid #000000; padding:2px;"><tr><td colspan="2" class="form_text_pl" style="font-family:verdana; font-size:10px; color:#000000; font-weight:normal; " height="20"><span style="color:#FF0000;">(Optional) </span>Special service only for Deal4loans customers:</td></tr> <tr><td width="23"><input type="checkbox"  name="hdfclife" id="hdfclife" value="1"/></td> <td width="611" class="frmbldtxt" style="font-family:verdana; font-size:10px; color:#000000; font-weight:normal; "> I would like to avail of <b>FREE </b>financial planning services by <b>Insurance & Investment experts</b> from HDFC Life.</td>		 </tr>	 </table>';	
	}
...
function validmobile(mobile) 
{
	...
	if(!checkData(document.home_loan.Phone, 'Mobile number', 10))
		return false;
				...
				<tr align="left">
				  <Td colspan="2" width="100%" id="myDivhl"></Td>
                              ...
                              <tr>
							   ...
							   <tr>
                                <td colspan="2" id="hdfclife" class="nrmltxt" ></td></tr>
	<tr>
                                <td colspan="2" class="nrmltxt" >&nbsp;</td></tr>
                              <tr>
