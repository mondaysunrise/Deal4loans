...
$getpersonal_Lead="select Name, Employment_Status, Company_Name, City, City_Other, Mobile_Number, Net_Salary, Loan_Amount, DOB, Updated_Date,Email From Req_Loan_Personal where RequestID=".$custid;
...
<h1>You have already applied with us for Personal Loan
on <? echo $showDate; ?>. Your application is under process.
You will hear from our team to process your application.<br /></h1>
<form name="loan_form" method="post" action="/duplicate-personal-loan-values.php" onSubmit="return chkform();">
  ...
  <tr>
        ...
        <tr>
          <td height="74" valign="middle" background="new-images/apl-tp.gif" style="background-repeat:no-repeat;"><h1 >Your Personal Loan Details</h1></td>
      </tr>
  <tr>
