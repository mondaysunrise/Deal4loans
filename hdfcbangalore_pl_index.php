...
{
	var gifName = form;
	document.frmsearch.action="hdfcbangalore_pl_index.php?search=y"+gifName;
...
function chkform()
{
	...
	if(document.frmsearch.min_date.value<"2007-07-24")
	{
		alert("Sorry!!!! Your minimum date is 2007-07-24.Please Select.");
		document.frmsearch.min_date.value="";
		document.frmsearch.min_date.focus();
		return false;
	}
	if(document.frmsearch.max_date.value>"2007-08-14")
	{
		alert("Your Maximum date is 2007-08-14.");
...
function MM_jumpMenu(targ,selObj,restore){ //v3.0
 ...
 <form name="frmsearch" action="hdfcbangalore_pl_index.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
   ...
   <tr>
     ...
     <td width="80%">From 
       <input name="min_date" type="text" id="min_date" size="15" <? if($min_date=="") { ?>value="2007-07-24"<? } else { ?>value="<? echo $min_date; ?>" <? }?>>
