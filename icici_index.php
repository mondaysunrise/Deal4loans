...
function popitup(url) {
	newwindow=window.open(url,'name','height=150,width=290');
...
{
	var gifName = form;
	document.frmsearch.action="icici_index.php?search=y"+gifName;
...
<tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#45B2D8">
		<tr>
		  <td style="padding-top:5px; font-size:13px;">&nbsp;</td>
		</tr>
      <tr>
...
<tr><td>&nbsp;</td></tr>
 ...
 <form name="frmsearch" action="icici_index.php?search=y" method="post" onSubmit="return chkform();">
 ...
 <? 
		...
		$search_qry="SELECT * from pl_icici_leads where ReqID=0 and  (finalLoanAmount >'100000' and (Dated  Between '".($min_date)."' and '".($max_date)."') )";

		$search_qry=$search_qry."group by pl_icici_leads.Mobile_Number";
		$search_qry=$search_qry." order by pl_icici_leads.Dated DESC";

		$qry="SELECT * from pl_icici_leads where ReqID=0 and  (finalLoanAmount >'100000' and (Dated  Between '".($min_date)."' and '".($max_date)."') )";
		$qry=$qry.$FeedbackClause;
		$qry=$qry."group by pl_icici_leads.Mobile_Number";
 ...
 ?>
   ...
   <tr>
	...
	<?
		...
		$qry=$qry."group by pl_icici_leads.Mobile_Number";
		$qry=$qry." order by pl_icici_leads.Dated DESC";
...
//echo $qry;
   ...
   <tr>
     ...
     <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Net_Salary"]; ?></td>
	  <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Company_Name"]; ?></td>
	   <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["finalLoanAmount"]; ?></td>
	
     <td align="center" bgcolor="#DFF6FF" class="style3"><? if($row["Employment_Status"]==0) { echo "Self Employed"; } else { echo "Salaried"; }?></td> 
   	    	<td align="center" bgcolor="#DFF6FF" class="bodyarial11" ><a href="#" onclick="return popitup('icicigeneratePDFexc.php?vid=<?php echo $row["RequestID"]; ?>')"
	>Download</td>
 ...
 <br>
<!--<form name="frmdownload" action="downloading.php" method="post">
