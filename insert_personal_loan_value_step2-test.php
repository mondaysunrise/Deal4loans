...
?>
	...
	<td width="141"><form action="apply_pl_consent.php" method="POST" target="_blank" >
  ...
  <br />
        ...
        {?>
            <td valign="top" ><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="crdbg">
                <tr>
                  <td height="30" class="crdbhdng"><a href="<? if (strlen($myrow[$p]["cc_bank_url"])>0) {echo $myrow[$p]["cc_bank_url"];} else {echo "#";}?>" target="_blank"><? echo $myrow[$p]["cc_bank_name"];?></a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="center" valign="bottom"><a href="<? if (strlen($myrow[$p]["cc_bank_url"])>0) {echo $myrow[$p]["cc_bank_url"];} else {echo "#";}?>" target="_blank">
