                ...
                <td align="center" valign="middle" background="images/hl_form_bg.gif" style="background-repeat:no-repeat; width:303px; height:44px; background-position:top;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
					...
					<tr><td colspan="2" id="myDiv" ></td></tr>-->
                      ...
                      <tr>
                        <td width="120" height="20" align="left" valign="middle" class="formtext">Date of Birth <font color="#FF0000">&nbsp;</font></td>
                      ...
                      <tr>
                        <td height="20" align="left" valign="middle" class="formtext">Pincode</td>
                      ...
                      <tr>
                        <td height="20" align="left" valign="middle" class="formtext">Employment Status <font color="#FF0000">&nbsp;</font></td>
                      ...
                      <tr>
                        <td height="20" align="left" valign="middle" class="formtext">Company Name </td>
                        <td><input type="text" name="Company_Name" id="Company_Name" style="width:140px;"/></td>
                      </tr>
                      <tr>
                        <td width="120" height="20" align="left" valign="middle" class="formtext">Property Identified</td>
                        <td class="formtext">
					...
					<option value="Above 25 Lakhs">Above 25 Lakhs</option>
                      ...
                      <tr>
                        <td height="20" align="left" valign="middle" class="formtext"><span class="form-text">When you are planning to take loan?</span></td>
            ...
            <td align="center" valign="top" background="images/hl_rgt-tp-bg.gif" style="background-repeat:no-repeat; width:272px; height:44px; background-position:top;"><table width="100%" height="260" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td style="padding:5px 0px; background-color:#EFE6CB; border:3px solid #FFFFFF;"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                    ...
                    <tr>
                      <td height="38" class="text">The one-stop shop for Best on Home loan<br />
                        requirements Now get offers from</td>
                    </tr>
                    <tr>
                      <td height="21" align="left" class="text" style="font-weight:bold; color:#7d0606;"><img src="images/rd_arrow.gif" width="8" height="8" border="0" /> LIC Home Finance </td>
                    </tr>
                    <tr>
                      <td height="21" align="left" class="text" style="font-weight:bold; color:#7d0606;"><img src="images/rd_arrow.gif" width="8" height="8" border="0" /> HDFC Ltd</td>
                    </tr>
                    <tr>
                      <td height="21" align="left"   class="text" style="font-weight:bold; color:#7d0606;"><img src="images/rd_arrow.gif" width="8" height="8" border="0" /> ICICI</td>
                    </tr>
                    <tr>
                      <td height="21" align="left" class="text" style="font-weight:bold; color:#7d0606;"><img src="images/rd_arrow.gif" width="8" height="8" border="0" /> IDBI &amp; DHFL &amp; SBI</td>
                    </tr>
                    <tr>
                      <td height="21" align="left" class="text">and Choose the Best Deal!</td>
                    </tr>
                    <tr>
