...
<tr>
	...
	<a  href="callinglms/bajajlms_index.php" style="color:#FFFFFF;"><b>Home</b></a>
	</td></tr>
 <tr><td align="center"> 
...
<form  action="bidders_update_feedback_continue_ref.php"  method="post"  enctype="multipart/form-data">
  <input type="hidden" name="BidderIDstatic" id="BidderIDstatic" value="<? echo $BidderIDstatic;?>">
   ...
   <tr>
     <td valign="middle" colspan="3" class="style1" align="center"> Upload Feedback & Comment (Only CSV file accepted) </td>
       </tr>
   <tr>
