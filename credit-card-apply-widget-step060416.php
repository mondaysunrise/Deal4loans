<div class="mobile-main-wrapper">
  <div class="mobile-form-left">
    ...
    <form method="post" name="ccstep2frm" id="ccstep2frm" action="sbi-credit-card-thankyou-new.php"  onSubmit="return validateccstep2frm(document.ccstep2frm); ">
	...
	<input type="hidden" name="card_id" id="card_id" value="<? echo $cc_bankid; ?>">
      <div class="annual-income-ui-input-wrapper">
        <input name="first_name" id="first_name" type="text" class="annual-income-ui-input man-icon float-left" placeholder="First Name" onKeyPress="return isCharsetKey(event);" onkeydown="validateDiv('FirstnameVal');" maxlength="12" value="<?php echo $first; ?>">
         <div style="clear:both;"></div>
        <div id="FirstnameVal"></div>
      </div>
      <div class="annual-income-ui-input-wrapper margin-a-left">
        <input name="middle_name" id="middle_name" type="text" class="annual-income-ui-input float-left" placeholder="Middle Name" onKeyPress="return isCharsetKey(event);" maxlength="10" value="<?php if(strlen($middle)>0 && strlen($last)>0) { echo $middle;} else { echo "";} ?>">
      </div>
      <div class="annual-income-ui-input-wrapper margin-a-left">
        <input name="last_name" id="last_name" type="text" class="annual-income-ui-input float-left" placeholder="Last Name" onKeyPress="return isCharsetKey(event);" onkeydown="validateDiv('LastnameVal');" maxlength="16" value="<?php if(strlen($last)>0) { echo $last;} elseif(strlen($middle)>0 && $last==""){ echo $middle;} else { echo "";} ?>">
         <div style="clear:both;"></div>
        <div id="LastnameVal"></div>
      </div>
      <div style="clear:both;"></div>
      <div class="annual-income-ui-input-wrapper">
        <input name="panno" id="panno" type="text" class="annual-income-ui-input pancard-icon float-left" placeholder="PAN card Number" onkeydown="validateDiv('pannoVal');" maxlength="10">
         <div style="clear:both;"></div>
        <div id="pannoVal"></div>
      </div>
      <div class="annual-income-ui-input-wrapper margin-a-left">
...
?>
      ...
      <div class="annual-income-ui-input-wrapper margin-a-left">
        <select name="pincode" id="PincodeText" class="mobile-ui-input location-icon input-bottom-margin" onchange="validateDiv('pincodeVal'); showProfDetails(event)">
          <?php
if($City)
{
$getPinSql = "SELECT * FROM sbi_cc_city_state_list WHERE city like '%".$City."%'";
...
?>
          <option >Select Residence Pincode</option>
          <?php }?>
        </select>
         <div style="clear:both;"></div>
     ...
     <div id="DesignationVal"></div>
        ...
        <input name="OfficeAddress1" id="OfficeAddress1" type="text" class="mobile-ui-input input-bottom-margin location-icon" placeholder="Complete Office Adress" onkeydown="validateDiv('OfficeAddressVal');"  maxlength="120">
         <div style="clear:both;"></div>
...
?>
      ...
      <div class="annual-income-ui-input-wrapper margin-a-left">
        <select name="OfficePin" id="txtHint" class="mobile-ui-input location-icon input-bottom-margin" onchange="validateDiv('OfficePinVal');">
          <option >Select Office Pincode</option>
        </select>
         <div style="clear:both;"></div>
