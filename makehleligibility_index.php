...
?>
<form action="makehleligibility_continue.php" method="post">
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td colspan="2"><div align="center">Home Loan Eligibility Page</div></td>
    </tr>
   <tr>
    <td width="25%"><strong>State</strong></td>
    <td width="75%">
      <input type="text" name="State" id="State" class="input" style="width:202px;"  />
    </td>
  </tr>
  <tr>
    <td width="25%"><strong>City</strong></td>
    <td width="75%">
      <input type="text" name="City" id="City" class="input" style="width:202px;"  />
    </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td colspan="2"><textarea class="ckeditor" cols="120" id="header" name="header" rows="10"></textarea></td>
  </tr>
  <tr>
    <td colspan="2"><strong>Main Description</strong></td>
  </tr>
     <tr>
    <td colspan="2"> <textarea class="ckeditor" cols="120" id="mainDesc" name="mainDesc" rows="20"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
