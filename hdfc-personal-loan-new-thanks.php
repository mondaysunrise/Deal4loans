...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <table width="949"  align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	// $updateSql = "update hdfc_pl_calc_leads set eligible='Yes', eligible_loanAmt ='".$getloanamout."', eligible_interestRate ='".$interestrate."',  eligible_emi ='".$get_emi."', eligible_term ='".$getterm."' where hdfcplid ='".$last_inserted_id."'";
	 
	  $updateSql = "update hdfc_pl_calc_leads set eligible_loanAmt ='".$getloanamout."', eligible_interestRate ='".$interestrate."',  eligible_emi ='".$get_emi."', eligible_term ='".$getterm."' where hdfcplid ='".$last_inserted_id."'";
	...
	//	 $updateSql = "update hdfc_pl_calc_leads set MAIL_SENT='Sent' where hdfcplid ='".$last_inserted_id."'";
		//$updateQuery = ExecQuery($updateSql);	
	}
		?>
	<tr>
	...
	<tr><td colspan="7" style="color:#103E6B; padding-left:15px; line-height:25px; font-size:12px; " class="boldtxt">&nbsp;</td>
	</tr>
	<form action="hdfc-personal-loan-newthanks.php" name="Sub" method="post">
	<input type="hidden" name="lead_id" value="<?php echo $last_inserted_id; ?>">
	<input type="hidden" name="city" value="<?php echo $city; ?>">
	<tr><td colspan="7" style="color:#103E6B;line-height:25px; font-size:12px; " class="boldtxt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="62%">For next steps,  do you wish to connect with HDFC Personal Loan Team: </td>
    <td width="38%"><input type="image" name="Yes" value="" src="new-images/yes-btn.gif" border="0" style="border:0px;">&nbsp;&nbsp; 
      <img src="new-images/no-btn.gif" width="103" height="35" border="0"></td>
  </tr>
</table>
</td>
	</tr>
