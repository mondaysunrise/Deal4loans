...
{   
	...
	$qry = "SELECT * FROM Bidders_List WHERE (City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and Reply_type=1 and `bidder_postpaid`=1 and Bidder_Name like '%Bajaj%') order by Bidder_Name ASC";
