...
$Today=date('Y-m-d');
	...
	$citifinquery="SELECT Property_Identified,Employment_Status,Name,DOB,Email,Company_Name,City,City_Other,Pincode,Mobile_Number,Net_Salary,Add_Comment,Loan_Amount,Property_Loc,Allocation_Date FROM Req_Feedback_Bidder1,Req_Loan_Home WHERE (Req_Feedback_Bidder1.AllRequestID=Req_Loan_Home.RequestID and Req_Feedback_Bidder1.BidderID in (2718,2719,2720,2835,2852,3082,3129,3291,3299,3357,3824) and Req_Feedback_Bidder1.Reply_Type=2 and Req_Feedback_Bidder1.Allocation_Date Between '".($min_date)."' and '".($max_date)."')";
...
//$newToday ="280112";
	...
	$newfileatt = "/home/deal4loans/public_html/hldwnld/axis".$newToday."2724.xls";
...
if($recordcount>0)
	...
	$to = "yatish@prosales.in"; 
	   ...
	   $fileatt = "/home/deal4loans/public_html/hldwnld/axis".$newToday."2724.xls";
        $fileatttype = "application/xls"; 
        $fileattname = "axis".$newToday."2724.xls";
