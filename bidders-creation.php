<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$Email = $_POST['Email'];
		$PWD = $_POST['PWD'];
		if($Email=="biddercreate@d4l.com" && $PWD == "d4lcreatenw")
		{
			$_SESSION['Email'] = "biddercreate@d4l.com";
			$_SESSION['UName'] = "Bidder Creation";
			$_SESSION['BidderID'] = "190011";
			$_SESSION['UserType'] = "CreateBidder";
//			echo "upendra";
			header("Location: create-bidder.php");
			exit();
		}
		else
		{
...
<title>Login - Bidder Creation</title>
