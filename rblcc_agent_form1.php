<?php 
	...
	$slct="select applied_card_name,Pancard, Name,DOB,City,Pincode,Residence_Address,Gender from Req_Credit_Card Where (RequestID='".$RequestID."')";
...
<div class="mobile-main-wrapper">
  <div class="mobile-form-left">
    ...
    <form method="post" name="ccstep2frm" id="ccstep2frm" action="rbl-credit-card-thankyou.php" >
      ...
      <div class="annual-income-ui-input-wrapper margin-a-left">
        <div class="gender-box"> <strong>Gender</strong>
          <div class="form-required">
            <label for="radio-one">
              <input type="radio" name="Gender" id="radio-one" value="1" onclick="return ShowCityField(event)" <? if($Gender=="Male") {echo 'checked="checked"';} ?>/>
              <i></i> <span>Male</span> </label>
            <label for="radio-two">
              <input type="radio" name="Gender" id="radio-two" value="2" onclick="return ShowCityField(event)" <? if($Gender=="Female") {echo 'checked="checked"';} ?>>
      ...
      <input name="resiaddress1" id="resiaddress1" type="text" class="annual-income-ui-input pancard-icon float-left" placeholder="Complete Residential address" onkeydown="validateDiv('resiaddressVal');"  maxlength="120" value="<?php echo $Residence_Address; ?>">
      <div style="clear:both;"></div>
