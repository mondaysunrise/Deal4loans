...
# Rating Reviews :: Product type 1 for Personal Loans
$session_id = session_id();
$product_type = 1;

$showRatingQry = ExecQuery("select avg(rating),count(product_id) as total_review from product_rating where product_id='".$product_type."' and status=1");
$avg_rating = round(mysql_result($showRatingQry,0),1);
//$total_records = mysql_result($showRatingQry,1);
$showtotalReviewQry = ExecQuery("select id from product_rating where product_id='".$product_type."' and status=1");
...
<title>Personal Loan | Online Personal loans India 2014</title>
...
<meta name="description" content="Compare Personal loans India: Get details on ✓Special offers ✓compare best personal loans ✓benefits ✓Documents ✓Eligibility Criteria by Various Banks and Cibil Score Importance."/>
<style type="text/css">
...
<body onload="MM_preloadImages('images/apply2.gif','images/get2.gif')">
...
<div class="pl_titile_wraper" style="width:100%;">
    ...
    <h1 class="text3" id="title_pl" itemprop="name" style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px;">Personal Loan</h1>    
    <div itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" style="float:left; margin-left:-40px; margin-top:20px;">
    ...
    <div class="pl_emi_btn_box"><a href="Contents_Calculators.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/emi2.gif',1)"><img src="images/emi1.gif" name="Image3" width="95" height="20" border="0" id="Image3" /></a></div>
    <div style="clear:both;"></div>
    <div style="width:100%; border-bottom:thin solid #88a943; padding:5px 0px 5px 0px;"></div>
</div>
<div style="clear:both;"></div>
...
<div class="review_wrapper">
    ...
    <div class="review_star">
        <div class="exemple5" data-average="<?php echo $avg_rating; ?>" data-id="<?php echo $product_type; ?>"></div>
    </div>
    <div class="datasSent">
        <p></p>
    </div>
...
<p class="text11 style1"><a href="http://www.deal4loans.com/hdfc-personal-loan-eligibility.php"><strong>HDFC Bank Personal loan</strong></a>:<br />
  Interest  Rates: 11.99% to 20% | Prepayment charges: 4% | Processing Fees: 0.8% -  1.75% (for special companies), 2% (HDFC AC holder), 2.5% for others | Loan  disbursement time: 1-7 days  | Total loan  disbursed per month- 1100 Crs<br /><br />
  <a href="http://www.deal4loans.com/personal-loan-icici-bank.php"><strong>ICICI Personal Loan</strong></a>: <br />
  Interest  Rates: 13.49% to 17.50% | Prepayment charges: NIL (For Loan amount >10 lacs & 12 EMI paid), else 5%  | Processing Fees: 0.5% for special companies else 1.50% - 2.25% | Loan disbursement time: 3-4 Days  | Total Loan disbursed Per Month- 350 crs<br />
  <strong><br />
  ...
  Interest Rates: 15.00% to 17.00% | Prepayment charges: 0% | Processing Fees: 2% to 2.50% | Loan disbursement time: 1-7 Days | Total loan disbursed per month- 105 Crs<br /><br />
   <a href="http://www.deal4loans.com/citibank-personal-loan-eligibility.php"><strong>Citibank personal loan</strong></a>: <br />
  Interest  Rates: 13.75% to 15.25% | Prepayment charges: Upto 0.75% | Processing Fees: Upto 1%| Loan  disbursement time: 48 Hours| Total Loan disbursed per month- 125 crs<br />
  <br />
  <a href="http://www.deal4loans.com/loans/personal-loan/indusind-bank-personal-loan-interest-rates-eligibility-documents/"><strong>Indus Ind Bank personal loan</strong></a>: <br />
  Interest  Rates: 14% to 16.50% | Prepayment charges: 4% | Processing Fees: 1% - 2% | Loan  disbursement time: 4 working days | Total Loan disbursed per month- 30 crs<br />
  <br />
  <a href="http://www.deal4loans.com/personal-loan-hdb-financial-services.php"><strong>HDB Financial Services personal loan</strong></a>: <br />
  Interest  Rates: 16% - 21% | Prepayment charges: NIL for Select Corporates Employees (CAT A &amp; B), else 4 % | Processing Fees: up to 2% | Loan  disbursement time: 2 days - 7 days <br />
  <br />
  <strong><a href="http://www.deal4loans.com/kotak-personal-loan-eligibility.php">Kotak Personal loan</a></strong>: <br />
  Interest  Rates: 13.60% to 18% | Prepayment charges: 5% | Processing Fees:2%  | Loan  disbursement time: 3-4 Days | Total Loan Disbursed per month – 35 Crs<br />
  <br />
   <a href="http://www.deal4loans.com/personal-loan-ingvysya-bank.php"><strong>Ing Vysya Personal Loan</strong></a>: <br />
  Interest Rates: 13.75% to 17.25% | Prepayment charges:Nil (till <strong>Sept'14</strong>)| Processing Fees: Flat Processing Fees – 999/- offer for Special companies & Salary Above 65k or Upto 2%   | Loan disbursement time: 1-4 days  | Total loan disbursed per month- 45 Crs<br />
  <br />
  ...
  Interest Rates: 21.00% - 32% | Prepayment charges: 4% | Processing Fees: 2% | Loan Disbursement time: 2-8 days | Total Loan Disbursed Per Month – 180 Crs<br /><br />
