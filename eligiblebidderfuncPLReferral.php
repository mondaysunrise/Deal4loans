...
{   
	...
	if($strreferral==1)
	{
	 ...
	 $qry = "SELECT * FROM Bidders_List WHERE (Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and Referral_Flag=1 and BankID=17)";
	}
	else if($strreferral==2)
	{
	
	 $qry = "SELECT * FROM Bidders_List WHERE (Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and  bidder_postpaid=1  and BankID=17)";
	}
	else
	{
		$qry = "SELECT * FROM Bidders_List WHERE (Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1  and BankID=17)";
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$qry2 = $query." and (City in ".$propercity." or City_Other in ".$propercity." )and Req_Partner_PL.RequestID ='".$RequestID."'";
