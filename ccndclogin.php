<?php
	...
	function formHandler(){
		...
		$result = ("select * from Bidders where Email='$Email' and PWD='$PWD' and BidderID=76");
		...
		if($num_rows > 0){
			...
			setSessionBidder($Email, $myrow);	   

			 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."ccndcadmin.php");
			exit;
		}
		else{
			global $Msg;
