...
echo "Current Date & Time - ".$DateTime."<br>";
$request = '';
...
//$url = 'https://cbv2cpu.uat.experian.in:16443/ECV/content/openCustomerDetailsFormAction.action';
...
{
	echo "<br><b>No Response from the Web Service</b>";	
}
curl_close($ch);
