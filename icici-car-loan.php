...
function chkcarloan(Form)
{
	...
	if (Form.current_experience.value=="" || (Form.current_experience.value=="(in Yrs)"))
	{
	...
	if (Form.total_experience.value=="" || (Form.total_experience.value=="(in Yrs)"))
	{
...
<form name="hdfc_calc" method="POST" action="icici-car-loan-continue2.php" onSubmit="return chkcarloan(document.hdfc_calc);">
...
<select name='fm_subcategory' id='sub_category' style='width:170px' tabindex="13" class="txtbox"></select></td>
                  </tr>
