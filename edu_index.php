...
{
	var gifName = form;
	document.frmsearch.action="edu_index.php?search=y"+gifName;
...
function chkform()
{
	...
	{
		alert("Sorry!!!! Your minimum date should be greater than <?php echo $mindefineDate;?>.Please Select.");
		document.frmsearch.min_date.value="";
		document.frmsearch.min_date.focus();
		return false;
	}

	/*	if(document.frmsearch.max_date.value>"2011-05-31")
	{
		alert("Sorry!!!! Please Enter Maximum date is 2011-05-31.");
...
<tr>
 ...
 <form name="frmsearch" action="edu_index.php?search=y" method="post" onSubmit="return chkform();">
   ...
   <tr>
	...
	if($search=="y")
	{
		...
		//$cityList = "Mumbai,Pune,Nashik,Ahmedabad,Bhopal,Jaipur,Kota,Chennai,Coimbatore,Tiruchirapalli,Hosur,Madurai,Kochi,Thiruvananthapuram,Thrissur,Hyderabad,Guntur,Vijayawada,Visakhapatnam,Bangalore,Mangalore,New Delhi,Greater Noida,Ghaziabad,Gaziabad,Gurgaon, Faridabad,chandigarh,Kolkata,Raipur,Nagpur,Jamshedpur,Bhubaneswar,Delhi";
		
		
		$cityList ="Ahmednagar,Akola,Amravati,Aurangabad,Buldhana,Chandrapur,Chiplun,Dhule,Jalgaon,Kolhapur,Mumbai,Nagpur,Nashik,Pune,Sangli,Satara,Solapur,Washim,Yavatmal,Durgapur,Kolkata,Siliguri,,Ahmedabad,Anand,Ankleshwar,Bharuch,Gandhidham,Jamnagar,Rajkot,Surat,Vadodara,Vapi,Calicut,Kannur,Kochi,Kollam,Kottayam,Malappuram,Palakkad,Pathanamthitta,Thiruvananthapuram,Trivandrum,Thrissur,Chennai,Coimbatore,Erode,Hosur,Madurai,Nagercoil,Salem,Tiruchirapalli,Tirunelveli,Tiruppur,Tuticorin,Agra ,Allahabad,Bareilly,Gaziabad,Gorakhpur,Greater Noida,Jhansi,Kanpur,Lucknow,Meerut,Noida,Varanasi,Banaras,Ambala,Faridabad,Gurgaon,Hisar,Karnal,Panchkula,Yamuna Nagar,
Ajmer,Alwar,Bhilwara,Bhiwadi,Bikaner,Jaipur,Jodhpur,Kota,Udaipur,Jamshedpur,Ranchi,Guntur,Hyderabad,Nellore,Rajahmundry,Vijayawada,Visakhapatnam,Bangalore,Gulbarga,Hubli,Mangalore,Mysore,BANGARPET,Bhilai,Bilaspur,Korba,Raipur,Bhubaneswar,Cuttack,Bhopal,Dewas,Gwalior,Indore,Jabalpur,Pithampur,Ratlam,Ujjain,Amritsar,Bhatinda,Jalandhar,Ludhiana,Moga,Mohali,Patiala,Ropar,Dehradun,Haldwani,Haridwar,Guwahati,Patna,Chandigarh,Delhi,Shimla,Goa,Jammu,Puducherry";
		
		$city_List = explode(",", $cityList);
		$finalCity = implode("','", $city_List);
		$cityCaluse = " and (Req_Loan_Education.Residence_City in ('".$finalCity."') or Req_Loan_Education.Residence_City_Other in ('".$finalCity."') )";// City List
		
		$loanAmtClaue = " and Req_Loan_Education.Loan_Amount>=100000 ";
		
		$ageClause = " and (Req_Loan_Education.DOB!='' and DATE_SUB(CURDATE(),INTERVAL 18 YEAR) >= Req_Loan_Education.DOB)";
 ...
 <? 
		$search_qry="SELECT * FROM Req_Loan_Education where (1=1 and (Req_Loan_Education.Dated Between '".($min_date)."' and '".($max_date)."') and (RequestID>=1376 and RequestID<=23084) ";	
		$search_qry=$search_qry.$cityCaluse;
		$search_qry=$search_qry.$loanAmtClaue;
		$search_qry=$search_qry.$ageClause;
		$search_qry=$search_qry."group by Req_Loan_Education.Mobile_Number";
		$search_qry=$search_qry." order by Req_Loan_Education.Dated DESC";

		$qry="SELECT * FROM Req_Loan_Education where (1=1 and (Req_Loan_Education.Dated Between '".($min_date)."' and '".($max_date)."') and (RequestID>=1376 and RequestID<=23084)) ";
		$qry=$qry.$cityCaluse;
		$qry=$qry.$loanAmtClaue;
		$qry=$qry.$ageClause;
		$qry=$qry."group by Req_Loan_Education.Mobile_Number";
 ...
 ?>
  <tr>
   ...
   <tr>
	 ...
	 <td width="88" align="center" bgcolor="#FFFFFF" class="style2">Age</td>
	 <td width="100" align="center" bgcolor="#FFFFFF" class="style2">Gender </td>
	 <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Country of Study </td>
	 <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Course of Study</td>
     <td width="130" align="center" bgcolor="#FFFFFF" class="style2">Required Loan Amount</td>
     <td width="110" align="center" bgcolor="#FFFFFF" class="style2">Email ID</td>
	 <td width="180" align="center" bgcolor="#FFFFFF" class="style2">Mobile Number</td>
	 <td width="100" align="center" bgcolor="#FFFFFF" class="style2">City</td>
     	 <td width="100" align="center" bgcolor="#FFFFFF" class="style2">Providing Collateral Security</td>
   </tr>
	<?
		...
		$qry=$qry.$ageClause;
		$qry=$qry."group by Req_Loan_Education.Mobile_Number";
		$qry=$qry." order by Req_Loan_Education.Dated DESC";
...
//echo $qry;
   ...
   <tr>
		...
		echo $age; ?></td>
        <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Gender"]; ?></td>
        <td align="center" bgcolor="#DFF6FF" class="style3">
            <? 
			if($row["Country"]=="1")
			{
        ...
        <? 
			...
			{
				echo "Post Graduation Courses";
			}
			else if($row["Course"]=="3")
			{
				echo "Graduation Courses";
			}
        ...
        <td align="center" bgcolor="#DFF6FF" class="style3">
        <? echo $row["Residence_City"]; ?>
        </td>
        <td align="center" bgcolor="#DFF6FF" class="style3">
        <? echo $row["Collateral_Security"]; ?>
        </td>
 </tr>
	<?
...
<table width="500" border="0" cellspacing="1" cellpadding="4">
 <form name="frmdownload" action="edu_download.php" method="post">
   <tr>
     <td align="center">
