<?php
if (mom_option('mom_share_function') == 1) {
...
<?php if ($style == 'vertical') { ?>
        ...
        <?php if (mom_option('post_share_twitter') != false) { ?>
            <div class="ss-icon twitter">
                <a href="http://twitter.com/share?text=<?php echo $title; ?>&url=<?php echo $url; ?>" onclick="window.open(this.href, '<?php _e('Post this On twitter', 'theme'); ?>', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,width=<?php echo $window_width; ?>,height=<?php echo $window_height; ?>');"><span class="icon"><i class="fa-icon-twitter"></i><?php _e('Tweet', 'theme'); ?></span></a>
