...
<div style="display:none;">
  <div >
    ...
    <?php _e('Reviewed by', 'theme'); ?><span ><?php echo get_the_author_meta( 'display_name' ); ?></span> <?php _e('on', 'theme'); ?>
    <time  datetime="<?php the_time('Y-m-d'); ?>"><?php the_time('F d'); ?></time>.
    <span ><?php if($summary){ echo $summary; } ?></span>
    <span ><?php if($desc){ echo $desc; } ?></span>
    <?php _e('Rating', 'theme'); ?>: <span ><?php echo $stars; ?></span>
  </div>
</div>
