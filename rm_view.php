...
<tr><td align="right" colspan="5" class="style2"><a href="add_rm_referal.php"  class="style2">Add RM</a></td></tr>   
<tr>
<td width="141" align="center" bgcolor="#FFFFFF" class="style2" height="29">RM's Name </td>
<td width="141" align="center" bgcolor="#FFFFFF" class="style2">Contact Details </td>
...
<td width="141" align="center" bgcolor="#FFFFFF" class="style2">Edit</td>    
   ...
   <?
$result=ExecQuery("Select * From RM_List Where 1=1 order by BD_Name asc ");
...
<tr>
       <td align="center" bgcolor="#DFF6FF" class="style3" height="23"><? echo $row["BD_Name"]; ?></td>
<td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["BD_Number"]; ?></td>
<td align="center" bgcolor="#DFF6FF" class="style3"><?  echo $row["BD_Email"]; ?></td>
<td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["BD_pwd"]; ?></td>
<td align="center" bgcolor="#DFF6FF" class="style3"><a href="edit_rm_referal.php?BD_ID=<? echo $row["BD_ID"]; ?>">Edit</a></td>
