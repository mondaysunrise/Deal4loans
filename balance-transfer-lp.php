  ...
  <tr>
    <td height="30" colspan="2" class="form_text"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="49%" style="font-size:10px; color:#FFF; font-weight:normal;"><img src="images/bt_locked.png" width="12" height="12">we secure your details</td>
      </tr>
      <tr>
...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" valign="middle" class="body" style="font-size:11px; text-align:left;"><input type="checkbox" name="checkbox" id="checkbox" tabindex="11" />
