...
function Insert_clientlead($ProductValue, $Name, $City, $Phone, $Email, $mahindra_life)
	{
		...
		$tomorrow  = mktime(0, 0, 0, date("m")  , date("d")-30, date("Y"));
			...
			$getdetails="select RequestID From ".$Type_Loan."  Where (Mobile_Number not in (9971396361,9811215138,9811555306) and Mobile_Number='".$Phone."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
...
if($City=="Others")
	...
	if($hdfclife==1)
		{
			$Product=2;
			Insert_HdfcLife_nw($Name, $City, $Phone, $dateofbirth, $Email, $Net_Salary, $Product, $ProductValue, $source );
