...
$sql ="select City,Employment_Status,EMI_Paid From Req_Loan_Personal Where (RequestID=".$_SESSION['Temp_LID'].")";
...
function blockSpecialChar(e){
        e = e || event;
        return /^[a-zA-Z0-9-#'(),. ]+$/.test(String.fromCharCode(e.charCode || e.keyCode));
        }
...
<div style="margin:auto; width:100%; height:11px; margin-top:70px; color:#0a8bd9;"></div>
<!--logo navigation-->
<div class="text12" style="margin:auto; height:11px; margin-top:11px; color:#0a8bd9;"><u><a href="index.php" class="text12" style="color:#0080d6;">Home</a></u> > <a href="#"  class="text12" style="color:#0080d6;"><u>Personal Loan</u></a> <a href="#" class="text12" style="color:#4c4c4c;">> Apply for Personal Loan</a></div>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<tr>               
       <td align="center" valign="middle" style="color: #643E02; font-weight:bold; font-size:14px;">60% of your application for quote from all Banks is complete.</td>            
      </tr>
	  <tr>
	   <td align="center" >&nbsp;</td>            
      </tr>
      ...
      <tr>               
       <td align="center" valign="middle"><img src="images/1-2.-stepsjpg.jpg" width="284" height="64" /></td>            
      </tr>
	   <tr>
	   <td align="center" >&nbsp;</td>            
      </tr>
	  <tr>               
       <td align="center" valign="middle" style="color: #136071; font-weight:bold; font-size:14px;">Share few more details to get exact quote on Emi,Rates & Loan Amount.
</td>
      </tr>
    </table></td>
  </tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><form name="personalloan_form"  action="insert_personal_loan_value_httpsstep2.php" method="POST" onsubmit="return submitform(document.personalloan_form); ">
      <input type="hidden" value="<? echo $_SESSION['Temp_LID'];?>" name="leadid" />
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        
        <tr align="center" bgcolor="#f4f4f4">
          <td height="35" colspan="2" class="bldtxt" style="font-size:16px; "> Personal Loan Quote Request</td>
          </tr>
        <tr>
          <td height="10" colspan="2" ></td>
          </tr>
        <tr>
          <td width="42%" height="35" align="left" class="bldtxt" style="font-size:14px;">Primary Account 
            in which bank?  </td>
          <td width="58%" height="20"  align="left"><input type="text" class="emi_input" name="Primary_Acc" id="Primary_Acc" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event); getstatementlink();" onchange="getstatementlink();" onkeydown="getstatementlink();" onclick="getstatementlink();"></td>
          </tr>
        <? if($flg['Employment_Status']==0) 
		   { } 
		   else 
        ...
        <tr>
          <td height="20" align="left" class="bldtxt" style="font-size:14px;">Residential Status </td>
          <td  align="left" ><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
        ...
        <tr>
          <td height="35" class="bldtxt" style="font-size:14px;">Company Type</td>
        ...
        <? if($flg['Employment_Status']==0) 
		   { ?>
        <tr>
          <td height="35" class="bldtxt" style="font-size:14px;">Professional details</td>
       <td class="frmtxt"><select name="professional_details" id="professional_details" class="emi_select">
            <option value="0">Please Select</option>
        ...
        <? }
		   ?>
        <tr>
          <td height="35" align="left" class="bldtxt" style="font-size:14px;"><? if($flg['Employment_Status']==0) 
        ...
        <tr>
          <td height="42" align="left" class="bldtxt" style="font-size:14px;">Total Experience (Years)/
            Total Years  
            in Business</td>
...
{
?>      <tr>
          <td height="30" align="left" class="bldtxt" style="font-size:14px;">Any Loan running?</td>
