...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	//echo $IP; die;
	$Uname = 'admin@deal4loans.com';
	$Password = 'd4lifscadmin@!@#';
	
	/*if(($IP=="122.176.100.27" || $IP=="122.176.100.28" || $IP=="122.176.122.134" || $IP=="122.161.196.68" || $IP=="61.246.3.127" || $IP=="122.160.30.168" || $IP=="180.188.224.34" || $IP=="122.161.193.191" || $IP=="122.161.196.39"))
			{*/
	...
	if($adminUname!=$Uname)
		{
			redirectURL(SITE_URL."index.php?msg=".urlencode("Please enter correct username!"));
		}
	if($adminPass!=$Password)
		{
			redirectURL(SITE_URL."index.php?msg=".urlencode("Your password does not match with our record. Please enter correct password!"));
		}
...
<?php include "includes/header.php";?>
    <div id="payment_container">
      <div class="wel_paymentsText">Welcome to <a href="#">Deal4Loans IFSC Code </a> . Please Register with your appropriate details. </div>
