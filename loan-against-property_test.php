...
<title>Loan Against Property - Best property loans <?php echo date("Y");?> India</title>
...
<div class="lap_inner_wrapper" style="margin:auto;" itemscope itemtype="http://schema.org/Product">
<div style="margin-top:70px;" class="common-bread-crumb"><a href="index.php"  itemprop="url" class="text12" style="color:#0080d6; font-size:14px;">Home</a> <strong style="font-size:14px; font-weight:normal;" class="text12"> » </strong> <span style="color:#4c4c4c; font-size:14px;">Loan Against Property</span></div>
  
  
  <h1 class="lap-h1" itemprop="name">Loan Against Property</h1>
   <div itemprop="description">While searching for a loan against property, the first question that comes to mind is how much I can get "<strong>Kitna Milega?</strong>" <br />
    <br />
...
for($i=0;$i<$getRatesNumRows;$i++)
{
	...
	$Upto30 = $getRatesQuery[$i][$i]['Upto30'];
