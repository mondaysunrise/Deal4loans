<?
function geteligibleBiddersList_proploc($strProduct,$strRequestID,$strCity)
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $City = trim($row["City"]);
		...
		$qry2 = $query." and (Property_Loc in ".$propercity.")and Req_Loan_Home.RequestID ='".$RequestID."'";
