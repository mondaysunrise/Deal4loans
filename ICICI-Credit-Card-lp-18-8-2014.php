...
if((strlen(trim($crd_nme))>0) && $cc_bankid >1)
{
	...
	list($recordcount,$row)=Mainselectfunc($slct,$array = array());
	...
	list($recordcount,$rownew)=Mainselectfunc($slctccelb,$array = array());
...
list($alreadyExist,$hdfcrow)=Mainselectfunc($hdfcd,$array = array());
