...
{
		var ni = document.getElementById('myDiv1');
		ni.innerHTML = '<table border="0"><tr><td height="20" colspan="2" align="left" valign="center" class="subheading"><input type="checkbox" name="updateProperty" style="border:none;" checked ><span class="form-text">&nbsp;Can HDFCRed suggest some properties</font></td></tr></table>';
...
<div id="container">
 ...
 <form name="loan_form" method="post" action="hdfcred-home-loans-continue-test.php" onSubmit="return chkform();">
 <input type="hidden" name="Activate" id="Activate" ><input type="hidden" name="source" value="hdfcred">
...
font-weight:normal; color:#333333;font-Family:Verdana;text-transform: capitalize;'></span></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#FFFFFF" class="text"><b>9.50% - 11%</b></td>
