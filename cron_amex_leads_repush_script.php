...
$getAmexNoResponseLeadsInfoSQL = "SELECT * FROM `credit_card_banks_apply` WHERE `applied_bankname` LIKE 'American Express' AND `request_data` != '' AND `response_data` = '' AND (date_created BETWEEN '".$previousDayDateTime."' AND '".$currentDayDateTime."') ORDER BY `id` DESC";
