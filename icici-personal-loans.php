...
<title>ICICI Personal loans</title>
<meta name="keywords" content="icici personal loan,icici personal loans,icici personal loans india,icici low interest personal loan"/>
<meta name="description" content="Compare personal loans from  Icici, Sbi,Hdfc,Citibank,Standard Chartered bank and get lowest EMI & Rates."/>
...
function chgtxtsal()
{
	...
	if(citemp==0)
	{
		...
		niadtxt.innerHTML="Annual Turnover <select name='Annual_Turnover' id='Annual_Turnover'  style='width:140px;'>		<option value='1'> 0 - 30 Lacs</option>		<option value='2'> 30 Lacs - 60 Lacs</option>		<option value='3'> 60 Lacs - 1 Cr</option>		<option value='4'> 1 Cr & above</option>		</select>";	
	}
	else 
	{
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="167" align="left" valign="top"><img src="new-images/pl/hdr5-icici.gif" width="161" height="167" /></td>
            <td height="167" align="left" valign="top"><img src="new-images/pl/hdr6-icici.gif" width="158" height="167" /></td>
          ...
          <tr>
			...
			<tr>
			     <td height="8"></td>
				  ...
				  <tr>
                <td height="25" class="bldtxt" style="font-size:13px; font-family:Verdana, Arial, Helvetica, sans-serif; " >Icici Personal loan Features
</td>
              </tr>
              <tr>
                <td><table width="550" border="0" cellspacing="0" cellpadding="0" >
                  <tr>
                    <td align="left"><table width="371"   border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="44" height="22" align="right" valign="middle"><b>1)</b></td>
                        <td width="327">&nbsp; Loans for Salaried and Self Employed.</td>
                      </tr>
                      <tr>
                        <td width="44" height="22" align="right" valign="middle"><b>2)</b></td>
                        <td>&nbsp; Loans from 1 lac- 15 lacs.</td>
                      </tr>
					  <tr>
                        <td width="44" height="22" align="right" valign="middle"><b>3)</b></td>
                        <td>&nbsp; Rate of interest from 14- 19%.</td>
                      </tr>
                  ...
                  <tr>
                    <td width="644" style="padding-left:10px; "><table width="99%"  border="0" cellspacing="0" cellpadding="0">
					 ...
					 <tr>
                        ...
                        <td width="589"><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Compare other Banks quotes with Icici Bank Personal Loan.</div></td>
                      </tr>
                      <tr>
                        <td width="34" height="40" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="18%"><img src="new-images/pl/hdfc.jpg" width="99" height="29" /></td>
                          <td width="19%"><img src="new-images/pl/fultrn_n.jpg" width="100" height="29" /></td>
                          <td width="17%"><img src="new-images/pl/sbi.gif" width="97" height="24" /></td>
                          <td width="18%"><img src="new-images/pl/ingvysya_n.jpg" width="100" height="29" /></td>
						  <td width="28%"><img src="new-images/pl/bajajfin.jpg" width="150" height="27" /></td>
                        </tr>
                    </table></td>
                  </tr>
                </table>                  </td>
        ...
        <td width="322" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="289" height="88" align="left" valign="top"><img src="new-images/pl/icici-frmhdng.gif" width="289" height="88" /></td>
              </tr>
              <tr>
...
<input type="hidden" name="source" value="apply PL icici bank"> 
<input type="hidden" name="referrer" value=""> 
<input type="hidden" name="Activate" id="Activate" >
<input type="hidden" name="PostURL" value="/icici-personal-loans.php">
<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif;" color="#FF0000"><strong></strong></font></div><table width="95%"  border="0" align="right" cellpadding="0" cellspacing="0">
				<tr align="left">
				  <Td>&nbsp;</Td>
				  <Td>&nbsp;</Td>
				  </tr>
				...
				<Td width="40%" class="bldtxt">Full Name </Td>
 				<Td width="60%"><input name="Name" type="text" value="" id="Name" style=" width:140px;" onBlur="onBlurDefault(this,'Name');"  onFocus="onFocusBlank(this,'Name');" onchange="insertData();"/></Td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
				  ...
				  <Td>+91 
	  <input name="Phone" id="Phone" type="text"  value="" style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();" maxlength="10"  /></Td>
				  </tr>
				   <tr>
		  <td colspan="2"><div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:11px;"></div></td>
				...
				<tr align="left">
				  ...
				  <Td><input name="Email" id="Email" type="text" value="" style="width:140px; "  onblur="onBlurDefault(this,'Email Id');" onFocus="removetooltip();"  onChange="insertData();"/></Td>
				  </tr>
				<tr align="left">
