...
<title>Fullerton Personal Loan</title>
          ...
          <tr>
			...
			<tr>
			     <td height="8"></td>
				  ...
				  <tr>
                <td height="25" class="bldtxt" style="font-size:13px; font-family:Verdana, Arial, Helvetica, sans-serif; " >Fullerton Personal Loans Features
</td>
              </tr>
              <tr>
                <td><table width="550" border="0" cellspacing="0" cellpadding="0" >
                  <tr>
                    <td align="left"><table width="494"   border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="44" height="22" align="right" valign="middle"><b>1)</b></td>
                        <td width="450">&nbsp; Loans for salaried and Self Employed.</td>
                      </tr>
                      <tr>
                        <td width="44" height="22" align="right" valign="middle"><b>2)</b></td>
                        <td>&nbsp; Loan from 40000 to 10,00,000.</td>
                      </tr>
					  <tr>
                        <td width="44" height="22" align="right" valign="middle"><b>3)</b></td>
                        <td>&nbsp; Rate of interest from 19-30%.</td>
                      </tr>
					  <tr>
                        <td width="44" height="22" align="right" valign="middle"><b>3)</b></td>
                        <td>&nbsp; India number one non banking financial personal loan company.</td>
                      </tr>
                  ...
                  <tr>
                    <td width="644" style="padding-left:10px; "><table width="99%"  border="0" cellspacing="0" cellpadding="0">
					 ...
					 <tr>
                        ...
                        <td width="589"><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Compare other Banks quotes with Fullerton Personal Loan.</div></td>
                      </tr>
                      <tr>
                        <td width="34" height="40" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        ...
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Personal Loan Quotes are free for customers. It's a totally free service for customers. All loans repayment period are over 6 months. No short term loans.</div></td>
                      </tr>
                      <tr>
                        <td width="34" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
...
<input type="hidden" name="source" value="P0F0L"> 
	  ...
	  <input name="Phone" id="Phone" type="text"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?>style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();" maxlength="10"  /></Td>
		  ...
		  <td colspan="2"><div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:11px;"></div></td>
				...
				<tr align="left">
				  ...
				  <Td><select style="width:142px; height:18px;  "  name="City" id="City" onchange="othercity1(this); insertData(); addhdfclife();"  >
        <?=plgetCityList($City)?>
      </select>
				...
				<tr align="left">
				  ...
				  <Td><input name="City_Other" id="City_Other" type="text" value="Other City" style="width:140px; " onblur="onBlurDefault(this,'Other City');"  onfocus="onFocusBlank(this,'Other City');" disabled onKeyUp="searchSuggest();"  /><div id="CityOLayer"></div></Td>
				  </tr>
				<tr align="left">
