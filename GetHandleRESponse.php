			...
			if ($ResResult == 'CAPTURED' || $ResResult == 'APPROVED')
			{
				...
				*/
				...
				//===================PARAMETER VALIDATION CONDITION END=========================================
					...
					$ReqTranportalId = "<id>90003023</id>";
...
//				$Resudf1
		...
		AND THEN REDIRECT CUSTOMER ON RESULT PAGE
		*/
		$REDIRECT = 'REDIRECT=http://www.deal4loans.com/FailedTRAN.php?Message=Transaction Failed&ResTrackId='.$ResTrackID.'&ResAmount='.$ResAmount.'&ResError='.$ResErrorText.'&Rid='.$Rid.'&Pid='.$Pid;
		echo $REDIRECT;
		}
	}
	else
