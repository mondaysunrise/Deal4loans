...
var queryString = "?nwLA=" + nwLA +"&tenure=" + tenure + "&countr=" + countr + "&hdfcCity=" + hdfcCity + "&krcFlag=" + krcFlag + "&compCategory=" + compCategory + "&carName=" + carName;
		//alert(queryString);	
...
<div class="navy-header"><div style=" padding:20px 0px 0px 0px;"><span class="navy-body_text_a" style="padding-right:7px;">HDFC Bank offers you complete package of</span><span class="tata-body_text_b" style="padding-left:0px; font-size:20px; !important">timely service,</span>
    <br />
...
<tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="25" style=" background:url(new-images/specification-bg.jpg) repeat-x;"class="white_text">Car Video</td
	><tr>
       <tr>
      <td  style="background:url(new-images/hdfcapp/specification-bg1.jpg) repeat-x;"><table width="100%" border="0" cellpadding="4" cellspacing="2" height="200">
  <tr>
...
<tr><td colspan="4"><input type="hidden" name="newj" id="newj" value="<? echo $j; ?>" />
...
<input type="hidden"  name="hdfc_carprice_<? echo $j; ?>" id="hdfc_carprice_<? echo $j; ?>" value="<? if($hdfc_city=="Delhi") { echo $hdfc_car_price_delhi[$j]; } else { echo $hdfc_car_price[$j]; } ?>" /></td></tr>
  <tr>
...
?>
  ...
  <div id="navigation" style="display:none; vertical-align:top; padding-top:-100px;">
	...
	<div align="center" class="body_text_nw" style="padding-top:15px;" ><table width="900" style="border:#CCCCCC thin solid;"align="center" cellpadding="0" cellspacing="0">
       <tr>
       ...
       <tr>
        ...
        <table width="900" style="border:#CCCCCC thin solid;" align="center" cellpadding="0" cellspacing="0" border="1">    
        <tr><?php
		...
		for($gS=0;$gS<$numGiftsQuery;$gS++)
		{
			...
			echo '<td align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:10px; color:#0000FF;" width="120">';
