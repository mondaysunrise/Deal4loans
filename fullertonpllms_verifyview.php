...
{
	var gifName = form;
	document.frmsearch.action="fullertonpllms_verifyview.php?search=y"+gifName;
...
if (restore) selObj.selectedIndex=0;
 ...
 <form name="frmsearch" action="fullertonpllms_verifyview.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
 ...
 <?
		$qry="Select fullertonrequestID From Fullerton_Allocated_Leads Where (((Fullerton_Allocated_Leads.Dated Between '".$min_date."' and '".$max_date."')) and Fullerton_Allocated_Leads.approved=1)";
 ...
 ?>
   ...
   <tr>   
	...
	<?
		...
		$qry="Select *  From Fullerton_Allocated_Leads Where (((Fullerton_Allocated_Leads.Dated Between '".$min_date."' and '".$max_date."')) and Fullerton_Allocated_Leads.approved=1)";
		$qry=$qry.$FeedbackClause;
		$qry=$qry."group by Fullerton_Allocated_Leads.RequestID";
