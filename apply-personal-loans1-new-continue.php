<?php
	...
	$ctySql = "Select City,CC_Holder,RequestID,Employment_Status from Req_Loan_Personal Where (RequestID=".$_SESSION['Temp_LID'].")";
	list($Getnum,$ctyrow)=Mainselectfunc($ctySql,$array = array());


	//$ctyrow['Employment_Status'] = 1;
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="pl_cont_text" style="color:#136071;">Share few more details to get exact quote on Emi,Rates &amp; Loan Amount.</div>
  ...
  <form name="personalloan_form"  action="insert_personal_loan_httpsvaluestep2.php" method="POST" onSubmit="return submitform(document.personalloan_form); ">
