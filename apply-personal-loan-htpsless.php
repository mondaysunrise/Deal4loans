...
$ctySql = "Select City,CC_Holder,RequestID,Employment_Status,EMI_Paid from Req_Loan_Personal Where (RequestID=".$_SESSION['Temp_LID'].")";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><form name="personalloan_form"  action="insert_personal_loan_httpsvaluestep2.php" method="POST" onsubmit="return submitform(document.personalloan_form); ">
      ...
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="35%" height="35" align="left" class="bldtxt">Primary Account 
            in which bank?  </td>
          <td width="65%" height="20"  align="left"><input type="text" style="width:200px;" name="Primary_Acc" id="Primary_Acc" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event); getstatementlink();" onchange="getstatementlink();" onkeydown="getstatementlink();" onclick="getstatementlink();"></td>
          </tr>
        <? if($ctyrow['Employment_Status']==0) 
		   { 
		   } else 
