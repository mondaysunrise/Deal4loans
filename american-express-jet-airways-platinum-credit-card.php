...
<title>Jet Airways American Express Platinum Credit Card </title>
...
function addProfessionalDetails()
{
	...
	ni2.innerHTML ='<div class="crdit_card_box" style="margin-top:2px;"> <img src="images/american-express-jet-airways2.png" width="196" height="137"></div><div class="crdit_card_box"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td height="25" style="border-bottom:#a41b29 solid thin;"><span class="form_head_text">Jet Airways American Express Platinum Credit Card </span></td></tr><tr><td>&nbsp;</td></tr>  <tr>    <td valign="top" class="bullet_text"><ul>      <li> Complimentary access to American Express Platinum Lounges at Delhi and Mumbai Domestic Airports.</li>      <li>Enjoy complimentary membership to Priority Pass, with the US$99 annual membership fee waived off exclusively for you.</li>      <li> Enjoy Dedicated Check in & Excess Baggage Waiver of 10kg on Jet Airways and JetKonnect flights within India.</li>    </ul></td>  </tr>  <tr>  <td valign="middle" height="35" class="form_head_text" style="text-align:left;">Jet Airways &amp; JetKonnect Privileges</td></tr>  <tr>    <td valign="top" class="bullet_text"><ul>    <li> Enjoy 5% discount on Base Fare for revenue ticket bookings made on jetairways.com or jetkonnect.com </li>    <li> Get 25% Base Fare discount on one Domestic Business Class Companion Ticket <span style="font-size:10px;">(valid till November 30, 2013).</span></li>    <li>Enjoy exclusive offers on travel, dining, shopping and entertainment around the world, with American Express Global Selects.</li>    </ul></td>  </tr></table></div>';
...
function addexistingCustDetails()
{
	var ni1 = document.getElementById('existingCustDetails');
		ni1.innerHTML = '<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td height="32" class="form_body_text">Provide your Membership Number </td>    <td height="32" class="form_body_text"><input class="pl_input-box" type="text" name="membership_number"  maxlength="12" onkeypress="intOnly(this);" onkeyup="intOnly(this);"></td>    </tr>  <tr>    <td height="32" class="form_body_text">Select your membership tier</td><td height="32" class="form_body_text"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td height="32" class="form_body_text"><input type="radio" name="membership_tier" id="membership_tier" value="Platinum" /> Platinum</td><td><input type="radio" name="membership_tier" id="membership_tier" value="Gold" /> Gold</td></tr><tr><td><input type="radio" name="membership_tier" id="membership_tier" value="Silver" /> Silver</td><td><input type="radio" name="membership_tier" id="membership_tier" value="BluePlus" /> BluePlus</td><tr><td colspan="2"><input type="radio" name="membership_tier" id="membership_tier" value="Blue" /> Blue</td></tr></table></td>  </tr></table>';
	
	
}

function addexistingCustDetailsCancel()
{
	var ni1 = document.getElementById('existingCustDetails');
...
<body>
<form action="american-express-jet-airways-platinum-credit-card-continue.php" method="post" name="cc_form" onSubmit="return chkform();">
...
<div class="left_inner_text_bx" style="margin-top:6px;">Jet Airways American Express Platinum Credit Card </div>
<div class="filed-box">
...
<div class="rightbox form_text" id="professionalContent">The Annual Membership Fee for the Jet Airways American Express Platinum Credit Card is Rs.10,000 plus service tax.
<div class="bullet_text">
<ul>
<li>Get a Welcome Gift of 20,000 Bonus JPMiles + one-way complimentary Jet Airways Base Fare Waived Domestic Ticket on your first charge</li>
<li>
  Enjoy complimentary membership to the American Express Platinum Lounges at Delhi &amp; Mumbai Domestic Airports</li>
</ul>
</div>
<div class="crdit_card_box" style="margin-top:2px;"> <img src="images/american-express-jet-airways.png" width="156" height="109"></div>
