...
$plfb_alldetails = d4l_ExecQuery("select Allocation_Date,Asm_Comments,AsmID,smsflag,Feedback,Followup_Date,Comments,caller_name from client_lead_allocate Where (AllRequestID=".$requestid."  and `Reply_Type`=2)");
