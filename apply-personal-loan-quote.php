...
<title>Personal Loans - Compare Lowest Rates</title>
...
{
	//alert('hello');
		var ni2 = document.getElementById('myDivOC');
		...
		if(ni2.innerHTML=="")
		{
			...
			if(document.personalloan_form.City.value=="Others")
			{
				...
				ni2.innerHTML = '<table width="100%"><tr align="left">				  <Td height="26" class="bldtxt" width="110">Other City </Td>				  <Td><input name="City_Other" id="City_Other" type="text" value="Other City" style="width:140px; " onblur="onBlurDefault(this,\'Other City\');"  onfocus="onFocusBlank(this,\'Other City\');" /></Td> </tr></table>';
			}
			else
			{
				ni2.innerHTML="";
		...
		else
	{
		if(document.personalloan_form.City.value=="Others")
			{
				//alert(document.personalloan_form.City.value);
				ni2.innerHTML = '<table width="100%"><tr align="left">				  <Td height="26" class="bldtxt" width="90">Other City </Td>				  <Td><input name="City_Other" id="City_Other" type="text" value="Other City" style="width:140px; " onblur="onBlurDefault(this,\'Other City\');"  onfocus="onFocusBlank(this,\'Other City\');" disabled  /></Td> </tr></table>';
			}
			else
			{
				ni2.innerHTML="";
...
{
	var ni5 = document.getElementById('myDivOccup');
		//alert("hello");
		if(ni5.innerHTML=="")
		{
		//alert(document.personalloan_form.Employment_Status.selectedIndex);
			if(document.personalloan_form.Employment_Status.selectedIndex==1 || document.personalloan_form.Employment_Status.selectedIndex==2)
			{
				//alert(document.personalloan_form.City.value);
				ni5.innerHTML = '<table width="100%"><tr align="left"> <Td height="26" class="bldtxt">Company Name </Td>				  <Td><input name="Company_Name" id="Company_Name" type="text" style="width:130px; "  onBlur="onBlurDefault(this,\'Company Name\');"  onFocus="onFocusBlank(this,\'Company Name\');"  onKeyUp="ajax_showOptions(this,\'getCountriesByLetters\',event)" /></Td></tr>				<tr align="left">  <Td height="26" class="bldtxt">Annual Income </Td>  <Td><input name="IncomeAmount" id="IncomeAmount" type="text"  style="width:130px; " onFocus="this.select();"  onChange="intOnly(this); addDiv();"  onKeyUp="intOnly(this);PlgetDigitToWords(\'IncomeAmount\',\'formatedIncome\',\'wordIncome\'); addDiv();" onKeyPress="intOnly(this); PlgetDigitToWords(\'IncomeAmount\',\'formatedIncome\',\'wordIncome\');" onBlur="PlgetDigitToWords(\'IncomeAmount\',\'formatedIncome\',\'wordIncome\'); "/>				  </Td>				  </tr>				  <tr>  <td colspan="2" align="left">	<span id="formatedIncome" style="font-size:11px; font-weight:bold;color:666699;font-Family:Verdana;"></span>	<span id="wordIncome" style="font-size:11px;font-weight:bold;color:666699;font-Family:Verdana;text-transform: capitalize;   margin-left:10px; margin-bottom:5px;"></span></td>				  </tr>				<tr align="left">				  <Td height="26" class="bldtxt">Loan Amount </Td>				  <Td><input name="Loan_Amount" id="Loan_Amount" type="text"  style="width:130px; " onFocus="this.select(); onBlurDefault(this,\'Loan Amount\');" onChange="intOnly(this);"  onKeyUp="intOnly(this);PlgetDigitToWords(\'Loan_Amount\',\'formatedlA\',\'wordloanAmount\');"  onKeyDown="PlgetDigitToWords(\'Loan_Amount\',\'formatedlA\',\'wordloanAmount\');" onKeyPress="intOnly(this); PlgetDigitToWords(\'Loan_Amount\',\'formatedlA\',\'wordloanAmount\');" onBlur="PlgetDigitToWords(\'Loan_Amount\',\'formatedlA\',\'wordloanAmount\'); onBlurDefault(this,\'Loan Amount\'); onBlurDefault(this,\'Loan Amount\');">				</Td>				  </tr>				  <tr>				  <td colspan="2" align="left">  <span id="formatedlA" style="font-size:11px; font-weight:bold;color:666699;font-Family:Verdana; "></span><span id="wordloanAmount" style="font-size:11px;font-weight:bold;color:666699;font-Family:Verdana;text-transform: capitalize; margin-left:10px; margin-bottom:5px;"></span></td> </tr><tr align="left">				  <Td height="26" class="bldtxt" >Are you a Credit card holder?</td> <Td><input type="radio"  name="CC_Holder" id="CC_Holder" value="1"  style="border:none;" onclick="addElement();" >Yes<input type="radio"  name="CC_Holder" id="CC_Holder" style="border:none;" value="0" onClick="removeElement();">No</Td>				  </tr>				<tr align="left">				  <Td colspan="2" ><div  id="myDiv"></div></Td>		  </tr></table>';
			}
			else
			{
				ni5.innerHTML="";
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="167" align="left" valign="top"><img src="new-images/pl/hdr5-new.gif" width="161" height="167" /></td>
            <td height="167" align="left" valign="top"><img src="new-images/pl/hdr6-new.gif" width="158" height="167" /></td>
            ...
            <td colspan="4"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0" style="border:2px solid #def3f8; ">
                  <tr>
                    <td style="padding-left:15px; "><table width="98%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="30" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Deal4loans.com has tie ups with all Personal loan Banks in India.</div></td>
                      </tr>
					  <tr>
                        <td width="30" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Your contact details will not be shared with any Bank, Unless you Apply after quote in next stage.</div></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
              ...
              <tr>
                <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="100"><b>Loan Partners</b></td>
                    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><img src="new-images/pl/barclays.jpg" width="96" height="25" /></td>
                          <td><img src="new-images/pl/hdfc.jpg" width="99" height="29" /></td>
                          <td><img src="new-images/pl/partner_fullerton.gif" width="90" height="26" /></td>
                          <td><img src="new-images/pl/sbi.gif" width="97" height="24" /></td>
                          <!--<td><img src="new-images/pl/partner_citifinancial.gif" width="94" height="25" /></td>-->
                        </tr>
                    </table></td>
                  </tr>
                </table>                  </td>
...
<input type="hidden" name="source" value="PostPaid Sent1"> 
	  ...
	  <input name="Phone" id="Phone" type="text"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?>style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();" maxlength="10"  /></Td>
		  ...
		  <td colspan="2"><div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:11px;"></div></td>
				...
				<tr align="left">
				  ...
				  <Td><select style="width:142px; height:18px;  "  name="City" id="City" OnChange="addOtherCity();"  >
        <?=plgetCityList($City)?>
      </select>
 
	  </Td>  </tr>
				  <tr align="left">
				  <Td colspan="2" ><div  id="myDivOC"></div></Td>
		  </tr>
				<!---->
				<tr align="left">
        ...
        <option value="0">Self Employed</option>
				  ...
				  <Td colspan="2" ><div  id="myDivOccup"></div></Td>
		  </tr>-->
				<tr align="left">
...
No</Td>
				...
				<tr align="left">
				  <Td colspan="2" ><div  id="myDiv"></div></Td>
					...
					<tr align="left">
				  <Td height="50" colspan="2" style="font-size:9px;"><input type="checkbox"  name="accept" style="border:none;" checked  > I have read the <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and agree to the <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a><br /></Td>
