...
?>
<link href="http://www.deal4loans.com/css/pl-formcity-loan-styles.css" type="text/css" rel="stylesheet" />
...
<input type="hidden" name="source" value="<? echo $newsource; ?>">
    ...
    <div class="blmainform" id="self-employed-frm">
      <div class="newui-left">
        <strong class="pl-h2" style="color:#FFF !important;"><?php if((strlen(strpos($_SERVER['REQUEST_URI'], "/personal-loan/")) > 0)) { ?>
Get lowest interest rates on Personal loan in <?php echo $City; ?> from top 10 Banks
<? }
else 
{ ?>
Get lowest interest rates quote on Personal loan in <?php echo $City; ?> from top 10 Banks
<? } ?></strong>
      </div>
      <div class="offerimg"><a href="http://www.deal4loans.com/lowestratequote.php" style="text-decoration:none;" target="_blank"><img src="http://www.deal4loans.com/new-images/apply-personal-loan-continue-final.jpg" width="203" height="58" border="0" /></a></div>
      ...
      <div id="SelfEmployee">
        <div class="blmainforminn margin-top-business-loan" id="running-business-ar" style="display:none;">
          ...
          <div class="inputwrapprer">
            ...
            <label for="running_business1" class="css-label radGroup2 margin-radio">Less Than 2 Yrs</label>
          ...
          <div class="inputwrapprer">
            ...
            <label for="running_business3" class="css-label radGroup margin-radio">3 To 5 Yrs</label>
        ...
        <div class="blmainforminn margin-top-business-loan" id="annual-ancome-ar" style="display:none;">
          ...
          <div class="inputwrapprer">
            ...
            <label for="IncomeAmount4" class="css-label radGroup2 margin-radio">5 Lacs & Above</label>
        ...
        <div class="blmainforminn margin-top-business-loan" id="annual-turnover-ar" style="display:none;">
          ...
          <div class="inputwrapprer">
            ...
            <label for="Annual_Turnover2" class="css-label radGroup2 margin-radio" >50 Lacs To 1 Cr</label>
          </div>
          <div class="inputwrapprer">
        ...
        <div class="blmainforminn" id="credit-card-ar" style="display:none;">
          ...
          <div id="holding-card-ar" style="display:none;">
            ...
            <div class="inputwrapprer">
              ...
              <label for="Card_Vintage3" class="css-label radGroup2 margin-radio">9 To 12 Months</label>
              <input type="radio"name="Card_Vintage" id="Card_Vintage4" value="4" class="css-checkbox" onClick="validateDiv('CardVintageVal')"/>
              <label for="Card_Vintage4" class="css-label radGroup2 margin-radio2" >More Than 12 Months</label>
