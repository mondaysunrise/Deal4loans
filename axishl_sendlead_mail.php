...
function retrivedataforcitifin()
	...
	$citifinquery="SELECT Property_Identified,Employment_Status,Name,DOB,Email,Company_Name,City,City_Other,Pincode,Mobile_Number,Net_Salary,Add_Comment,Loan_Amount,Property_Loc,Allocation_Date FROM Req_Feedback_Bidder_HL,Req_Loan_Home WHERE (Req_Feedback_Bidder_HL.AllRequestID=Req_Loan_Home.RequestID and Req_Feedback_Bidder_HL.BidderID=2414 and Req_Feedback_Bidder_HL.Reply_Type=2 and Req_Feedback_Bidder_HL.Allocation_Date Between '".($min_date)."' and '".($max_date)."')  ";
...
$newToday = date('d')."".date('m')."".date('y');
	...
	$newfileatt = "/home/deal4loans/public_html/AxisBank/axisbank".$newToday.".xls";
...
$to = "Prateek.Jadhav@axisbank.com,balbir.singh@deal4loans.com"; 

       $from = "Deal4loans <no-reply@deal4loans.com>"; 
        $subject = "HomeLoan Leads @ deal4loans.com".$newToday; 
    
       
	   $fileatt = "/home/deal4loans/public_html/AxisBank/axisbank".$newToday.".xls";
