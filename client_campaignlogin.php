<?php
	...
	{
			if($Email=="mahindralifespace@d4l.com" && $PWD=="mahindrals")
			{
				$_SESSION["client_name"] = "mahindra_lifespace";
				$_SESSION["UserType"] = "bidder";
				$_SESSION['UName'] = "Mahindra";
			}
			...
			else
		{
			...
			$Msg =  "** You are not Authorized. Please try again **";
		  		 ...
		  		 $strDir = dir_name();
			header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."client_campaignview.php");
			exit;
