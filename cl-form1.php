...
<h1 class="text3" style=" color:#FFF; font-size:24px; text-transform:none; "><strong>Apply <?php echo $subjectLine; ?></strong></h1>
<div class="text3" style="float:left; width:575px; font-size:24px; color:#FFF; text-transform:none; margin-top:11px" id="imgDisplay"><img src="/images/animated_cl.gif"  /></div>
</div>
...
<div class="pl_input_box">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td height="25" ><select name="City" id="City" class="pl_select_b" onChange="addhdfclife(); validateDiv('cityVal');" tabindex="3">
<?=plgetCityList($City)?>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td height="25">
      <input type="text" name="Net_Salary" id="Net_Salary" class="pl_input_b" onKeyUp="intOnly(this); getDiToWordsIncome('Net_Salary','formatedIncome','wordIncome');" onKeyPress="addPersonalDetails(); intOnly(this);"  onblur="getDiToWordsIncome('Net_Salary','formatedIncome','wordIncome');"  onchange="ShowHide('incomeShow','Net_Salary');" tabindex="4" autocomplete="off" onkeydown="validateDiv('netSalaryVal');" />
