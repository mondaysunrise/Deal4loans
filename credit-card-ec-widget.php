...
function addhdfclife()
{
	...
	var cit = document.creditcard_form.City.value;
	var txtview= '<div style="margin-left:20px;"><table  style="border:1px solid #FFF; padding:2px;"><tr><td colspan="2" class="frmbldtxt" style="font-family:verdana; font-size:10px; color:#ffffff; font-weight:normal; " height="20"><span style="color:#FF0000;">(Optional) </span>Special service only for Deal4loans customers:</td></tr> <tr><td width="23"><input type="checkbox"  name="hdfclife" id="hdfclife" value="1"/></td> <td width="611" class="frmbldtxt" style="font-family:verdana; font-size:10px; color:#ffffff; font-weight:normal; "> I would like to avail of <b>FREE </b>financial planning services by <b>Insurance & Investment experts</b> from HDFC Life.</td>		 </tr>	 </table></div>';	
...
if(document.creditcard_form.Employment_Status.value==0)
	...
	ni3.innerHTML = '<div style="clear:both;"></div><div class="p-details termtext">  <input name="accept" type="checkbox" checked="checked" />I authorize Deal4loans.com & its partnering banks to contact me to explain the product & I Agree to <a href="/Privacy.php" target="_blank" rel="nofollow"   style=" color:#FFF; text-decoration:underline;">Privacy policy</a> and <a href="/Privacy.php" target="_blank" rel="nofollow"  style=" color:#FFF; text-decoration:underline;">Terms and Conditions</a>. <div id="acceptVal"></div></div><div class="cc_bnt_b"> <input type="submit" class="cc-get-quotebtn" value="Get Quote"/></div> <div style="clear:both;"></div> <div id="hdfclife"></div>                    <div style="clear:both;"></div>';
}
