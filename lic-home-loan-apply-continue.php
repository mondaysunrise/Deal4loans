...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($Activate>0)
	{
		...
		$tomorrow  = mktime(0, 0, 0, date("m")  , date("d")-30, date("Y"));
			...
			$getdetails="select RequestID From ".$Type_Loan."  Where ( Mobile_Number not in (9971396361,9811215138,9999047207,9891118553,9999570210) and Mobile_Number='".$Phone."' and Updated_Date between '".$days30datetime."' and '".$currentdatetime."') order by RequestID DESC";
      ...
      <tr>
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<td height="25"  style=" padding-left:10px; " ><div style="color:#5e5e5e; font-size:13px; font-weight:bold;line-height:24px;  ">Features & Benefits of LIC Housing Home Loan</div></td>
              </tr>
              <tr>
                <td height="25"  style="padding-left:15px; " ><table width="550" border="0" cellspacing="0" cellpadding="0" style="border:2px solid #def3f8; ">
                  <tr>
                    <td ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="35" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#5e5e5e; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  "> Lowest rates from 10.65% - 12%.</div></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
