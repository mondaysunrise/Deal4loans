		...
		$_SESSION['last_inserted_value'] = $last_inserted_value;
 		  ...
 		  ExecQuery($sqlTrackBidder);
			...
			elseif($_SESSION['BidderID']==6492)
              ...
              elseif($_SESSION['BidderID']==5933 || $_SESSION['BidderID']==5934 || $_SESSION['BidderID']==7102 || $_SESSION['BidderID']==7103 || $_SESSION['BidderID']==7179  || $_SESSION['BidderID']==7185 || $_SESSION['BidderID']==7499 || $_SESSION['BidderID']==7522 || $_SESSION['BidderID']==5023 || $_SESSION['BidderID']==1888)
				{
					header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."bidders_hdfc_index.php");
					exit;
				}
			elseif($_SESSION['leadidentifier']=="CallerAccount" || $_SESSION['leadidentifier']=="Fullertonpllms" || $_SESSION['leadidentifier']=="Fullertonpllms7444"  || $_SESSION['leadidentifier']=="Fullertonpllms4665")
				{
	 ...
	 <tr>
		<td style="padding-top:15px;">
			<table  width="669" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#45B2D8" >
				...
				<tr>
				  <td width="669" height="174" align="left" valign="top" bgcolor="#45B2D8"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="52" align="center"  ><h1 style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#052733; line-height:18px; font-weight:bold;">
	&nbsp;</h1></td>
  </tr>
  <tr>
    <td  style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#052733; line-height:18px;">
	&nbsp;</td>
  </tr>
</table>
</td>
