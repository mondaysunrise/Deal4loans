...
else
{
    ...
    $titles = array(
		'5498' => 'Indranil.Mukharjee@Tata-bss.com',
		'6090' => 'Mohammed.Siraj@Tata-bss.com',
		'5499' => 'Ujjwal.Singh@Tata-bss.com',
		'6091' => 'Divya.Sharma@Tata-bss.com',
		...
		//'5500' => 'Kiran.B@tatacapital.com,vikas.khapne@TataCapital.Com,Anirban.Chakraborty@Tata-bss.com,Dhirendra.Bashani@tatacapital.com,Jayesh.Kambli@e-nxt.com'
		 );
...
function getReqemailCCValue($pKey){
    $titles = array(
		'5498' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com',
		'6090' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com',
		'5499' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com',
		'6091' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com',
		'6092' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com',
		'6097' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com',
		'6098' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com',
		'6099' => 'Siddhesh.Sawant@Tata-bss.com,Akshay.Kapse@Tata-bss.com'
...
function retrivedatafortata()
{
	...
	{
		$min_date=$Today." 12:00:00";
		$max_date=$Today." 14:59:59";
	}
	elseif($time>15 && $time<=18)
	{
		$min_date=$Today." 15:00:00";
	...
	$hdfchl = array('5498','6090','5499','6091','6092','6097','6098','6099');
	...
	$newfileatt = "/home/deal4loans/public_html/hldwnld/tatacpital5500pl".$cityname."".$newToday.".xls";
	...
	function sendexcelfileattachment($emailid,$session_id,$emailid, $ccemailid, $cityname)
	{
		...
		$fileatt = "/home/deal4loans/public_html/hldwnld/tatacpital5500pl".$cityname."".$newToday.".xls";
		$fileatttype = "application/xls"; 
		$fileattname = "tatacpital5500pl".$cityname."".$newToday.".xls";
		...
		//$headers .= "Cc:	Kiran.B@tatacapital.com,vikas.khapne@TataCapital.Com,Anirban.Chakraborty@Tata-bss.com,Dhirendra.Bashani@tatacapital.com,Cdatar.prj@tatacapital.com,Harshita.jain@deal4loans.com"."\n";
$headers .= "Cc:Harshita.jain@deal4loans.com"."\n";
