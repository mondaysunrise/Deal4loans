        ...
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="682"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
			 <tr>
            <td colspan="4"><img src="http://www.deal4loans.com/new-images/d4l-sml-logo.gif" alt="Deal4loans"  onclick="javascript:location.href='http://www.deal4loans.com/'" height="73px"/></td></tr>
              <tr>
              ...
              <tr>
                <td><table width="620" border="0" cellspacing="0" cellpadding="0" style="border:2px solid #def3f8; ">
                  <tr>
                    <td width="590" style="padding-left:15px; "><table width="100%"  border="0" cellspacing="0" cellpadding="0">
					
					<tr>
                        <td width="33" height="40" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td width="523"><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Get instant personal loan of Upto 30 lacs without any collateral.</div></td>
                      </tr>
					  <tr>
                        <td width="33" height="40" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Renovation of your home, down payment of your flat or purchase of a plot.</div></td>
                      </tr>
					 <tr>
                        <td width="33" height="40" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
                        <td><div style="color:#7e5a09; font-size:13px; font-weight:bold; background-color:#f6fcfd; line-height:24px;  ">Over 7 lakh customers have taken quote at Deal4loans.com</div></td>
                      </tr>
                                          <tr>
                        <td width="33" height="35" align="center" valign="middle"><img src="new-images/pl/arrow.gif" width="20" height="22" /></td>
              ...
              <tr>
               ...
               <tr>
                <td  ><img src="http://www.deal4loans.com/new-images/pl_quote_n.jpg" style="border:1px solid #333333;"></td>
              </tr>
            </table></td>
            </tr>
        </table></td>
...
<input type="hidden" name="source" value="postpaid-mailer"> 
	  ...
	  <input name="Phone" id="Phone" type="text"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?>style="width:110px; " onChange="intOnly(this); tosendsms(); insertData();" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" onFocus="addtooltip();" maxlength="10"  /></Td>
		  ...
		  <td colspan="2"><div id="myDiv1" style="color:#7d0606; font-family:Verdana; font-size:11px;"></div></td>
				...
				<tr align="left">
				  ...
				  <Td><select style="width:142px; height:18px;  "  name="City" id="City" onchange="othercity1(this); addibibo(); insertData(); "  >
        <?=plgetCityList($City)?>
      </select>
...
No</Td>
				...
				<tr align="left">
				  <Td colspan="2" ><div  id="myDiv"></div></Td>
					...
					<tr align="left">
				  <Td  Height="45" colspan="2" style="font-size:9px;"><input type="checkbox"  name="accept" style="border:none;" checked  > I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a>.</Td>
				  </tr>
