...
//$qrysql="SELECT Name,RequestID,Mobile_Number FROM ".$feedback_tble.",".TABLE_REQ_CC." LEFT OUTER JOIN Req_Feedback_CC ON Req_Feedback_CC.AllRequestID=".TABLE_REQ_CC.".RequestID AND Req_Feedback_CC.BidderID in ".$BidderIDstatic." WHERE ".$feedback_tble.".AllRequestID=".TABLE_REQ_CC.".RequestID and ".$feedback_tble.".BidderID in ".$BidderIDstatic." and ".$feedback_tble.".Reply_Type=4 and ( ".$feedback_tble.".Allocation_Date Between '".$currentdate." 00:00:00' and '".$todaydate." 23:59:59' or Req_Feedback_CC.Followup_Date Between '".$currentdate." 12:00:00' and '".$todaydate." 23:59:59')";

$qrysql="SELECT Name,RequestID,Mobile_Number FROM ".$feedback_tble." LEFT OUTER JOIN ".TABLE_REQ_CC." ON ".$feedback_tble.".AllRequestID=".TABLE_REQ_CC.".RequestID WHERE ".$feedback_tble.".AllRequestID=".TABLE_REQ_CC.".RequestID and ".$feedback_tble.".BidderID in  ".$BidderIDstatic." and ".$feedback_tble.".Reply_Type=4 and ".$feedback_tble.".leadid >=45890";
echo $qrysql."<br>";
$qrysqlresult = ExecQuery($qrysql);
echo mysql_num_rows($qrysqlresult);
//exit();
