<?php
	...
	//require 'get_affliate_costcut.php';


$_SESSION['Partner_Date']; 
list($partDated,$time) = split(' ', $_SESSION['Partner_Date']);
$Dated=date('Y-m')."-01";
...
{
	var gifName = form;
	document.frmsearch.action="partners_report.php?search=y"+gifName;
...
function chkform()
{
	...
	if(document.frmsearch.min_date.value<"<? echo $partDated; ?>")
	{
		alert("Sorry!!!! Your minimum date is <? echo $partDated; ?>.Please Select.");
		document.frmsearch.min_date.value="";
		document.frmsearch.min_date.focus();
		return false;
	}
...
<tr>
 ...
 <tr><td width="200" valign="top"><?php include '~Partners_Left.php';?></td>
 <td align="center" height="300" valign="top">Welcome</td>
 </tr>
 <tr>
