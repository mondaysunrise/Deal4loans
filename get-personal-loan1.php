...
font-weight:normal; color:#000;font-Family:Verdana;text-transform: capitalize;'></span>
       <div id="netSalaryVal"></div></td>
         ...
         <?=plgetCityList($City)?>
              ...
              <tr>
                <td height="45" colspan="2" align="center"  class="sbi_home_loan_text_c" style="font-weight:normal; font-size:24px; color:#f69900; ">Call us Now @ <strong style=" color:#2f8497; font-size:28px;">1800 3000 1500</strong> <span style="font-size:18px;">Toll Free</span></td>
              </tr>
             <tr>
