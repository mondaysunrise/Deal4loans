...
<link rel="stylesheet" href="css/personal-loan-new.css" type="text/css" />
<style>
.addexpandeddiv{
height:150px;
width:auto;
...
<div id="img-lft"></div>
<div id="img-rgt"></div>
<div class="content-pnl" >Pay your Credit Card Dues</div>
<div  class="content-deal">Get Loan at minimum Interest Rate to pay your Credit Card and other Bills.</div>
...
<div  class="content-deal">The one-stop shop for best on all Personal loan requirements
 ...
 <div class="content-pnl"><?php include 'footer_landingpage.php'; ?></div>


</div>

<form name="personalloan_form"  action="apply-for-personal-loan-continue.php" method="POST" onSubmit="return chkpersonalloan(document.personalloan_form);">
...
<input type="hidden" name="source" value="credit card loan"> 
