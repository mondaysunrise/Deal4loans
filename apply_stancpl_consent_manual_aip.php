...
<html>
    <head>
        ...
        <title>Standard Chartered Bank Manual AIP</title>
        ...
        <section>
            <div class="scb-container pd-top-25">
                <div class="scb-col-left">
                    <form  name="plscb_form" action="/apply_stancpl_continue_manual_aip.php" method="POST" onSubmit="return scbkpersonalloan_test(document.plscb_form);">
						...
						<input type="hidden" name="pl_bank_name" id="pl_bank_name" value="<? echo $pl_bank_name; ?>">
						  ...
						  <div class="scb-form">
                            ...
                            <div class="clearfix"></div>
                            <div class="scb-label-wrapper">Mobile Num</div>
                            <div class="scb-input-wrapper"><input name="Mobile_Number" id="Mobile_Number" type="text" onkeydown="validateDiv('MobileNumVal')"><div id="MobileNumVal" class="alert_msg"></div></div>
                            <div class="clearfix"></div>
                            <div class="scb-label-wrapper">Email</div>
                            <div class="scb-input-wrapper"><input name="Email" id="Email" type="text" onkeydown="validateDiv('EmailVal')"><div id="EmailVal" class="alert_msg"></div></div>
                            <div class="clearfix"></div>
                  ...
                  <?php echo plgetCityList($City);?>
                           ...
                           <div class="clearfix"></div>
                            ...
                            <div class="scb-input-wrapper">
                                <select name="SalaryBank" onchange="validateDiv('SalaryBankVal');">
                                    <option value="0">Select</option>
