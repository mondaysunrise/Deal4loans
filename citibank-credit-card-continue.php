...
if((Form.DOB.value=="")||(Form.DOB.value=="DD/MM/YYYY"))
	...
	{
		document.getElementById('QualificationVal').innerHTML = "<span  class='hintanchor'>Please Select Qualification!</span>";
		Form.Qualification.focus();
		return false;
	}	
if (Form.Designation.selectedIndex==0)
	{
		document.getElementById('DesignationVal').innerHTML = "<span  class='hintanchor'>Please Select Designation!</span>";
