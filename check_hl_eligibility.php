            ...
            <td align="center" valign="top" background="images/hl_rgt-tp-bg.gif" style="background-repeat:no-repeat; width:272px; height:44px; background-position:top;"><table width="100%" height="260" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding-bottom:5px;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td align="center" style="background-color:#EFE6CB; border:3px solid #FFFFFF; border-top:none; padding-bottom:4px; "><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="17" height="20" align="center" valign="middle"><img src="images/hl_arrow.gif" width="11" height="9" /></td>
                            <td width="251" class="subheading" style="font-size:11px;"> Post your Home Loan requirement. </td>
                          </tr>
                          <tr>
                            <td width="15" height="20" align="center" valign="middle"><img src="images/hl_arrow.gif" width="11" height="9" /></td>
                            <td class="subheading" style="font-size:11px;"> Get &amp; Compare Home Loan Offers. </td>
                          </tr>
                          <tr>
                            <td width="15" height="19" align="center" valign="middle"><img src="images/hl_arrow.gif" width="11" height="9" /></td>
                            <td class="subheading" style="font-size:11px;"> Get the Best Deal for your Home Loan. </td>
                          </tr>
                      </table></td>
                    </tr>
                </table></td>
            ...
            <td width="303" align="left" valign="top"><table width="100%" height="270" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="600" align="center" valign="middle" background="images/hl_form_bg.gif" style="background-repeat:no-repeat; width:303px; height:44px; background-position:top;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="40" align="center" class="heading">Apply Home Loan </td>
                      </tr>
                      <tr>
                        <td align="center" style="background-color:#EFE6CB; border:3px solid #FFFFFF; border-top:none; "><form name="loancalc" id="loancalc" method="post" action="check_hl_eligibility_continue.php" onSubmit="return check_form(document.loancalc);" >	 <table width="97%" border="0" align="right" cellpadding="0" cellspacing="0" id="frm">
              <tr>
