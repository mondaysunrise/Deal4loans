<?php
	...
	function formHandler(){
		...
		$result = ("select * from Bidders where Email='$Email' and PWD='$PWD' and BidderID in (2776,2801)");
...
//			if($_SESSION['BidderID']==2776)
			if($_SESSION['BidderID']==277699)
			{
				//header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."hllms_2.php");
				//exit;	
			} 
			else if($_SESSION['BidderID']==2801)
			{
				//header("Location: http://".$_SERVER['HTTP_HOST'].$strDir."hllms_mum.php");
				//exit;
			}
		}
		else{
