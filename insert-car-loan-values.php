    ...
    <head>
        ...
        <script language="javascript">
            function chkform()
            {
                ...
                if ((document.car_loan_verify.Gender[0].checked == false) && (document.car_loan_verify.Gender[1].checked == false))
                {
                    alert("Please choose your Gender: Male or Female");
                    return false;
                }
                if (document.car_loan_verify.Residence_Address.value == "")
                {
                    alert("Please Enter Residence Address");
                    document.car_loan_verify.Residence_Address.focus();
                    return false;
                }
                if (document.car_loan_verify.Pincode.value == "")
                {
                    alert("Please Enter Pincode");
                    document.car_loan_verify.Pincode.focus();
                    return false;
                }
                var a = document.car_loan_verify.Pancard.value;
                ...
                if (regex1.test(a) == false)
                {
                    ...
                    document.car_loan_verify.Pancard.focus();
                    return false;
                }
                if (document.car_loan_verify.Pancard.value.charAt(3) != "P" && Form.Pancard.value.charAt(3) != "p")
                {
                    alert("Please enter correct PAN number");
                    document.car_loan_verify.Pancard.focus();
                    return false;
                ...
                if ((document.car_loan_verify.Pancard.value == ""))
                {
                ...
                <form name="car_loan_verify" action="thank_cl.php" method="post" onSubmit="return chkform();" >
                    ...
                    <div class="hl_emi_cal_form" style="background-color:#0e79b9 !important;">
                        ...
                        <div class="inser_cl_input">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="30%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Gender:</span></td>
                                    <td width="70%"><div class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;" id="contentarea">
                                            <input type="radio" name="Gender" id="Gender" value="1" class="css-checkbox" />
                        ...
                        <div class="inser_cl_input">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="60%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Residence Address:</span></td>
                                    <td width="40%"><div class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;" id="contentarea">
                                            <textarea name="Residence_Address" id="Residence_Address" maxlength="250" onkeypress="return blockSpecialChar(event)" onkeydown="validateDiv('ResiAddVal');" style="width:155px;"></textarea>
                                        </div></td>
                                </tr>
                            </table>
                        </div>
                        <div class="inser_cl_input">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="60%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">Residence Pincode:</span></td>
                                    <td width="40%"><div class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;" id="contentarea">
                                            <input type="text" name="Pincode" id="Pincode" maxlength="6" onkeydown="validateDiv('PincodeVal');" style="width:100px; height:18px;"/>
                                        </div></td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="inser_cl_input">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="60%"><span class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;">PAN No:</span></td>
                                    <td width="40%"><div class="text" style=" float:left; height:auto; color:#FFF; font-size:14px; text-transform:none;" id="contentarea">
                                            <input type="text" name="Pancard" id="Pancard" maxlength="10" onkeydown="validateDiv('PancardVal');" class="form-input" style="text-transform: uppercase;" onkeypress="return blockAllSpecialChar(event)"  />
                                        </div></td>
                                </tr>
                            </table>
                        </div>
