...
{ 
	//echo $agent_user;
	if($lead_identifier=="ICICIBANKREC")
	{
		echo click2call_addlead_dialler3($agent_user, $mobile, $RequestID,1002);
	}
	else if($lead_identifier=="TATACAPITALSALAccount")
	{
		echo click2call_addlead_dialler3($agent_user, $mobile, $RequestID,1012);
	}
	else if($lead_identifier=="INDUSINDSALAccount")
	{
		echo click2call_addlead_dialler3($agent_user, $mobile, $RequestID,1013);
	}
	else
	{
