...
<link href="css/apply-personal-loans1-new.css" type="text/css" rel="stylesheet" />
...
<div class="pl_form_radius_top"><div style="width:80%; float:right; margin-top:2px;">Welcome Rewards
<br>
<span  class="text_2"> Get cash back gifts upto Rs. 13500 on disbursal*</span> </div></div>
...
<div class="pl-right_img_box"><div class="table_sample"><img src="d4limages/apply-pl-main-img-new.jpg" width="461" height="123" class="stepImg"></div>
<div class="pkup">
  <img src="d4limages/sample-table.jpg" width="461" height="79" class="stepImg"> </div>
    ...
    <td><table width="100%" style="border:#6dcbe1 solid thin;" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="35" align="center" bgcolor="#F4F9FC"><img src="d4limages/bullet-why_pl.jpg" style="width:27px; height:21px;" width="27" height="21"></td>
            <td bgcolor="#F4F9FC" class="pl_why_bullet"> It's a totally <span style="font-size:18px; font-weight:bold;">free</span> service for customers.</td>
            </tr>
          <tr>
            <td style="height:5px;"></td>
            </tr>
...
<div style="clear:both;"></div>
<div style="width:98%; margin-top:7px;"><div class="scrolling_box">
<?
$sql = "SELECT Company_Name, Net_Salary, City,City_Other FROM Req_Loan_Home WHERE (Net_Salary >400000 AND Employment_Status =1 AND Allocated =1 and Property_Identified=1 and LENGTH(Company_Name)>10) ORDER BY RequestID DESC  LIMIT 0 , 6";
...
<? if($source=="rediff_160x600banner")
{
	...
	$data = array("banner_name"=>$source , "capture_clicks"=>'1', "ip_address"=>$IP, "dated"=>$Dated );
	$insert = Maininsertfunc ("captute_banner_click", $data);
