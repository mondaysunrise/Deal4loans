...
if (strlen($Phone) > 9) {
    ...
    $getdetails = "select RequestID From Req_Loan_Home  Where ((Mobile_Number='" . $Phone . "' and Mobile_Number not in ('9811555306','9811215138','9717594465','9717594462')) and Updated_Date between '" . $days30datetime . "' and '" . $currentdatetime . "') order by RequestID DESC";
    ...
    if ($alreadyExist > 0) {
        ...
        $dataInsert = array('Name' => $Name, 'Email' => $Email, 'Employment_Status' => $EmpStatus, 'Mobile_Number' => $Phone, 'Dated' => $Dated,  'source' => $Source, 'IP_Address' => $IP, 'Updated_Date' => $Dated, 'Net_Salary'=>$Net_Salary, 'City' => $City, 'wishfin_id'=>$ReqID);
