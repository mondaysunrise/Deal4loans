...
<font face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><strong>
          <?php if(isset($_GET['msg']) && ($_GET['msg']=="NotAuthorised")) echo "Kindly give Valid Details"; ?>
            ...
            <form name="personalloan_form"  action="insert_personal_loan_step1.php" method="POST" onSubmit="return chkpersonalloan(document.personalloan_form);"> 
        ...
        <td  valign="top">
          <table width="286" align="left" cellpadding="0" cellspacing="0" border="0">
            <tr>
              ...
              <? echo $myrow[$ii]["pl_bank_name"];?></td>
            </tr>
            <tr>
              <td height="40" align="center" class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow[$ii]["pl_bank_roi"];?></b></td>
	        </tr>
            <tr>
              <td height="50" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow[$ii]["pl_bank_processing_fee"];?></b></td>
	        </tr>
            <tr>
              <td height="40" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow[$ii]["pl_bank_loan_amt"];?></b></td>
	        </tr>
            <tr>
              <td height="40" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow[$ii]["pl_bank_prepayment"];?></b> </td>
	        </tr>
            <tr>
              <td height="40" align="center"  class="txt-hd" valign="middle" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><b><? echo $myrow[$ii]["pl_bank_disbursal_time"];?></b> </td>
	        </tr>
            <tr>
              <td align="left" height="350" class="txt-hd" valign="top" style="border-right:1px solid #d5cfb1; border-bottom:1px solid #d5cfb1; padding-left:2px;"><? echo $myrow[$ii]["pl_bank_documents"];?> </td></tr>
        </table></td>
           <? 
			   $i=$i+1;
			   }
