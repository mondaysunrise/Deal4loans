...
$getUserDetailsSql = "select Name, Mobile_Number from Req_Loan_Against_Property where RequestID = '".$RequestID."'";
...
?>
http://www.deal4loans.com/dialerclick2calllap.php?RequestID=147236&agent_user=6468