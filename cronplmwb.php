...
require 'scripts/functions.php';
	...
	if(strlen($City)>2 && strlen($Phone)>9)
	{
		...
		{			
			...
			if($callerID>0)
			{			
				$insertAgentQry="INSERT INTO plcallinglms_allocation (AllRequestID, BidderID, Allocation_Date, DOE, status) VALUES ('".$ProductValue."', '".$callerID."', '".$Dated."', '".$Dated."','cronplmwb')";
