...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$cl_bank_name = FixString($_POST["cl_bank_name"]);
...
if (strlen($cl_bank_name)>1 && $requestid>1)
{
	$dataInsert = array('RequestID'=>$requestid,'Name'=>$name,'City'=>$City,'Mobile_Number'=>$Mobile_Number,'DOB'=>$dob,'Gender'=>$gender,'Pancard'=>$panno,'Loan_Amount'=>$loan_amount,'Company_Name'=>$company_name,'Residence_Address'=>$caddress,'Office_Address'=>$paddress,'Gross_Monthly_Salary'=>$net_salary,'Net_Monthly_Salary'=>$salary,'Bank_Name'=>$cl_bank_name,'dated'=>$Dated);
	$ProductValue = Maininsertfunc('Req_Loan_Car_Bankwise', $dataInsert);
}	
?>
...
<div id="container">
  <div id="txt"  style="padding-top:15px; height:60px;">
   <h1 style="color:#ae4212 !important; margin:0px; padding:0px; font-size:13px !important; line-height:22px; padding-left:20px;" align="center"> Thanks for applying Car Loan from <? echo $cl_bank_name; ?> through Deal4loans.com </h1>
 </div>
</div>
