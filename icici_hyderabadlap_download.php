<?
	...
	while($cntr<count($row_result))
		...
		$dataInsert = array("session_id"=>$session_id, "name"=>$row_result[$cntr]["Name"], "dob"=>$dob, "email"=>$row_result[$cntr]["Email"], "emp_status"=>$emp_status, "residential_status"=>$residential_status, "c_name"=>$row_result[$cntr]["Company_Name"], "city"=>$row_result[$cntr]["City"], "city_other"=>$row_result[$cntr]["City_Other"], "total_exp"=>$row_result[$cntr]["Total_Experience"], "std_code"=>$row_result[$cntr]["Code"], "landline"=>$row_result[$cntr]["Land"], "std_code_o"=>$row_result[$cntr]["Std_Code_O"], "landline_o"=>$row_result[$cntr]["Landline_O"], "mobile_number"=>$row_result[$cntr]["Mobile_Number"], "net_salary"=>$row_result[$cntr]["Net_Salary"], "descr"=>$row_result[$cntr]["Descr"], "property_type"=>$property_type, "property_value"=>$row_result[$cntr]["Property_Value"], "loan_amount"=>$row_result[$cntr]["Loan_Amount"], "pincode"=>$row_result[$cntr]["Pincode"], "Feedback"=>$row_result[$cntr]["Feedback"], "count_views"=>$row_result[$cntr]["Count_Views"], "count_replies"=>$row_result[$cntr]["Count_Replies"], "is_modified"=>$row_result[$cntr]["IsModified"], "is_processed"=>$row_result[$cntr]["IsProcessed"], "doe"=>$row_result[$cntr]["Dated"]);
$table = 'temp';
$insert = Maininsertfunc ($table, $dataInsert);
	...
	$qry="select name, dob, email, std_code, landline, std_code_o, landline_o, mobile_number, emp_status, c_name, city, city_other, net_salary, residential_status, descr, property_type, property_value, loan_amount, pincode, Feedback, doe from temp where session_id='".$session_id."'";
