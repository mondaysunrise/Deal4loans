...
{
	var gifName = form;
	document.frmsearch.action="partners_index.php?search=y"+gifName;
...
<tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#45B2D8">
      <tr>
	  <td style="border-right:1px solid #FFFFFF;" valign="top"><?php include '~Partners_Left.php';?></td>
 ...
 <form name="frmsearch" action="partners_index.php?search=y" method="post" onSubmit="return chkform();">
   ...
   <tr>
	...
	if($search=="y")
	{
		...
		{
			$FeedbackClause=" AND (Feedback IS NULL OR Req_Feedback.Feedback='') ";
		}
 ...
 <table width="890" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" >
 <? 
		$search_qry="SELECT * from Req_Partner_PL where (Dated  Between '".($min_date)."' and '".($max_date)."') and Referral_ID = '".$_SESSION['BidderID']."' ";	
		...
		$qry="SELECT * from Req_Partner_PL where (Dated  Between '".($min_date)."' and '".($max_date)."')  and Referral_ID = '".$_SESSION['BidderID']."' ";
...
//		echo"hello".$qry."<br>";
 ...
 ?>
   ...
   <tr>
     ...
     <td width="90" align="center" bgcolor="#FFFFFF" class="style2">Dated</td>
     <td width="130" align="center" bgcolor="#FFFFFF" class="style2">Callcenter Feedback</td>
	 <td width="130" align="center" bgcolor="#FFFFFF" class="style2">Bank Feedback </td>
...
//echo $qry;
   ...
   <tr>
	 ...
	 <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Loan_Amount"]; ?></td>
          <td align="center" bgcolor="#DFF6FF" class="style3"><? echo $row["Dated"]; ?></td>
...
<?
 ...
 function AlffliaTotalCost($get_product,$bidid,$total_disbursed,$loan_disbursed)
{
	//echo "hello";
//echo "<br>".$get_product."<br>".$bidid."<br>".$total_disbursed."<br>".$loan_disbursed;
if($get_product==1)
		{
			//echo "1";
			//echo $bidid;
