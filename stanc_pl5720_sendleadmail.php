...
function main()
{
    ...
    $titles = array(
		'Chandigarh' => 'Vishal.Mahajan@sc.com,rabindar.prasad@sc.com',
		'Delhi' => 'Vishal.Mahajan@sc.com,rabindar.prasad@sc.com',
		'Ahmedabad' => 'MansiBipin.Shah@sc.com,sujeet.tiwari@sc.com',
		'Mumbai' => 'MansiBipin.Shah@sc.com,sujeet.tiwari@sc.com',
		'Kolkata' => 'Rupen.Chowdhury@sc.com',
		'Bangalore' => 'Dhanya.Rai@sc.com,Selva.Kumar@sc.com',
		'Hyderabad' => 'Indira.Vaduka@sc.com,Moushumi.Sheikh@sc.com',
		'Jaipur' => 'Vishal.Mahajan@sc.com,rabindar.prasad@sc.com'
		 );
 ...
 function retrivedataforstanc()
	...
	$stancpl = array('Chandigarh','Delhi','Ahmedabad','Mumbai','Kolkata','Bangalore','Hyderabad','Jaipur');
	
	for($k=0;$k<count($stancpl);$k++)
		 {
		if($stancpl[$k]=="Delhi")
			 {
				$strcity="Delhi','Gurgaon','Gaziabad','Faridabad','Noida";
			 }
			 elseif($stancpl[$k]=="Mumbai")
			 {
				$strcity="Mumbai','Thane','Navi Mumbai";
			 }
			 else
			 {
				$strcity=$stancpl[$k];
	...
	$newfileatt = "/home/deal4loans/public_html/pldwnld/stanc5720".$cityname."".$newToday.".xls";
...
if($recordcount>0)
	...
	function sendexcelfileattachment($emailid,$session_id, $emailid,$cityname)
	{
	    ...
	    $fileatt = "/home/deal4loans/public_html/pldwnld/stanc5720".$cityname."".$newToday.".xls";
        $fileatttype = "application/xls"; 
        $fileattname = "stanc5720".$cityname."".$newToday.".xls";
