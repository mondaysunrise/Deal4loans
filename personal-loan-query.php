...
function	chkpersonalloanMob()
{
    if((document.loan_formMob.Name2.value=="") || (Trim(document.loan_formMob.Name2.value))==false)
	{
        document.getElementById('name2Val').innerHTML = "<span  class='hintanchor'>Please Enter Your name</span>";		
		document.loan_formMob.Name2.focus();
		return false;
	}

   for (var i = 0; i <document.loan_formMob.Name2.value.length; i++) 
   {
		if (iChars.indexOf(document.loan_formMob.Name2.value.charAt(i)) != -1) 
		{
			document.getElementById('name2Val').innerHTML = "<span  class='hintanchor'>Contains special characters!</span>";
			document.loan_formMob.Name2.focus();
			return false;
		}
  }
	
	if (document.loan_formMob.City2.selectedIndex==0)
	{
		document.getElementById('city2Val').innerHTML = "<span  class='hintanchor'>Enter City to Continue!</span>";	
		document.loan_formMob.City2.focus();
		return false;
	}
	

	if(document.loan_formMob.Phone2.value=="")
	{
		document.getElementById('phone2Val').innerHTML = "<span  class='hintanchor'>Fill Mobile Number!</span>";
		document.loan_formMob.Phone2.focus();
		return false;
	}
	if(isNaN(document.loan_formMob.Phone2.value)|| document.loan_formMob.Phone2.value.indexOf(" ")!=-1)
	{
		document.getElementById('phone2Val').innerHTML = "<span  class='hintanchor'>Enter numeric value!</span>";
		document.loan_formMob.Phone2.focus();
		return false;  
	}
	if (document.loan_formMob.Phone2.value.length < 10 )
	{
	  	document.getElementById('phone2Val').innerHTML = "<span  class='hintanchor'>Enter 10 Digits!</span>";	
		document.loan_formMob.Phone2.focus();
		return false;
	}
	if ((document.loan_formMob.Phone2.value.charAt(0)!="9") && (document.loan_formMob.Phone2.value.charAt(0)!="8") && (document.loan_formMob.Phone2.value.charAt(0)!="7"))
	{
	  	document.getElementById('phone2Val').innerHTML = "<span  class='hintanchor'>should start with 9 or 8 or 7!</span>";	
		document.loan_formMob.Phone2.focus();
		return false;
	}
	if(!document.loan_formMob.accept2.checked)
	{
		document.getElementById('accept2Val').innerHTML = "<span  class='hintanchor'>Read and Accept Terms & Conditions!</span>";	

		document.loan_formMob.accept2.focus();
		return false;
	}	
	return true;
}
...
"><span class="sbi-bank">Sbi (State Bank)</span>, Hdfc Bank</span>,	<span class="bajaj-finserv">			Bajaj Finserv</span>, <span class="kotak">Kotak</span>, <span class="ing-vysya">Ing Vsaya,</span> <span class="fullerton">Fullerton</span>, <span class="pnb-bank">PNB</span>  <strong>and </strong><span class="Standard-Chart">Standard Chartered.</span></div>
  <div id="content"><div class="content-innerbx">
...
<input type="hidden" name="source" id="source" value="display" />
...
font-weight:normal; color:#000;font-Family:Verdana;text-transform: capitalize;'></span>  <div id="loanAmtVal"></div></td>
     ...
     <div id="companyNameVal"></div></td>
			  ...
			  <tr>
			    <td height="35" valign="top" bgcolor="#FFFFFF" class="sbi_text_c">Net yearly Income</td>
		     
			    <td height="35" valign="middle" bgcolor="#FFFFFF" class="alert_msg"><input name="IncomeAmount" type="text" class="sbi_input" id="IncomeAmount"   onblur="getDigitToWords('IncomeAmount','formatedIncome','wordIncome');" onKeyPress="addPersonalDetails(); intOnly(this);" onKeyDown="validateDiv('netSalaryVal');"  onkeyup="intOnly(this); getDigitToWords('IncomeAmount','formatedIncome','wordIncome');"  />    
...
font-weight:normal; color:#000;font-Family:Verdana;text-transform: capitalize;'></span>
       <div id="netSalaryVal"></div></td>
			  ...
			  <tr><td colspan="2" id="personalDetails"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2"><tr><td width="100%" height="0" align="center" valign="middle" bgcolor="#FFFFFF" ><img src="images/sbi_get_quote_btn.png" style="width: 148px; height: 43px; margin-bottom: 0px;" /></td></tr></table></td></tr>
             <tr>
      <td height="45" colspan="2" align="left"  class="sbi_home_loan_text_c" style="font-weight:normal; font-size:11px; "><strong>Disclaimer: </strong>All loans are on sole discretion on the respective banks</td>
          ...
          <div class="mobilecontentbox">
             <form method="post"  name="loan_formMob" action="personal-loan-query-continue.php" onSubmit="return chkpersonalloanMob();"><input type="hidden" name="PostURL" value="<?php echo $_SERVER['REQUEST_URI']; ?>">

<input type="hidden" name="source" id="source" value="display" />
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
    <td width="27%" height="25" valign="middle" bgcolor="#FFFFFF" class="sbi_text_c">Name</td>
    <td width="73%" height="0" valign="middle" bgcolor="#FFFFFF">
<input name="Name2" type="text" class="sbi_input" id="Name2" onKeyDown="validateDiv('name2Val');" /> <div id="name2Val" class="alert_msg"></div>
      </td>
  </tr>
  <tr>
    <td height="35" valign="middle" bgcolor="#FFFFFF" class="sbi_text_c">Mobile No.</td>
    <td height="35" valign="middle" bgcolor="#FFFFFF"><label for="textfield2"></label>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="8%">+91</td>
          <td width="92%"><input name="Phone2" type="text" class="sbi_input" id="Phone2" onchange="intOnly(this);" onKeyPress="intOnly(this)"  onKeyDown="validateDiv('phone2Val');" onKeyUp="intOnly(this);" maxlength="10"; /><div id="phone2Val"  class="alert_msg"></div></td>
        </tr>
    </table></td>
  </tr>
  <tr>
    <td height="35" valign="middle" bgcolor="#FFFFFF" id="chnge_empstst_label" class="sbi_text_c">City</td>
    <td height="35" valign="middle" bgcolor="#FFFFFF" ><select name="City2" class="sbi_input" id="City2"  onChange="validateDiv('city2Val');"  style="height:30px;"><?=plgetCityList($City)?><option value="Vapi">Vapi</option><option value="Ankleshwar">Ankleshwar</option><option value="Anand">Anand</option><option value="Anand">Dahod</option><option value="Anand">Navsari</option></select><div id="city2Val"  class="alert_msg"></div>
    </td>
  </tr>
  <tr><td height="35" valign="middle" bgcolor="#FFFFFF" colspan="2" ><span style="font-size:10px; font-weight:normal;"><input type="checkbox" name="accept2" checked  style="border:none;"/>I have read the <a href="privacy.php" target="_blank">Privacy Policy</a> and agree to the <a href="privacy.php">Terms And Condition</a>.</span><div id="accept2Val"  class="alert_msg"></div></td></tr><tr><td height="0" align="center" valign="middle" bgcolor="#FFFFFF" colspan="2" >  <input type="submit" style="border: 0px none ; background-image: url(images/sbi_get_quote_btn.png); width: 148px; height: 43px; margin-bottom: 0px;" value=""/></td></tr>
   <tr>
    <td height="45" colspan="2" align="left"  class="sbi_home_loan_text_c" style="font-weight:normal; font-size:11px; "><strong>Disclaimer: </strong>All loans are on sole discretion on the respective banks</td>
  </tr>
</table></form>
