<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'GET'){
		...
		$result = ("Select * From Req_Loan_Home Where RequestID=$RequestID");
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		//SQL Query
		//$sql = "Update Req_Loan_Home SET Employment_Status='$Employment_Status', Company_Name='$Company_Name', City='$City', City_Other='$City_Other', Total_Experience='$Total_Experience', Net_Salary='$Net_Salary', Property_Type='$Property_Type',	Property_Value='$Property_Value', Loan_Amount='$Loan_Amount', Descr='$Descr', Dated=Now() WHERE RequestID=$RequestID" ;

		//$result = ExecQuery($sql);
		//echo mysql_error();
		
		$DataArray = array("Employment_Status"=>$Employment_Status, "Company_Name"=>$Company_Name, "City"=>$City, "City_Other"=>$City_Other, "Total_Experience"=>$Total_Experience, "Net_Salary"=>$Net_Salary, "Property_Type"=>$Property_Type,	"Property_Value"=>$Property_Value, "Loan_Amount"=>$Loan_Amount, "Descr"=>$Descr, "Dated"=>$Dated);
...
<Script Language="JavaScript">
 ...
 <table width="450" border="0" cellpadding="4" cellspacing="0" class="blueborder" id="frm">
   <tr>
     <td colspan="2" class="head1">Edit Home Loan Request</td>
   </tr>
