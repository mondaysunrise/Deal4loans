            ...
            <td align="center" valign="top" background="images/hl_rgt-tp-bg.gif" style="background-repeat:no-repeat; width:272px; height:44px; background-position:top;"><table width="100%" height="260" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td  style="padding:5px 0px; background-color:#EFE6CB; border:3px solid #FFFFFF;"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                                          <tr>
                        <td class="text" style="padding-bottom:3px;">The one-stop shop for Best on Property Loan requirements Now Get Offers from</td>
                      </tr>
                      <tr>
                        <td height="261"  align="center" valign="top" background="new-images/hl-logo.gif" style=" background-repeat:no-repeat; background-position:center; "><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td height="28">&nbsp;</td>
                              <td valign="middle" class="bnksname">State Bank of India </td>
                            </tr>
                            <tr>
                              <td height="37">&nbsp;</td>
                              <td valign="middle" class="bnksname">ICICI Bank </td>
                            </tr>
                            <tr>
                              <td height="28">&nbsp;</td>
                              <td valign="middle" class="bnksname"> IDBI Bank </td>
                            </tr>
                            <tr>
                              <td width="41%" height="35">&nbsp;</td>
                              <td width="59%" valign="middle" class="bnksname">LIC Housing Finance </td>
                            </tr>
                            <tr>
                              <td height="35">&nbsp;</td>
                              <td valign="middle" class="bnksname">Axis Bank </td>
                            </tr>
                            <tr>
                              <td height="35">&nbsp;</td>
                              <td valign="middle" class="bnksname">HDFC Ltd </td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
            ...
            <td width="303" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="600" align="center" valign="middle" background="images/hl_form_bg.gif" style="background-repeat:no-repeat; width:303px; height:44px; background-position:top;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td align="center" style="background-color:#EFE6CB; border:3px solid #FFFFFF; border-top:none; "><form name="home_loan" action="home-loan-property-continue.php" onSubmit="return submitform(document.home_loan);" method="post">
                            <table width="93%" border="0" align="right" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td class="formtext"><select size="1" align="left" style="width:140"  name="City" id="City" onChange="tataaig_comp(); insertData(); othercity1(this); " />
                              ...
                              <tr>
                                ...
                                <td class="formtext"><input disabled value="Other City"  onfocus="this.select();" name="City_Other" id="City_Other" style="width: 140px;"  onBlur="onBlurDefault(this,'Other City');">
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td class="formtext"><input value="Loan Amount" name="Loan_Amount"  id="Loan_Amount" onFocus="this.select();" class="style4"onChange="intOnly(this);"  onKeyUp="intOnly(this); getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onKeyPress="intOnly(this); getDigitToWords('Loan_Amount', 'formatedlA','wordloanAmount');" style="width:140px;" onKeyDown="getDigitToWords('Loan_Amount','formatedlA','wordloanAmount');" onBlur="getDigitToWords('Loan_Amount', 'formatedlA', 'wordloanAmount'); onBlurDefault(this,'Loan Amount');">
                                    ...
                                    <input type="hidden" name="source" value="PptHL">
                              ...
                              <tr>
                                <td height="20" colspan="2" align="left" valign="middle"><input type="hidden" name="Activate" id="Activate" >
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="8%"><input type="checkbox" name="accept" style="border:none;" checked></td>
                                        <td width="92%" height="35" class="subheading" style="font-weight:normal; "> I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a>.</td>
                                      </tr>
                                  </table></td>
                              </tr>
                              <tr>
                  ...
                  <td  style="padding:5px 0px; "><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="background-color:#EFE6CB; border:3px solid #FFFFFF; padding:5px 0px; "><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              <td class="text"><ul><li>Home Loan Quotes are free for customers. It's a totally free service for customers.</li>
<li>All loans repayment period are over 6 months. No short term loans.</li></ul></td>
                            </tr>
                            <tr>
                              <td align="left"  class="text"></td>
                            </tr>
      ...
      <tr>
        <td valign="top" style=" background-color:#EFE6CB; border:3px solid #FFFFFF;"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="text"> Property Loans to buy Flats, Apartments, Bungalow, studio apartments, Designer flats.
Property Loans for property in Delhi, Bangalore, Mumbai,  Pune, Chennai, Hyderabad, Chandigarh, Ahmedabad.
</td>
            </tr>
        </table></td>
