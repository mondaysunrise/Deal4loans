...
<div class="text_head"><strong><?php if((strlen(strpos($_SERVER['REQUEST_URI'], "home-loans-interest-rates")) > 0) || (strlen(strpos($_SERVER['REQUEST_URI'], "home-loan-sbi")) > 0)) 
			 { echo $subjectLine; } else {?>Compare Home loan Rates &amp; Eligibility<?php } ?></strong></div><div class="box_c">
<div class="input_box">
...
<div class="box_b" ><span style=" color:#fff; font-size:11px; text-transform:capitalize;  margin-top:2px;"><strong style="color:#fff;">Bank A</strong> - Rates as low as 10%<span style="color:#FF0000; font-weight:bold;">*</span> | <strong style="color:#fff;">Bank B</strong>- Fixed rate for 10 years.<span style="color:#FF0000; font-weight:bold;">*</span><br />
...
<div class="box_d"><div class="box_term"><span class="text" style="  color:#FFF; font-size:11px; text-transform:none; margin-top:5px; line-height:20px;">
<input name="accept" type="checkbox"  />
I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  class="text" style=" color:#88a943; font-size:11px; text-decoration:underline;">Privacy policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow"  class="text" style=" color:#88a943; font-size:11px; text-decoration:underline;">Terms and Conditions</a>.</span></div>
 <div style=" clear:both; height:15px;"></div>
