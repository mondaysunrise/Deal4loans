...
<div class="new-contaner-bajaj">
  <div id="content">
    <form name="cibil_form" method="post" action="apply-pl-bajajfinserv5-nw.php"  onSubmit="return ckhcreditcard(document.cibil_form); ">
...
<option value="Divorced">Divorced</option></select>
        ...
        <tr>
          <td class="sbi_text_c" >Residence Address <br />
            (With Landmark):</td>
          <td ><textarea rows="3" cols="21" name="caddress" id="caddress" class="bajaj-fin_txtinput" maxlength="100"></textarea></td>
        </tr>
        <tr>
          <td class="sbi_text_c">Current Residence Pincode:</td>
          <td><input type="text" name="Resi_Pincode" id="Resi_Pincode" value="<? echo $Resi_Pincode; ?>" class="bajaj-fin_input" maxlength="6" onkeypress="return numOnly(event)"/></td>
        </tr>
		<tr>
