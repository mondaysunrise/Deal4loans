...
<input type="hidden" name="stat_code" id="stat_code" tabindex=15>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>
	 <!--<input type="text" name="car_name" id="car_name" style="width:245px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid; "  value="Type slowly for autofill" onblur="onBlurDefault(this,'Type slowly for autofill'); " onfocus="onFocusBlank(this,'Type slowly for autofill');"   tabindex="1"/>-->
<input type="text" name="car_name" id="car_name" style="width:245px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid; "  value="<?php echo $car_name; ?>" readonly="readonly" tabindex="1"/>
  ...
  <tr>
    ...
    <td height="35" class="form_body_text" valign="top"><label>
              <div id="car_price_pop" class="inputtext" style="width:300px;"><? 
		$sql = "Select hdfc_car_price_delhi,hdfc_car_price from hdfc_car_list_category Where hdfc_car_name='".$car_name."'";
		list($getNumRows,$row)=Mainselectfunc($sql,$array = array());
  ...
  <tr> <td colspan="4" align="center"><table width="668" border="0" align="center" cellpadding="0" cellspacing="0"> <tr>     <td width="44">&nbsp;</td>   <td width="20" align="left"><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td> <td width="302" align="left" class="form_body_text">Annual Income</td>  <td width="24"><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td>   <td width="278" align="left" class="form_body_text">Company Name</td>  </tr> 
  <tr>  
  <td>&nbsp;</td>  <td>&nbsp;</td>  <td align="left"> <input type="text" name="Net_Salary" id="Net_Salary" style="width:175px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid; " tabindex="2" onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"/></td>        <td>&nbsp;</td>   <td align="left"><input type="text" name="Company_Name" id="Company_Name" style="width:175px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid; "  value="Type slowly for autofill" onblur="onBlurDefault(this,'Type slowly for autofill'); "  onfocus="onFocusBlank(this,'Type slowly for autofill');" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event, 'http://www.deal4loans.com/hdfcajax-cmplist-cl.php')" tabindex="3"/></td> </tr> 
  <tr> <td>&nbsp;</td>        <td>&nbsp;</td>  <td>&nbsp;</td>  <td>&nbsp;</td>  <td>&nbsp;</td>  </tr>  <tr>  <td>&nbsp;</td>        <td colspan="4" ><table width="100%" border="0" cellpadding="0" cellspacing="0">   <tr>            <td width="53%" align="left" class="form_head_text"> Personal information</td> <td width="4%" valign="middle"><img src="new-images/hdfcapp/personal-security.png" width="14" height="16" /></td>     <td width="43%" align="left" class="form_body_text">We keep this secure</td>    </tr>    </table></td> </tr>
  <tr>     <td colspan="5" class="lining">&nbsp;</td>  </tr>    <tr>  <td>&nbsp;</td>    <td ><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td>   <td align="left" class="form_body_text" >Name</td>  <td align="left" ><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td>   <td align="left" ><span class="form_body_text">Mobile Number</span></td>   </tr> 
  <tr>   <td>&nbsp;</td>  <td >&nbsp;</td>   <td align="left" >		<input type="text" name="Name" id="Name" style="width:175px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid; " tabindex="4"/></td>     <td >&nbsp;</td>        <td align="left"><table width="80%" border="0" cellpadding="0" cellspacing="0" align="left">     <tr>        <td width="15%">			<div style="width:20px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid; font-size:12px; font-family:Arial, Helvetica, sans-serif;">+91</div></td>        <td width="85%" align="left"><input type="text" name="Phone" id="Phone" style="width:125px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid; " maxlength="10" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);" tabindex="5" onchange="intOnly(this); insertstat_code();" /></td>      </tr>      </table>          </td>    </tr> 
  <tr>   <td>&nbsp;</td>   <td >&nbsp;</td>     <td >&nbsp;</td>     <td >&nbsp;</td>     <td >&nbsp;</td>    </tr>   <tr>      <td>&nbsp;</td>        <td ><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td>        <td align="left" class="form_body_text" >E-mail</td>        <td align="left" ><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td>        <td align="left" ><span class="form_body_text">City</span></td>      </tr>
  <tr> <td>&nbsp;</td>  <td >&nbsp;</td>  <td align="left" ><input type="text" name="Email" id="Email" style="width:175px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid;" tabindex="6" onchange="insertstat_code();" /> 	</td>    <td >&nbsp;</td>    <td align="left" ><select name="City" id="City" style="width:175px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid;" class="inputtext" tabindex="7">        <?=plgetCityList($City)?>       </select></td>    </tr>  
  <tr>    <td>&nbsp;</td> <td >&nbsp;</td>      <td >&nbsp;</td>    <td >&nbsp;</td>   <td >&nbsp;</td>    </tr><tr>     <td>&nbsp;</td>        <td ><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td>        <td align="left" class="form_body_text" >DOB</td>        <td ><img src="new-images/hdfcapp/navy-blue-bullet.png" alt="" width="15" height="15" /></td>  <td class="form_body_text" >Enter Validation Code sent on ur Mobile No.</td> </tr> 
  <tr> <td>&nbsp;</td> <td >&nbsp;</td>       <td ><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr> <td width="14%"><input name="dd" id="dd" type="text" maxlength="2" class="inputtext" onblur="onBlurDefault(this,'DD');" onfocus="onFocusBlank(this,'DD');" onChange="intOnly(this);" onKeyUp="intOnly(this); swtchToNextTab_dd();" onKeyPress="intOnly(this);" tabindex="8" style="width:35px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid;" value="DD"></td><td width="15%" align="left"><input name="mm" id="mm" type="text" maxlength="2" class="inputtext" onChange="intOnly(this);" onKeyUp="intOnly(this); swtchToNextTab_mm();" onKeyPress="intOnly(this);" onblur="onBlurDefault(this,'MM');" onfocus="onFocusBlank(this,'MM');" tabindex="9" style="width:35px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid;" value="MM"/></td>   <td width="71%" align="left">	<input name="yyyy" id="yyyy" type="text" maxlength="4" class="inputtext" onChange="intOnly(this);" onKeyUp="intOnly(this); swtchToNextTab_yyyy();" onKeyPress="intOnly(this);" onblur="onBlurDefault(this,'YYYY');" onfocus="onFocusBlank(this,'YYYY');" tabindex="10" style="width:75px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid;" value="YYYY"/></td>         </tr>    </table></td>        <td >&nbsp;</td>   <td ><table width="100%" border="0" cellpadding="0" cellspacing="0">     <tr>            <td width="31%"><input type="text" name="otp_code" id="otp_code"  style="width:75px; height:20px; border-radius:5px 5px 5px 5px; border:thin #bebebf solid;" maxlength="5" tabindex="11"/>	</td>            <td width="69%" class="form_body_text"><em>(Verify your Mobile Number)</em></td>    </tr>      </table></td>      </tr>   <tr>     <td>&nbsp;</td>   <td >&nbsp;</td><td >&nbsp;</td>  <td >&nbsp;</td>        <td >&nbsp;</td>    </tr>   <tr>        <td>&nbsp;</td>     <td >  </td>        <td class="form_body_text" ><table width="100%" border="0" cellpadding="0" cellspacing="0">     <tr>            <td width="11%" align="center"><input type="checkbox" name="checkbox" id="checkbox" /></td>            <td width="89%" align="left">I read &amp; agree to terms and conditions </td>          </tr>        </table></td>        <td colspan="2" align="left" >		<input type="image" name="Submit"  src="new-images/hdfcapp/get-quote.jpg"  style="width:146px; height:50px; border:none; " />		</td>        </tr>    </table></td>    </tr>  <tr>    <td colspan="4">&nbsp;</td>    </tr>
 </table>
 </form>
    </div>
