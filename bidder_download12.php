...
//HDFC Bank
            if ($BidderIDstatic == 2663 || $BidderIDstatic == 6279 || $BidderIDstatic == 6387) {
                $asmtype = "";
                if ($row_result['sentbidder'] == "1888") {
                    $asmtype = "Priyanka";
                    $smtype = "Manish Vaghela";
                    ...
                    $asmtype = "Lakhan Pandey";
                    $smtype = "Shani jaiswal";
                } else if ($row_result['sentbidder'] == "5315") {
                    $asmtype = "Kamana Vishwakarma";
                    $smtype = "Anup Dhote";
                    ...
                    $asmtype = "Shweta Singh";
                    $smtype = "Anup Dhote";
                } elseif ($row_result["sentbidder"] == "5456") {
                    $asmtype = "Sagar Badukale";
                    $smtype = "Shani jaiswal";
                } elseif ($row_result["sentbidder"] == "6044") {
                    $asmtype = "Pradip Chawgule";
                    $smtype = "Sandeep Sherawat";
            ...
            if ($BidderIDstatic == 5373 || $BidderIDstatic == 6116 || $BidderIDstatic == 6117) {//HDFc small cities
                ...
                if ($row_result['sentbidder'] == "5033" || $allocatebid['sentbidder'] == "5033") {
                ...
                } elseif ($row_result["sentbidder"] == "4403" || $allocatebid["sentbidder"] == "4403") {
                    $asmtype = "Padma Rao";
                } elseif ($row_result["sentbidder"] == "5454" || $allocatebid["sentbidder"] == "5454") {
                    $asmtype = "Anuja";
                    $smtype = "Arvind Singh";
                } elseif ($row_result["sentbidder"] == "6631" || $allocatebid["sentbidder"] == "6631") {
                    $asmtype = "AKshay";
                    $smtype = "Anup Dhote";
                } elseif ($row_result["sentbidder"] == "5456" || $allocatebid["sentbidder"] == "5456") {
                    $asmtype = "Manisha";
                    ...
                    $asmtype = "Anupam Soni";
                } else if ($row_result['sentbidder'] == "5314" || $allocatebid["sentbidder"] == "5314") {
                    $asmtype = "Govinda";
...
//				$south_zone = array(3000,3001,3002,3011);
            ...
            if ($BidderIDstatic == 1023 || $BidderIDstatic == 2679) {
            ...
            } elseif ($BidderIDstatic == 5648 || $BidderIDstatic == 5649 || $BidderIDstatic == 5650 || $BidderIDstatic == 5654) {
            ...
            } elseif ($BidderIDstatic == 5373 || $BidderIDstatic == 6116 || $BidderIDstatic == 6117) {
                ...
                $qry1 = "insert into temp (session_id, name, dob, email, emp_status, c_name, city, city_other, year_in_comp, total_exp, mobile_number, net_salary, residential_status, loan_any, emi_paid, cc_holder, loan_amount, Feedback, count_views, count_replies, is_modified, is_processed, pincode, doe, card_vintage, card_limit,ip_address,add_comment,Documents,residence_address, bank_name,property_type,address_apt, referred_page,vehicle_owned, plan_interested, current_age, docs,request_id, car_make, car_model, car_type,account_no, budget, unique_id, std_code_o, landline_o, pancard) values ('" . $session_id . "', '" . $row_result["Name"] . "', '" . $dob . "', '" . $row_result["Email"] . "', '" . $emp_status . "', '" . $row_result["Company_Name"] . "', '" . $row_result["City"] . "', '" . $row_result["City_Other"] . "', '" . $row_result["Years_In_Company"] . "', '" . $row_result["Total_Experience"] . "', '" . $contactNo . "', '" . $Salary . "', '" . $residential_status . "', '" . $row_result["Loan_Any"] . "', '" . $emi_paid . "', '" . $cc_holder . "', '" . $Loan_Amount . "', '" . $feedback . "', '" . $hdfceligibility . "', '" . $citieligibility . "', '" . $barclayeligibility . "', '" . $row_result["PL_EMI_Amt"] . "', '" . $row_result["Pincode"] . "', '" . $Dateofallocation . "', '" . $card_vintage . "', '" . $row_result["Card_Limit"] . "','" . $row_result["IP_Address"] . "','" . $row_result["Add_Comment"] . "','" . $row_result["identification_proof"] . "','" . $asmtype . "','" . $row_result["Primary_Acc"] . "','" . $Company_Type . "','" . $Salary_Drawn . "','" . $row_result["axis_executive_name"] . "', '" . $zone . "','" . $annual_turnover . "','" . $exclusiveLead . "', '" . $BiddCity . "','" . $citiuniqueid . "', '" . $row_result["Existing_Bank"] . "', '" . $row_result["Existing_Loan"] . "', '" . $row_result["Existing_ROI"] . "', '" . $comment_section . "', '" . $smtype . "','" . $uniqueid . "', '" . $row_result["Pincode"] . "', '" . $row_result["Residence_Address"] . "', '" . $row_result["Pancard"] . "')";
                //$qry1="insert into temp (session_id, name, dob, email, emp_status, c_name, city, city_other, year_in_comp, total_exp, mobile_number, net_salary, residential_status, loan_any, emi_paid, cc_holder, loan_amount, Feedback, count_views, count_replies, is_modified, is_processed, pincode, doe, card_vintage, card_limit,ip_address,add_comment,Documents,residence_address, bank_name,property_type,address_apt, referred_page,vehicle_owned, plan_interested, current_age, docs,request_id, car_make, car_model, car_type,account_no, budget, unique_id) values ('".$session_id."', '".$row_result["Name"]."', '".$dob."', '".$row_result["Email"]."', '".$emp_status."', '".$row_result["Company_Name"]."', '".$row_result["City"]."', '".$row_result["City_Other"]."', '".$row_result["Years_In_Company"]."', '".$row_result["Total_Experience"]."', '".$contactNo."', '".$Salary."', '".$residential_status."', '".$row_result["Loan_Any"]."', '".$emi_paid."', '".$cc_holder."', '".$Loan_Amount."', '".$feedback."', '".$hdfceligibility."', '".$citieligibility."', '".$barclayeligibility."', '".$row_result["PL_EMI_Amt"]."', '".$row_result["Pincode"]."', '".$Dateofallocation."', '".$card_vintage."', '".$row_result["Card_Limit"]."','".$row_result["IP_Address"]."','".$row_result["Add_Comment"]."','".$row_result["identification_proof"]."','".$asmtype."','".$row_result["Primary_Acc"]."','".$Company_Type."','".$Salary_Drawn."','".$row_result["axis_executive_name"]."', '".$zone."','".$annual_turnover."','".$exclusiveLead."', '".$BiddCity."','".$citiuniqueid."', '".$row_result["Existing_Bank"]."', '".$row_result["Existing_Loan"]."', '".$row_result["Existing_ROI"]."', '', '".$smtype."','".$uniqueid."')";
            }
        }
    ...
    if ($qry2 == "Req_Loan_Home") {
        ...
        if ($BidderIDstatic == 6319) {
            ...
            $GetupdateddateSql = ExecQuery("select Dated from telecaller_feedback_bookkeeping where (AllRequestID=" . $row_result["AllRequestID"] . " and BidderID in (6307,6308,6309,6310,6311,6312,6313,6314,6315,6316,6317,6318,6560,6561,6562) ) order by bookkeepid LIMIT 0,1");
            $ltuprow = mysql_fetch_array($GetupdateddateSql);

            /* SBI HL ASM Details */
            $ASMSBISql = ExecQuery("select final_feedback,feedback from webservice_bidder_details where (cust_requestid=" . $row_result["AllRequestID"] . " and BidderID in (6307,6308,6309,6310,6311,6312,6313,6314,6315,6316,6317,6318,6560,6561,6562,6168) )");
...
if ($qry2 == "Req_Loan_Personal") {
    ...
    if (strlen($keyFBidders) > 0) {
        ...
        $qry = "select unique_id AS ReferenceID, name AS Name, dob AS DOB, email AS Email, mobile_number AS MobileNo, emp_status AS Occupation, c_name AS CompanyName, city AS City, city_other AS OtherCity, pincode AS Pincode, cc_holder AS CardHolder, bank_name AS PrimaryAcc,net_salary AS AnnualIncome, residential_status AS ResidentType, loan_any AS LoanRunning, emi_paid AS EMIPaid,is_processed AS EMIAmt, loan_amount AS LoanAmount, Feedback, card_vintage AS CardVintage, card_limit AS CardLimit, ip_address,Documents AS AvailableDocuments,account_no AS Comments,add_comment AS D4lComment,doe,property_type AS CompanyType, vehicle_owned as Zone,residence_address AS ASMType, current_age as ExclusiveLead, car_make AS BTBank, car_model AS BTLoanAmt, car_type AS BTROI, std_code_o AS ResidencePincode, landline_o AS ResidenceAddress, total_exp AS TotalExp, pancard AS Pancard from temp where session_id='" . $session_id . "' order by doe DESC ";
    ...
    } elseif ($BidderIDstatic == 2663 || $BidderIDstatic == 6279 || $BidderIDstatic == 6387) {
    ...
    } elseif ($BidderIDstatic == 5648 || $BidderIDstatic == 5649 || $BidderIDstatic == 5650 || $BidderIDstatic == 5654 || $BidderIDstatic == 5373 || $BidderIDstatic == 6116 || $BidderIDstatic == 6117) {
...
if ($qry2 == "Req_Loan_Home") {
	...
	elseif($BidderIDstatic == 6717) {
       $qry = "select  unique_id AS ReferenceID, name, dob, email, mobile_number, emp_status, c_name AS CompanyName, city, city_other, pincode, net_salary, descr, loan_amount, Feedback, logout_date AS FollowUpDate, property_identified, property_loc,property_value AS PropertyValue, budget, residence_address, loan_time, doe, add_comment ,gender AS BTfromBank,marital_status AS BTROI, residential_status AS BTloanamt, current_age as ExclusiveLead, request_id AS Agentid, contact_time AS ReassignAgentid, docs AS selectedBank, bank_name AS LastUpdatedDate  from temp where session_id='" . $session_id . "' order by doe DESC";
    }
	else {
