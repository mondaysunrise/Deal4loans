...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><form name="personalloan_form"  action="insert_personal_loan_valu.php" method="POST" onsubmit="return submitform(document.personalloan_form); ">
...
<option value="3">By Account Transfer</option>
            ...
            <tr>
              ...
              <td align="left" ><input style="width:200px;" name="Credit_Limit" id="Credit_Limit" onchange="intOnly(this);" onkeyup="intOnly(this);" onkeypress="intOnly(this);" onfocus="this.select();">              </td>
            </tr>
            <? } ?>
            <tr>
          ...
          <!--<tr>
              <td width="234" height="35" align="left" class="bldtxt">Activation Code?  </td>
              <td width="313" height="20"  align="left"><input type="text" style="width:90px;" name="activation_code" id="activation_code" maxlength="4" onFocus="return Decorate('Please enter 4 digit code you have received on your mobile,to activate your loan request and to get the bidder contacts.')"  onBlur="return Decorate1(' ')"><div id="plantype2" style="position:absolute;font-size:10px;width:150;font-weight:none; " ></div></td>
            </tr>-->
            <!--<tr>
