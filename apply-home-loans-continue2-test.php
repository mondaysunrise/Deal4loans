<?php
	...
	require 'scripts/sbi_hl_eligibility.php';
...
function  InsertEdelweiss($ProductValue, $Name,$City, $Phone, $DOB , $Pincode)
	{
		...
		$insert = Maininsertfunc ('edelweiss_leads', $dataInsert);
	}
...
<td   bgcolor="#FFFFFF" height="57" colspan="5"><b>Get Quote on call from Bank</b></td>
	...
	?>
		...
		<tr align="center">
		  <td width="145"  ><img src="http://www.deal4loans.com/new-images/hl-thnk-sbi.jpg" width="90" height="40" /><br /> 
