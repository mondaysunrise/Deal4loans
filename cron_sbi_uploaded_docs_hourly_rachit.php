...
foreach($data as $mainKey => $mainVal){
	...
	if(!empty($BidderEmail)){
				...
				<tr>
					<td bgcolor="#bdd8ef">
						<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td height="35" bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#171717; padding-left:15px;">Dear '.$BidderName.',</td>
							</tr>
							<tr>
		...
		foreach($mainVal as $subKey => $subVal){
			...
			$message .= '<tr><td><table border="1" align="center" cellpadding="0" cellspacing="0"><tr>
							<td bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#4c4c4c; line-height:21px; padding-left:15px;">1. Doc Category : '.$subVal['doc_category'].'</td>
						</tr>
						<tr>
							<td bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#4c4c4c; line-height:21px; padding-left:15px;">2. Doc Type : '.$subVal['doc_type'].'</td>
						</tr>
						<tr>
							<td bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#4c4c4c; line-height:21px; padding-left:15px;">3. Doc Name : '.$subVal['doc_name'].'</td>
						</tr>
						<tr>
							<td bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#4c4c4c; line-height:21px; padding-left:15px;">4. File Upload Location : http://www.deal4loans.com/sbi-documents-details.php?reqid='.$subVal['RequestID'].'&biddt='.$BidderID.'</td>
						</tr>
						<tr>
						...
						<tr>
							<td bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#4c4c4c; line-height:21px; padding-left:30px;">a. Lead Reference No : '.$subVal['LeadRefNumber'].'</td>
						</tr>
						<tr>
							<td bgcolor="#FFFFFF" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#4c4c4c; line-height:21px; padding-left:30px;">b. Application Status : '.$subVal['ApplicationNumber'].'</td>
						</tr>
						</table></td></td>';
		}
		
		$message .= '<tr><td bgcolor="#FFFFFF">&nbsp;</td></tr>
						<tr>
