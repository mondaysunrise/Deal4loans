...
list($cNumRows,$caresult)=Mainselectfunc($caqry,$array = array());

$car_price_category = $carow["car_price_category"];
$car_loan_category = $carow["car_loan_category"];
if($city=="Delhi")
{
	$car_price = $carow["car_loan_price_dellhi"];
}
else
{
...
if(strlen($city)>0)
	{
		...
		list($NumRows,$clsresult)=Mainselectfunc($clsqry,$array = array());
...
<table width="886" align="center" border="0" cellpadding="0" cellspacing="0" >
  <tbody><tr>
    <td background="icici_car/main_bg.gif"><table  width="872" align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
 <td width="626" align="center" valign="top" background="icici_car/calc-bg1.gif" style="background-repeat:no-repeat;    height:180px; background-position: top;"><!--D4l Here-->
<? if($maxLoan_Amount>0)
{
...
<table width="100%" cellpadding="0" border="0">
 <tr>
   ...
   <td width="57%" align="right" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td align="left" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; color:#a41c2b; ">&nbsp;</td>
       <td align="right">&nbsp;</td>
     </tr>
     <tr>
       <td width="62%" align="left" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; color:#a41c2b; "> Eligible Loan Amount:</td>
       <td width="37%" align="right"><input type="text" id="amount" style="border:0; color:#a41c2b; font-weight:bold; width:65px; font-family:Verdana, Arial, Helvetica, sans-serif;" /></td>
     </tr>
   </table></td>
   <td align="left" style="font-size:9px; "></td>
 </tr>
 <tr><td width="19%"></td><td height="15">
<div id="slider-range-min" onClick="insertData();" onChange="insertData();" onMouseDown="insertData(); insertloadpie();" onMouseUp="insertloadpie();"></div>
</td><td width="24%" align="right"></td></tr>
 <tr>
   <td>&nbsp;</td>
   <td colspan="2" align="left" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td width="57%" style="font-size:9px; font-family:Verdana, Arial, Helvetica, sans-serif; color:#5b5b5b "><b>Min:</b> Rs.100000</td>
...
<tr>
 ...
 <tr>
  ...
  <td><table width="93%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="70%" align="left" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; color:#a41c2b; "> Tenure in month:</td>
      <td width="29%" align="right"><input type="text" id="amount1" style="border:0; color:#a41c2b; font-weight:bold; width:25px; font-family:Verdana, Arial, Helvetica, sans-serif;" /></td>
    </tr>
  </table></td>
  <td align="right">&nbsp;</td>
</tr>
<tr><td width="19%">&nbsp;</td><td>
<div id="slider-range-min1" onClick="insertData();" onChange="insertData();" onMouseDown="insertData(); insertloadpie();" onMouseUp="insertloadpie();"></div>
</td><td width="24%" align="right">&nbsp;</td></tr>
<tr>
  <td>&nbsp;</td>
  <td colspan="2" align="left" style="font-size:9px; font-family:Verdana, Arial, Helvetica, sans-serif;  color:#5b5b5b "><table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="60%" style="font-size:9px; font-family:Verdana, Arial, Helvetica, sans-serif; color:#5b5b5b "><b>Min:</b> 12 Months</td>
      <td width="40%" style="font-size:9px; font-family:Verdana, Arial, Helvetica, sans-serif; color:#5b5b5b "><b>Max:</b> <? echo $maxTenure; ?>(Months)</td>
    </tr>
  </table></td>
  </tr>
</table>
...
<!--</td>
	...
	<table>
	<tr>
 <td align="left" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; color:#a41c2b; "> Not Eligible for the Loan.</td>
 </tr></table>
	<? }?>
...
?>
	...
	<div style="position:absolute; z-index:100; left:600px; top:110px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; color:#a41c2b;">PIE CHART<? $total_cost = ($emiPerLac*$tenure) + $processing_fee;
