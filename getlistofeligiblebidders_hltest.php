...
function getBiddersList($strProduct,$strRequestID,$strCity,$bank_id)
{   
   ...
   if($bank_id=="All")
	...
	{
		$qry = "SELECT * FROM Bidders_List WHERE (Reply_Type='".$mvarType."' and City LIKE '%".$mvarCity."%' and  Restrict_Bidder=1 and BankID in (".$bank_id."))";
	}
	//}
