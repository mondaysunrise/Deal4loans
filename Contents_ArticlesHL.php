...
<title> Deal4Loans - Home loans India | Home loan interest rates | Flexible home loan repayment | Housing financial services India</title>
...
<table>
		<?php
		$cntr1 = 0;
		while($cntr1<count($ArrRow))
		{
			$Art_Sub_Title = $ArrRow[$cntr1]['Art_Sub_Title'];
			$Art_Url = $ArrRow[$cntr1]['Art_Url'];
			$Art_Content = $ArrRow[$cntr1]['Art_Content'];
