...
function retrivedatafortata()
{
	...
	$newfileatt = "/home/deal4loans/public_html/pldwnld/hdfcltd".$cityname."".$newToday.".xls";
	...
	function sendexcelfileattachment($emailid,$session_id,$emailid,$cityname)
	{
		...
		$fileatt = "/home/deal4loans/public_html/pldwnld/hdfcltd".$cityname."".$newToday.".xls";
		$fileatttype = "application/xls"; 
		$fileattname = "hdfcltd".$cityname."".$newToday.".xls";
