...
$residence_pincode = FixString($residence_pincode);
...
$getpldetails="select City_Other,City,Company_Name,Name,Net_Salary,DOB From Req_Loan_Personal Where (RequestID='".$leadid."')";
	...
	list($alreadyExist,$myrow)=MainselectfuncNew($getpldetails,$array = array());
...
if($leadid>0)
{														
		$dataUpdate = array('Is_Valid'=>$Is_Valid, 'Company_Name'=>$Company_Name, 'Pincode'=>$Pincode, 'Loan_Amount'=>$Loan_Amount, 'CC_Holder'=>$CC_Holder, 'Card_Vintage'=>$Card_Vintage, 'Company_Type'=>$Company_Type, 'PL_EMI_Amt'=>$PL_EMI_Amt, 'Primary_Acc'=>$Primary_Acc, 'Residential_Status'=>$Residential_Status , 'Card_Limit'=> $Credit_Limit, 'Years_In_Company'=>$Years_In_Company, 'Total_Experience'=>$Total_Experience, 'EMI_Paid'=>$EMI_Paid, 'Loan_Any'=>$Loan_A, 'identification_proof'=>$Document_proof_doc, 'Gender'=>$Gender, 'Residence_Address'=>$Residence_Address, 'Pincode'=>$residence_pincode, 'Pancard'=>$Pancard);
...
<!--<META HTTP-EQUIV="Refresh" CONTENT="5;URL=apply_personal_loan_step_thank.php">-->
...
var pauseit=1
var marqueecontent='<nobr><img src="new-images/thumb/hdfc-logo.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/fullrton.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/axis.jpg" />&nbsp;&nbsp;<img src="new-images/slider/thumb/hdbfs_logo.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/stndc.jpg" />&nbsp;&nbsp;<img src="new-images/thumb/hdfc-logo.jpg" /></nobr>'
