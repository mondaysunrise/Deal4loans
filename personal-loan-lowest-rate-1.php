...
if(strlen($_REQUEST['source'])>0){	$retrivesource=$_REQUEST['source'];} else {	$retrivesource="lowestrateLPNW"; }
...
if($retrivesource=="AFL_MLR_OPTMED_PL")
{
}
else
{
...
<link rel="stylesheet" href="css/pl_apply-tab_styles-new18-2-2015.css">
...
<? if($retrivesource=="komlipl" || $retrivesource=="timesmobpl"  || $retrivesource=="logicserve"  || $retrivesource=="dgm_ploct13" || $retrivesource=="infomedia" || $retrivesource=="hindustantimes" || $retrivesource=="inuxu_oct13" || $retrivesource=="netcorepl" || $retrivesource=="pyxelconnectpl" || $retrivesource=="icubespl" || $retrivesource=="ibiboplnw" || $retrivesource=="monsterpl" || $retrivesource=="yahoopl" || $retrivesource=="valuefirstpl" || $retrivesource=="adshreempl" || $retrivesource=="proformicspl" || $retrivesource=="timesjobspl"  || $retrivesource=="shopatbestpl" || $retrivesource=="cardekhopl" || $retrivesource=="vcommissionpl" || $retrivesource=="pkonlinepl" || $retrivesource=="svgmediapl" || $retrivesource=="ammv3pl" || $retrivesource=="ammbctpl"  || $retrivesource=="AFL_MLR_OPTMED_PL" || $retrivesource=="AFL_MLR_POINTIFIC_PL" || $retrivesource=="AFL_MLR_OPICLE_PL" || $retrivesource=="AFL_MLR_SHOPATBEST_PL" || $retrivesource=="AFL_MLR_MONSTER_PL" || $retrivesource=="AFL_MLR_HTTPOOLPIVOT_PL" || $retrivesource=="AFL_MLR_ADCANOPUSPIVOT_PL" || $retrivesource=="AFL_WFMLR_CARTRADE_PL" || $retrivesource=="AFL_MLR_LEADSUTRA_PL" || $retrivesource=="AFL_D4LMLR_SHOPCLUES_PL" || $retrivesource=="AFL_D4LMLR_LUCINI_PL" || $retrivesource=="AFL_MLR_AD2CLICK_PL" || $retrivesource=="AFL_MLR_LEADSUTRA_NEW_PL" || $retrivesource=="AFL_MLR_PROFILIAD_PL" || (strncmp ("inuxu", $retrivesource,5)==0))
...
<tr align="left">
  ...
  <tr>
   ...
   <tr>
<td colspan="2" class="form_text"  id="personalDetails">
<table align="center" width="100%"><tr><td align="center"><img src="images/get-quote-btn-newlp.png" width="119" height="45" /></td></tr></table>
<div style="clear:both;"></div>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <tr>
       <td class="text_head-bullet" style="color:#CC0000;"><ul>
         ...
         <li>Lowest Rate starting as low as <strong>11.29% </strong></li>
...
interest only on used amount</li>
 ...
 <div class="news-box">
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td width="72%"><span class="pl_why_bullet_newone">Silicon Valley stalwarts from <strong style="color:#0072bc;">Google</strong> and <strong style="color:#087d1b;">Whatsapp</strong> back financial technology firm <strong style="color:#0072bc;">Deal4Loans</strong></span></td>
       <td width="28%"><img src="images/the-economic-times.png" width="132" style="height:12px;" /></td>
     </tr>
   </table>
 </div>
 <div class="table_bg" style="background:none; ">
   <table width="98%" border="0" cellpadding="5" cellspacing="1">
    <tr>
      <td width="925" height="35" valign="middle" bgcolor="#F1EEEE" class="text_head-h" style=" font-family:'Raleway'; font-size:19px;"><strong style="color:#ca4d02; font-size:19px;">61,</strong> <strong style="color:#08809e;">67,</strong> <strong style="color:#0277c3;">640</strong> quotes taken</td>
</tr>
   </table>
   <div style="clear:both;"></div>
 </div>
