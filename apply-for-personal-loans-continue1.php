...
$sql = "select source,City,Employment_Status From Req_Loan_Personal Where (RequestID=" . $_SESSION['Temp_LID'] . ")";
...
<html>
    ...
    <body>
                ...
                <form name="personalloan_form"  action="insert_personal_loan_value_step2.php" method="POST" onSubmit="return submitform(document.personalloan_form);
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="6" bgcolor="#f4f4f4"><input name="Primary_Acc" type="text" class="input_box_s" id="Primary_Acc" onChange="getstatementlink();" onClick="getstatementlink();" onKeyDown="getstatementlink();
                                    validateDiv('priAccVal');" onKeyUp="ajax_showOptions(this, 'getCountriesByLetters', event);
                                            getstatementlink();"  autocomplete="off" ><div id="priAccVal" class="alert_msg"></div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="6"><input type="radio" style="border:none;"  value="1"  name="LoanAny"  onclick="addElementLoan(); addDiv();
                                    validateDiv('loanVal');" /> Yes &nbsp;  <input size="10" type="radio"  name="LoanAny"  onclick="removeElementLoan();
                                            validateDiv('loanVal');" value="0" > No   <div id="loanVal"></div></td>
                        </tr>
                        <tr>
        ...
        <? if ($flg["source"] == "new personalloan" || $flg["source"] == "Pl display") {
            ?>
