...
//exit();
            try
			{
				...
				{
					$failedurl='https://www.deal4loans.com/FailedTRAN.php?Message=Transaction Failed&ResTrackId='.$TranTrackid.'&ResAmount='.$TranAmount.'&ResError='.$response.'&Rid='.$Rid.'&Pid='.$Pid;
