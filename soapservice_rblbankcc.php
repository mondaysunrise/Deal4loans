...
//$auth = array("Authentication"=>array("UserId"=>"cc_connector_2", "Password"=>"dfl6prd$42*ats5"));// for production
$cust_details = array("CreditCard"=>array("Version"=>6, "ConUniqRefCode"=>"rbl12345", "CreditCardApplied"=>"16", "HadLoanOrCreditCardFromAnyBank"=>"N", "Title"=>"1","FirstName"=>"Shweta", "MiddleName"=>"","LastName"=>"sharma","FatherName"=>"","Gender"=>2,"DOB"=>"30-11-1984","ResAddress1"=>"Koramangala, HSR Layout, NGV", "ResAddress2"=>"", "Landmark"=>"","ResCity"=>"318", "ResPIN"=>"110001", "Email"=>"shweta@d4l.com", "Mobile"=>"9999407207", "EmpType"=>"1", "NMI"=>"90000", "PAN"=>"AAAPA1112A", "OTP"=>"", "Token"=>"", "Param1"=>"", "Param2"=>"", "Param3"=>"", "Param4"=>"", "Param5"=>""));
