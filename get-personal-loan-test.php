...
"><span class="sbi-bank">Sbi (State Bank)</span>, Hdfc Bank</span>,	<span class="bajaj-finserv">			Bajaj Finserv</span>, <span class="kotak">Kotak</span>, <span class="ing-vysya">Ing Vsaya,</span> <span class="fullerton">Fullerton</span>, <span class="pnb-bank">PNB</span>  <strong>and </strong><span class="Standard-Chart">Standard Chartered.</span></div>
  <div id="content">
       <form method="post"  name="loan_form"  action="insertPL1_d4l.php"  onSubmit="return chkpersonalloan();">
...
font-weight:normal; color:#000;font-Family:Verdana;text-transform: capitalize;'></span>  <div id="loanAmtVal"></div></td>
			  ...
			  <tr>
			    ...
			    <td height="35" valign="middle" bgcolor="#FFFFFF" class="alert_msg"><select name="Employment_Status" class="sbi_input" id="Employment_Status" onChange="validateDiv('empStatusVal'); " style="height:30px;" >
...
font-weight:normal; color:#000;font-Family:Verdana;text-transform: capitalize;'></span>
       <div id="netSalaryVal"></div></td>
              ...
              <tr>
			    <td height="43" bgcolor="#FFFFFF" colspan="2" class="heading_text_c" id="viewform_part_here"></td></tr>
			  ...
			  <tr>
		        ...
		        I have read the <a href="Privacy.php" target="_blank">Privacy Policy</a> and agree to the <a href="Privacy.php" target="_blank">Terms And Condition</a>.</span><div id="acceptVal"></div></td>
		    </tr>
			  <tr>
...
<div style="clear:both;"></div>
	<div class="bank_logo_box" style="margin-top:-25px;"><img src="images/loan-partner-img.jpg"></div>
</div>
<script type="text/javascript">
