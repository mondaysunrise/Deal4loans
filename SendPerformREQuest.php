...
$responseURL="responseURL=http://www.deal4loans.com/Get_Handle_RESponse.php";
...
*/ 
$errorURL="errorURL=http://www.deal4loans.com/FailedTRAN.php";
...
$url = "https://securepgtest.fssnet.co.in/pgway/servlet/PaymentInitHTTPServlet"; //Commented for Testing 

//$url = "https://securepgtest.fssnet.co.in/pgway/gateway/Merchant/index.jsp";
/* 
...
$response = $data1;
            try
			{
				...
				{
					$failedurl='http://www.deal4loans.com/FailedTRAN.php?Message=Transaction Failed&ResTrackId='.$TranTrackid.'&ResAmount='.$TranAmount.'&ResError='.$response.'&Rid='.$Rid.'&Pid='.$Pid;
