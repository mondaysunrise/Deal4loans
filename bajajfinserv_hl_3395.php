...
function retrivedataforbajajhl()
	{
...
$Today=date('Y-m-d');
	...
	$citifinquery="SELECT Property_Identified,Employment_Status,Name,DOB,Email,Company_Name,City,City_Other,Pincode,Mobile_Number,Net_Salary,Add_Comment,Loan_Amount,Property_Loc,Allocation_Date FROM Req_Feedback_Bidder_HL,Req_Loan_Home WHERE (Req_Feedback_Bidder_HL.AllRequestID=Req_Loan_Home.RequestID and Req_Feedback_Bidder_HL.BidderID in (3394,3396,3453,3454,3455,3456,3457,3458,3459,3460,3461,3462,3463,3464,3465,3466,3467,3468,3469,3470,3471,3472,3473,3474,3475,3476) and Req_Feedback_Bidder_HL.Reply_Type=2 and Req_Feedback_Bidder_HL.Allocation_Date Between '".($min_date)."' and '".($max_date)."')";
...
//$newToday ="280112";
	...
	$newfileatt = "/home/deal4loans/public_html/hldwnld/bajajfin".$newToday."2724.xls";
...
if($recordcount>0)
	...
	$to = "subhan.shaik@bajajfinserv.in,krishna.pecheti@bajajfinserv.in"; 
	
       $from = "Deal4loans <no-reply@deal4loans.com>"; 
        $subject = "Bajaj Finserv Home Loan Leads @ deal4loans.com".$newToday; 
          
	   $fileatt = "/home/deal4loans/public_html/hldwnld/bajajfin".$newToday."2724.xls";
        $fileatttype = "application/xls"; 
        $fileattname = "bajajfin".$newToday."2724.xls";
       ...
       $file = fopen( $fileatt, 'r+' ); 
		...
		$headers .= "Cc: pankaj.gupta@bajajfinserv.in,balbir.singh@deal4loans.com,neha.gupta@deal4loans.com"."\n";
