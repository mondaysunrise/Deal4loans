...
{
	var gifName = form;
	document.frmsearch.action="hdfc_cl_appview.php?search=y"+gifName;
...
function chkform()
{
	...
	if(ss.length<10 || ss.length>10)
	{
		...
		if(document.frmsearch.min_date.value<"2013-01-10")
	{
		alert("Sorry!!!! Your minimum date is 2013-01-10.Please Select.");
		document.frmsearch.min_date.value="";
		document.frmsearch.min_date.focus();
		return false;
	}
...
<tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#45B2D8">
      <tr>
	  <td style="padding-top:15px;"><table  width="900" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#5BBEE0" >
  ...
  <tr><td align="right" ><a href="/hdfc_cl_view.php" style="text-decoration:none; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px;"><b>Site Leads</b></a></td></tr>
 ...
 <form name="frmsearch" action="hdfc_cl_appview.php?search=y" method="post" onSubmit="return chkform();">
 ...
 <? 
	if(strlen($branch)>0)
		...
		$search_qry="SELECT * FROM  hdfc_car_loan_leads WHERE (hdfc_car_loan_leads.Dated Between '".($min_date)."' and '".($max_date)."' and hdfc_car_loan_leads.Source='car-loan-hdfc')";	
		...
		$qry="SELECT * FROM  hdfc_car_loan_leads WHERE (hdfc_car_loan_leads.Dated Between '".($min_date)."' and '".($max_date)."' and hdfc_car_loan_leads.Source='car-loan-hdfc')";
		...
		else
		{
			...
			$search_qry="SELECT * FROM  hdfc_car_loan_leads WHERE (hdfc_car_loan_leads.Dated Between '".($min_date)."' and '".($max_date)."' and hdfc_car_loan_leads.Source='car-loan-hdfc' and hdfc_car_loan_leads.City in ".$propercity.") ";	
		//$search_qry=$search_qry.$FeedbackClause;
		$search_qry=$search_qry."group by ".$val.".Mobile_Number";
		$search_qry=$search_qry." order by ".$val.".Dated DESC";

		$qry="SELECT * FROM  hdfc_car_loan_leads WHERE (hdfc_car_loan_leads.Dated Between '".($min_date)."' and '".($max_date)."' and hdfc_car_loan_leads.Source='car-loan-hdfc' and hdfc_car_loan_leads.City in ".$propercity.") ";
		//$qry=$qry.$FeedbackClause;
		$qry=$qry."group by ".$val.".Mobile_Number";
...
//echo $qry;
 ...
 <form name="frmdownload" action="bidder_download.php" method="post">
  ...
  <td align="center">
 <table border="0" cellspacing="0" cellpadding="0">
 <form name="xlsdownload" action="hdfc_appdownloading.php" method="post">
   <tr>
     <td align="center">
	   <input type="hidden" name="qry1" value="<? echo $search_qry; ?>">
	   <input type="hidden" name="qry2" value="<? echo $val; ?>">
