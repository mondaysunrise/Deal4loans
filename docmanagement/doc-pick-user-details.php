...
//		   $getBankSql = "select Associated_Bank from Bidders left join Req_Feedback_Bidder_PL on Bidders.BidderID=Req_Feedback_Bidder_PL.BidderID where Req_Feedback_Bidder_PL.AllRequestID='".$rowsCon->AllRequestID."' and Bidders.Associated_Bank in ('Tata Capital', 'ICICI Bank')";
        ...
        <tr>
          ...
          <td>
          <?php
           if($rowsCon->spoc_status=="Sent For Login")
           {
				echo $rowsCon->spoc_status;
		   }
		   else
		   {          
			 ?>
          
          <select name="spoc_status" id="spoc_status" onchange="loadSpocStatus(<?php echo $rowsCon->id;?>,this.value,'<?php echo $_SESSION['UID'];?>')">
          <option value="">Please Select</option>
          		<option value="Pre-login Reject" <?php if($rowsCon->spoc_status== "Pre-login Reject") { echo 'selected';} ?> >Pre-login Reject</option>
         ...
         <option value="Complete Pick-up" <?php if($rowsCon->spoc_status=="Complete Pick-up"){ echo "selected";} ?>>Complete Pick-up</option>
          <option value="Incomplete Pick-up" <?php if($rowsCon->spoc_status=="Incomplete Pick-up"){ echo "selected";} ?>>Incomplete Pick-up</option>
           <option value="Sent For Login" <?php if($rowsCon->spoc_status=="Sent For Login"){ echo "selected";} ?>>Sent For Login</option>
</select>
			<?php
			}
			?>
