...
<div id="payment_container-dash_page">
  ...
  <div class="content_right">
    ...
    <div id="txtHint" style="float:right; color:#0C3; font-weight:bold;"></div>
           ...
           <form name="frmsearch" action="pl_document_picked1.php" method="get" onSubmit="return chkform();">
     <table width="700" border="1" cellpadding="4" cellspacing="1" class="blueborder" bgcolor="#FFFFFF" style="border:#666 1px solid;">
 ...
 $Query = "select Req_Loan_Personal.RequestID as AllRequestID, Name,City, Mobile_Number, id, docpickerid, IDProof, AddressProof, zexternal_appointment_docs.PanCard, SalSlip, BankStmnt, PassSizePhoto, IDProof_Status, AddressProof_Status, PanCard_Status, SalSlip_Status, BankStmnt_Status, PassSizePhoto, PassSizePhoto_Status, AssignBy, docStatus, caller_id from zexternal_appointment_docs LEFT OUTER JOIN Req_Loan_Personal ON Req_Loan_Personal.RequestID= zexternal_appointment_docs.RequestID where id!='' and zexternal_appointment_docs.Reply_Type=1 and zexternal_appointment_docs.viewstatus=1 and zexternal_appointment_docs.docpickerid!=0  and  zexternal_appointment_docs.BankID='".$BankID."' ";
