		...
		if(document.personalloan_form.CC_Holder.value="on")
			{
				...
				ni1.innerHTML = '<select size="1" name="Card_Vintage" class="select" ><option value="0">Please select</option> <option value="1">Less than 6 months</option> <option value="2">6 to 9 months</option> <option value="3">9 to 12 months</option><option value="4">more than 12 months</option> </select>';
			}
		}
		return true;
	}
...
{
	//alert("Kindly fill in your Name!");
	document.getElementById('nameVal2').innerHTML = "<span  class='hintanchor'>Please Enter Your name</span>";		
	Form.Name2.focus();
	return false;
}
else if(containsdigit(Form.Name2.value)==true)
{
	document.getElementById('nameVal2').innerHTML = "<span  class='hintanchor'>Name Contains Numbers</span>";		
//	alert("Name contains numbers!");
	Form.Name2.focus();
	return false;
}
...
for (var i = 0; i < Form.Name2.value.length; i++) 
{
	...
	{
//		alert ("Name has special characters.\n Please remove them and try again.");
		document.getElementById('nameVal2').innerHTML = "<span  class='hintanchor'>Name has special characters</span>";		
		Form.Name2.focus();
		return false;
  	}
}
...
{
	//alert("Kindly fill in your Mobile Number!");
	document.getElementById('mobileVal2').innerHTML = "<span class='hintanchor'>Enter Mobile Number</span>";
	Form.Phone2.focus();
	return false;
}
		...
		{
		  //alert("Enter numeric value in ");
		  document.getElementById('mobileVal2').innerHTML = "<span class='hintanchor'>Enter Numeric Value</span>";
		  Form.Phone2.focus();
		  return false;  
		}
...
//		  alert("Please Enter 10 Digits"); 
		...
		{
                alert("The number should start only with 9 or 8 or 7");
				 document.getElementById('mobileVal2').innerHTML = "<span class='hintanchor'>Start with 9 or 8 or 7</span>";
				 Form.Phone2.focus();
                return false;
        }
	...
	{
//		alert("Accept the Terms and Condition");
		document.getElementById('acceptVal2').innerHTML = "<span  class='hintanchor'>Accept Terms & Condition!</span>";	
		Form.accept2.focus();
		return false;
	}
}
...
function addPersonalDetails()
{
	...
	ni1.innerHTML = '<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td align="left" valign="middle" class="bldtxt" colspan="2" style="padding-top:3px;" ><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="48%"  align="left" class="personal_text" colspan="2"> Personal Details</td></tr><tr><td width="4%" style="font-size:10px; font-weight:normal; color:#999999;"><img src="http://www.deal4loans.com/images/security.png" width="14" height="16"></td><td width="96%" align="left"class="sbi_text_a"  style="font-size:10px; font-weight:normal; color:#156dd1;">Your Information is secure with us & will not be shared without your consent</td></tr></table></td></tr>    <tr>    <td width="42%" height="45" class="form_text">Full Name</td>    <td width="58%"  class="alert_msg"><input name="Name" type="text" class="input" id="Name" tabindex=6  onFocus="onFocusBlank(this,\'Name\');"  onBlur="onBlurDefault(this,\'Name\');" onChange="insertData();" <? if(isset($loan_type)) { ?>value="<? echo $name; ?>" <? }else {?>value=""<? }?>  onkeydown="validateDiv(\'nameVal\');"/><div id="nameVal"></div></td>  </tr>  <tr>    <td height="45" class="form_text">DOB</td>    <td  class="alert_msg"><input name="day" type="text" class="month" id="day" tabindex=7  onFocus="onFocusBlank(this,\'dd\');" onBlur="onBlurDefault(this,\'dd\');" onChange="intOnly(this);" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="dd" maxlength="2" onKeyDown="validateDiv(\'dobVal\');"/> <input name="month" type="text" class="month" id="month" tabindex=8 onFocus="onFocusBlank(this,\'mm\');" onBlur="onBlurDefault(this,\'mm\');" onChange="intOnly(this);" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="mm" maxlength="2" onKeyDown="validateDiv(\'dobVal\');" /> <input name="year" type="text" class="year" id="year" tabindex=9  onFocus="onFocusBlank(this,\'yyyy\');"   onBlur="onBlurDefault(this,\'yyyy\');" onChange="intOnly(this); insertData();" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" value="yyyy" maxlength="4" onKeyDown="validateDiv(\'dobVal\');" /><div id="dobVal"></div></td>  </tr>  <tr>   <td height="45" class="form_text">Mobile No.</td>    <td  class="form_text"  >+91 <input name="Phone" type="text" class="mobile" id="Phone"  tabindex=10 onFocus="addtooltip();" onChange="intOnly(this); tosendsms(); insertData();" onKeyPress="intOnly(this);" onKeyUp="intOnly(this);" maxlength="10"  <? if(isset($loan_type)) { ?>value="<? echo $mobile; ?>" <? }else {?>value="" <? }?> onKeyDown="validateDiv(\'mobileVal\');" /><div id="mobileVal" class="alert_msg"></div></td>  </tr>  <tr>    <td height="45" class="form_text">Email Id</td>    <td class="alert_msg"><input name="Email" id="Email" type="text" <? if(isset($loan_type)) { ?>value="<? echo $Email; ?>" <? }else { ?>value=""<? } ?>   onblur="onBlurDefault(this,\'Email Id\');" onFocus="removetooltip();"  onChange="insertData();" tabindex=11 onKeyDown="validateDiv(\'emailVal\');" class="input" /><div id="emailVal"></div></td>  </tr><tr>    <td height="45" class="form_text">Are you a Credit card holder?</td>    <td  class="form_text"><input type="radio"  name="CC_Holder" id="CC_Holder" value="1" tabindex="12" style="border:none;" onClick="addElement(); validateDiv(\'ccholderVal\');" > Yes <input type="radio"  name="CC_Holder" id="CC_Holder" style="border:none;" tabindex="13" value="0" onClick="removeElement(); validateDiv(\'ccholderVal\'); "> No  <div id="ccholderVal" class="alert_msg" ></div> </td>  </tr>	<tr align="left"> <Td id="myDivcc"  class="form_text" ></Td><Td id="myDivcc1"  ></Td>		  </tr>  <tr>    <td height="0" colspan="2"align="center" class="form_text" style="font-size:10px; text-align:left;"><input type="checkbox"  name="accept" style="border:none;" checked tabindex="15" > I Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank" rel="nofollow">Terms and Conditions</a>.<div id="acceptVal" class="alert_msg"></div></td>  </tr>  <tr>    <td height="0" colspan="2" align="center">&nbsp;</td> </tr>  <tr>    <td height="45" colspan="2" align="center"><input type="image" name="Submit" src="d4limages/aplp_get-quote-btn.jpg" style="width:172px; height:40px; border:none;" tabindex="16" /></td>    </tr>    </table>';
...
<input type="hidden" name="source" value="applypersonal-loans"> 
...
<tr align="left">
  ...
  <tr>
    <td height="34" colspan="2" align="center" class="form_text"  id="personalDetails"><img src="d4limages/aplp_get-quote-btn.jpg" width="172" height="40" /></td>
  </tr>
  <tr>
    <td height="20" colspan="2" align="center" class="form_text">&nbsp;</td>
		...
		<div id="leavenumber" class="hide">
         ...
         <input type="hidden" name="source2" value="applypersonal-loans"> 
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" class="personal_text"> </td>
  </tr>
  <tr>
    <td height="35" colspan="2" style="color:#0881ac;" class="form_text">      Leave your Contact Number &amp; our loan experts will call back with best offers.
  ...
  <tr>
    <td height="35" colspan="2" align="center" class="form_text"><input type="image" name="Submit2" src="d4limages/aplp_submit_btn.jpg" style="width:173px; height:40px; border:none;" /></td>
  </tr>
</table></form>
		</div>
 ...
 <div class="row_a"><span class="text_head" style="font-size:17px;">Top 9 Banks with 3 Banks having NIL Prepayment Charges</span>
   <br>
...
list($cityNum,$ArrRow)=Mainselectfunc($total_amtcntr,$array = array());
