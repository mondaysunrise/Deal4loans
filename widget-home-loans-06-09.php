...
list($alreadyExist,$cfrow)=MainselectfuncNew($cfcampaign,$array = array()); 
...
<div class="form-ui-main-wrapper">
  <div class="form-ui-main-wrapper-inner">
    <form name="loan_form" method="post" action="apply-home-loanscontinue1-06-09.php" onSubmit="return chkform();">
...
<select onkeydown="validateDiv('AgeVal');" class="form-select" name="CoAge" id="CoAge">
            ...
            <div class="form-input-wrapper form-box-left-margin">
              <div class="form-icon"></div>
              <div class="form-clear"></div>
              <input type="text" class="form-input" value="Gross Annual Salary" name="co_monthly_income" id="co_monthly_income" onblur="if (this.value == '') {this.value = 'Gross Annual Salary';}" onfocus="if (this.value == 'Gross Annual Salary') {this.value = '';}"/>
            </div>
            <div class="form-input-wrapper">
              <div class="form-icon"></div>
              <div class="form-clear"></div>
