              ...
              <tr>
				...
				<form name="home_loan"  action="apply-home-loan-thank.php" method="post" onSubmit="return submitform(document.home_loan);" >
						...
						<tr><td colspan="2" align="left" class="nrmltxt" id="myDiv2"></td></tr>
							...
							<input type="hidden" name="Phone" id="Phone" value="<?php echo $_SESSION['Temp_mobile']; ?>" />
							...
							<input type="hidden" name="City_Other" id="City_Other" value="<?php echo $_SESSION['Temp_city_other']; ?>" /></td>
                              </tr>
                              <tr>
