         ...
         <api:userContext>		
				...
				<api:objects>		
					<api:CRMnextObject xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="api:Lead">
						...
						<api:Address>Priya enclave</api:Address>
						<api:AssignToCode></api:AssignToCode>
						<api:AssignToName></api:AssignToName>											
						<api:AssigntoKey></api:AssigntoKey>
						<api:CampaignKey>11</api:CampaignKey>
						<api:CampaignName>NB</api:CampaignName>
						<api:ChildAccountID>-1</api:ChildAccountID>						<api:City>New Delhi</api:City>
						<api:Comments></api:Comments>
						<api:CompanyName>Mywish Marketplace pvt ltd</api:CompanyName>
						<api:Country>India</api:Country>
						<api:CreatedBy>1</api:CreatedBy>
						<api:CreatedByCode></api:CreatedByCode>
						<api:CreatedOn>2017-06-01T11:21:30</api:CreatedOn>
						...
						<api:Custom>
							...
							<api:l_DOB>01/05/1983</api:l_DOB>
							<api:l_PAN>AAAPA2114C</api:l_PAN>
							<api:l_Gross_Monthly_Income>90000</api:l_Gross_Monthly_Income>
							<api:l_Gender>M</api:l_Gender>
							<api:l_MaritalStatus>2</api:l_MaritalStatus>
							<api:l_Father_First_Name></api:l_Father_First_Name>
							<api:FieldID_67>Priya Enclave</api:FieldID_67>
							...
							<api:l_Office_Address1>E-30 Noida</api:l_Office_Address1>
							...
							<api:l_Res_Mobile_No>9599344051</api:l_Res_Mobile_No>
							...
							<api:l_Net_Monthly_Income>90000</api:l_Net_Monthly_Income>
							...
							<api:l_RequiredLoanAmt>100000</api:l_RequiredLoanAmt>
							...
							<api:l_Type>1</api:l_Type>
							 ...
							 <api:l_Currentpincode>110002</api:l_Currentpincode>
							 <api:l_Office_City></api:l_Office_City>
							 <api:l_OfficePincode>201301</api:l_OfficePincode>
							 <api:l_OmniUpdate></api:l_OmniUpdate>
							 <api:FieldID_1042>0</api:FieldID_1042>
							 <api:l_Report_EmpType>1</api:l_Report_EmpType>
							 <api:FieldID_1070>DEALS4 LOANS (WRS Info India P LTd)_MA002</api:FieldID_1070>
							 ...
							 <api:l_Lead_Created_On>19/05/17 18:59 PM</api:l_Lead_Created_On>
							...
							<api:l_RiskStatus>GREEN</api:l_RiskStatus>
							<api:l_RiskGrade>GRADEE</api:l_RiskGrade>
							<api:l_RpPowerRiskStatus>R</api:l_RpPowerRiskStatus>
							<api:l_RPCIBIL_Score>-0001</api:l_RPCIBIL_Score>
							<api:l_RPConnectToken>3197295</api:l_RPConnectToken>
						</api:Custom>															
						<api:District/>
						<api:Email>balbir@deal4loans.com</api:Email>
						<api:EmployeeCount/>
						<!--api:EmployeeCountKey>0</api:EmployeeCountKey-->
						<api:ExternalSLAOn>0001-01-01T00:00:00</api:ExternalSLAOn>
						<api:Fax/>
						<api:FirstName>Balbir</api:FirstName>
						...
						<api:LastName>Singh</api:LastName>
						...
						<api:l_Professional_Status1>1</api:l_Professional_Status1>
						<api:LeadAmount>100000</api:LeadAmount>
						<api:LeadAmountDefault>0</api:LeadAmountDefault>
						<api:LeadKey></api:LeadKey>
						<api:LeadName>Balbir Singh</api:LeadName>
						...
						<api:MobilePhone>9717594462</api:MobilePhone>
...
$soapClient = new nusoap_client("https://cnextuat.fullertonindia.com/CRMnextWebApi/CRMnextService.svc?wsdl", true);   
...
//l_RpPowerRiskStatus has to be passed
?>
