...
if (strlen($pl_bank_name)>1 && $requestid>1)
{
	...
	$ProductValue = Maininsertfunc('Req_Loan_Home_Bankwise', $dataInsert);
}	
?>
...
<title>Apply for Home Loan  | Home Loan Application | Home Loans Comparison Chart</title>
...
<div id="container">
  <div id="txt"  style="padding-top:15px; height:60px;">
   <h1 style="color:#ae4212 !important; margin:0px; padding:0px; font-size:13px !important; line-height:22px; padding-left:20px;" align="center"> Thanks for applying Home Loan from <? echo $pl_bank_name; ?> through Deal4loans.com </h1>
 </div>
</div>
