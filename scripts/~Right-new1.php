	...
	?>	</td>
	 ...
	 <select style="width:137px;" name="Type_Loan">
	  ...
	  <option value="Req_Loan_Personal">Personal Loan</option>
	   ...
	   <option value="Req_Loan_Against_Property" <?php if((strlen(strpos($_SERVER['REQUEST_URI'], "loan-against-property")) > 0))
	{ echo "selected"; } ?>>Loan against Property</option>
 ...
 -->	 </select></td>
  ...
  <tr align="left"><td colspan="2"><input type="hidden" name="source" value="<? if(isset($_REQUEST['source'])) { echo $_REQUEST['source'];} else { echo "QuickApply";} ?>" /></td>
	...
	<tr>
	 ...
	 </tr>	 <tr><td colspan="2" style="color:#000000; font-family:Verdana,Arial,Helvetica,sans-serif; font-size:9px; font-weight:normal; text-align:left;" ><br /><input type="checkbox"  name="accept" style="border:none;" checked > I authorize Deal4loans.com & its partnering Banks to call me with reference to my loan application  & Agree to <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Privacy Policy</a> and <a href="http://www.deal4loans.com/Privacy.php" target="_blank">Terms and Conditions</a>.<br /></td></tr>
...
<div id="tabvanilla" class="widget">
	...
	?>
  <tr>
    <td width="56%" height="22"><? echo $hlrow["bank_name"]; ?> </td>
     <td width="44%"><b><? echo $hlrow["ndtv_rates"]; ?></b></td>
    </tr>
	   <tr>
	...
	<? }?>
                    <!--<tr>
                      <td width="60%" height="22">Axis Bank </td>
                      <td width="40%"><b>8.75%- 9.25%</b></td>
                    </tr>
                    <tr>
                      <td height="2" colspan="2" align="center"><img src="/new-images/bt-line.gif" width="209" height="2" alt="" /></td>
                    </tr>
                    <tr>
                      <td height="22">HDFC </td>
                      <td><b>8.25%- 9.25%</b></td>
                    </tr>
                    <tr>
                      <td height="2" colspan="2" align="center"><img src="/new-images/bt-line.gif" width="209" height="2" alt="" /></td>
                    ...
                    <tr>
                      <td height="22" style="text-align:left; ">ICICI Bank</td>
                      <td><b>8.25%- 9.25%</b></td>
                    </tr>
                    <tr>
                      <td height="2" colspan="2" align="center"><img src="/new-images/bt-line.gif" width="209" height="2" alt="" /></td>
...
<div style="background:url(new-images/bg-bt.jpg); background-repeat:no-repeat; width:250px; height:19px;"></div>
			...
			<div style=" background:url(new-images/rgt-bg.gif); background-repeat:repeat-y; width:250px;">
              <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
<? $getplrates=ExecQuery("Select cat_a,bank_name,others From personal_loan_interest_rate_chart where (flag=1 and rateid in (1,2,3,7))");
while($plrow=mysql_fetch_array($getplrates))
{
?>
<tr>
 <td width="56%" height="22"><? echo $plrow["bank_name"]; ?></td>
<td width="44%"><b><? echo $plrow["cat_a"]."-".$plrow["others"]; ?></b></td>
</tr>
...
<!--<div align="center">
<span style="font-size:11px; color:#333333; width:240px;text-align:center;">Advertisement</span>
<a href="http://www.deal4loans.com/earn-credit-card1.php" target="_blank"><img src="images/250x132.gif" border="0"></a>
</div>-->
		 <?php
		 }
		 ?>
