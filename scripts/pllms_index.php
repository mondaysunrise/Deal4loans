...
$BidderIDstatic="";
	...
	{
		echo $BidderIDstatic=$_REQUEST['BidderIDstatic'];
	}
...
function submitform()
{
 ...
 <input type="text" name="BidderIDstatic" id="BidderIDstatic" value="<? echo $_SESSION["BidderID"];?>">
   <tr>
 ...
 <p>&nbsp;</p>
	...
	if(strlen(trim($RequestID))>0)
	{
		...
		$result = ExecQuery("select FeedbackID from Req_Feedback_PL where AllRequestID=$RequestID and BidderID=".$_SESSION['BidderID']." AND Reply_Type=1");		
...
//		echo $strSQL;
 ...
 <? 
	...
	(
	(MOD(Req_Loan_Personal.RequestID,6)=0 and Req_Loan_Personal.Direct_Allocation=0)
	or
	(MOD(Req_Loan_Personal.RequestID,6)=0 and (DATE_SUB( NOW() , INTERVAL '00:07'
	HOUR_MINUTE ) >= Req_Loan_Personal.Updated_Date) and Req_Loan_Personal.Is_Valid=0 and Req_Loan_Personal.Direct_Allocation=1 and Req_Loan_Personal.Employment_Status=0))
	and 
	((Req_Loan_Personal.Updated_Date Between '".$min_date."' and '".$max_date."' ) or
((Req_Feedback_PL.Followup_Date Between '".$min_date."' and '".$max_date."' ) and Req_Feedback_PL.BidderID='846')) and (Req_Loan_Personal.source!='hdfc_plmlr' and Req_Loan_Personal.source!='PlUploadibibo' and Req_Loan_Personal.source!='postpaid-mailer' and Req_Loan_Personal.ex_source!='below60k' and Req_Loan_Personal.source!='HDFC Bank PL NEW' and Req_Loan_Personal.source!='incoming_call' and Req_Loan_Personal.source!='fullertonmlr' and Req_Loan_Personal.source!='bajajfinserv_testing' and Req_Loan_Personal.source!='HDFC Bank PL' and Req_Loan_Personal.source!='applypersonal-loans')  and Req_Loan_Personal.Allocated=0 ".$salaryfilter." )";
	$qry=$qry.$FeedbackClause;
	//$qry=$qry."group by Req_Loan_Personal.Mobile_Number ";
		}
		elseif($_SESSION['BidderID']==847)
		{
	...
	(
	(MOD(Req_Loan_Personal.RequestID,6)=1 and Req_Loan_Personal.Direct_Allocation=0)
	or
	(MOD(Req_Loan_Personal.RequestID,6)=1 and (DATE_SUB( NOW() , INTERVAL '00:07'
	HOUR_MINUTE ) >= Req_Loan_Personal.Updated_Date) and Req_Loan_Personal.Is_Valid=0 and Req_Loan_Personal.Direct_Allocation=1 and Req_Loan_Personal.Employment_Status=0))
	and ((Req_Loan_Personal.Updated_Date Between '".$min_date."' and '".$max_date."' ) or
((Req_Feedback_PL.Followup_Date Between '".$min_date."' and '".$max_date."' ) and Req_Feedback_PL.BidderID='847')) and (Req_Loan_Personal.source!='hdfc_plmlr' and Req_Loan_Personal.source!='PlUploadibibo' and Req_Loan_Personal.source!='postpaid-mailer' and Req_Loan_Personal.ex_source!='below60k' and Req_Loan_Personal.source!='HDFC Bank PL NEW' and Req_Loan_Personal.source!='HDFC Bank PL' and Req_Loan_Personal.source!='incoming_call' and Req_Loan_Personal.source!='fullertonmlr' and Req_Loan_Personal.source!='bajajfinserv_testing' and Req_Loan_Personal.source!='applypersonal-loans') and Req_Loan_Personal.Allocated=0 ".$salaryfilter." )";
	$qry=$qry.$FeedbackClause;
	//$qry=$qry."group by Req_Loan_Personal.Mobile_Number";
		}
		elseif($_SESSION['BidderID']==854)
		{
...
(
(MOD(Req_Loan_Personal.RequestID,6)=2 and Req_Loan_Personal.Direct_Allocation=0)
or
(MOD(Req_Loan_Personal.RequestID,6)=2 and (DATE_SUB( NOW() , INTERVAL '00:07'
HOUR_MINUTE ) >= Req_Loan_Personal.Updated_Date) and Req_Loan_Personal.Is_Valid=0 and Req_Loan_Personal.Direct_Allocation=1 and Req_Loan_Personal.Employment_Status=0))
and ((Req_Loan_Personal.Updated_Date Between '".$min_date."' and '".$max_date."' ) or
((Req_Feedback_PL.Followup_Date Between '".$min_date."' and '".$max_date."' ) and Req_Feedback_PL.BidderID='854')) and (Req_Loan_Personal.source!='hdfc_plmlr' and Req_Loan_Personal.source!='PlUploadibibo' and Req_Loan_Personal.source!='postpaid-mailer' and Req_Loan_Personal.ex_source!='below60k' and Req_Loan_Personal.source!='HDFC Bank PL NEW' and Req_Loan_Personal.source!='HDFC Bank PL' and Req_Loan_Personal.source!='incoming_call' and Req_Loan_Personal.source!='fullertonmlr' and Req_Loan_Personal.source!='bajajfinserv_testing' and Req_Loan_Personal.source!='applypersonal-loans') and Req_Loan_Personal.Allocated=0 ".$salaryfilter." )";
		$qry=$qry.$FeedbackClause;
	//	$qry=$qry."group by Req_Loan_Personal.Mobile_Number";
		}
		elseif($_SESSION['BidderID']==9)
		{
...
(
(MOD(Req_Loan_Personal.RequestID,6)=3 and Req_Loan_Personal.Direct_Allocation=0)
or
(MOD(Req_Loan_Personal.RequestID,6)=3 and (DATE_SUB( NOW() , INTERVAL '00:07'
HOUR_MINUTE ) >= Req_Loan_Personal.Updated_Date) and Req_Loan_Personal.Is_Valid=0 and Req_Loan_Personal.Direct_Allocation=1 and Req_Loan_Personal.Employment_Status=0))
and ((Req_Loan_Personal.Updated_Date Between '".$min_date."' and '".$max_date."' ) or
((Req_Feedback_PL.Followup_Date Between '".$min_date."' and '".$max_date."' ) and Req_Feedback_PL.BidderID='9')) and (Req_Loan_Personal.source!='hdfc_plmlr' and Req_Loan_Personal.source!='PlUploadibibo' and Req_Loan_Personal.source!='postpaid-mailer' and Req_Loan_Personal.ex_source!='below60k' and Req_Loan_Personal.source!='HDFC Bank PL NEW' and Req_Loan_Personal.source!='HDFC Bank PL' and Req_Loan_Personal.source!='incoming_call' and Req_Loan_Personal.source!='fullertonmlr' and Req_Loan_Personal.source!='bajajfinserv_testing' and Req_Loan_Personal.source!='applypersonal-loans') and Req_Loan_Personal.Allocated=0 ".$salaryfilter." )";
		$qry=$qry.$FeedbackClause;
	//	$qry=$qry."group by Req_Loan_Personal.Mobile_Number";
		}
elseif($_SESSION['BidderID']==10)
		{
...
(
(MOD(Req_Loan_Personal.RequestID,6)=4 and Req_Loan_Personal.Direct_Allocation=0)
or
(MOD(Req_Loan_Personal.RequestID,6)=4 and (DATE_SUB( NOW() , INTERVAL '00:07'
HOUR_MINUTE ) >= Req_Loan_Personal.Updated_Date) and Req_Loan_Personal.Is_Valid=0 and Req_Loan_Personal.Direct_Allocation=1 and Req_Loan_Personal.Employment_Status=0))
and ((Req_Loan_Personal.Updated_Date Between '".$min_date."' and '".$max_date."' ) or
((Req_Feedback_PL.Followup_Date Between '".$min_date."' and '".$max_date."' ) and Req_Feedback_PL.BidderID='10')) and (Req_Loan_Personal.source!='hdfc_plmlr' and Req_Loan_Personal.source!='PlUploadibibo' and Req_Loan_Personal.source!='postpaid-mailer' and Req_Loan_Personal.ex_source!='below60k' and Req_Loan_Personal.source!='HDFC Bank PL NEW' and Req_Loan_Personal.source!='HDFC Bank PL' and Req_Loan_Personal.source!='incoming_call' and Req_Loan_Personal.source!='fullertonmlr' and Req_Loan_Personal.source!='bajajfinserv_testing' and Req_Loan_Personal.source!='applypersonal-loans')  and Req_Loan_Personal.Allocated=0 ".$salaryfilter." )";
		$qry=$qry.$FeedbackClause;
		}
		elseif($_SESSION['BidderID']==63)
		{
...
(
(MOD(Req_Loan_Personal.RequestID,6)=5 and Req_Loan_Personal.Direct_Allocation=0)
or
(MOD(Req_Loan_Personal.RequestID,6)=5 and (DATE_SUB( NOW() , INTERVAL '00:07'
HOUR_MINUTE ) >= Req_Loan_Personal.Updated_Date) and Req_Loan_Personal.Is_Valid=0 and Req_Loan_Personal.Direct_Allocation=1 and Req_Loan_Personal.Employment_Status=0))
and ((Req_Loan_Personal.Updated_Date Between '".$min_date."' and '".$max_date."' ) or
((Req_Feedback_PL.Followup_Date Between '".$min_date."' and '".$max_date."' ) and Req_Feedback_PL.BidderID='63')) and (Req_Loan_Personal.source!='hdfc_plmlr' and Req_Loan_Personal.source!='PlUploadibibo' and Req_Loan_Personal.source!='postpaid-mailer' and Req_Loan_Personal.ex_source!='below60k' and Req_Loan_Personal.source!='HDFC Bank PL NEW' and Req_Loan_Personal.source!='HDFC Bank PL' and Req_Loan_Personal.source!='incoming_call' and Req_Loan_Personal.source!='fullertonmlr' and Req_Loan_Personal.source!='bajajfinserv_testing' and Req_Loan_Personal.source!='applypersonal-loans')  and Req_Loan_Personal.Allocated=0 ".$salaryfilter." )";
		$qry=$qry.$FeedbackClause;
		}
		else
		{
