...
//Exact Loan Amount
	...
	//echo "<br><br>here 3 : <br><br>".$loan_amount;
############final loan amount is here#########################
//echo "jhij".$loan_amount."-".$reqdloan_amount;
if(round($loan_amount)>$reqdloan_amount)
	...
	//echo "here i m ";
		...
		//echo $company."-".$category."-".$reqdloan_amount."-".$interestrate."-".$intr."-".$proc_Fee."-".$calcterm."-".$getterm;
	}
#####################################
...
if(($comppos>=0 && $comppos!='') && $loan_amount>1000000)
	{
	...
	elseif(($comppos>=0 && $comppos!='') && $loan_amount<1000000)
	{
		//echo "enter";
	if($loan_amount<1000000 && ($category=="Elite" || $category=="SuperPrime" || $category=="Preferred" || $category=="SUPERPRIME"  || $category=="ELITE" || $category=="PREFERRED"))
	{
