...
function SendSMSAir2Web($SMSMessage, $PhoneNumber)
{
	...
	// 6161
	/*$param["pcode"] = "DEAL4LOANS"; 
	$param["acode"] = "DEAL4LOANS"; 
	$param["message"] = $SMSMessage; //this is the message that we want to send
	$param["mnumber"] = "91".$PhoneNumber; //these are the recipients of the message
	$param["pin"] = "dl4ln";
	*/
...
//	print_r($output);
	...
	if(strlen($getMob)>0)
	{
		$insSql = "INSERT INTO tracksms ( Phone , Reply_Type , RequestID, Dated, Status )VALUES ('".$getMob."', '".$Reply_Type."', '".$RequestID."', Now(), '".$output[9]."')";
