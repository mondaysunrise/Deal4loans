...
function PlgetDigitToWords(field,formattednoId,wordId){
		...
		var emplomentstat = document.getElementById('Employment_Status').value;
		/*if(emplomentstat==1)
					{
				var MONTHLY_SUFFIX ="Annualy Income";
