...
{
	var gifName = form;
	document.frmsearch.action="commonf_lms_view.php?search=y"+gifName;
...
<tr>
 ...
 <form name="frmsearch" action="commonf_lms_view.php?search=y" method="post" onSubmit="return chkform();">
   <tr>
...
//		echo $strSQL;
 ...
 ?>
   ...
   <tr>   
	 ...
	 <td width="71" align="center" bgcolor="#FFFFFF" class="style2">Total Cost</td>
   </tr>
	<?
...
//echo $qry;
   ...
   <tr> 
     <td align="left" bgcolor="#DFF6FF" class="style3" ><? echo $row["Name"]; ?></td>
	 <td align="left" bgcolor="#DFF6FF" class="style3"><? echo $row["City"]; ?></td>
	...
	<? $geteligiblebidder=ExecQuery("select BidderID From Req_Feedback_Bidder1 where (Reply_Type=".$pro_code." and AllRequestID=".$row["RequestID"].")");
	 ...
	 while($get=mysql_fetch_array($geteligiblebidder))
		...
		//	print_r($arrgetBidderID);
			?>
	<td align="left" bgcolor="#DFF6FF" class="style3"><? //echo implode(",",$arrgetBidderID); 
	//echo "<br>";
	echo implode(",",$arrgetBidderName); ?></td>
<? 
$strgetBidderID= implode(",",$arrgetBidderID);
list($getsumcost)=checktotalcost($strgetBidderID,$pro_code);
	 ?>

	<td align="center" bgcolor="#DFF6FF" class="style3"><? if($getsumcost>0) echo $getsumcost; ?></td>
