...
//print_r($_REQUEST);
?>
<select name="car_model" id="car_model"  style="height:25px; width:170px" onChange="return addMagma();" >
...
for($cN=0;$cN<$numRowsCarName;$cN++)
{
	...
	?>
 	<option value="<?php echo $hdfc_clid; ?>"><?php echo $hdfc_car_manufacturer; ?></option>   
    <?php
}
?>
</select>
